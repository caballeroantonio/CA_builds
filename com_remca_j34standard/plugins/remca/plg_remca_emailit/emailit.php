...
//like houseicon->email
    ...
    private function populateParams() {
        ...
        $arrParams = array("FB_appId","headline_content","headline_font-family","headline_font-size","headline_color","popup","mobile_position","rounded","size","emailit_branding","mobile_services","mob_button_set","mobile_back_color","logo","circular","global_button","toolbar_type","global_back_color","back_color","default_buttons","follow_services","thanks_message","display_counter", "global_text_color","text_color","text_display","mobile_bar","after_share_dialog","display_ads","hover_pinit","ad_url","follow_after_share","open_on","auto_popup","show_frontpage", "position", "filter_art", "filter_cat", "filter_sec", "TwitterID");
