jQuery(document).ready(function () {
    ...
    jQuery.getScript("plugins/content/emailit/js/button.js", function () {
        ...
        function mobileButttonSetChanged() {
            ...
            if (value === "mob_custom") {
                jQuery("#jform_params_mobile_services").parent().show();
            } else {
                jQuery("#jform_params_mobile_services").parent().hide();
            }
        }
        mobileButttonSetChanged();
        ...
        function styleChanged() {
            ...
            var nativeServices = ["Facebook", "Facebook_Like", "Facebook_Like_and_Share", "Messenger", "Twitter", "Google_Plus", "LinkedIn", "Pinterest", "VKontakte", "Odnoklassniki"];
            var value = jQuery("#jform_params_toolbar_type input[type='radio']:checked").val();
            if (value === "native") {
                jQuery("#jform_params_size").parent().hide();
                jQuery("#jform_params_text_color").parent().hide();
                jQuery("#jform_params_back_color").parent().hide();
                jQuery("#jform_params_rounded").parent().hide();
                jQuery("#jform_params_text_display").parent().show();
                jQuery("#jform_params_global_text_color").parent().show();
                ...
                jQuery("#servicess label").each(function () {
                    ...
                    jQuery("#jform_params_text_display").parent().hide();                    
                    jQuery("#servicess label").show();
                    jQuery("#servicess label#Facebook_Like, #servicess label#Facebook_Like_and_Share").hide();
                    ...
                    jQuery("#jform_params_back_color").parent().show();
                    jQuery("#jform_params_global_text_color").parent().hide();
                if (value === "wide") {
                    jQuery("#jform_params_text_color").parent().show();
                    jQuery("#jform_params_rounded").parent().show();
                    jQuery("#jform_params_global_text_color").parent().show();
                    jQuery("#jform_params_text_display").parent().show();
