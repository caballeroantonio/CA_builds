 ...
 * @package			com_remca
 * @subpackage		com_remca.finder.remca.wa_entry_conversations
 * @copyright		
...
/**
 * Finder adapter for com_remca - wa_entry_conversations
 *
 */
class PlgFinderWa_entry_conversations extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Wa_entry_conversations';
	 ...
	 */
	protected $layout = 'wa_entry_conversation';
	 ...
	 */
	protected $table = '#__rem_wa_entry_conversations';
	...
	{
		if ($context == 'com_remca.wa_entry_conversation')
		{
			$id = $table->id;
		}
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = RemcaHelperRoute::getWa_entry_conversationRoute($item->slug, $item->catid, $this->sub_layout);
		...
		$item->addTaxonomy('Type', 'Entrada De La Conversación Whatsapp');
