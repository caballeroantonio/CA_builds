 ...
 *
 */
class RemcaTableRem_categories extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_rem_categories', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.rem_category'));
	}
