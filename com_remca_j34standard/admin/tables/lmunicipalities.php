 ...
 *
 */
class RemcaTableLmunicipalities extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_lmunicipalities', 'id', $db);
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lmunicipalities','RemcaTable');

		// For all keys
		foreach ($pks as $pk)
		{
			// Load the lmunicipality
			if(!$table->load($pk))
			{
