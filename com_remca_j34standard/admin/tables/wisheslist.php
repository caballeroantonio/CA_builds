 ...
 *
 */
class RemcaTableWisheslist extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_wisheslist', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.wishlist'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Wisheslist','RemcaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Favorito. A created and created_by field can be set by the user,
