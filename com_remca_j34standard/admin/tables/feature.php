 ...
 *
 */
class RemcaTableFeature extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.feature'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Feature','RemcaTable');
