 ...
 *
 */
class RemcaTableMainCategories extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.maincategory'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('MainCategories', 'RemcaTable');
