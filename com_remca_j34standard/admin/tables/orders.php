 ...
 *
 */
class RemcaTableOrders extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_orders', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.order'));
	}
