 ...
 *
 */
class RemcaTableFeature_houses extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_feature_houses', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.feature_house'));
	}
