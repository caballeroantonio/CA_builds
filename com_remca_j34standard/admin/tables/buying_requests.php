...
/**
 * Buying_request table
 *
 */
class RemcaTableBuying_requests extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_buying_requests', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.buying_request'));
	}
