 ...
 *
 */
class RemcaTableUsersWishlist extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_users_wishlist', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.userswishlist'));
	}
