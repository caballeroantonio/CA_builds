 ...
 *
 */
class RemcaTableMain_categories extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.main_category'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Main_categories', 'RemcaTable');
		if ($table->load(array('alias'=>$this->alias)) AND ($table->id != $this->id OR $this->id==0))
		{
			$this->setError(JText::_('COM_REMCA_FIELD_ALIAS_DUPLICATED'));
			return false;
		}		
