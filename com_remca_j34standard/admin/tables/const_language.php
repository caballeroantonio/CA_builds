...
/**
 * Const_language table
 *
 */
class RemcaTableConst_language extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_const_language', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.const_language'));
	}
