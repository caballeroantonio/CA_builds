...
/**
 * Mls_for_delete table
 *
 */
class RemcaTableMls_for_delete extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_mls_for_delete', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.mls_for_delete'));
	}
