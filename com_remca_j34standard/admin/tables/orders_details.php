 ...
 *
 */
class RemcaTableOrders_details extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rem_orders_details', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_remca.orders_detail'));
	}
