...
/**
 * Wa_entry_conversation Field class from the Joomla! Framework.
 *
 */
class JFormFieldWa_entry_conversation extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * 
	 */
	protected $type = 'Wa_entry_conversation';
