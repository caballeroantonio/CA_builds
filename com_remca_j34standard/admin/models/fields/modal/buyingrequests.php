 ...
 *
 */
class JFormFieldModal_BuyingRequests extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * 
	 */
	protected $type = 'Modal_BuyingRequests';
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_remca&amp;view=buying_requests&amp;layout=modal&amp;tmpl=component&amp;function=jSelectBuyingRequest_'.$this->id;
		...
		if ($allow_edit)
		{
			$html[] = '<a class="btn hasTooltip'.($value ? '' : ' hidden').'" href="index.php?option=com_remca&layout=modal&tmpl=component&task=buyingrequest.edit&id=' . $value. '" target="_blank" title="'.JHtml::tooltipText('COM_REMCA_BUYING_REQUESTS_EDIT_DESC').'" ><span class="icon-edit"></span> ' . JText::_('JACTION_EDIT') . '</a>';
		}
