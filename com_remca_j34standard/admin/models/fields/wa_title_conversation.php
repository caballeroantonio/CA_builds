...
/**
 * Wa_title_conversation Field class from the Joomla! Framework.
 *
 */
class JFormFieldWa_title_conversation extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * 
	 */
	protected $type = 'Wa_title_conversation';
