 ...
 *
 */
class RemcaModelWishlist extends JModelAdmin
{
	/**
	...
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.wishlist')
	 */
	 ...
	 */
	protected $event_before_save = 'onWishlistBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onWishlistAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onWishlistBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onWishlistAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onWishlistChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.wishlist.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the favorito version number.
		$table->version++;
	}
	/**
