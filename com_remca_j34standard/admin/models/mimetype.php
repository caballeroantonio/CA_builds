 ...
 *
 */
class RemcaModelMimeType extends JModelAdmin
{
	/**
	...
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.mimetype')
	 */
	 ...
	 */
	protected $event_before_save = 'onMimeTypeBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onMimeTypeAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onMimeTypeBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onMimeTypeAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.mimetype.data', array());
