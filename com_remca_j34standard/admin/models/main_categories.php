...
/**
 * Methods supporting a list of main_category records.
 *
 */
class RemcaModelMain_categories extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if ($assoc)
		{
			...
			$query->join('LEFT', $db->quoteName('#__associations').' AS as1 ON '.$db->quoteName('as1.id').' = '.$db->quoteName('a.id').' AND '.$db->quoteName('as1.context').' = '.$db->quote('com_remca.main_category.item'));
