 ...
 *
 */
class RemcaModelRent extends JModelAdmin
{
	/**
	...
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.rent')
	 */
	public $typeAlias = 'com_remca.rent';	
	/**
	 * @var		string	The context for the app call.
	 */
	protected $context = 'com_remca.rents';	
	/**
	 * @var		string	The event to trigger after before the data.
	 */
	protected $event_before_save = 'onRentBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onRentAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onRentBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onRentAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.rent.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the rent version number.
		$table->version++;
	}
	/**
