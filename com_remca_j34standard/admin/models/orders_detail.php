 ...
 *
 */
class RemcaModelOrders_detail extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_ORDERS_DETAILS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.orders_detail')
	 */
	 ...
	 */
	protected $event_before_save = 'onOrders_detailBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onOrders_detailAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onOrders_detailBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onOrders_detailAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.orders_detail.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the orders_detail version number.
		$table->version++;
	}
	/**
