 ...
 *
 */
class RemcaModelOrder extends JModelAdmin
{
	/**
	...
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.order')
	 */
	 ...
	 */
	protected $event_before_save = 'onOrderBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onOrderAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onOrderBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onOrderAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.order.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the order version number.
		$table->version++;
	}
	/**
