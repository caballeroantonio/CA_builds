...
/**
 * Buying_request model.
 *
 */
class RemcaModelBuying_request extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_BUYING_REQUESTS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.buying_request')
	 */
	 ...
	 */
	protected $event_before_save = 'onBuying_requestBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onBuying_requestAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onBuying_requestBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onBuying_requestAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.buying_request.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the buying requests version number.
		$table->version++;
	}
	/**
