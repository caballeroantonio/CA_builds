 ...
 *
 */
class RemcaModelFeatureHouse extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_FEATURE_HOUSES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.featurehouse')
	 */
	 ...
	 */
	protected $event_before_save = 'onFeatureHouseBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onFeatureHouseAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onFeatureHouseBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onFeatureHouseAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.featurehouse.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the feature_house version number.
		$table->version++;
	}
	/**
