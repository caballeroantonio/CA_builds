 ...
 *
 */
class RemcaModelRem_category extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_REM_CATEGORIES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.rem_category')
	 */
	 ...
	 */
	protected $event_before_save = 'onRem_categoryBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onRem_categoryAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onRem_categoryBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onRem_categoryAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.rem_category.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the category version number.
		$table->version++;
	}
	/**
