 ...
 *
 */
class RemcaModelMime_type extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_MIME_TYPES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.mime_type')
	 */
	 ...
	 */
	protected $event_before_save = 'onMime_typeBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onMime_typeAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onMime_typeBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onMime_typeAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.mime_type.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the mime_type version number.
		$table->version++;
	}
	/**
