 ...
 *
 */
class RemcaModelLstate extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_LSTATES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_remca.lstate')
	 */
	 ...
	 */
	protected $event_before_save = 'onLstateBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLstateAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLstateBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLstateAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLstateChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_remca.edit.lstate.data', array());
