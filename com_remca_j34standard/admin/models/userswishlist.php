...
/**
 * Methods supporting a list of userswishlist records.
 *
 */
class RemcaModelUsersWishlist extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// Select the required users_wishlists from the table.
		$query->select(
			$this->getState(
					'list.select',
					'a.*'
		...
		// Filter by and return name for fk_userid level. %@ToDo fix, if NOT INCLUDE_NAME then OBJECT_LABEL_FIELD = OBJECT_ORDERING_FIELD, then SELECT  is repeated, e.id AS e_expediente_id x 2
