...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.wa_title_conversation';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_WA_TITLE_CONVERSATIONS' AND `type`='component';
DROP TABLE IF EXISTS `#__rem_wa_entry_conversations`;
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.wa_entry_conversation';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_WA_ENTRY_CONVERSATIONS' AND `type`='component';
...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.mime_type';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_MIME_TYPES' AND `type`='component';
DROP TABLE IF EXISTS `#__rem_mls_for_delete`;
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.mls_for_delete';
...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.orders_detail';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_ORDERS_DETAILS' AND `type`='component';
DROP TABLE IF EXISTS `#__rem_main_categories`;
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.main_category';
...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.rent_request';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_RENT_REQUESTS' AND `type`='component';
DROP TABLE IF EXISTS `#__rem_rent_sal`;
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.rent_sal';
...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.track_source';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_TRACK_SOURCE' AND `type`='component';
DROP TABLE IF EXISTS `#__rem_wisheslist`;
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.wishlist';
DELETE FROM `#__menu` WHERE `title`='COM_REMCA_WISHESLIST' AND `type`='component';
DROP TABLE IF EXISTS `#__rem_video_source`;
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.video_source';
...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.const_language';
...
DELETE FROM `#__content_types` WHERE `type_alias` = 'com_remca.feature_house';
