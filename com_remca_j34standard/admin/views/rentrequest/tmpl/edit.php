...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rentrequest&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rentrequest-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'rentrequest-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rentrequest-tabs', 'details', JText::_('COM_REMCA_RENT_REQUEST_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('rentrequest_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'rentrequest-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rentrequest-tabs', 'fieldset-jos_rem_rent_request_fs', JText::_('COM_REMCA_RENT_REQUEST_FIELDSET_JOS_REM_RENT_REQUEST_FS_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<?php foreach($this->form->getFieldset('fieldset_jos_rem_rent_request_fs') as $field): ?>
					<?php if (!$field->hidden) : ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="rentrequest-form" />
