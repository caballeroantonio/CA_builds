...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=video_source&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="video_source-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'video_source-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'video_source-tabs', 'details', JText::_('COM_REMCA_VIDEO_SOURCE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('video_source_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'video_source-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'video_source-tabs', 'fieldset-video_source_fs', JText::_('COM_REMCA_VIDEO_SOURCE_FIELDSET_VIDEO_SOURCE_FS_LABEL', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="video_source-form" />
