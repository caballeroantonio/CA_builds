...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mls_for_delete'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="mls_for_delete-list">
			<thead>
				<tr>
