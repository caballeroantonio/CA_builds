...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mls_for_delete&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="mls_for_delete-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'mls_for_delete-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mls_for_delete-tabs', 'details', JText::_('COM_REMCA_MLS_FOR_DELETE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('mls_for_delete_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'mls_for_delete-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mls_for_delete-tabs', 'fieldset-mls_for_delete_fs', JText::_('COM_REMCA_MLS_FOR_DELETE_FIELDSET_MLS_FOR_DELETE_FS_LABEL', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="mls_for_delete-form" />
