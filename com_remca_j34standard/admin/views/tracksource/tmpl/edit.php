...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=tracksource&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="tracksource-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'tracksource-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'tracksource-tabs', 'details', JText::_('COM_REMCA_TRACK_SOURCE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'tracksource-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'tracksource-tabs', 'fieldset-jos_rem_track_source_fs', JText::_('COM_REMCA_TRACK_SOURCE_FIELDSET_JOS_REM_TRACK_SOURCE_FS_LABEL', true)); ?>
