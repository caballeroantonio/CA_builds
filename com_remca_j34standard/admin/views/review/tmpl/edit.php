...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=review&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="review-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'review-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'review-tabs', 'details', JText::_('COM_REMCA_REVIEWS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'review-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'review-tabs', 'fieldset-review_fs', JText::_('COM_REMCA_REVIEWS_FIELDSET_REVIEW_FS_LABEL', true)); ?>
