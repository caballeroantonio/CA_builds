...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=review'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="review-list">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'review.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'review');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'review');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'review');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'review');
								endif;
