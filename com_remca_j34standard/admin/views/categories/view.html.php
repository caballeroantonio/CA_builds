...
class RemcaViewCategories extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_REMCA_CATEGORIES_LIST_HEADER'), 'stack categories');
		...
		JToolbarHelper::deleteList('', 'categories.delete','JTOOLBAR_DELETE');
                ...
                JToolbarHelper::custom('categories.export', 'download','download', 'JTOOLBAR_EXPORT', FALSE);

				
		JToolbarHelper::preferences('com_remca');
		JToolbarHelper::help('JHELP_COMPONENTS_COM_REMCA_CATEGORY', true, null, 'com_remca');
	}
	/**
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_remca&view=categories');
