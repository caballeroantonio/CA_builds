...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=feature'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="feature-list">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'feature.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'feature');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'feature');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'feature');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'feature');
								endif;
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=feature.edit&id='.(int) $item->id); ?>">
