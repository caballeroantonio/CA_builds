...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=feature&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="feature-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'feature-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'feature-tabs', 'details', JText::_('COM_REMCA_FEATURE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('feature_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'feature-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'feature-tabs', 'fieldset-jos_rem_feature_fs', JText::_('COM_REMCA_FEATURE_FIELDSET_JOS_REM_FEATURE_FS_LABEL', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="feature-form" />
