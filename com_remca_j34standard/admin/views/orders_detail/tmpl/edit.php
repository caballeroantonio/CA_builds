...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=orders_detail&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="orders_detail-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'orders_detail-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'orders_detail-tabs', 'details', JText::_('COM_REMCA_ORDERS_DETAILS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'orders_detail-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'orders_detail-tabs', 'fieldset-orders_details_fs', JText::_('COM_REMCA_ORDERS_DETAILS_FIELDSET_ORDERS_DETAILS_FS_LABEL', true)); ?>
