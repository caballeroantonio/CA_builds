...
$function	= $app->input->get('function', 'jSelectMime_type');
...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mime_types&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
