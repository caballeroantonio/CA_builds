...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mime_types'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="mime_type-list">
			<thead>
				<tr>
