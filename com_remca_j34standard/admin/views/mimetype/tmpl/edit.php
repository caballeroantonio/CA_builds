...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mimetype&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="mimetype-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'mimetype-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mimetype-tabs', 'details', JText::_('COM_REMCA_MIME_TYPES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'mimetype-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
