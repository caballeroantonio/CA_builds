...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=lstate&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lstate-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lstate-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lstate-tabs', 'details', JText::_('COM_REMCA_LSTATES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lstate-tabs', 'fieldset-state_fs', JText::_('COM_REMCA_LSTATES_FIELDSET_STATE_FS_LABEL', true)); ?>
