...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_remca&task=lstates.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'lstate-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=lstates'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="lstate-list">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'lstates.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'lstates');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'lstates');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'lstates');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'lstates');
								endif;
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=lstate.edit&id='.(int) $item->id); ?>">
