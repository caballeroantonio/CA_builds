...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=language&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="language-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'language-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'language-tabs', 'details', JText::_('COM_REMCA_LANGUAGES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'language-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
