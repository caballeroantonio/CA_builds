...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=order&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="order-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'order-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'order-tabs', 'details', JText::_('COM_REMCA_ORDERS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('order_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'order-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'order-tabs', 'fieldset-jos_rem_orders_fs', JText::_('COM_REMCA_ORDERS_FIELDSET_JOS_REM_ORDERS_FS_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<?php foreach($this->form->getFieldset('fieldset_jos_rem_orders_fs') as $field): ?>
					<?php if (!$field->hidden) : ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="order-form" />
