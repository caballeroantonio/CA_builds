		...
		<?php echo JHtml::_('bootstrap.startTabSet', 'order-tabs', array('active' => 'details')); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'order-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'order-tabs', 'fieldset-orders_fs', JText::_('COM_REMCA_ORDERS_FIELDSET_ORDERS_FS_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<?php foreach($this->form->getFieldset('fieldset_orders_fs') as $field): ?>
					<?php if (!$field->hidden) : ?>
