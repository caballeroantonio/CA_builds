...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mime_type&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="mime_type-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'mime_type-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mime_type-tabs', 'details', JText::_('COM_REMCA_MIME_TYPES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'mime_type-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mime_type-tabs', 'fieldset-mime_types_fs', JText::_('COM_REMCA_MIME_TYPES_FIELDSET_MIME_TYPES_FS_LABEL', true)); ?>
