...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=const_language'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="const_language-list">
			<thead>
				<tr>
