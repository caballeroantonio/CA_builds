...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=lmunicipality&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lmunicipality-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lmunicipality-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lmunicipality-tabs', 'details', JText::_('COM_REMCA_LMUNICIPALITIES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lmunicipality-tabs', 'fieldset-municipality_fs', JText::_('COM_REMCA_LMUNICIPALITIES_FIELDSET_MUNICIPALITY_FS_LABEL', true)); ?>
