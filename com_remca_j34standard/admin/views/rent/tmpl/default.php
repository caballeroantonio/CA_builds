...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
							<?php if ($item->checked_out) : ?>
								<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'rent.', $can_checkin); ?>
							<?php endif; ?>	
