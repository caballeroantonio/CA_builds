...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rent-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'rent-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rent-tabs', 'details', JText::_('COM_REMCA_RENT_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'rent-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rent-tabs', 'fieldset-jos_rem_rent_fs', JText::_('COM_REMCA_RENT_FIELDSET_JOS_REM_RENT_FS_LABEL', true)); ?>
