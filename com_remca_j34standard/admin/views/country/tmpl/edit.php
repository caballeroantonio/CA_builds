...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=country&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="country-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'country-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'country-tabs', 'details', JText::_('COM_REMCA_COUNTRIES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'country-tabs', 'fieldset-country_fs', JText::_('COM_REMCA_COUNTRIES_FIELDSET_COUNTRY_FS_LABEL', true)); ?>
