...
class RemcaViewCountry extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		JToolbarHelper::help('JHELP_COMPONENTS_COM_REMCA_COUNTRY_EDIT', true, null, 'com_remca');
		$this->addToolbar();
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
				JText::_('COM_REMCA_COUNTRIES_' . (isset($checkedOut) && $checkedOut ? 'VIEW_HEADER' : ($is_new ? 'NEW_HEADER' : 'EDIT_HEADER'))), 
				'countries.png'
		);
