		...
		<?php echo JHtml::_('bootstrap.startTabSet', 'constlanguage-tabs', array('active' => 'details')); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'constlanguage-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'constlanguage-tabs', 'fieldset-const_languages_fs', JText::_('COM_REMCA_CONST_LANGUAGE_FIELDSET_CONST_LANGUAGES_FS_LABEL', true)); ?>
