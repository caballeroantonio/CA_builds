...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=constlanguage&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="constlanguage-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'constlanguage-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'constlanguage-tabs', 'details', JText::_('COM_REMCA_CONST_LANGUAGE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'constlanguage-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'constlanguage-tabs', 'fieldset-jos_rem_const_languages_fs', JText::_('COM_REMCA_CONST_LANGUAGE_FIELDSET_JOS_REM_CONST_LANGUAGES_FS_LABEL', true)); ?>
