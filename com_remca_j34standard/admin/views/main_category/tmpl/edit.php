...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=main_category&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="main_category-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'main_category-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'main_category-tabs', 'details', JText::_('COM_REMCA_MAIN_CATEGORIES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('main_category_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'main_category-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'main_category-tabs', 'fieldset-main_categories_fs', JText::_('COM_REMCA_MAIN_CATEGORIES_FIELDSET_MAIN_CATEGORIES_FS_LABEL', true)); ?>
			...
			<?php foreach ($fieldsets as $name => $fieldset) :?>
				<?php echo JHtml::_('bootstrap.addTab', 'main_category-tabs', 'params-'.$name, JText::_($fieldset->label, true)); ?>
				<div class="row-fluid form-horizontal-desktop">
					
						<?php
						if (isset($fieldset->description) AND trim($fieldset->description)) :
							echo '<p class="alert alert-info">'.JText::_($fieldset->description).'</p>';
						endif;
						?>
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'main_category-tabs', 'associations', JText::_('COM_REMCA_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'main_category-tabs', 'permissions', JText::_('COM_REMCA_MAIN_CATEGORIES_FIELDSET_RULES', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="main_category-form" />
