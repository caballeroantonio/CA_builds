...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mlsfordelete&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="mlsfordelete-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'mlsfordelete-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mlsfordelete-tabs', 'details', JText::_('COM_REMCA_MLS_FOR_DELETE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'mlsfordelete-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'mlsfordelete-tabs', 'fieldset-jos_rem_mls_for_delete_fs', JText::_('COM_REMCA_MLS_FOR_DELETE_FIELDSET_JOS_REM_MLS_FOR_DELETE_FS_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<?php foreach($this->form->getFieldset('fieldset_jos_rem_mls_for_delete_fs') as $field): ?>
					<?php if (!$field->hidden) : ?>
