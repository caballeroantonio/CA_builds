...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=buying_request&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="buying_request-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'buying_request-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'buying_request-tabs', 'details', JText::_('COM_REMCA_BUYING_REQUESTS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'buying_request-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'buying_request-tabs', 'fieldset-buying_request_fs', JText::_('COM_REMCA_BUYING_REQUESTS_FIELDSET_BUYING_REQUEST_FS_LABEL', true)); ?>
