...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rents'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="rent-list">
			<thead>
				<tr>
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
							<?php if ($item->checked_out) : ?>
								<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'rents.', $can_checkin); ?>
							<?php endif; ?>	
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=rent.edit&id='.(int) $item->id); ?>">
