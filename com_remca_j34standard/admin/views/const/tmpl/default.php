...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=const'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="const-list">
			<thead>
				<tr>
