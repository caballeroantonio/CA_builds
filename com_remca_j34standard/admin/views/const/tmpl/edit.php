...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=const&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="const-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'const-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'const-tabs', 'details', JText::_('COM_REMCA_CONST_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'const-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'const-tabs', 'fieldset-jos_rem_const_fs', JText::_('COM_REMCA_CONST_FIELDSET_JOS_REM_CONST_FS_LABEL', true)); ?>
