...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=track_source&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="track_source-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'track_source-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'track_source-tabs', 'details', JText::_('COM_REMCA_TRACK_SOURCE_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'track_source-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'track_source-tabs', 'fieldset-track_source_fs', JText::_('COM_REMCA_TRACK_SOURCE_FIELDSET_TRACK_SOURCE_FS_LABEL', true)); ?>
