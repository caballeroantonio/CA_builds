...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wishlist&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="wishlist-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'wishlist-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'wishlist-tabs', 'details', JText::_('COM_REMCA_WISHESLIST_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('wishlist_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'wishlist-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'wishlist-tabs', 'fieldset-users_wishlist_fs', JText::_('COM_REMCA_WISHESLIST_FIELDSET_USERS_WISHLIST_FS_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<?php foreach($this->form->getFieldset('fieldset_users_wishlist_fs') as $field): ?>
					<?php if (!$field->hidden) : ?>
