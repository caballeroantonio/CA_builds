...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=maincategory&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="maincategory-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'maincategory-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'maincategory-tabs', 'details', JText::_('COM_REMCA_MAIN_CATEGORIES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('maincategory_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'maincategory-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
			...
			<?php foreach ($fieldsets as $name => $fieldset) :?>
				<?php echo JHtml::_('bootstrap.addTab', 'maincategory-tabs', 'params-'.$name, JText::_($fieldset->label, true)); ?>
				<div class="row-fluid form-horizontal-desktop">
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'maincategory-tabs', 'associations', JText::_('COM_REMCA_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'maincategory-tabs', 'permissions', JText::_('COM_REMCA_MAIN_CATEGORIES_FIELDSET_RULES', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="maincategory-form" />
