...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=users_wishlist'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="userswishlist-list">
			<thead>
				<tr>
