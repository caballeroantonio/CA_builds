...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=userswishlist&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="userswishlist-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'userswishlist-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'userswishlist-tabs', 'details', JText::_('COM_REMCA_USERS_WISHLIST_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
                    ...
                    <?php
						...
						if (
							...
							AND $params->get('userswishlist_save_history')
						)
			...
			<?php echo JHtml::_('bootstrap.addTab', 'userswishlist-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'userswishlist-tabs', 'fieldset-jos_rem_users_wishlist_fs', JText::_('COM_REMCA_USERS_WISHLIST_FIELDSET_JOS_REM_USERS_WISHLIST_FS_LABEL', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="userswishlist-form" />
