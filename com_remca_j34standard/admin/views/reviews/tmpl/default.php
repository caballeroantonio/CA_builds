...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=reviews'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="review-list">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'reviews.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'reviews');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'reviews');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'reviews');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'reviews');
								endif;
