...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_remca&task=wa_title_conversations.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'wa_title_conversation-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wa_title_conversations'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="wa_title_conversation-list">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'wa_title_conversations.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'wa_title_conversations');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'wa_title_conversations');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'wa_title_conversations');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'wa_title_conversations');
								endif;
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=wa_title_conversation.edit&id='.(int) $item->id); ?>">
