...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=photo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="photo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'photo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'photo-tabs', 'details', JText::_('COM_REMCA_PHOTOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
