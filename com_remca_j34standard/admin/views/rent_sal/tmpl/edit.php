...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_sal&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rent_sal-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'rent_sal-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rent_sal-tabs', 'details', JText::_('COM_REMCA_RENT_SAL_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'rent_sal-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rent_sal-tabs', 'fieldset-rent_sal_fs', JText::_('COM_REMCA_RENT_SAL_FIELDSET_RENT_SAL_FS_LABEL', true)); ?>
