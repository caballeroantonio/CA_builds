...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_sal'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="rent_sal-list">
			<thead>
				<tr>
