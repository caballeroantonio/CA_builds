...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rem_categories'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="rem_category-list">
			<thead>
				<tr>
