...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=languages'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="language-list">
			<thead>
				<tr>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=language.edit&id='.(int) $item->id); ?>">
