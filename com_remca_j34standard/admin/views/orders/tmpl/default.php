...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=orders'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=order.edit&id='.(int) $item->id); ?>">
