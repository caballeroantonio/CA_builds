...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_remca&task=lmunicipalities.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'lmunicipality-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=lmunicipalities'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="lmunicipality-list">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'lmunicipalities.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'lmunicipalities');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'lmunicipalities');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'lmunicipalities');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'lmunicipalities');
								endif;
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=lmunicipality.edit&id='.(int) $item->id); ?>">
