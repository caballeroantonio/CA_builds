...
if ($save_order)
{
	...
	JHtml::_('sortablelist.sortable', 'main_category-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="main_category-list">
			<thead>
				<tr>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
							...
							<?php endif; ?>	
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=main_category.edit&id='.(int) $item->id); ?>">
					...
					<?php if ($assoc) : ?>
						<td class="small hidden-phone">
							<?php if ($item->association) : ?>
								<?php echo JHtml::_('main_categoryadministrator.association', $item->id); ?>
							<?php endif; ?>
						</td>
					<?php endif;?>				
