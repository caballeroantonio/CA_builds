...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wisheslist'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="wishlist-list">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'wisheslist.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'wisheslist');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'wisheslist');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'wisheslist');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'wisheslist');
								endif;
