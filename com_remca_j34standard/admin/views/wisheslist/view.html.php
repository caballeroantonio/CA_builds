...
/**
 * View class for a list of wisheslist.
 *
 */
class RemcaViewWisheslist extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::editList('wishlist.edit','JTOOLBAR_EDIT');
			...
			{
				JToolbarHelper::custom('wisheslist.publish', 'publish.png', 'publish_f2.png','JTOOLBAR_PUBLISH', true);
				JToolbarHelper::custom('wisheslist.unpublish', 'unpublish.png', 'unpublish_f2.png', 'JTOOLBAR_UNPUBLISH', true);
			}
			...
			if ($this->state->get('filter.state') != -1 ) 
			{
				if ($this->state->get('filter.state') != 2) 
				{
					JToolbarHelper::archiveList('wisheslist.archive','JTOOLBAR_ARCHIVE');
				}
				else 
				{
					if ($this->state->get('filter.state') == 2) 
					{
						JToolbarHelper::unarchiveList('wisheslist.publish', 'JTOOLBAR_UNARCHIVE');
					}
				}
			}
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_remca&view=wisheslist');
