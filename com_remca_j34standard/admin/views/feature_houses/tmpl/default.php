...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=feature_houses'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="feature_house-list">
			<thead>
				<tr>
