...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=category&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="category-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'category-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'category-tabs', 'details', JText::_('COM_REMCA_CATEGORIES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'category-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'category-tabs', 'fieldset-jos_rem_categories_fs', JText::_('COM_REMCA_CATEGORIES_FIELDSET_JOS_REM_CATEGORIES_FS_LABEL', true)); ?>
