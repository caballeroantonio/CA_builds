...
class RemcaViewCountries extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_REMCA_COUNTRIES_LIST_HEADER'), 'stack countries');
		...
		else 
		{
			JToolbarHelper::trash('countries.trash','JTOOLBAR_TRASH');
                ...
                JToolbarHelper::custom('countries.export', 'download','download', 'JTOOLBAR_EXPORT', FALSE);

				
		JToolbarHelper::preferences('com_remca');
		JToolbarHelper::help('JHELP_COMPONENTS_COM_REMCA_COUNTRY', true, null, 'com_remca');
	}
	/**
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_remca&view=countries');
