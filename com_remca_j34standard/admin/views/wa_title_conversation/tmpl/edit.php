...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wa_title_conversation&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="wa_title_conversation-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'wa_title_conversation-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'wa_title_conversation-tabs', 'details', JText::_('COM_REMCA_WA_TITLE_CONVERSATIONS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'wa_title_conversation-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
