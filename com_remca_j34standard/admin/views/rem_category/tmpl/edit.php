...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rem_category&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rem_category-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'rem_category-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rem_category-tabs', 'details', JText::_('COM_REMCA_REM_CATEGORIES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'rem_category-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rem_category-tabs', 'fieldset-categories_fs', JText::_('COM_REMCA_REM_CATEGORIES_FIELDSET_CATEGORIES_FS_LABEL', true)); ?>
