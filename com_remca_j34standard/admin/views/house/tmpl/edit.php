...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=house&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="house-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'house-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'house-tabs', 'details', JText::_('COM_REMCA_HOUSES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
