...
class RemcaViewHouse extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		JToolbarHelper::help('JHELP_COMPONENTS_COM_REMCA_HOUSE_EDIT', true, null, 'com_remca');
		$this->addToolbar();
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
				JText::_('COM_REMCA_HOUSES_' . (isset($checkedOut) && $checkedOut ? 'VIEW_HEADER' : ($is_new ? 'NEW_HEADER' : 'EDIT_HEADER'))), 
				'houses.png'
		);
			...
			)
		{
			...
			$type_alias = 'com_remca.house';
			JToolbarHelper::versions($type_alias, $item_id);
		}
				
		if (empty($this->item->id))
		{
			JToolbarHelper::cancel('house.cancel','JTOOLBAR_CANCEL');
		}
		else
		{
			JToolbarHelper::cancel('house.cancel', 'JTOOLBAR_CLOSE');
		}
	}
	/**
