...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rentsal&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rentsal-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'rentsal-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rentsal-tabs', 'details', JText::_('COM_REMCA_RENT_SAL_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'rentsal-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rentsal-tabs', 'fieldset-jos_rem_rent_sal_fs', JText::_('COM_REMCA_RENT_SAL_FIELDSET_JOS_REM_RENT_SAL_FS_LABEL', true)); ?>
