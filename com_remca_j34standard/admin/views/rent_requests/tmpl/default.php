...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_requests'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="rent_request-list">
			<thead>
				<tr>
