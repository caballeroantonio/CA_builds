...
<form action="<?php echo JRoute::_('index.php?option=com_remca&view=feature_house&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="feature_house-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'feature_house-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'feature_house-tabs', 'details', JText::_('COM_REMCA_FEATURE_HOUSES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'feature_house-tabs', 'publishing', JText::_('COM_REMCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
                    <?php
						$user  = JFactory::getUser();
						if (
							$this->item->version 
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'feature_house-tabs', 'fieldset-feature_houses_fs', JText::_('COM_REMCA_FEATURE_HOUSES_FIELDSET_FEATURE_HOUSES_FS_LABEL', true)); ?>
