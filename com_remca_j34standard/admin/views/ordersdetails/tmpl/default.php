...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="ordersdetail-list">
			<thead>
				<tr>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_remca&task=ordersdetail.edit&id='.(int) $item->id); ?>">
