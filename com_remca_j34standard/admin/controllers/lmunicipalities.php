 ...
 * 
 */
class RemcaControllerLmunicipalities extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lmunicipality', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lmunicipalities','RemcaModel', array('ignore_request' => FALSE));
