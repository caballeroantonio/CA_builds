 ...
 * 
 */
class RemcaControllerPhotos extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Photo', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Photos','RemcaModel', array('ignore_request' => FALSE));
