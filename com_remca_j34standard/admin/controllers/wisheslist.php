 ...
 * 
 */
class RemcaControllerWisheslist extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Wishlist', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Wisheslist','RemcaModel', array('ignore_request' => FALSE));
			
            $model = $this->getModel('Wisheslist','RemcaModel',array('ignore_request' => FALSE));
