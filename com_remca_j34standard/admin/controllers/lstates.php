 ...
 * 
 */
class RemcaControllerLstates extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lstate', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lstates','RemcaModel', array('ignore_request' => FALSE));
