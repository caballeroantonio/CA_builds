 ...
 * 
 */
class RemcaControllerOrders extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Order', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Orders','RemcaModel', array('ignore_request' => FALSE));
			
            $model = $this->getModel('Orders','RemcaModel',array('ignore_request' => FALSE));
