 ...
 * 
 */
class RemcaControllerConst extends JControllerAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 * 
	 */
	protected $text_prefix = 'COM_REMCA_CONST';
	 ...
	 * 
	 */
	public function getModel($name = 'Const', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Const','RemcaModel', array('ignore_request' => FALSE));
