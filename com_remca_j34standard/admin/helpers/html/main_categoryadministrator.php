...
/**
 * main_categories component helper.
 *
 */
abstract class JHtmlMain_categoryAdministrator
{
	/**
	 * Render the list of associated items
	 * 
	 * @param	integer $main_category_id	The main_category item id
	 * 
	 * @return  string  The language HTML
     */
	public static function association($main_category_id)
	{
		...
		// Get the associations
		if ($associations = JLanguageAssociations::getAssociations('com_remca', '#__rem_main_categories', 'com_remca.main_category.item',  $main_category_id, 'id', 'alias', null))
		{		
			...
			if ($items)
			{
				foreach ($items as &$item)
				{
					...
					$url = JRoute::_('index.php?option=com_remca&task=main_category.edit&id=' . (int) $item->id);
					$tooltip_parts = array(
