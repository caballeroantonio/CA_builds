 ...
 *
 */
abstract class JHtmlMainCategoryAdministrator
{
	/**
	 * Render the list of associated items
	 * 
	 * @param	integer $maincategory_id	The main_category item id
	 * 
	 * @return  string  The language HTML
     */
	public static function association($maincategory_id)
	{
		...
		// Get the associations
		if ($associations = JLanguageAssociations::getAssociations('com_remca', '#__rem_main_categories', 'com_remca.maincategory.item',  $maincategory_id, 'id', 'alias', null))
		{		
			...
			if ($items)
			{
				foreach ($items as &$item)
				{
					...
					$url = JRoute::_('index.php?option=com_remca&task=maincategory.edit&id=' . (int) $item->id);
					$tooltip_parts = array(
