...
require_once JPATH_ADMINISTRATOR.'/components/com_remca/models/category.php';

class RemcaModelCategoryForm extends RemcaModelCategory
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_remca.edit.category';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_remca.category';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_remca.edit.category', 'category', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('category.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_remca.edit.category.data', array());
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onCategoryBeforeSave', array('com_remca.category', &$table, $is_new));
		...
		$dispatcher->trigger('onCategoryAfterSave', array('com_remca.category', $table, $is_new));
