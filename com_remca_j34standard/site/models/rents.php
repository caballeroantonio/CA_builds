...
/**
 * This models supports retrieving lists of rents.
 *
 */
class RemcaModelRents extends JModelList
{
	/**
	...
	/**
	 * Get the main query for retrieving a list of rents subject to the model state.
	 *
	...
	protected function getListQuery()
	{
		...
		// Filter by a single or group of rents.
