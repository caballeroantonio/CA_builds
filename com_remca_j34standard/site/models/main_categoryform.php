...
require_once JPATH_ADMINISTRATOR.'/components/com_remca/models/main_category.php';

class RemcaModelMain_categoryForm extends RemcaModelMain_category
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_remca.edit.main_category';
	/**
	...
	*/
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('main_category.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_remca.edit.main_category.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('main_category.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onMain_categoryBeforeSave', array('com_remca.main_category', &$table, $is_new));
		...
		$dispatcher->trigger('onMain_categoryAfterSave', array('com_remca.main_category', $table, $is_new));

		$this->setState('main_category.id', $table->id);
