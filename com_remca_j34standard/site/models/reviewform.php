...
require_once JPATH_ADMINISTRATOR.'/components/com_remca/models/review.php';

class RemcaModelReviewForm extends RemcaModelReview
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_remca.edit.review';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_remca.review';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_remca.edit.review', 'review', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('review.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_remca.edit.review.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('review.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onReviewBeforeSave', array('com_remca.review', &$table, $is_new));
		...
		$dispatcher->trigger('onReviewAfterSave', array('com_remca.review', $table, $is_new));
