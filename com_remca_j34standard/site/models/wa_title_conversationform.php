...
require_once JPATH_ADMINISTRATOR.'/components/com_remca/models/wa_title_conversation.php';

class RemcaModelWa_title_conversationForm extends RemcaModelWa_title_conversation
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_remca.edit.wa_title_conversation';
	/**
	...
	*/
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('wa_title_conversation.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_remca.edit.wa_title_conversation.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('wa_title_conversation.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onWa_title_conversationBeforeSave', array('com_remca.wa_title_conversation', &$table, $is_new));
		...
		$dispatcher->trigger('onWa_title_conversationAfterSave', array('com_remca.wa_title_conversation', $table, $is_new));

		$this->setState('wa_title_conversation.id', $table->id);
