...
require_once JPATH_ADMINISTRATOR.'/components/com_remca/models/order.php';

class RemcaModelOrderForm extends RemcaModelOrder
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_remca.edit.order';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_remca.order';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_remca.edit.order', 'order', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('order.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_remca.edit.order.data', array());
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onOrderBeforeSave', array('com_remca.order', &$table, $is_new));
		...
		$dispatcher->trigger('onOrderAfterSave', array('com_remca.order', $table, $is_new));
