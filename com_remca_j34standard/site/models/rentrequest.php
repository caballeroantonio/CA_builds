...
/**
 * This models supports retrieving lists of rent_request.
 *
 */
class RemcaModelRentRequest extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single rent_request has been specified either as a parameter or in the url Request
	...
	/**
	 * Get the main query for retrieving a list of rent_request subject to the model state.
	 *
	...
	protected function getListQuery()
	{
		...
		// Filter by a single or group of rent_request.
	...
	/**
	 * Method to get a list of rent_request.
	 *
