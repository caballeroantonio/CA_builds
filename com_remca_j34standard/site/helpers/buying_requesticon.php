...
class JHTMLBuying_requestIcon
{
	/**
	 * Display an create icon for the buying_request.
	 *
	 * @param	Registry   $params	  The buying_request parameters
	 * @param   array      $attribs   Optional attributes for the link
	 * @param   boolean    $legacy    True to use legacy images, false to use icomoon based graphic
	 *
	 * @return	string	The HTML for the buying_request create icon.
	 * 
	 */
	public static function create($params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_remca&task=buying_request.add&layout=edit&return='.base64_encode($uri);
		$tmpl = JFactory::getApplication()->input->get('tmpl');
		if($tmpl)
			$url = "{$url}&tmpl={$tmpl}";
		if ($params->get('show_buying_request_icons'))
		{
			if ($legacy)
			{
	...
	/**
	 * Display an edit icon for the buying_request.
	 *
	 * This icon will not display in a popup window, nor if the buying requests is trashed.
	 * Edit access checks must be performed in the calling code.
	 *
	 * @param	object		$buying_request	The buying_request in question.
	 * @param	Registry	$params		The buying_request parameters
	 * @param	array		$attribs	Not used??
	 * @param   boolean		$legacy   True to use legacy images, false to use icomoon based graphic
	 *
	 * @return	string	The HTML for the buying_request edit icon.
	 * 
	 */
	public static function edit($buying_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$url	= 'index.php?option=com_remca&task=buying_request.edit&layout=edit&id='.$buying_request->id.'&return='.base64_encode($uri);
	...
	/**
	 * Display an delete icon for the buying_request.
	 *
	 * This icon will not display in a popup window, nor if the buying requests is trashed.
	 * Edit access checks must be performed in the calling code.
	 *
	...
	public static function delete($buying_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_remca&task=buying_request.delete&id='.$buying_request->id.'&'.JSession::getFormToken().'=1'.'&return='.base64_encode($uri);
	...
	/**
	 * Method to generate a link to the email item page for the given buying_request
	 *
	 * @param   object     $buying_request  The buying_request information
	...
	public static function email($buying_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$link	= $base.JRoute::_(RemcaHelperRoute::getBuying_requestRoute($buying_request->slug,
									$layout,
									$params->get('keep_buying_request_itemid')) , false);
	...
	/**
	 * Method to generate a popup link to print an buying_request
	 *
	 * @param   object		$buying_request  The buying_request information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	...
	public static function print_popup($buying_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$link	= JRoute::_(RemcaHelperRoute::getBuying_requestRoute($buying_request->slug,
									$layout,
									$params->get('keep_buying_request_itemid')) , false);
	...
	/**
	 * Method to generate a link to print an buying_request
	 *
	 * @param   object		$buying_request  The buying_request information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	...
	/**
	 * Method to generate a link to versions an buying_request
	 *
	 * @param   object		$buying_request  The buying_request information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	 ...
	 * @return  string  The HTML markup for the popup link
	 */
	public static function versions($buying_request, $params, $attribs = array(), $legacy = false)
	{
...
//            return "<a href=\"index.php?option=com_remca&task=buying_request.showHistory&item_id={$buying_request->id}\"  target=\"_blank\" onclick=\"window.open(this.href, this.target, 'width=800,height=600'); return false;\">{$text}</a>";
			return "<a href=\"#\" onclick=\"show_collapsibleModal({$buying_request->id});return false;\">{$text}</a>";
	}
}
