...
class JHTMLRent_requestIcon
{
	/**
	 * Display an create icon for the rent_request.
	 *
	 * @param	Registry   $params	  The rent_request parameters
	 * @param   array      $attribs   Optional attributes for the link
	 * @param   boolean    $legacy    True to use legacy images, false to use icomoon based graphic
	 *
	 * @return	string	The HTML for the rent_request create icon.
	 * 
	 */
	public static function create($params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_remca&task=rent_request.add&layout=edit&return='.base64_encode($uri);
		$tmpl = JFactory::getApplication()->input->get('tmpl');
		if($tmpl)
			$url = "{$url}&tmpl={$tmpl}";
		if ($params->get('show_rent_request_icons'))
		{
			if ($legacy)
			{
	...
	/**
	 * Display an edit icon for the rent_request.
	 *
	 * This icon will not display in a popup window, nor if the rent request is trashed.
	 * Edit access checks must be performed in the calling code.
	 *
	 * @param	object		$rent_request	The rent_request in question.
	 * @param	Registry	$params		The rent_request parameters
	 * @param	array		$attribs	Not used??
	 * @param   boolean		$legacy   True to use legacy images, false to use icomoon based graphic
	 *
	 * @return	string	The HTML for the rent_request edit icon.
	 * 
	 */
	public static function edit($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		if (property_exists($rent_request, 'checked_out') AND 
			...
			$rent_request->checked_out != $user->get('id'))
		{
			$check_out_user = JFactory::getUser($rent_request->checked_out);
			$button = JHtml::_('image','com_remca/checked_out.png', NULL, NULL, true);
			$date = JHtml::_('date',$rent_request->checked_out_time);
		...
		$url	= 'index.php?option=com_remca&task=rent_request.edit&layout=edit&id='.$rent_request->id.'&return='.base64_encode($uri);
	...
	/**
	 * Display an delete icon for the rent_request.
	 *
	 * This icon will not display in a popup window, nor if the rent request is trashed.
	 * Edit access checks must be performed in the calling code.
	 *
	 ...
	 * 
	 */
	public static function delete($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_remca&task=rent_request.delete&id='.$rent_request->id.'&'.JSession::getFormToken().'=1'.'&return='.base64_encode($uri);
	...
	/**
	 * Method to generate a link to the email item page for the given rent_request
	 *
	 * @param   object     $rent_request  The rent_request information
	 ...
	 */	
	public static function email($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$link	= $base.JRoute::_(RemcaHelperRoute::getRent_requestRoute($rent_request->slug,
									$layout,
									$params->get('keep_rent_request_itemid')) , false);
	...
	/**
	 * Method to generate a popup link to print an rent_request
	 *
	 * @param   object		$rent_request  The rent_request information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	 ...
	 */	
	public static function print_popup($rent_request, $params, $attribs = array(), $legacy = false)
	{
		$app = JFactory::getApplication();
		$input = $app->input;
		...
		$link	= JRoute::_(RemcaHelperRoute::getRent_requestRoute($rent_request->slug,
									$layout,
									$params->get('keep_rent_request_itemid')) , false);
	...
	/**
	 * Method to generate a link to print an rent_request
	 *
	 * @param   object		$rent_request  The rent_request information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	 ...
	 * @return  string  The HTML markup for the popup link
	 */
	public static function print_screen($rent_request, $params, $attribs = array(), $legacy = false)
	{
		// checks template image directory for image, if non found default are loaded
		if ($params->get('show_rent_request_icons') )
		{
	...
	/**
	 * Method to generate a link to versions an rent_request
	 *
	 * @param   object		$rent_request  The rent_request information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	 ...
	 * @return  string  The HTML markup for the popup link
	 */
	public static function versions($rent_request, $params, $attribs = array(), $legacy = false)
	{
...
//            return "<a href=\"index.php?option=com_remca&task=rent_request.showHistory&item_id={$rent_request->id}\"  target=\"_blank\" onclick=\"window.open(this.href, this.target, 'width=800,height=600'); return false;\">{$text}</a>";
			return "<a href=\"#\" onclick=\"show_collapsibleModal({$rent_request->id});return false;\">{$text}</a>";
	}
}
