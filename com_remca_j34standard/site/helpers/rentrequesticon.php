...
class JHTMLRentRequestIcon
{
	/**
	 * Display an create icon for the rentrequest.
	 *
	 * @param	Registry   $params	  The rentrequest parameters
	 * @param   array      $attribs   Optional attributes for the link
	 * @param   boolean    $legacy    True to use legacy images, false to use icomoon based graphic
	 *
	 * @return	string	The HTML for the rentrequest create icon.
	 * 
	 */
	public static function create($params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_remca&task=rentrequest.add&layout=edit&return='.base64_encode($uri);
		$tmpl = JFactory::getApplication()->input->get('tmpl');
		if($tmpl)
			$url = "{$url}&tmpl={$tmpl}";
		if ($params->get('show_rentrequest_icons'))
		{
			if ($legacy)
			{
	 ...
	 * @param   boolean		$legacy   True to use legacy images, false to use icomoon based graphic
	 *
	 * @return	string	The HTML for the rentrequest edit icon.
	 * 
	 */
	public static function edit($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$url	= 'index.php?option=com_remca&task=rentrequest.edit&layout=edit&id='.$rent_request->id.'&return='.base64_encode($uri);
	...
	public static function delete($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_remca&task=rentrequest.delete&id='.$rent_request->id.'&'.JSession::getFormToken().'=1'.'&return='.base64_encode($uri);
	...
	/**
	 * Method to generate a link to the email item page for the given rentrequest
	 *
	 * @param   object     $rent_request  The rentrequest information
	...
	public static function email($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$link	= $base.JRoute::_(RemcaHelperRoute::getRentRequestRoute($rent_request->slug,
									$layout,
									$params->get('keep_rentrequest_itemid')) , false);
	...
	/**
	 * Method to generate a popup link to print an rentrequest
	 *
	 * @param   object		$rent_request  The rentrequest information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	...
	public static function print_popup($rent_request, $params, $attribs = array(), $legacy = false)
	{
		...
		$link	= JRoute::_(RemcaHelperRoute::getRentRequestRoute($rent_request->slug,
									$layout,
									$params->get('keep_rentrequest_itemid')) , false);
	...
	/**
	 * Method to generate a link to print an rentrequest
	 *
	 * @param   object		$rent_request  The rentrequest information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	...
	/**
	 * Method to generate a link to versions an rentrequest
	 *
	 * @param   object		$rentrequest  The rentrequest information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	 * @param   boolean		$legacy   True to use legacy images, false to use icomoon based graphic
	 *
	 * @return  string  The HTML markup for the popup link
	 */
	public static function versions($rentrequest, $params, $attribs = array(), $legacy = false)
	{
...
//            return "<a href=\"index.php?option=com_remca&task=rentrequest.showHistory&item_id={$rentrequest->id}\"  target=\"_blank\" onclick=\"window.open(this.href, this.target, 'width=800,height=600'); return false;\">{$text}</a>";
			return "<a href=\"#\" onclick=\"show_collapsibleModal({$rentrequest->id});return false;\">{$text}</a>";
	}
}
