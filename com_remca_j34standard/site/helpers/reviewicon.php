...
//            return "<a href=\"index.php?option=com_remca&task=review.showHistory&item_id={$review->id}\"  target=\"_blank\" onclick=\"window.open(this.href, this.target, 'width=800,height=600'); return false;\">{$text}</a>";
			return "<a href=\"#\" onclick=\"show_collapsibleModal({$review->id});return false;\">{$text}</a>";
	}
}
