 ...
 *
 */
class RemcaControllerRentSal extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'RentSal', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
        ...
        public function export(){
			return false;
            $model = $this->getModel = $this->getModel('RentSal','RemcaModel',array('ignore_request' => FALSE));
...
//			$model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('RentSal',$query);
        }
}