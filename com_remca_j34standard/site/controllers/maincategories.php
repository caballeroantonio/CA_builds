 ...
 *
 */
class RemcaControllerMainCategories extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'MainCategories', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
        ...
        public function export(){
			return false;
            $model = $this->getModel = $this->getModel('MainCategories','RemcaModel',array('ignore_request' => FALSE));
...
//			$model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('MainCategories',$query);
        }
}