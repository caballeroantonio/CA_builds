 ...
 *
 */
class RemcaControllerOrdersDetails extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'OrdersDetails', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
        ...
        public function export(){
			return false;
            $model = $this->getModel = $this->getModel('OrdersDetails','RemcaModel',array('ignore_request' => FALSE));
...
//			$model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('OrdersDetails',$query);
        }
}