 ...
 *
 */
class RemcaControllerOrders extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Orders', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
         ...
         * from outside: $model = JModelLegacy::getInstance('orderForm','RemcaModel', array('ignore_request' => FALSE));	
         */
        public function export(){
            //die('not allowed');
            $model = $this->getModel = $this->getModel('Orders','RemcaModel',array('ignore_request' => FALSE));
...
//            $model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('Orders',$query);
        }
}
