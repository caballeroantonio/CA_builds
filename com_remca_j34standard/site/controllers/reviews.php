 ...
 *
 */
class RemcaControllerReviews extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Reviews', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
         ...
         * from outside: $model = JModelLegacy::getInstance('reviewForm','RemcaModel', array('ignore_request' => FALSE));	
         */
