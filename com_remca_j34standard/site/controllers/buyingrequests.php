 ...
 *
 */
class RemcaControllerBuyingRequests extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'BuyingRequests', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
        ...
        public function export(){
			return false;
            $model = $this->getModel = $this->getModel('BuyingRequests','RemcaModel',array('ignore_request' => FALSE));
...
//			$model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('BuyingRequests',$query);
        }
}