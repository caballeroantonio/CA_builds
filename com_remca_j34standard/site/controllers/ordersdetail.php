...
/**
 * OrdersDetail controller class.
 * 
 */
class RemcaControllerOrdersDetail extends JControllerForm
{
	/**
	 * @var    string	$view_item	The URL view item variable.
	 */
	protected $view_item = 'ordersdetailform';
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'ordersdetailform', $prefix = '',$config = array('ignore_request' => true))
	{
	...
	public function edit($key = 'id', $url_var = null)
	{
		...
		$model = $this->getModel('ordersdetailform');
		// Set the return url
		$this->setReturnPage($context);
	...
	public function save($key = 'id', $url_var = null)
	{
		...
		switch ($task)
		{
			case 'apply':
				...
				$record_id = $model->getState('ordersdetail.id');
				$this->holdEditId($context, $record_id);
				$app->setUserState($context.'.data',	null);
	...
	public function delete()
	{
		...
		// Get the menu item model.
		$model = $this->getModel('ordersdetail');
