...
/**
 * MainCategory controller class.
 * 
 */
class RemcaControllerMainCategory extends JControllerForm
{
	/**
	 * @var    string	$view_item	The URL view item variable.
	 */
	protected $view_item = 'maincategoryform';
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'maincategoryform', $prefix = '',$config = array('ignore_request' => true))
	{
	...
	public function edit($key = 'id', $url_var = null)
	{
		...
		$model = $this->getModel('maincategoryform');
		// Set the return url
		$this->setReturnPage($context);
	...
	public function save($key = 'id', $url_var = null)
	{
		...
		switch ($task)
		{
			case 'apply':
				...
				$record_id = $model->getState('maincategory.id');
				$this->holdEditId($context, $record_id);
				$app->setUserState($context.'.data',	null);
	...
	public function delete()
	{
		...
		// Get the menu item model.
		$model = $this->getModel('maincategory');
