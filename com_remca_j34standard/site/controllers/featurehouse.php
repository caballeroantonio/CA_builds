...
/**
 * FeatureHouse controller class.
 * 
 */
class RemcaControllerFeatureHouse extends JControllerForm
{
	/**
	 * @var    string	$view_item	The URL view item variable.
	 */
	protected $view_item = 'featurehouseform';
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'featurehouseform', $prefix = '',$config = array('ignore_request' => true))
	{
	...
	public function edit($key = 'id', $url_var = null)
	{
		...
		$model = $this->getModel('featurehouseform');
		// Set the return url
		$this->setReturnPage($context);
	...
	public function save($key = 'id', $url_var = null)
	{
		...
		switch ($task)
		{
			case 'apply':
				...
				$record_id = $model->getState('featurehouse.id');
				$this->holdEditId($context, $record_id);
				$app->setUserState($context.'.data',	null);
	...
	public function delete()
	{
		...
		// Get the menu item model.
		$model = $this->getModel('featurehouse');
