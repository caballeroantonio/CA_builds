...
class RemcaControllerHouses extends JControllerLegacy
{
	 ...
	 * 
	 */
	public function getModel($name = 'Houses', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
         ...
         * from outside: $model = JModelLegacy::getInstance('houseForm','RemcaModel', array('ignore_request' => FALSE));	
         */
...
//            $model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('Houses',$query);
        }
}
