...
/**
 * MimeType controller class.
 * 
 */
class RemcaControllerMimeType extends JControllerForm
{
	/**
	 * @var    string	$view_item	The URL view item variable.
	 */
	protected $view_item = 'mimetypeform';
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'mimetypeform', $prefix = '',$config = array('ignore_request' => true))
	{
	...
	public function edit($key = 'id', $url_var = null)
	{
		...
		$model = $this->getModel('mimetypeform');
		// Set the return url
		$this->setReturnPage($context);
	...
	public function save($key = 'id', $url_var = null)
	{
		...
		switch ($task)
		{
			case 'apply':
				...
				$record_id = $model->getState('mimetype.id');
				$this->holdEditId($context, $record_id);
				$app->setUserState($context.'.data',	null);
