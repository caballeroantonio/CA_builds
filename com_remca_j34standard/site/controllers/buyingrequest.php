...
/**
 * BuyingRequest controller class.
 * 
 */
class RemcaControllerBuyingRequest extends JControllerForm
{
	/**
	 * @var    string	$view_item	The URL view item variable.
	 */
	protected $view_item = 'buyingrequestform';
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'buyingrequestform', $prefix = '',$config = array('ignore_request' => true))
	{
	...
	public function save($key = 'id', $url_var = null)
	{
		...
		switch ($task)
		{
			case 'apply':
				...
				$record_id = $model->getState('buyingrequest.id');
				$this->holdEditId($context, $record_id);
				$app->setUserState($context.'.data',	null);
	...
	public function delete()
	{
		...
		// Get the menu item model.
		$model = $this->getModel('buyingrequest');
