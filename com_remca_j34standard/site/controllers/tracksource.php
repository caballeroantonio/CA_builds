 ...
 *
 */
class RemcaControllerTrackSource extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'TrackSource', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
        ...
        public function export(){
			return false;
            $model = $this->getModel = $this->getModel('TrackSource','RemcaModel',array('ignore_request' => FALSE));
...
//			$model->setState('list.select', 'a.*');//override
            ...
            $remca_helper->export('TrackSource',$query);
        }
}