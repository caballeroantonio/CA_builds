 ...
 *
 */
class RemcaControllerConfigs extends JControllerLegacy
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_REMCA_CONFIGS';
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Configs', $prefix = 'RemcaModel',$config = array('ignore_request' => true))
	{
        ...
        public function export(){
            ...
            $model = $this->getModel('Configs','RemcaModel',array('ignore_request' => FALSE));
