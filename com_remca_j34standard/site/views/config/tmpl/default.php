...
<div class="remca config-view<?php echo $params->get('pageclass_sfx')?>">
	...
	<div style="padding-top: 10px;">
			...
			<?php $dummy = false;
					$display_fieldset = (
								($params->get('show_config_gmaps_api_key')) OR 
								$dummy
								);
			?>
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_REMCA_CONFIGS_FIELDSET_CONFIG_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_config_gmaps_api_key')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_REMCA_CONFIGS_FIELD_GMAPS_API_KEY_LABEL'); ?>
							</label>
							<span>
								<?php
									echo $this->item->gmaps_api_key != '' ? $this->item->gmaps_api_key : $empty;
								?>
							</span>
						</div>	
						<?php endif; ?>
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_config_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php endif; ?>
				...
				<?php if ($params->get('show_config_admin')) : ?>
