...
<div class="remca ordersdetail-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=ordersdetailform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ordersdetail-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('ordersdetail.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('ordersdetail.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('ordersdetail_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jos_rem_orders_details_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jos_rem_orders_details_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_ORDERS_DETAILS_FIELDSET_JOS_REM_ORDERS_DETAILS_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="ordersdetail-form" />
