...
$function	= $app->input->get('function', 'jSelectWa_title_conversation');
 ...
 */
?>
<div class="wa_title_conversations-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_WA_TITLE_CONVERSATIONS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wa_title_conversations&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="wa_title_conversations">
			<thead>
				<tr>
					<th>
...
if ($this->params->get('show_wa_title_conversation_add_link', 1) AND $can_create)
	echo JHtml::_('wa_title_conversationicon.create', $this->params);
?>
