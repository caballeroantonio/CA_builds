...
class RemcaViewWa_title_conversations extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_remca&view=wa_title_conversations');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the wa_title_conversation slug
			$row->slug = $row->id;

			// url link to wa_title_conversation
			$link = JRoute::_(RemcaHelperRoute::getWa_title_conversationRoute($row->slug, 
																						'default',								
