...
if ($this->params->get('save_history') AND $this->params->get('feature_house_save_history'))
{
...
<div class="remca feature_house-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=feature_houseform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="feature_house-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('feature_house.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('feature_house.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('feature_house_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_feature_houses_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-feature_houses_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_FEATURE_HOUSES_FIELDSET_FEATURE_HOUSES_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="feature_house-form" />
