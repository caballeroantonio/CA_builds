...
$function	= $app->input->get('function', 'jSelectOrdersDetail');
...
if ($this->params->get('show_ordersdetail_add_link', 1) AND $can_create)
	echo JHtml::_('ordersdetailicon.create', $this->params);
?>
