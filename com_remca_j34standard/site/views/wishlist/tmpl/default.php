...
<div class="remca wishlist-view<?php echo $params->get('pageclass_sfx')?>">
	...
	<div style="padding-top: 10px;">
			...
			<form action="" name="wishlistForm" id="wishlistForm">
			<?php $dummy = false;
					$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_REMCA_WISHESLIST_FIELDSET_USERS_WISHLIST_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_wishlist_id_user')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_REMCA_WISHESLIST_FIELD_ID_USER_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_REMCA_WISHESLIST_FIELD_ID_HOUSE_LABEL'); ?>
							</label>
							<span>
								<?php
		...
		$display_fieldset = (
							...
							($params->get('show_wishlist_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php endif; ?>
			<?php if ($params->get('show_wishlist_modified')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>	
				<?php if ($params->get('show_wishlist_admin')) : ?>
