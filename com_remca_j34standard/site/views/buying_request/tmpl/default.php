...
<div class="remca buying_request-view<?php echo $params->get('pageclass_sfx')?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<h1>
		<?php echo $this->escape($this->params->get('page_heading')); ?>
	</h1>
	<?php endif; ?>
	<?php if ($params->get('show_buying_request_icons',-1) >= 0) : ?>
		<?php if ($params->get('show_buying_request_print_icon') 
			OR $params->get('show_buying_request_email_icon') 
			): ?>
			<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu">
					<?php if (!$this->print) : ?>
							<?php if ($params->get('show_buying_request_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('buying_requesticon.print_popup',  $this->item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_buying_request_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('buying_requesticon.email',  $this->item, $params); ?>
								</li>
							<?php endif; ?>
								<li class="edit-icon">
									<?php echo JHtml::_('buying_requesticon.edit', $this->item, $params); ?>
								</li>
								<li class="delete-icon">
									<?php echo JHtml::_('buying_requesticon.delete',$this->item, $params); ?>
								</li>					
					<?php else : ?>
						<li>
							<?php echo JHtml::_('buying_requesticon.print_screen',  $this->item, $params); ?>
						</li>
					<?php endif; ?>
				</ul>
			</div>
	...
	<?php echo $this->item->event->beforeDisplayBuying_request; ?>
	<div style="clear:both; padding-top: 10px;">

	</div>
	<div style="padding-top: 10px;">

			<form action="" name="buying_requestForm" id="buying_requestForm">
			<?php $dummy = false;
					$display_fieldset = (
								($params->get('show_buying_request_id_house')) OR 
								($params->get('show_buying_request_id_user')) OR 
								($params->get('show_buying_request_buying_request')) OR 
								($params->get('show_buying_request_customer_name')) OR 
								($params->get('show_buying_request_customer_email')) OR 
								($params->get('show_buying_request_customer_phone')) OR 
								($params->get('show_buying_request_customer_comment')) OR 
								($params->get('show_buying_request_status')) OR 
								$dummy
								);
			?>
			...
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_buying_request_id_house')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_id_user')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_buying_request')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_customer_name')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_customer_email')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_customer_phone')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_customer_comment')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_buying_request_status')) : ?>
						<div class="formelm">
							<label>
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_buying_request_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php endif; ?>
				...
				<?php if ($params->get('show_buying_request_admin')) : ?>
		...
		<?php echo $this->item->event->afterDisplayBuying_request; ?>
	</div>		
</div>