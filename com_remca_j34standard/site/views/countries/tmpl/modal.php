...
$function	= $app->input->get('function', 'jSelectCountry');
 ...
 */
?>
<div class="countries-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_COUNTRIES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=countries&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_country_add_link', 1) AND $can_create)
	echo JHtml::_('countryicon.create', $this->params);
?>
