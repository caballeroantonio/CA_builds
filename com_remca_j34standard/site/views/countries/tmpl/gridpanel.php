...
function getFields(){
    ...
    /*
                ...
                FIELD_DB=`` INT(11) NOT NULL DEFAULT '1' ordering_cur
    ...
    */
    $fields['ordering_cur'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'published_cur',
        'FIELD_CODE_NAME' => 'published_cur',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 22,
    );
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' published_cur
    ...
    */
    $fields['published_cur'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'iso2',
        'FIELD_CODE_NAME' => 'iso2',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(2) DEFAULT NULL iso2
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(3) DEFAULT NULL iso3
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DECIMAL(11,2) NOT NULL DEFAULT '0' conversion
    ...
    */
    $fields['conversion'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'conversion_date',
        'FIELD_CODE_NAME' => 'conversion_date',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL conversion_date
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('country_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('CountryForm','RemcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=countryform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
