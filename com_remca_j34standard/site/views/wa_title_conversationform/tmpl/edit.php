...
<div class="remca wa_title_conversation-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_WA_TITLE_CONVERSATIONS_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wa_title_conversationform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="wa_title_conversation-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('wa_title_conversation.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('wa_title_conversation.cancel')">
...
<?php /*?>
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_REMCA_WA_TITLE_CONVERSATIONS_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
<?php */?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_WA_TITLE_CONVERSATIONS_FIELDSET_DETAILS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="wa_title_conversation-form" />
