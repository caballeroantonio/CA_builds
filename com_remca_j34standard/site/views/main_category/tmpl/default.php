...
<div class="remca main_category-view<?php echo $params->get('pageclass_sfx')?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<h1>
		<?php echo $this->escape($this->params->get('page_heading')); ?>
	</h1>
	<?php endif; ?>
	<?php if ($params->get('show_main_category_icons',-1) >= 0) : ?>
		<?php if ($params->get('show_main_category_print_icon') 
			OR $params->get('show_main_category_email_icon') 
			): ?>
				...
				<ul class="dropdown-menu">
					<?php if (!$this->print) : ?>
						<?php if ($params->get('access-view')) : ?>
							<?php if ($params->get('show_main_category_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('main_categoryicon.print_popup',  $this->item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_main_category_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('main_categoryicon.email',  $this->item, $params); ?>
								</li>
							<?php endif; ?>
								<li class="edit-icon">
									<?php echo JHtml::_('main_categoryicon.edit', $this->item, $params); ?>
								</li>
								<li class="delete-icon">
									<?php echo JHtml::_('main_categoryicon.delete',$this->item, $params); ?>
								</li>					
						<?php endif; ?>
					<?php else : ?>
						<li>
							<?php echo JHtml::_('main_categoryicon.print_screen',  $this->item, $params); ?>
						</li>
					<?php endif; ?>
				</ul>
			</div>
	...
	<?php if ($params->get('show_main_category_name')) : ?>
		<div style="float: left;">
			<h2>
				<?php if ($params->get('link_main_category_names') AND !empty($this->item->readmore_link)) : ?>
	...
	<?php endif; ?>
	<?php  echo $this->item->event->afterDisplayMain_categoryName;	?>
	
	<?php echo $this->item->event->beforeDisplayMain_category; ?>
			...
			if ($params->get('show_main_category_readmore')) :
				...
				<p class="readmore">
					<a href="<?php echo $link; ?>">
						<?php
						if ($this->item->main_category_alternative_readmore == null) :
							if ($params->get('show_main_category_readmore_name') == 0) :					
								echo JText::_('COM_REMCA_REGISTER_TO_READ_MORE');
							else :
								echo JText::_('COM_REMCA_REGISTER_TO_READMORE_NAME');
								echo JHtml::_('string.truncate', ($this->item->name), $params->get('main_category_readmore_limit'));
							endif;
						else :
							echo $this->item->main_category_alternative_readmore;
							if ($params->get('show_main_category_readmore_name') == 1) :
								echo JHtml::_('string.truncate', ': '.($this->item->name), $params->get('main_category_readmore_limit'));
							endif;
						endif;
						?>
	...
	<div style="padding-top: 10px;">
		<?php if ($params->get('access-view')) : ?>	
			...
			<form action="" name="main_categoryForm" id="main_categoryForm">
			<?php $dummy = false;
					$display_fieldset = (
								($params->get('show_main_category_parent_id')) OR 
								($params->get('show_main_category_associate_category')) OR 
								($params->get('show_main_category_title')) OR 
								($params->get('show_main_category_image')) OR 
								($params->get('show_main_category_section')) OR 
								($params->get('show_main_category_image_position')) OR 
								($params->get('show_main_category_editor')) OR 
								($params->get('show_main_category_count')) OR 
								($params->get('show_main_category_params2')) OR 
								$dummy
								);
			?>
			...
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_main_category_parent_id')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_associate_category')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_title')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_image')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_section')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_image_position')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_editor')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_count')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_main_category_params2')) : ?>
						<div class="formelm">
							<label>
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_main_category_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php endif; ?>
				...
				<?php if ($params->get('show_main_category_admin')) : ?>
		...
		<?php endif; ?>	
		<?php echo $this->item->event->afterDisplayMain_category; ?>
	</div>		
</div>