...
$function	= $app->input->get('function', 'jSelectBuyingRequest');
 ...
 */
?>
<div class="buying_request-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_BUYING_REQUEST_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=buying_request&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_buyingrequest_add_link', 1) AND $can_create)
	echo JHtml::_('buyingrequesticon.create', $this->params);
?>
