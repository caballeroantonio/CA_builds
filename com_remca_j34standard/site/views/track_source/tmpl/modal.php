...
$function	= $app->input->get('function', 'jSelectTrack_source');
 ...
 */
?>
<div class="track_source-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_TRACK_SOURCE_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=track_source&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_track_source_add_link', 1) AND $can_create)
	echo JHtml::_('track_sourceicon.create', $this->params);
?>
