...
class track_sourceApp extends ExtJSHelper{
    
}
$extJSHelper = new track_sourceApp();
$extJSHelper->parse('track_source');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.track_source', {
