...
<div class="remca order-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_ORDERS_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=orderform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="order-form" class="form-validate">
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_ORDERS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-jos_rem_orders_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_ORDERS_FIELDSET_JOS_REM_ORDERS_FS_LABEL');?></a></li>
