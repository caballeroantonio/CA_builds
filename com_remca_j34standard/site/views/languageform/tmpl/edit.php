...
if ($this->params->get('save_history') AND $this->params->get('language_save_history'))
{
...
<div class="remca language-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_LANGUAGES_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=languageform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="language-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('language.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('language.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('language_save_history')
			) : ?>
				<div class="btn-group">
...
<?php /*?>			<ul class="nav nav-tabs">
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="language-form" />
