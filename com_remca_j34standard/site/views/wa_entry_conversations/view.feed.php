...
class RemcaViewWa_entry_conversations extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_remca&view=wa_entry_conversations');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the wa_entry_conversation slug
			$row->slug = $row->id;
			...
			if ($item->featured == 1)
			{
				$item->category[]	= JText::_('JFEATURED'); // All featured wa_entry_conversations are categorized as "Featured"
			}
