...
function getFields(){
    ...
    $field = array(
        'FIELD_NAME' => 'Teléfono',
        'FIELD_CODE_NAME' => 'phone',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 29,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=PHONE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(50) NOT NULL DEFAULT '' Teléfono

                FIELD_NAME_LATEX=Tel\'efono
                FIELD_CODE_NAME_LATEX=phone
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'id_wa_title_conversation',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 13,
    );
    /*
                ...
                FIELD_DB=`` INT(10) UNSIGNED  NOT NULL DEFAULT '0' Tema de la conversación Whatsapp
    ...
    */
    $fields['id_wa_title_conversation'] = $field;
    return $fields;
}
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('wa_entry_conversation_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Wa_entry_conversationForm','RemcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=wa_entry_conversationform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'Entrada Conversaciones Wtsapp ',
