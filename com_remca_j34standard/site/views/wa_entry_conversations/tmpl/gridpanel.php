...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.wa_entry_conversation', {
...
Ext.application({
    ...
    stores: [
        ...
        'wa_entry_conversations',//current store
    ],
    paths: {
...
<a href="remca/index.php?task=wa_entry_conversations.export&amp;option=com_remca&amp;Itemid=129" class="btn btn-primary"><span class="icon-download"></span>Export</a>