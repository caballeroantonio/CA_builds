 ...
 */
?>
<div class="wa_entry_conversations-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_WA_ENTRY_CONVERSATIONS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=wa_entry_conversations&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_wa_entry_conversation_add_link', 1) AND $can_create)
	echo JHtml::_('wa_entry_conversationicon.create', $this->params);
?>
