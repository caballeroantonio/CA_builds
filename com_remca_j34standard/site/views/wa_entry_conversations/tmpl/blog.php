...
<div class="remca wa_entry_conversations-blog<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<?php else : ?>
		...
		<div class="pagination">
				...
				<?php if ($this->params->def('show_wa_entry_conversation_pagination_results', 1)) : ?>
					<p class="counter">
