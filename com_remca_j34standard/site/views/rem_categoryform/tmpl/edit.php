...
if ($this->params->get('save_history') AND $this->params->get('rem_category_save_history'))
{
...
<div class="remca rem_category-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rem_categoryform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rem_category-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('rem_category.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('rem_category.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('rem_category_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_categories_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_REM_CATEGORIES_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-categories_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_REM_CATEGORIES_FIELDSET_CATEGORIES_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="rem_category-form" />
