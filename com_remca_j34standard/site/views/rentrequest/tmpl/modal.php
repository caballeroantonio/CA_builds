 ...
 */
?>
<div class="rent_request-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_RENT_REQUEST_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_request&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
