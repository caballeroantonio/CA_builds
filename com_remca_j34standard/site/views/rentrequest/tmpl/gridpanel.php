...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) NOT NULL DEFAULT '0' fk_userid
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL rent_request
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('RentRequestForm','RemcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=rentrequestform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
