...
$function	= $app->input->get('function', 'jSelectBuying_request');
 ...
 */
?>
<div class="buying_requests-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_BUYING_REQUESTS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=buying_requests&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_buying_request_add_link', 1) AND $can_create)
	echo JHtml::_('buying_requesticon.create', $this->params);
?>
