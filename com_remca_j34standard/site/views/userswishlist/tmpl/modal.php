...
$function	= $app->input->get('function', 'jSelectUsersWishlist');
 ...
 */
?>
<div class="users_wishlist-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_USERS_WISHLIST_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=users_wishlist&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_userswishlist_add_link', 1) AND $can_create)
	echo JHtml::_('userswishlisticon.create', $this->params);
?>
