...
if ($this->params->get('save_history') AND $this->params->get('track_source_save_history'))
{
...
<div class="remca track_source-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=track_sourceform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="track_source-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('track_source.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('track_source.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('track_source_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_track_source_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_TRACK_SOURCE_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-track_source_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_TRACK_SOURCE_FIELDSET_TRACK_SOURCE_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="track_source-form" />
