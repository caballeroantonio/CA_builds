...
class featureApp extends ExtJSHelper{
    
}
$extJSHelper = new featureApp();
$extJSHelper->parse('feature');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.feature', {
...
<div id="extjs-content"></div>
		...
		<?php 
			if($user->id == 1){
				//JHtml::_('featureicon.create', $this->params); 
	            echo '<span class="hasTooltip tip" title="Export"><a href="index.php?task=feature.export" class="btn btn-primary"><span class="icon-download"></span>Export</a></span>';
			}
        ?>
	</form>
</div>
