...
if ($this->params->get('save_history') AND $this->params->get('main_category_save_history'))
{
...
<div class="remca main_category-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_MAIN_CATEGORIES_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=main_categoryform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="main_category-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('main_category.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('main_category.cancel')">
...
<?php /*?>
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_REMCA_MAIN_CATEGORIES_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
<?php */?>
