...
$function	= $app->input->get('function', 'jSelectFeature_house');
 ...
 */
?>
<div class="feature_houses-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_FEATURE_HOUSES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=feature_houses&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_feature_house_add_link', 1) AND $can_create)
	echo JHtml::_('feature_houseicon.create', $this->params);
?>
