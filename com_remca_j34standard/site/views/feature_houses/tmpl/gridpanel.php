...
class feature_housesApp extends ExtJSHelper{
    
}
$extJSHelper = new feature_housesApp();
$extJSHelper->parse('feature_house');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.feature_house', {
