...
$function	= $app->input->get('function', 'jSelectRentSal');
 ...
 */
?>
<div class="rent_sal-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_RENT_SAL_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_sal&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_rentsal_add_link', 1) AND $can_create)
	echo JHtml::_('rentsalicon.create', $this->params);
?>
