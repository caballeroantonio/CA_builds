...
$layout		= $this->params->get('mimetype_layout', 'default');
...
<div class="remca mime_types-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<?php
		...
		$show_actions = false;
		if ($this->params->get('show_mimetype_icons',1) >= 0) :
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php if ($this->params->get('show_mimetype_pagination_limit')) : ?>
		...
		<div style="overflow-x:auto;">
			...
			<thead>
				<tr>
					...
					<?php if ($date = $this->params->get('list_show_mimetype_date')) : ?>
			...
			<tbody>
				...
				?>			
					...
					<?php if ($this->params->get('list_show_mimetype_date')) : ?>
						<td class="list-date">
							<time datetime="<?php echo JHtml::_('date', $item->display_date, 'c'); ?>">
								<?php echo JHtml::_('date',$item->display_date, $this->escape($this->params->get('mimetype_date_format', JText::_('DATE_FORMAT_LC3')))); ?>
							</time>
						</td>
					<?php endif; ?>
					<?php if ($this->params->get('list_show_mimetype_mime_ext',1)) : ?>
