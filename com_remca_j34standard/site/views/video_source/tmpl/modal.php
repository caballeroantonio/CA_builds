...
$function	= $app->input->get('function', 'jSelectVideo_source');
 ...
 */
?>
<div class="video_source-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_VIDEO_SOURCE_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=video_source&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_video_source_add_link', 1) AND $can_create)
	echo JHtml::_('video_sourceicon.create', $this->params);
?>
