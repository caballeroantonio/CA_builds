...
class video_sourceApp extends ExtJSHelper{
    
}
$extJSHelper = new video_sourceApp();
$extJSHelper->parse('video_source');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.video_source', {
