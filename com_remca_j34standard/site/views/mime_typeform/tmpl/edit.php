...
if ($this->params->get('save_history') AND $this->params->get('mime_type_save_history'))
{
...
<div class="remca mime_type-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mime_typeform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="mime_type-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('mime_type.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('mime_type.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('mime_type_save_history')
			) : ?>
				<div class="btn-group">
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-mime_types_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_MIME_TYPES_FIELDSET_MIME_TYPES_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="mime_type-form" />
