...
$function	= $app->input->get('function', 'jSelectVideoSource');
...
if ($this->params->get('show_videosource_add_link', 1) AND $can_create)
	echo JHtml::_('videosourceicon.create', $this->params);
?>
