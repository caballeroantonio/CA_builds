...
$function	= $app->input->get('function', 'jSelectConfig');
 ...
 */
?>
<div class="configs-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_CONFIGS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=configs&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_config_add_link', 1) AND $can_create)
	echo JHtml::_('configicon.create', $this->params);
?>
