...
$function	= $app->input->get('function', 'jSelectCategory');
 ...
 */
?>
<div class="categories-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_CATEGORIES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=categories&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_category_add_link', 1) AND $can_create)
	echo JHtml::_('categoryicon.create', $this->params);
?>
