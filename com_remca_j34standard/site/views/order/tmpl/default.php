...
<div class="remca order-view<?php echo $params->get('pageclass_sfx')?>">
	...
	<div style="padding-top: 10px;">
			...
			<?php $dummy = false;
					$display_fieldset = (
								($params->get('show_order_fk_user_id')) OR 
								...
								($params->get('show_order_fk_house_id')) OR 
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_REMCA_ORDERS_FIELDSET_JOS_REM_ORDERS_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_order_fk_user_id')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_REMCA_ORDERS_FIELD_FK_USER_ID_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_order_fk_house_id')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_REMCA_ORDERS_FIELD_FK_HOUSE_ID_LABEL'); ?>
							</label>
							<span>
								<?php
