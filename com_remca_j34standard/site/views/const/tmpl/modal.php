...
$function	= $app->input->get('function', 'jSelectConst');
 ...
 */
?>
<div class="const-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_CONST_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=const&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_const_add_link', 1) AND $can_create)
	echo JHtml::_('consticon.create', $this->params);
?>
