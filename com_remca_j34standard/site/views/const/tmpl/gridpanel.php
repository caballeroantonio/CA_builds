...
function getFields(){
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(250) DEFAULT NULL const
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(250) DEFAULT NULL sys_type
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=constform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
