...
class RemcaViewConst extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// PREPARE THE DATA
		// Compute the const slugs and set the trigger events.
		foreach ($items as $i => &$item)
		{
			...
			$dispatcher->trigger('onConstPrepare', array ('com_remca.const', &$item, &$item->params,$i));
			...
			$results = $dispatcher->trigger('onConstAfterDisplay', array('com_remca.const', &$item, &$item->params,$i));
			$item->event->afterDisplayConst = JString::trim(implode("\n", $results));
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_REMCA_CONST'));
		}
