...
$function	= $app->input->get('function', 'jSelectRem_category');
 ...
 */
?>
<div class="rem_categories-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_REM_CATEGORIES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rem_categories&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_rem_category_add_link', 1) AND $can_create)
	echo JHtml::_('rem_categoryicon.create', $this->params);
?>
