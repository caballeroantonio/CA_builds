...
class rem_categoriesApp extends ExtJSHelper{
    
}
$extJSHelper = new rem_categoriesApp();
$extJSHelper->parse('rem_category', 'rem_categories');
...
Ext.Loader.require(
    ...
    */
    ...
    Ext.define('remca.model.rem_category', {
