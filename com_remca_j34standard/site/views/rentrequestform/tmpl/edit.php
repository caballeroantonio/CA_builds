...
if ($this->params->get('save_history') AND $this->params->get('rentrequest_save_history'))
{
...
<div class="remca rentrequest-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rentrequestform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rentrequest-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('rentrequest.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('rentrequest.cancel')">
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jos_rem_rent_request_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_RENT_REQUEST_FIELDSET_JOS_REM_RENT_REQUEST_FS_LABEL');?></a></li>
