...
/**
 * HTML Rent_request View class for the RealEstateManager component
 *
 */
class RemcaViewRentRequestForm extends JViewLegacy
{
	...
	protected function prepareDocument()
	{
		...
		{
			$this->document->setTitle($rent_request->page_title.' - '.JText::sprintf('COM_REMCA_PAGEBREAK_PAGE_NUM', $this->state->get('page.offset') + 1));
		}
