...
$function	= $app->input->get('function', 'jSelectRent_request');
 ...
 */
?>
<div class="rent_requests-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_RENT_REQUESTS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_requests&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_rent_request_add_link', 1) AND $can_create)
	echo JHtml::_('rent_requesticon.create', $this->params);
?>
