...
class rent_requestsApp extends ExtJSHelper{
    
}
$extJSHelper = new rent_requestsApp();
$extJSHelper->parse('rent_request');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.rent_request', {
