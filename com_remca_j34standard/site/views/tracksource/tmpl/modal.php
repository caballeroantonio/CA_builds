...
$function	= $app->input->get('function', 'jSelectTrackSource');
...
if ($this->params->get('show_tracksource_add_link', 1) AND $can_create)
	echo JHtml::_('tracksourceicon.create', $this->params);
?>
