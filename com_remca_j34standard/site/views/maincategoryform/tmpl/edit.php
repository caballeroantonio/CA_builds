...
<div class="remca maincategory-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=maincategoryform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="maincategory-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('maincategory.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('maincategory.cancel')">
