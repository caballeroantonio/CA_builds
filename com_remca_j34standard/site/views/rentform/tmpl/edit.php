...
<div class="remca rent-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rentform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rent-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('rent.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('rent.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('rent_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jos_rem_rent_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_RENT_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-jos_rem_rent_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_RENT_FIELDSET_JOS_REM_RENT_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="rent-form" />
