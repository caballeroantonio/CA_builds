...
/**
 * HTML Review View class for the RealEstateManager component
 *
 */
class RemcaViewReviewForm extends JViewLegacy
{
	protected $state;
	protected $item;
	...
	protected function prepareDocument()
	{
		...
		{
			$this->document->setTitle($review->page_title.' - '.JText::sprintf('COM_REMCA_PAGEBREAK_PAGE_NUM', $this->state->get('page.offset') + 1));
		}
