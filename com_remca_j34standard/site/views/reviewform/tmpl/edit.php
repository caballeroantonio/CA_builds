...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_review_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_REVIEWS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-review_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_REVIEWS_FIELDSET_REVIEW_FS_LABEL');?></a></li>
