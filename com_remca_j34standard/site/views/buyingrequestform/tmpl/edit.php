...
<div class="remca buyingrequest-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=buyingrequestform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="buyingrequest-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('buyingrequest.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('buyingrequest.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('buyingrequest_save_history')
			) : ?>
				<div class="btn-group">
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_BUYING_REQUEST_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-jos_rem_buying_request_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_BUYING_REQUEST_FIELDSET_JOS_REM_BUYING_REQUEST_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="buyingrequest-form" />
