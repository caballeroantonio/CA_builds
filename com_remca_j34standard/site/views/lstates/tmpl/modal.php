...
$function	= $app->input->get('function', 'jSelectLstate');
 ...
 */
?>
<div class="lstates-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_LSTATES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=lstates&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lstate_add_link', 1) AND $can_create)
	echo JHtml::_('lstateicon.create', $this->params);
?>
