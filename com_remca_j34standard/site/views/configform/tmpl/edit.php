...
<div class="remca config-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=configform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="config-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('config.save')">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_config_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_CONFIGS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-config_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_CONFIGS_FIELDSET_CONFIG_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="config-form" />
