...
class RemcaViewHouses extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_remca&view=houses');
		...
		foreach ($rows as $row)
		{
			...
			if ($item->featured == 1)
			{
				$item->category[]	= JText::_('JFEATURED'); // All featured houses are categorized as "Featured"
			}
