...
class ordersApp extends ExtJSHelper{
    
}
$extJSHelper = new ordersApp();
$extJSHelper->parse('order', 'orders');
...
<div id="extjs-content"></div>
		...
		<?php 
			if($user->id == 1){
				//JHtml::_('ordericon.create', $this->params); 
	            echo '<span class="hasTooltip tip" title="Export"><a href="index.php?task=orders.export" class="btn btn-primary"><span class="icon-download"></span>Export</a></span>';
			}
        ?>
	</form>
</div>
