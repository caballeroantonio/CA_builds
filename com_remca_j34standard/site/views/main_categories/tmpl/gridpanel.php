...
class main_categoriesApp extends ExtJSHelper{
    
}
$extJSHelper = new main_categoriesApp();
$extJSHelper->parse('main_category');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.main_category', {
