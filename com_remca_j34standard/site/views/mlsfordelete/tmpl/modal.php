...
$function	= $app->input->get('function', 'jSelectMlsForDelete');
...
if ($this->params->get('show_mlsfordelete_add_link', 1) AND $can_create)
	echo JHtml::_('mlsfordeleteicon.create', $this->params);
?>
