...
if ($this->params->get('save_history') AND $this->params->get('buying_request_save_history'))
{
...
<div class="remca buying_request-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=buying_requestform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="buying_request-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('buying_request.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('buying_request.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('buying_request_save_history')
			) : ?>
				<div class="btn-group">
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_BUYING_REQUESTS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-buying_request_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_BUYING_REQUESTS_FIELDSET_BUYING_REQUEST_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="buying_request-form" />
