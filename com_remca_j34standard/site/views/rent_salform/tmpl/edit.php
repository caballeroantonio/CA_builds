...
if ($this->params->get('save_history') AND $this->params->get('rent_sal_save_history'))
{
...
<div class="remca rent_sal-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rent_salform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rent_sal-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('rent_sal.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('rent_sal.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('rent_sal_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_rent_sal_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_RENT_SAL_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-rent_sal_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_RENT_SAL_FIELDSET_RENT_SAL_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="rent_sal-form" />
