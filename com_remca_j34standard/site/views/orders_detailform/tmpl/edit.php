...
if ($this->params->get('save_history') AND $this->params->get('orders_detail_save_history'))
{
...
<div class="remca orders_detail-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_ORDERS_DETAILS_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=orders_detailform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="orders_detail-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('orders_detail.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('orders_detail.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('orders_detail_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_orders_details_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_ORDERS_DETAILS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-orders_details_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_ORDERS_DETAILS_FIELDSET_ORDERS_DETAILS_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="orders_detail-form" />
