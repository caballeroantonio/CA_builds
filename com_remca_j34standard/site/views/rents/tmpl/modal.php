 ...
 */
?>
<div class="rents-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_RENTS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=rents&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
