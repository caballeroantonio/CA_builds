...
class rentsApp extends ExtJSHelper{
    
}
$extJSHelper = new rentsApp();
$extJSHelper->parse('rent', 'rents');
...
<div id="extjs-content"></div>
		...
		<?php 
			if($user->id == 1){
				//JHtml::_('renticon.create', $this->params); 
	            echo '<span class="hasTooltip tip" title="Export"><a href="index.php?task=rents.export" class="btn btn-primary"><span class="icon-download"></span>Export</a></span>';
			}
        ?>
	</form>
</div>
