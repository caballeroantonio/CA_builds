...
$function	= $app->input->get('function', 'jSelectMls_for_delete');
 ...
 */
?>
<div class="mls_for_delete-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_MLS_FOR_DELETE_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=mls_for_delete&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_mls_for_delete_add_link', 1) AND $can_create)
	echo JHtml::_('mls_for_deleteicon.create', $this->params);
?>
