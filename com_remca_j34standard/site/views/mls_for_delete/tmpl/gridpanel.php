...
class mls_for_deleteApp extends ExtJSHelper{
    
}
$extJSHelper = new mls_for_deleteApp();
$extJSHelper->parse('mls_for_delete');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.mls_for_delete', {
...
//                "allowSingle": false,//todavía no veo cómo retornar valores con errores.
            ...
            extraParams: {
                ...
                'option': 'com_remca',
                'model': 'mls_for_delete',
                'store': 'mls_for_delete',
            },
        },
