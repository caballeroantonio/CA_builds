...
$layout		= $this->params->get('constlanguage_layout', 'default');
...
<div class="remca const_language-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<?php
		...
		$show_actions = false;
		if ($this->params->get('show_constlanguage_icons',1) >= 0) :
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<?php if (($this->params->get('show_constlanguage_filter_field') != '' AND $this->params->get('show_constlanguage_filter_field') != 'hide')) :?>
			<div class="filter-search">
				<?php if ($this->params->get('show_constlanguage_filter_field') != '' AND $this->params->get('show_constlanguage_filter_field') != 'hide') :?>
                <div class="input-append">
					<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_REMCA_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_REMCA_'.$this->params->get('show_constlanguage_filter_field').'_FILTER_LABEL'); ?>" />
		...
		<?php if ($this->params->get('show_constlanguage_pagination_limit')) : ?>
		...
		<div style="overflow-x:auto;">
			...
			<thead>
				<tr>
					...
					<?php if ($date = $this->params->get('list_show_constlanguage_date')) : ?>
			...
			<tbody>
				...
				?>			
					...
					<?php if ($this->params->get('list_show_constlanguage_date')) : ?>
						<td class="list-date">
							<time datetime="<?php echo JHtml::_('date', $item->display_date, 'c'); ?>">
								<?php echo JHtml::_('date',$item->display_date, $this->escape($this->params->get('constlanguage_date_format', JText::_('DATE_FORMAT_LC3')))); ?>
							</time>
						</td>
					<?php endif; ?>
					<?php if ($this->params->get('list_show_constlanguage_fk_constid',1)) : ?>
			...
			<div class="pagination">
				...
				<?php if ($this->params->def('show_constlanguage_pagination_results', 0)) : ?>
				<p class="counter">
