...
$function	= $app->input->get('function', 'jSelectConstLanguage');
...
if ($this->params->get('show_constlanguage_add_link', 1) AND $can_create)
	echo JHtml::_('constlanguageicon.create', $this->params);
?>
