...
<div class="remca lmunicipality-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_LMUNICIPALITIES_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=lmunicipalityform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lmunicipality-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('lmunicipality.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('lmunicipality.cancel')">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_municipality_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_REMCA_LMUNICIPALITIES_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
<?php */?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_LMUNICIPALITIES_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-municipality_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_LMUNICIPALITIES_FIELDSET_MUNICIPALITY_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="lmunicipality-form" />
