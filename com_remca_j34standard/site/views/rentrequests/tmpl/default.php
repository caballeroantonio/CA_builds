...
<div class="remca rent_requests-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div style="overflow-x:auto;">
			...
			<thead>
				<tr>
					...
					<?php if ($this->params->get('list_show_rentrequest_id_house',1)) : ?>
						<th class="list-id_house" id="tableOrderingid_house">
							<?php echo JTEXT::_('COM_REMCA_RENT_REQUESTS_HEADING_ID_HOUSE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_rentrequest_id_user',1)) : ?>
				...
				?>			
					...
					<?php if ($this->params->get('list_show_rentrequest_id_house',1)) : ?>
						<td class="list-id_house">
							<?php 
								if ($params->get('list_link_rentrequest_id_house')) :
					...
					<?php if ($this->params->get('list_show_rentrequest_id_user',1)) : ?>
						<td class="list-id_user">
							<?php 
								if ($params->get('list_link_rentrequest_id_user')) :
		...
		<?php 
			if($user->id == 1){
				//JHtml::_('rentrequesticon.create', $this->params); 
