...
$function	= $app->input->get('function', 'jSelectRentRequest');
...
if ($this->params->get('show_rentrequest_add_link', 1) AND $can_create)
	echo JHtml::_('rentrequesticon.create', $this->params);
?>
