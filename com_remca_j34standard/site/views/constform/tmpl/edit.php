...
if ($this->params->get('save_history') AND $this->params->get('const_save_history'))
{
...
<div class="remca const-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<?php if ($params->get('show_const_name')) : ?>
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_REMCA_CONST_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=constform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="const-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('const.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('const.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('const_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jos_rem_const_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_REMCA_CONST_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-jos_rem_const_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_CONST_FIELDSET_JOS_REM_CONST_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="const-form" />
