...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_const_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-const_fs" data-toggle="tab"><?php echo JText::_('COM_REMCA_CONST_FIELDSET_CONST_FS_LABEL');?></a></li>
