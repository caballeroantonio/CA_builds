...
<div class="remca orders_detail-view<?php echo $params->get('pageclass_sfx')?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<h1>
		<?php echo $this->escape($this->params->get('page_heading')); ?>
	</h1>
	<?php endif; ?>
	<?php if ($params->get('show_orders_detail_icons',-1) >= 0) : ?>
		<?php if ($params->get('show_orders_detail_print_icon') 
			OR $params->get('show_orders_detail_email_icon') 
			): ?>
			<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu">
					<?php if (!$this->print) : ?>
							<?php if ($params->get('show_orders_detail_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('orders_detailicon.print_popup',  $this->item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_orders_detail_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('orders_detailicon.email',  $this->item, $params); ?>
								</li>
							<?php endif; ?>
								<li class="edit-icon">
									<?php echo JHtml::_('orders_detailicon.edit', $this->item, $params); ?>
								</li>
								<li class="delete-icon">
									<?php echo JHtml::_('orders_detailicon.delete',$this->item, $params); ?>
								</li>					
					<?php else : ?>
						<li>
							<?php echo JHtml::_('orders_detailicon.print_screen',  $this->item, $params); ?>
						</li>
					<?php endif; ?>
				</ul>
			</div>
	...
	<?php if ($params->get('show_orders_detail_name')) : ?>
		<div style="float: left;">
			<h2>
				<?php if ($params->get('link_orders_detail_names') AND !empty($this->item->readmore_link)) : ?>
	...
	<?php endif; ?>
	<?php  echo $this->item->event->afterDisplayOrders_detailName;	?>
	
	<?php echo $this->item->event->beforeDisplayOrders_detail; ?>
	<div style="clear:both; padding-top: 10px;">

	</div>
	<div style="padding-top: 10px;">

			<form action="" name="orders_detailForm" id="orders_detailForm">
			<?php $dummy = false;
					$display_fieldset = (
								($params->get('show_orders_detail_id_order')) OR 
								($params->get('show_orders_detail_id_user')) OR 
								($params->get('show_orders_detail_fk_houses_htitle')) OR 
								($params->get('show_orders_detail_email')) OR 
								($params->get('show_orders_detail_status')) OR 
								($params->get('show_orders_detail_order_date')) OR 
								($params->get('show_orders_detail_id_house')) OR 
								($params->get('show_orders_detail_txn_type')) OR 
								($params->get('show_orders_detail_txn_id')) OR 
								($params->get('show_orders_detail_payer_id')) OR 
								($params->get('show_orders_detail_payer_status')) OR 
								($params->get('show_orders_detail_order_calculated_price')) OR 
								($params->get('show_orders_detail_order_price')) OR 
								($params->get('show_orders_detail_order_currency_code')) OR 
								($params->get('show_orders_detail_payment_details')) OR 
								($params->get('show_orders_detail_paypal_paykay')) OR 
								$dummy
								);
			?>
			...
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_orders_detail_id_order')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_id_user')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_fk_houses_htitle')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_email')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_status')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_order_date')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_id_house')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_txn_type')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_txn_id')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_payer_id')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_payer_status')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_order_calculated_price')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_order_price')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_order_currency_code')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_payment_details')) : ?>
						<div class="formelm">
							<label>
						...
						<?php endif; ?>
						<?php if ($params->get('show_orders_detail_paypal_paykay')) : ?>
						<div class="formelm">
							<label>
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_orders_detail_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php endif; ?>
				...
				<?php if ($params->get('show_orders_detail_admin')) : ?>
		...
		<?php echo $this->item->event->afterDisplayOrders_detail; ?>
	</div>		
</div>