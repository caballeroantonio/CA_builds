...
function getFields(){
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL mime_ext
    ...
    */
    $fields['mime_ext'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'mime_type',
        'FIELD_CODE_NAME' => 'mime_type',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 4,
    );
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL mime_type
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Mime_typeForm','RemcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=mime_typeform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
