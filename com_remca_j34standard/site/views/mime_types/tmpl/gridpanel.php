...
class mime_typesApp extends ExtJSHelper{
    
}
$extJSHelper = new mime_typesApp();
$extJSHelper->parse('mime_type');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.mime_type', {
