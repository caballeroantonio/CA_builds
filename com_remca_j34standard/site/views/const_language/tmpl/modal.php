...
$function	= $app->input->get('function', 'jSelectConst_language');
 ...
 */
?>
<div class="const_language-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_CONST_LANGUAGE_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=const_language&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_const_language_add_link', 1) AND $can_create)
	echo JHtml::_('const_languageicon.create', $this->params);
?>
