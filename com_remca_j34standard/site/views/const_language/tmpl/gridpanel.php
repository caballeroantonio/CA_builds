...
function getFields(){
    ...
    /*
                ...
                FIELD_DB=`` INT(10) UNSIGNED  NOT NULL DEFAULT '0' fk_constid
    ...
    */
    $fields['fk_constid'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'fk_languagesid',
        'FIELD_CODE_NAME' => 'fk_languagesid',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 13,
    );
    /*
                ...
                FIELD_DB=`` INT(10) UNSIGNED  NOT NULL DEFAULT '0' fk_languagesid
    ...
    */
    $fields['fk_languagesid'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'value_const',
        'FIELD_CODE_NAME' => 'value_const',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(2000) DEFAULT NULL value_const
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Const_languageForm','RemcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=const_languageform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
