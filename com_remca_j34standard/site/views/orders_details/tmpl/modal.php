...
$function	= $app->input->get('function', 'jSelectOrders_detail');
 ...
 */
?>
<div class="orders_details-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_REMCA_ORDERS_DETAILS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_remca&view=orders_details&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_orders_detail_add_link', 1) AND $can_create)
	echo JHtml::_('orders_detailicon.create', $this->params);
?>
