...
class orders_detailsApp extends ExtJSHelper{
    
}
$extJSHelper = new orders_detailsApp();
$extJSHelper->parse('orders_detail');
?>
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('remca.model.orders_detail', {
