...
$function	= $app->input->get('function', 'jSelectFeatureHouse');
...
if ($this->params->get('show_featurehouse_add_link', 1) AND $can_create)
	echo JHtml::_('featurehouseicon.create', $this->params);
?>
