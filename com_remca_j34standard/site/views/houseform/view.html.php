...
class RemcaViewHouseForm extends JViewLegacy
{
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_REMCA_HOUSES_EDIT_ITEM'));
		}
		...
		{
			$title = $this->params->def('page_title', JText::_('COM_REMCA_HOUSES_CREATE_ITEM'));
			
			$pathway->addItem(JText::_('COM_REMCA_HOUSES_CREATE_ITEM'),'');
		}
