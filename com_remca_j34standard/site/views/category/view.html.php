...
class RemcaViewCategory extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->category->tags->getItemTags('com_remca.category', $this->category->id);
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_REMCA_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_remca' OR
					 $menu->query['view'] == 'house' OR 
					 $menu->query['view'] == 'wa_entry_conversation' OR 
					 $id != $this->category->id))
		{
			$path = array(array('title' => $this->category->title, 'link' => ''));
			$category = $this->category->getParent();

			while (($menu->query['option'] != 'com_remca' OR
					$menu->query['view'] == 'house' OR
					$menu->query['view'] == 'wa_entry_conversation' OR
