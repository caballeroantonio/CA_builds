...
class RemcaViewWisheslist extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_remca&view=wisheslist');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the wishlist slug
			$row->slug = $row->id;

			// url link to wishlist
			$link = JRoute::_(RemcaHelperRoute::getWishlistRoute($row->slug, 
																						'default',								
