...
class RemcaViewLanguages extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// PREPARE THE DATA
		// Compute the language slugs and set the trigger events.
		foreach ($items as $i => &$item)
		{
			...
			$dispatcher->trigger('onLanguagePrepare', array ('com_remca.language', &$item, &$item->params,$i));
			...
			$results = $dispatcher->trigger('onLanguageAfterDisplay', array('com_remca.language', &$item, &$item->params,$i));
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_REMCA_LANGUAGES'));
		}
