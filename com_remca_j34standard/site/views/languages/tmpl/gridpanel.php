...
function getFields(){
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(7) DEFAULT NULL lang_code
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(250) DEFAULT NULL title
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(7) DEFAULT NULL sef
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('LanguageForm','RemcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_remca&view=languageform&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
