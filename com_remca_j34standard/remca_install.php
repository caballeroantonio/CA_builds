 ...
 */
class com_remcaInstallerScript
{
    /**
...
UPDATE #__extensions SET enabled = 1 WHERE type = 'plugin' name = {$plugin};
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/remca_install.html';
		...
		ob_start();            
		?>
		<div id="remcainstall-info">
			<h1><?php echo JText::_('COM_REMCA_INSTALL_HEADER'); ?></h1>
			<div id="remcainstall-intro">
				<?php echo JText::_('COM_REMCA_INSTALL_INTRO'); ?>
			</div>
			<table id="remcainstall-table" class="adminlist">
				<thead class="remcainstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_REMCA_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="remcainstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_REMCA_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_REMCA_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="remcainstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_REMCA');?>
						</td>
						<td class="remcainstall-success">
							<?php echo JText::_('COM_REMCA_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_REMCA_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="remcainstall-subheading">
				<th>
					<?php echo JText::_('COM_REMCA_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_REMCA_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_REMCA_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="remcainstall-subheading">
				<th>
					<?php echo JText::_('COM_REMCA_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_REMCA_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_REMCA_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="remcainstall-component-error">
									<?php echo JText::_('COM_REMCA_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="remcainstall-component-success">
									<?php echo JText::_('COM_REMCA_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_REMCA_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
...
$installer->uninstall('module', $mod_id)
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/remca_uninstall.html';
     ...
     ?>
	<div id="remcainstall-info">
		<h1><?php echo JText::_('COM_REMCA_UNINSTALL_HEADER'); ?></h1>
			<table id="remcainstall-table" class="adminlist">
				<thead class="remcainstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_REMCA_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="remcainstall-row">
						...
						<td class="remcainstall-success">
							<?php echo JText::_('COM_REMCA_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			JFolder::delete(JPATH_SITE.'/plugins/remca'); 
		}  
		...
		JFolder::delete(JPATH_SITE.'/images/remca'); 
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="remcainstall-component-error">
									<?php echo JText::_('COM_REMCA_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="remcainstall-component-success">
									<?php echo JText::_('COM_REMCA_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
...
UPDATE #__extensions SET enabled = 1 WHERE type = 'plugin' name = {$plugin};
    ...
    function update($parent) 
    {
		...
		?>
		<div id="remcainstall-info">
			<h1><?php echo JText::_('COM_REMCA_UPDATE_HEADER'); ?></h1>
			<table id="remcainstall-table" class="adminlist">
				<thead class="remcainstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_REMCA_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="remcainstall-row">
						...
						<td class="remcainstall-success">
							<?php echo JText::_('COM_REMCA_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="remcainstall-component-error">
									<?php echo JText::_('COM_REMCA_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="remcainstall-component-success">
									<?php echo JText::_('COM_REMCA_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_REMCA_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_REMCA_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/remca'); 
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_remca'));		
...
UPDATE #__extensions SET params = '{$params_string}' WHERE type = 'component' AND name = 'com_remca'
	...
	<tr class="remcainstall-row">
		...
		<td class="remcainstall-error">
			<div>
				<?php echo JText::_('COM_REMCA_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="remcainstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="remcainstall-row">
			...
			<td class="remcainstall-success">
				<div><?php echo JText::_('COM_REMCA_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
