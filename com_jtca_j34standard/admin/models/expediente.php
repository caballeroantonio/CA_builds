 ...
 *
 */
class JtcaModelExpediente extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_EXPEDIENTES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.expediente')
	 */
	 ...
	 */
	protected $event_before_save = 'onExpedienteBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onExpedienteAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onExpedienteBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onExpedienteAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onExpedienteChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.expediente.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the expedientes version number.
		$table->version++;
	}
	/**
	...
	public function save($data)
	{
		...
		$data['partescontenciosas'] = json_encode( array_values( $data['partescontenciosas']));
