 ...
 *
 */
class JtCaModelLsc03 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSC03S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsc03')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsc03BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsc03AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsc03BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsc03AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsc03ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsc03.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de vistas al m.p (oficial) version number.
		$table->version++;
