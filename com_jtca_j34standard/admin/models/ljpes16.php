 ...
 *
 */
class JtCaModelLjpes16 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJPES16S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljpes16')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjpes16BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjpes16AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjpes16BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjpes16AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjpes16ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljpes16.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de desistimientos version number.
		$table->version++;
