 ...
 *
 */
class JtcaModelSldilJccm07 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLDIL_JCCM07S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.sldiljccm07')
	 */
	 ...
	 */
	protected $event_before_save = 'onSldilJccm07BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSldilJccm07AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSldilJccm07BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSldilJccm07AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSldilJccm07ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.sldiljccm07.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro diligencia del libro de exhortos version number.
		$table->version++;
