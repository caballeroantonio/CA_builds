...
/**
 * Slaveriguacion model.
 *
 */
class JtcaModelSlaveriguacion extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLAVERIGUACIONES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slaveriguacion')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlaveriguacionBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlaveriguacionAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlaveriguacionBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlaveriguacionAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlaveriguacionChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slaveriguacion.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the averiguaciones previas version number.
		$table->version++;
