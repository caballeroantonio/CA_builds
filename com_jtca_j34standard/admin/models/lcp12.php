 ...
 *
 */
class JtCaModelLcp12 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP12S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp12')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp12BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp12AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp12BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp12AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp12ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp12.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de turno de salas para juzgados orales. version number.
		$table->version++;
