 ...
 *
 */
class JtCaModelLjomf21 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJOMF21S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljomf21')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjomf21BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjomf21AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjomf21BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjomf21AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjomf21ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljomf21.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de control de adopciones internacionales version number.
		$table->version++;
