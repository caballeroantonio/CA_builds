 ...
 *
 */
class JtcaModelLjpdng12 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJPDNG12S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljpdng12')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjpdng12BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjpdng12AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjpdng12BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjpdng12AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjpdng12ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljpdng12.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de control de fianzas version number.
		$table->version++;
