 ...
 *
 */
class JtCaModelLsc11 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSC11S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsc11')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsc11BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsc11AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsc11BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsc11AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsc11ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsc11.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de oficios (oficial) version number.
		$table->version++;
