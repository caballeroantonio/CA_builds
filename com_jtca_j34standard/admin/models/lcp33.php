 ...
 *
 */
class JtcaModelLcp33 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP33S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp33')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp33BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp33AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp33BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp33AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp33ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp33.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de libertades de salas penales version number.
		$table->version++;
