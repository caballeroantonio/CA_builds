 ...
 *
 */
class JtCaModelLcp35 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP35S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp35')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp35BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp35AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp35BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp35AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp35ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp35.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de libertades de salas de adolescentes version number.
		$table->version++;
