 ...
 *
 */
class JtCaModelLcp32 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP32S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp32')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp32BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp32AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp32BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp32AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp32ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp32.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de libertades juzgados de ejecución de sentencia version number.
		$table->version++;
