 ...
 *
 */
class JtcaModelSlfirmJjadg16 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLFIRM_JJADG16S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slfirmjjadg16')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlfirmJjadg16BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlfirmJjadg16AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlfirmJjadg16BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlfirmJjadg16AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlfirmJjadg16ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slfirmjjadg16.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro control de firmas del libro de control de presentacion de adolescentes en libertad ante el juez version number.
		$table->version++;
