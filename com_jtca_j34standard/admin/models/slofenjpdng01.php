 ...
 *
 */
class JtcaModelSlofenJpdng01 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLOFEN_JPDNG01S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slofenjpdng01')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlofenJpdng01BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlofenJpdng01AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlofenJpdng01BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlofenJpdng01AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlofenJpdng01ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slofenjpdng01.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro datos del(os) ofendido(s) del libro de gobierno version number.
		$table->version++;
