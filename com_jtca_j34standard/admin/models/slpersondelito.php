...
/**
 * Slpersondelito model.
 *
 */
class JtcaModelSlpersondelito extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLPERSONDELITOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slpersondelito')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlpersondelitoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlpersondelitoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlpersondelitoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlpersondelitoAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlpersondelitoChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slpersondelito.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the inculpados version number.
		$table->version++;
