 ...
 *
 */
class JtCaModelLcp30 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP30S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp30')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp30BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp30AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp30BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp30AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp30ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp30.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de libertades juzgados de primera instancia version number.
		$table->version++;
