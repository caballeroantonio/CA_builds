 ...
 *
 */
class JtcaModelSladolJjadg05 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLADOL_JJADG05S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.sladoljjadg05')
	 */
	 ...
	 */
	protected $event_before_save = 'onSladolJjadg05BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSladolJjadg05AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSladolJjadg05BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSladolJjadg05AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSladolJjadg05ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.sladoljjadg05.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro adolescentes del libro de sentencias version number.
		$table->version++;
