 ...
 *
 */
class JtcaModelLcp14 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP14S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp14')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp14BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp14AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp14BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp14AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp14ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp14.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de cumplimiento de ejecutorias para juzgados de ejecución. version number.
		$table->version++;
