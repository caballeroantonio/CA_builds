 ...
 *
 */
class JtcaModelLcp34 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP34S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp34')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp34BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp34AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp34BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp34AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp34ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp34.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de libertades juzgados de adolescentes version number.
		$table->version++;
