 ...
 *
 */
class JtcaModelSlpersonalias extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLPERSONALIASES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slpersonalias')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlpersonaliasBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlpersonaliasAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlpersonaliasBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlpersonaliasAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlpersonaliasChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slpersonalias.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the inculpado version number.
		$table->version++;
