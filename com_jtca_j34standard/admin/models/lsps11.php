 ...
 *
 */
class JtcaModelLsps11 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSPS11S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsps11')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsps11BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsps11AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsps11BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsps11AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsps11ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsps11.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de control de fianza version number.
		$table->version++;
