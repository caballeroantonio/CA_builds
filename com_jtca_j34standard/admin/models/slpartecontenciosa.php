...
/**
 * Slpartecontenciosa model.
 *
 */
class JtcaModelSlpartecontenciosa extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLPARTESCONTENCIOSAS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slpartecontenciosa')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlpartecontenciosaBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlpartecontenciosaAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlpartecontenciosaBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlpartecontenciosaAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlpartecontenciosaChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slpartecontenciosa.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the partes contenciosas en juicio version number.
		$table->version++;
