 ...
 *
 */
class JtcaModelLsc13 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSC13S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsc13')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsc13BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsc13AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsc13BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsc13AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsc13ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsc13.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the papeletas para el préstamo de expedientes version number.
		$table->version++;
