 ...
 *
 */
class JtcaModelSlperson extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLPERSONS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slperson')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlpersonBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlpersonAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlpersonBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlpersonAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlpersonChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slperson.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro personas version number.
		$table->version++;
