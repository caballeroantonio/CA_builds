...
/**
 * Methods supporting a list of lejemplo records.
 *
 */
class JtCaModelLejemplos extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// Select the required lejemplos from the table.
		$query->select(
			$this->getState(
					'list.select',
					'a.*'
		...
		// Filter by and return name for my_parent level. %@ToDo fix, if NOT INCLUDE_NAME then OBJECT_LABEL_FIELD = OBJECT_ORDERING_FIELD, then SELECT  is repeated, e.id AS e_expediente_id x 2
