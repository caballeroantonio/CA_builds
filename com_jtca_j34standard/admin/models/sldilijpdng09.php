 ...
 *
 */
class JtcaModelSldiliJpdng09 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLDILI_JPDNG09S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.sldilijpdng09')
	 */
	 ...
	 */
	protected $event_before_save = 'onSldiliJpdng09BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSldiliJpdng09AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSldiliJpdng09BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSldiliJpdng09AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSldiliJpdng09ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.sldilijpdng09.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro diligencia del libro de actuarios version number.
		$table->version++;
