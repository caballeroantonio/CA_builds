 ...
 *
 */
class JtCaModelLsc01 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSC01S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsc01')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsc01BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsc01AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsc01BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsc01AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsc01ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsc01.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de registro de sentencias -turno- (oficial) version number.
		$table->version++;
