 ...
 *
 */
class JtcaModelLcp16 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP16S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp16')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp16BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp16AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp16BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp16AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp16ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp16.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de  oficios de amparos de conocimiento. version number.
		$table->version++;
