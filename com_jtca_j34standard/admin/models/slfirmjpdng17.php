 ...
 *
 */
class JtcaModelSlfirmJpdng17 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLFIRM_JPDNG17S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slfirmjpdng17')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlfirmJpdng17BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlfirmJpdng17AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlfirmJpdng17BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlfirmJpdng17AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlfirmJpdng17ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slfirmjpdng17.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro control de firmas del libro de control de firmas procesados version number.
		$table->version++;
