 ...
 *
 */
class JtcaModelLjpes10 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJPES10S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljpes10')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjpes10BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjpes10AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjpes10BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjpes10AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjpes10ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljpes10.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the agenda de audiencias para juicios orales version number.
		$table->version++;
