 ...
 *
 */
class JtCaModelLcp13 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP13S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp13')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp13BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp13AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp13BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp13AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp13ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp13.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de expedientillos de juzgados de ejecución para juzgados penal o no graves. version number.
		$table->version++;
