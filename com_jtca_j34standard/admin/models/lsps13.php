 ...
 *
 */
class JtcaModelLsps13 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSPS13S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsps13')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsps13BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsps13AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsps13BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsps13AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsps13ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsps13.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the control de firmas del procesado version number.
		$table->version++;
