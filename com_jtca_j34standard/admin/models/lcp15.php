 ...
 *
 */
class JtCaModelLcp15 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP15S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp15')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp15BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp15AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp15BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp15AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp15ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp15.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de oficios de amparos de tramite. version number.
		$table->version++;
