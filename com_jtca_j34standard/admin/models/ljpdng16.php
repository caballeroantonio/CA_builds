 ...
 *
 */
class JtCaModelLjpdng16 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJPDNG16S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljpdng16')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjpdng16BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjpdng16AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjpdng16BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjpdng16AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjpdng16ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljpdng16.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de registro en que se haya obsequiado o negado la orden de aprehensión, comparecencia, presentación, artículo 36 del código de procedimientos penales y otros version number.
		$table->version++;
