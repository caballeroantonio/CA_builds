 ...
 *
 */
class JtcaModelSldepJoc03 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLDEP_JOC03S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.sldepjoc03')
	 */
	 ...
	 */
	protected $event_before_save = 'onSldepJoc03BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSldepJoc03AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSldepJoc03BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSldepJoc03AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSldepJoc03ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.sldepjoc03.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro certificado de egresos del libro de certificado de depósitos de ingresos y egresos version number.
		$table->version++;
