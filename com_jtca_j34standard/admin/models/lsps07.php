 ...
 *
 */
class JtCaModelLsps07 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSPS07S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsps07')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsps07BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsps07AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsps07BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsps07AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsps07ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsps07.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the registro de billetes de deposito version number.
		$table->version++;
