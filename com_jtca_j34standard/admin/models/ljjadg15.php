 ...
 *
 */
class JtCaModelLjjadg15 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJJADG15S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljjadg15')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjjadg15BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjjadg15AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjjadg15BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjjadg15AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjjadg15ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljjadg15.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the articulo 36 o articulo 28 ljadf version number.
		$table->version++;
