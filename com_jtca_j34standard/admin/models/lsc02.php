 ...
 *
 */
class JtcaModelLsc02 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSC02S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsc02')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsc02BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsc02AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsc02BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsc02AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsc02ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsc02.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de registro de asistencia (oficial) version number.
		$table->version++;
