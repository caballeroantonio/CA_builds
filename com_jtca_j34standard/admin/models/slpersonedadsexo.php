...
/**
 * Slpersonedadsexo model.
 *
 */
class JtcaModelSlpersonedadsexo extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLPERSONEDADSEXOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slpersonedadsexo')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlpersonedadsexoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlpersonedadsexoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlpersonedadsexoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlpersonedadsexoAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlpersonedadsexoChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slpersonedadsexo.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the adolescente version number.
		$table->version++;
