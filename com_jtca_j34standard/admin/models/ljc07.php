...
class JtCaModelLjc07 extends JModelAdmin
{
	 ...
	 */
	protected $text_prefix = 'COM_JTCA_LJC07S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljc07')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjc07BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjc07AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjc07BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjc07AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjc07ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljc07.data', array());
