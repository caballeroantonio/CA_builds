...
/**
 * SlinculJpdng01 model.
 *
 */
class JtcaModelSlinculJpdng01 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLINCUL_JPDNG01S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slinculjpdng01')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlinculJpdng01BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlinculJpdng01AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlinculJpdng01BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlinculJpdng01AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlinculJpdng01ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slinculjpdng01.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro datos del(os) inculpado(s) del libro de gobierno version number.
		$table->version++;
