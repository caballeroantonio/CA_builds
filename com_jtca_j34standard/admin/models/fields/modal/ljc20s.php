...
class JFormFieldModal_Ljc20s extends JFormField
{
	...
	protected function getInput()
	{
		...
		if ($allow_clear AND !$script_clear)
		{
			...
			$script[] = '	function jClearLjc20(id) {';
			$script[] = '		document.getElementById(id + "_id").value = "'.htmlspecialchars(JText::_('COM_JTCA_LJC20S_SELECT_ITEM_LABEL', true), ENT_COMPAT, 'UTF-8').'";';
