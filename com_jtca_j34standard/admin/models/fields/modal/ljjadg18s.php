...
class JFormFieldModal_Ljjadg18s extends JFormField
{
	...
	protected function getInput()
	{
		...
		if ($allow_clear AND !$script_clear)
		{
			...
			$script[] = '	function jClearLjjadg18(id) {';
			$script[] = '		document.getElementById(id + "_id").value = "'.htmlspecialchars(JText::_('COM_JTCA_LJJADG18S_SELECT_ITEM_LABEL', true), ENT_COMPAT, 'UTF-8').'";';
