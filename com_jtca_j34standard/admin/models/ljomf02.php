 ...
 *
 */
class JtCaModelLjomf02 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJOMF02S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljomf02')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjomf02BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjomf02AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjomf02BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjomf02AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjomf02ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljomf02.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de ingresos de valores version number.
		$table->version++;
