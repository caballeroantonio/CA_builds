 ...
 *
 */
class JtCaModelLsc05 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LSC05S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lsc05')
	 */
	 ...
	 */
	protected $event_before_save = 'onLsc05BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLsc05AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLsc05BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLsc05AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLsc05ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lsc05.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the agenda (oficial) version number.
		$table->version++;
