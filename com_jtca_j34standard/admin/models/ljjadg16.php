 ...
 *
 */
class JtCaModelLjjadg16 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LJJADG16S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.ljjadg16')
	 */
	 ...
	 */
	protected $event_before_save = 'onLjjadg16BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLjjadg16AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLjjadg16BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLjjadg16AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLjjadg16ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.ljjadg16.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libro de control de presentación de adolescentes en libertad ante el juez version number.
		$table->version++;
