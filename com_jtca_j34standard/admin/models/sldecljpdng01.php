 ...
 *
 */
class JtcaModelSldeclJpdng01 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLDECL_JPDNG01S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.sldecljpdng01')
	 */
	 ...
	 */
	protected $event_before_save = 'onSldeclJpdng01BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSldeclJpdng01AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSldeclJpdng01BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSldeclJpdng01AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSldeclJpdng01ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.sldecljpdng01.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro declaracion preparatoria del libro de gobierno version number.
		$table->version++;
