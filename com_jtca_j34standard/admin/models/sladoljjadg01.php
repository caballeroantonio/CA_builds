 ...
 *
 */
class JtcaModelSladolJjadg01 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLADOL_JJADG01S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.sladoljjadg01')
	 */
	 ...
	 */
	protected $event_before_save = 'onSladolJjadg01BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSladolJjadg01AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSladolJjadg01BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSladolJjadg01AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSladolJjadg01ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.sladoljjadg01.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the sub libro adolescente del libro de gobierno version number.
		$table->version++;
