...
/**
 * Slpersonaliasedad model.
 *
 */
class JtcaModelSlpersonaliasedad extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_SLPERSONALIASEDADES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.slpersonaliasedad')
	 */
	 ...
	 */
	protected $event_before_save = 'onSlpersonaliasedadBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSlpersonaliasedadAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSlpersonaliasedadBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSlpersonaliasedadAfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onSlpersonaliasedadChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.slpersonaliasedad.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the adolescentes version number.
		$table->version++;
