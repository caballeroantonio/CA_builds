 ...
 *
 */
class JtcaModelLcp36 extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_JTCA_LCP36S';
	/**
	 * @var      string	The type alias for this object (for example, 'com_jtca.lcp36')
	 */
	 ...
	 */
	protected $event_before_save = 'onLcp36BeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onLcp36AfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onLcp36BeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onLcp36AfterDelete';	
	/**
	 * @var    string	The event to trigger after changing the data's state field.
	 */
	protected $event_change_state = 'onLcp36ChangeState';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jtca.edit.lcp36.data', array());
	...
	protected function prepareTable($table)
	{
		...
		// Increment the libreta de returno de adolescentes version number.
		$table->version++;
