 ...
 *
 */
class JtCaTableLjc21s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc21s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc21'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field8_isMoral',$array)  ) 
		{
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc21s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE MINISTERIO PÚBLICO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE MINISTERIO PÚBLICO. A created and created_by field can be set by the user,
