 ...
 *
 */
class JtCaTableLspe08s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe08s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe08'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe08s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE INGRESO Y EGRESO DE BILLETES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE INGRESO Y EGRESO DE BILLETES. A created and created_by field can be set by the user,
