 ...
 *
 */
class JtCaTableLsc13s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc13s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc13'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc13s','JtCaTable');
	...
	/**
	 * Stores a PAPELETAS PARA EL PRÉSTAMO DE EXPEDIENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New PAPELETAS PARA EL PRÉSTAMO DE EXPEDIENTES. A created and created_by field can be set by the user,
