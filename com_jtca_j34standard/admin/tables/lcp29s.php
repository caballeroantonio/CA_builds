 ...
 *
 */
class JtCaTableLcp29s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp29s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp29'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp29s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE ORDENES PARA ARRAIGOS Y CATEOS DELITOS NO GRAVES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ORDENES PARA ARRAIGOS Y CATEOS DELITOS NO GRAVES. A created and created_by field can be set by the user,
