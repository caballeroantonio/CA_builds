 ...
 *
 */
class JtCaTableLcp18s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp18s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp18'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp18s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA CONSIGNACIONES CON DETENIDO PRIMERA INSTANCIA.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA CONSIGNACIONES CON DETENIDO PRIMERA INSTANCIA.. A created and created_by field can be set by the user,
