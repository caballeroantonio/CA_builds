 ...
 *
 */
class JtcaTableLjoc10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljoc10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljoc10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljoc10s','JtcaTable');
