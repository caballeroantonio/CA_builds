 ...
 *
 */
class JtcaTableLjpes13s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes13s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes13'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes13s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE RESOLUCIONES EN AUDIENCIA
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE RESOLUCIONES EN AUDIENCIA. A created and created_by field can be set by the user,
