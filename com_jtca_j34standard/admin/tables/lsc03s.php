 ...
 *
 */
class JtcaTableLsc03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc03s','JtcaTable');
	...
	/**
	 * Stores a LIBRETA DE VISTAS AL M.P (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE VISTAS AL M.P (OFICIAL). A created and created_by field can be set by the user,
