 ...
 *
 */
class JtCaTableLcp31s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp31s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp31'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp31s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE LIBERTADES JUZGADOS DE DELITOS NO GRAVES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE LIBERTADES JUZGADOS DE DELITOS NO GRAVES. A created and created_by field can be set by the user,
