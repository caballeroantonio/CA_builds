 ...
 *
 */
class JtcaTableSldilJccm09s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_sldil_jccm09s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.sldiljccm09'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('SldilJccm09s','JtcaTable');

		// For all keys
		foreach ($pks as $pk)
		{
			// Load the sldiljccm09
			if(!$table->load($pk))
			{
