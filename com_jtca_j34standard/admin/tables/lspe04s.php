 ...
 *
 */
class JtCaTableLspe04s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe04s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe04'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe04s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE BENEFICIOS REVOCADO Y O/A
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE BENEFICIOS REVOCADO Y O/A. A created and created_by field can be set by the user,
