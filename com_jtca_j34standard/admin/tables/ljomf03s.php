 ...
 *
 */
class JtCaTableLjomf03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljomf03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljomf03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljomf03s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE EGRESOS DE VALORES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE EGRESOS DE VALORES. A created and created_by field can be set by the user,
