 ...
 *
 */
class JtCaTableLjemst12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljemst12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljemst12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljemst12s','JtCaTable');
