 ...
 *
 */
class JtCaTableLcp06s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp06s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp06'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp06s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA INCOMPETENCIAS ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA INCOMPETENCIAS ADOLESCENTES. A created and created_by field can be set by the user,
