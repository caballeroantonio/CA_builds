 ...
 *
 */
class JtCaTableLjjadng10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljjadng10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljjadng10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljjadng10s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE PEDIMENTOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE PEDIMENTOS. A created and created_by field can be set by the user,
