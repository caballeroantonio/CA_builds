 ...
 *
 */
class JtcaTableLsps01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps01'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps01s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE GOBIERNO (SISTEMA TRADICIONAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE GOBIERNO (SISTEMA TRADICIONAL). A created and created_by field can be set by the user,
