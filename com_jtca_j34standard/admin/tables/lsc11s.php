 ...
 *
 */
class JtCaTableLsc11s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc11s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc11'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc11s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE OFICIOS (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE OFICIOS (OFICIAL). A created and created_by field can be set by the user,
