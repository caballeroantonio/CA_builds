 ...
 *
 */
class JtCaTableLcp22s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp22s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp22'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp22s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE ORDENES DE ARRAIGOS Y DE CATEOS PRIMERA INSTANCIA.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ORDENES DE ARRAIGOS Y DE CATEOS PRIMERA INSTANCIA.. A created and created_by field can be set by the user,
