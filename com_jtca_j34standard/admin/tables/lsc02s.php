 ...
 *
 */
class JtCaTableLsc02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc02s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE REGISTRO DE ASISTENCIA (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE REGISTRO DE ASISTENCIA (OFICIAL). A created and created_by field can be set by the user,
