 ...
 *
 */
class JtCaTableLjc13s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc13s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc13'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field2_isMoral',$array)  ) 
		{
			$array['field2_isMoral'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc13s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE FIANZAS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE FIANZAS. A created and created_by field can be set by the user,
