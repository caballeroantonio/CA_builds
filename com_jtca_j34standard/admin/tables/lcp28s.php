...
class JtCaTableLcp28s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp28s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp28'));
	}
	...
	/**
	 * Stores a LIBRO DE TURNO DE EXCUSAS PARA JUZGADOS  DE DELITOS NO GRAVES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE EXCUSAS PARA JUZGADOS  DE DELITOS NO GRAVES. A created and created_by field can be set by the user,
