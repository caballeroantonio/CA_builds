 ...
 *
 */
class JtcaTableLsc09s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc09s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc09'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc09s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE GOBIERNO (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE GOBIERNO (OFICIAL). A created and created_by field can be set by the user,
