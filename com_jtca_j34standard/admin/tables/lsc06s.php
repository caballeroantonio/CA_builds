 ...
 *
 */
class JtCaTableLsc06s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc06s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc06'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc06s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE BILLETES Y PÓLIZAS (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE BILLETES Y PÓLIZAS (OFICIAL). A created and created_by field can be set by the user,
