 ...
 *
 */
class JtcaTableLcp19s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp19s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp19'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp19s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA CONSIGNACIONES SIN DETENIDO PRIMERA INSTANCIA.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA CONSIGNACIONES SIN DETENIDO PRIMERA INSTANCIA.. A created and created_by field can be set by the user,
