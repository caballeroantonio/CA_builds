 ...
 *
 */
class JtcaTableLjpes10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes10s','JtcaTable');
	...
	/**
	 * Stores a AGENDA DE AUDIENCIAS PARA JUICIOS ORALES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New AGENDA DE AUDIENCIAS PARA JUICIOS ORALES. A created and created_by field can be set by the user,
