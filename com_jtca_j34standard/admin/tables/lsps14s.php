 ...
 *
 */
class JtcaTableLsps14s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps14s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps14'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps14s','JtcaTable');
