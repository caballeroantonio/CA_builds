 ...
 *
 */
class JtCaTableLjpes09s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes09s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes09'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes09s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE MULTAS JUDICIALES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE MULTAS JUDICIALES. A created and created_by field can be set by the user,
