 ...
 *
 */
class JtCaTableLejemplos extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lejemplo'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('my_boolean',$array)  ) 
		{
			$array['my_boolean'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lejemplos','JtCaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Libro De Ejemplo. A created and created_by field can be set by the user,
