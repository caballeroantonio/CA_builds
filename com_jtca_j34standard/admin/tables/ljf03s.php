 ...
 *
 */
class JtCaTableLjf03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljf03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljf03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljf03s','JtCaTable');
