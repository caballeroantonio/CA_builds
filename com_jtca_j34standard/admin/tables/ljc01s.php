 ...
 *
 */
class JtCaTableLjc01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc01'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc01s','JtCaTable');
