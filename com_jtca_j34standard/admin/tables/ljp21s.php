 ...
 *
 */
class JtCaTableLjp21s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp21s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp21'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp21s','JtCaTable');
