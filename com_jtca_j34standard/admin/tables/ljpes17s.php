 ...
 *
 */
class JtCaTableLjpes17s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes17s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes17'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes17s','JtCaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ARCHIVO. A created and created_by field can be set by the user,
