 ...
 *
 */
class JtCaTableLcp25s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp25s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp25'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp25s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA CONSIGNACIONES CON DETENIDO DELITOS NO GRAVES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA CONSIGNACIONES CON DETENIDO DELITOS NO GRAVES. A created and created_by field can be set by the user,
