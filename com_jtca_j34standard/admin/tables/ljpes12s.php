 ...
 *
 */
class JtCaTableLjpes12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes12s','JtCaTable');
