 ...
 *
 */
class JtCaTableLcp23s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp23s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp23'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp23s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE ORDENES DE APREHENSIÓN, REAPREHENSION Y TRASLADO.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ORDENES DE APREHENSIÓN, REAPREHENSION Y TRASLADO.. A created and created_by field can be set by the user,
