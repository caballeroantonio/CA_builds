 ...
 *
 */
class JtCaTableLspe05s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe05s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe05'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe05s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE DESISTIMIENTO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE DESISTIMIENTO. A created and created_by field can be set by the user,
