 ...
 *
 */
class JtcaTableLjp20s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp20s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp20'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp20s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA CONCLUSIONES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA CONCLUSIONES. A created and created_by field can be set by the user,
