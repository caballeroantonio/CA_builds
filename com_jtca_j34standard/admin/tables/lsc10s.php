 ...
 *
 */
class JtCaTableLsc10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc10s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE ACTUARIO (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ACTUARIO (OFICIAL). A created and created_by field can be set by the user,
