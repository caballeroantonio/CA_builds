 ...
 *
 */
class JtCaTableLjc05s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc05s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc05'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc05s','JtCaTable');
