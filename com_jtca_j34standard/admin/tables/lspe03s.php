 ...
 *
 */
class JtCaTableLspe03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe03s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE RESOLUCIONES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE RESOLUCIONES. A created and created_by field can be set by the user,
