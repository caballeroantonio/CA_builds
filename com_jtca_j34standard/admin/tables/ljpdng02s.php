 ...
 *
 */
class JtCaTableLjpdng02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpdng02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpdng02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpdng02s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CERTIFICADO DE DEPÓSITOS DE INGRESO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CERTIFICADO DE DEPÓSITOS DE INGRESO. A created and created_by field can be set by the user,
