 ...
 *
 */
class JtCaTableLjemst10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljemst10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljemst10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljemst10s','JtCaTable');
