 ...
 *
 */
class JtCaTableLcp02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp02s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO DE JUSTICIA PARA ADOLESCENTES SIN DETENIDO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE JUSTICIA PARA ADOLESCENTES SIN DETENIDO. A created and created_by field can be set by the user,
