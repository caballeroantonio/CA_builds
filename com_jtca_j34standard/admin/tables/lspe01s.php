 ...
 *
 */
class JtCaTableLspe01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe01'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe01s','JtCaTable');
