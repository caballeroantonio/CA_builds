 ...
 *
 */
class JtCaTableLcp15s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp15s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp15'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp15s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE OFICIOS DE AMPAROS DE TRAMITE.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE OFICIOS DE AMPAROS DE TRAMITE.. A created and created_by field can be set by the user,
