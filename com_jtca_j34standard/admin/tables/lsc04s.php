 ...
 *
 */
class JtCaTableLsc04s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc04s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc04'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc04s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE MULTAS (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE MULTAS (OFICIAL). A created and created_by field can be set by the user,
