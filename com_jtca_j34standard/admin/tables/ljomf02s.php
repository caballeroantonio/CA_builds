 ...
 *
 */
class JtCaTableLjomf02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljomf02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljomf02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljomf02s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE INGRESOS DE VALORES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE INGRESOS DE VALORES. A created and created_by field can be set by the user,
