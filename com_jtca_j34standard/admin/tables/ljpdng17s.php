 ...
 *
 */
class JtcaTableLjpdng17s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpdng17s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpdng17'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpdng17s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE FIRMAS PROCESADOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE FIRMAS PROCESADOS. A created and created_by field can be set by the user,
