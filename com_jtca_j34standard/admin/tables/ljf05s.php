 ...
 *
 */
class JtCaTableLjf05s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljf05s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljf05'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field8',$array)  ) 
		{
			$array['field8'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljf05s','JtCaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE SENTENCIAS. A created and created_by field can be set by the user,
