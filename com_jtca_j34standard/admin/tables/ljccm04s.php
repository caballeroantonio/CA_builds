 ...
 *
 */
class JtCaTableLjccm04s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljccm04s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljccm04'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljccm04s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE REGISTRO DE PROMOCIONES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REGISTRO DE PROMOCIONES. A created and created_by field can be set by the user,
