 ...
 *
 */
class JtCaTableLjp19s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp19s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp19'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp19s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE FIRMAS DE PROCESADOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE FIRMAS DE PROCESADOS. A created and created_by field can be set by the user,
