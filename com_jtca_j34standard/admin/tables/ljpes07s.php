 ...
 *
 */
class JtCaTableLjpes07s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes07s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes07'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes07s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE AMPAROS CIRCULANTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE AMPAROS CIRCULANTES. A created and created_by field can be set by the user,
