 ...
 *
 */
class JtCaTableLspe06s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe06s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe06'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe06s','JtCaTable');
