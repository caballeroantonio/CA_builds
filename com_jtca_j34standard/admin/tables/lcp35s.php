 ...
 *
 */
class JtCaTableLcp35s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp35s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp35'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp35s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE LIBERTADES DE SALAS DE ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE LIBERTADES DE SALAS DE ADOLESCENTES. A created and created_by field can be set by the user,
