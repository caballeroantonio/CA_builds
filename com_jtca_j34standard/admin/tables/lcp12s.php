 ...
 *
 */
class JtcaTableLcp12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp12s','JtcaTable');
	...
	/**
	 * Stores a LIBRETA DE TURNO DE SALAS PARA JUZGADOS ORALES.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE TURNO DE SALAS PARA JUZGADOS ORALES.. A created and created_by field can be set by the user,
