 ...
 *
 */
class JtcaTableLjpes14s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes14s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes14'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes14s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE RESOLUCIONES DE PLANO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE RESOLUCIONES DE PLANO. A created and created_by field can be set by the user,
