 ...
 *
 */
class JtCaTableLjoc03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljoc03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljoc03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljoc03s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CERTIFICADO DE DEPÓSITOS DE INGRESOS Y EGRESOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CERTIFICADO DE DEPÓSITOS DE INGRESOS Y EGRESOS. A created and created_by field can be set by the user,
