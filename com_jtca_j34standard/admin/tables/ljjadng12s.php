 ...
 *
 */
class JtCaTableLjjadng12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljjadng12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljjadng12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljjadng12s','JtCaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBROS DE VALORES. A created and created_by field can be set by the user,
