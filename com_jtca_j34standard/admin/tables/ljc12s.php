 ...
 *
 */
class JtCaTableLjc12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc12s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE REGISTRO DE AMPAROS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REGISTRO DE AMPAROS. A created and created_by field can be set by the user,
