 ...
 *
 */
class JtCaTableLcp33s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp33s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp33'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp33s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE LIBERTADES DE SALAS PENALES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE LIBERTADES DE SALAS PENALES. A created and created_by field can be set by the user,
