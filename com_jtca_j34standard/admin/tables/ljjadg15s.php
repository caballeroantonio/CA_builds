 ...
 *
 */
class JtcaTableLjjadg15s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljjadg15s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljjadg15'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljjadg15s','JtcaTable');
	...
	/**
	 * Stores a ARTICULO 36 O ARTICULO 28 LJADF
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New ARTICULO 36 O ARTICULO 28 LJADF. A created and created_by field can be set by the user,
