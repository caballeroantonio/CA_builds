 ...
 *
 */
class JtCaTableLjccm05s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljccm05s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljccm05'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field9',$array)  ) 
		{
			$array['field9'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljccm05s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA SENTENCIA
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA SENTENCIA. A created and created_by field can be set by the user,
