 ...
 *
 */
class JtcaTableLcp34s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp34s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp34'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp34s','JtcaTable');
	...
	/**
	 * Stores a LIBRETA DE LIBERTADES JUZGADOS DE ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE LIBERTADES JUZGADOS DE ADOLESCENTES. A created and created_by field can be set by the user,
