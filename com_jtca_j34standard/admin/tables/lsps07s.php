 ...
 *
 */
class JtcaTableLsps07s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps07s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps07'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps07s','JtcaTable');
	...
	/**
	 * Stores a REGISTRO DE BILLETES DE DEPOSITO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New REGISTRO DE BILLETES DE DEPOSITO. A created and created_by field can be set by the user,
