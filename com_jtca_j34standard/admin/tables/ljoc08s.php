 ...
 *
 */
class JtCaTableLjoc08s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljoc08s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljoc08'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljoc08s','JtCaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ACTUARIOS. A created and created_by field can be set by the user,
