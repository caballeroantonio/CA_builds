 ...
 *
 */
class JtCaTableLjp09s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp09s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp09'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp09s','JtCaTable');
