 ...
 *
 */
class JtCaTableLcp32s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp32s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp32'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp32s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE LIBERTADES JUZGADOS DE EJECUCIÓN DE SENTENCIA
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE LIBERTADES JUZGADOS DE EJECUCIÓN DE SENTENCIA. A created and created_by field can be set by the user,
