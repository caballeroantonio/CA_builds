 ...
 *
 */
class JtcaTableLjp02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp02s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE REGISTRO DE BILLETES DE DEPÓSITO (INGRESOS)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REGISTRO DE BILLETES DE DEPÓSITO (INGRESOS). A created and created_by field can be set by the user,
