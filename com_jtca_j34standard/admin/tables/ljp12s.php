 ...
 *
 */
class JtcaTableLjp12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp12s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE REGISTRO DE AMPAROS CIRCULANTES O NEGADOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REGISTRO DE AMPAROS CIRCULANTES O NEGADOS. A created and created_by field can be set by the user,
