 ...
 *
 */
class JtCaTableLjjadng01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljjadng01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljjadng01'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field19',$array)  ) 
		{
			$array['field19'] = '0';
		}
			
		if ( !array_key_exists('field21',$array)  ) 
		{
			$array['field21'] = '0';
		}
			
		if ( !array_key_exists('field23',$array)  ) 
		{
			$array['field23'] = '0';
		}
			
		if ( !array_key_exists('field30',$array)  ) 
		{
			$array['field30'] = '0';
		}
			
		if ( !array_key_exists('field38',$array)  ) 
		{
			$array['field38'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljjadng01s','JtCaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE GOBIERNO. A created and created_by field can be set by the user,
