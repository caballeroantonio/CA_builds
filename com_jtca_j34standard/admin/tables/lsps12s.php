 ...
 *
 */
class JtcaTableLsps12s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps12s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps12'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps12s','JtcaTable');
	...
	/**
	 * Stores a REGISTRO DE PROMOCIONES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New REGISTRO DE PROMOCIONES. A created and created_by field can be set by the user,
