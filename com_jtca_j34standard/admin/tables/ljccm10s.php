 ...
 *
 */
class JtCaTableLjccm10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljccm10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljccm10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljccm10s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE REGISTRO PARA NOTARIOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REGISTRO PARA NOTARIOS. A created and created_by field can be set by the user,
