 ...
 *
 */
class JtCaTableLjpdng18s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpdng18s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpdng18'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpdng18s','JtCaTable');
