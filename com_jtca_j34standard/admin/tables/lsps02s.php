 ...
 *
 */
class JtcaTableLsps02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps02'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field2363',$array)  ) 
		{
			$array['field2363'] = '0';
		}
			
		if ( !array_key_exists('field2365',$array)  ) 
		{
			$array['field2365'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps02s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE GOBIERNO (NUEVO SISTEMA) (UNITARIO)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE GOBIERNO (NUEVO SISTEMA) (UNITARIO). A created and created_by field can be set by the user,
