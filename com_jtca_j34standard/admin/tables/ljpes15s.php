 ...
 *
 */
class JtcaTableLjpes15s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes15s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes15'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes15s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE BENEFICIOS REVOCADOS Y ORDENES DE RE-APREHENSIÓN
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE BENEFICIOS REVOCADOS Y ORDENES DE RE-APREHENSIÓN. A created and created_by field can be set by the user,
