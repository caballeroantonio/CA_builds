 ...
 *
 */
class JtcaTableLsps03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps03'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field2374',$array)  ) 
		{
			$array['field2374'] = '0';
		}
			
		if ( !array_key_exists('field2376',$array)  ) 
		{
			$array['field2376'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps03s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE GOBIERNO (NUEVO SISTEMA) (COLEGIADO)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE GOBIERNO (NUEVO SISTEMA) (COLEGIADO). A created and created_by field can be set by the user,
