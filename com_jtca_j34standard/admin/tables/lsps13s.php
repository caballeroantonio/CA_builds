 ...
 *
 */
class JtcaTableLsps13s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps13s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps13'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps13s','JtcaTable');
	...
	/**
	 * Stores a CONTROL DE FIRMAS DEL PROCESADO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New CONTROL DE FIRMAS DEL PROCESADO. A created and created_by field can be set by the user,
