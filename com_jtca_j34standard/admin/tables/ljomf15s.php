 ...
 *
 */
class JtCaTableLjomf15s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljomf15s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljomf15'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljomf15s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO A CARGO DE LOS SECRETARIOS DE ACUERDOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO A CARGO DE LOS SECRETARIOS DE ACUERDOS. A created and created_by field can be set by the user,
