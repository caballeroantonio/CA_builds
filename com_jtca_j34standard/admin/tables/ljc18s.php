 ...
 *
 */
class JtCaTableLjc18s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc18s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc18'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field10_isMoral',$array)  ) 
		{
			$array['field10_isMoral'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc18s','JtCaTable');
