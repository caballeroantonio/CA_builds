 ...
 *
 */
class JtcaTableLjoc14s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljoc14s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljoc14'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljoc14s','JtcaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE FIANZAS. A created and created_by field can be set by the user,
