 ...
 *
 */
class JtCaTableLsc08s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc08s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc08'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc08s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE PÓLIZAS Y FIANZAS (OFICIAL) - Ingresos
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE PÓLIZAS Y FIANZAS (OFICIAL) - Ingresos. A created and created_by field can be set by the user,
