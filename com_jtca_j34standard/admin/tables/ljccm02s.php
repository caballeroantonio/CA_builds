 ...
 *
 */
class JtcaTableLjccm02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljccm02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljccm02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljccm02s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE INGRESO DE VALORES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE INGRESO DE VALORES. A created and created_by field can be set by the user,
