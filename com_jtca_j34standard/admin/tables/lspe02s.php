 ...
 *
 */
class JtCaTableLspe02s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lspe02s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lspe02'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lspe02s','JtCaTable');
