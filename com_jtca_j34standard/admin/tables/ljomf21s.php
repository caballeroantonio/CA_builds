 ...
 *
 */
class JtCaTableLjomf21s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljomf21s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljomf21'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljomf21s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE ADOPCIONES INTERNACIONALES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE ADOPCIONES INTERNACIONALES. A created and created_by field can be set by the user,
