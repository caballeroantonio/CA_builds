 ...
 *
 */
class JtCaTableLjomf22s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljomf22s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljomf22'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljomf22s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE RESTITUCIONES INTERNACIONALES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE RESTITUCIONES INTERNACIONALES. A created and created_by field can be set by the user,
