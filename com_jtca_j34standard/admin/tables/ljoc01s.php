 ...
 *
 */
class JtCaTableLjoc01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljoc01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljoc01'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljoc01s','JtCaTable');
