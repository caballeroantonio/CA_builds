 ...
 *
 */
class JtcaTableLcp09s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp09s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp09'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp09s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE ETAPA DE EJECUCIÓN PARA ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE ETAPA DE EJECUCIÓN PARA ADOLESCENTES. A created and created_by field can be set by the user,
