 ...
 *
 */
class JtCaTableLcp07s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp07s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp07'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp07s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA EXCUSAS DE ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA EXCUSAS DE ADOLESCENTES. A created and created_by field can be set by the user,
