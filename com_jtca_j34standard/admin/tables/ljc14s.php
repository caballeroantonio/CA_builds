 ...
 *
 */
class JtCaTableLjc14s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljc14s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljc14'));
	}
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('field5_isMoral',$array)  ) 
		{
			$array['field5_isMoral'] = '0';
		}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljc14s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE MULTAS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE MULTAS. A created and created_by field can be set by the user,
