 ...
 *
 */
class JtcaTableLjccm16s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljccm16s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljccm16'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljccm16s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE REMISIÓN DE EXPEDIENTES AL ARCHIVO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REMISIÓN DE EXPEDIENTES AL ARCHIVO. A created and created_by field can be set by the user,
