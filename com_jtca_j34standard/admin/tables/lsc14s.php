 ...
 *
 */
class JtCaTableLsc14s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc14s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc14'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc14s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE PÓLIZAS Y FIANZAS (OFICIAL) - Egresos
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE PÓLIZAS Y FIANZAS (OFICIAL) - Egresos. A created and created_by field can be set by the user,
