 ...
 *
 */
class JtcaTableLcp20s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp20s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp20'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp20s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA INCOMPETENCIAS PRIMERA INSTANCIA.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA INCOMPETENCIAS PRIMERA INSTANCIA.. A created and created_by field can be set by the user,
