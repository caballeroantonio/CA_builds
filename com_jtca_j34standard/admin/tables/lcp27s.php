 ...
 *
 */
class JtcaTableLcp27s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp27s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp27'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp27s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA INCOMPETENCIAS DELITOS NO GRAVES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA INCOMPETENCIAS DELITOS NO GRAVES. A created and created_by field can be set by the user,
