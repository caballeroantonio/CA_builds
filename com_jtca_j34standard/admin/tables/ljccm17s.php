 ...
 *
 */
class JtCaTableLjccm17s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljccm17s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljccm17'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljccm17s','JtCaTable');
