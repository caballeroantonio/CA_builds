 ...
 *
 */
class JtCaTableLcp03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp03s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO DE REMISIONES CON DETENIDO DE JUZGADOS ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE REMISIONES CON DETENIDO DE JUZGADOS ADOLESCENTES. A created and created_by field can be set by the user,
