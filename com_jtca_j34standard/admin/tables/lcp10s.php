 ...
 *
 */
class JtcaTableLcp10s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp10s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp10'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp10s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO DE BENEFICIOS PENITENCIARIOS.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE BENEFICIOS PENITENCIARIOS.. A created and created_by field can be set by the user,
