 ...
 *
 */
class JtcaTableSldepJoc03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_sldep_joc03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.sldepjoc03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('SldepJoc03s','JtcaTable');
	...
	/**
	 * Stores a Sub Libro CERTIFICADO DE EGRESOS Del LIBRO DE CERTIFICADO DE DEPÓSITOS DE INGRESOS Y EGRESOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Sub Libro CERTIFICADO DE EGRESOS Del LIBRO DE CERTIFICADO DE DEPÓSITOS DE INGRESOS Y EGRESOS. A created and created_by field can be set by the user,
