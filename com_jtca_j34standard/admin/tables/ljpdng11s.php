 ...
 *
 */
class JtCaTableLjpdng11s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpdng11s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpdng11'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpdng11s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE AMPAROS CIRCULANTES O NEGADOS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE AMPAROS CIRCULANTES O NEGADOS. A created and created_by field can be set by the user,
