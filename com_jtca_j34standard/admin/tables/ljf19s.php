 ...
 *
 */
class JtCaTableLjf19s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljf19s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljf19'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljf19s','JtCaTable');
