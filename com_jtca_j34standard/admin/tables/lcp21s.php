 ...
 *
 */
class JtcaTableLcp21s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp21s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp21'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp21s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO DE EXCUSAS PARA JUZGADOS DE PRIMERA INSTANCIA.
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE EXCUSAS PARA JUZGADOS DE PRIMERA INSTANCIA.. A created and created_by field can be set by the user,
