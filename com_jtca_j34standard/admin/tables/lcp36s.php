 ...
 *
 */
class JtcaTableLcp36s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp36s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp36'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp36s','JtcaTable');
	...
	/**
	 * Stores a LIBRETA DE RETURNO DE ADOLESCENTES
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE RETURNO DE ADOLESCENTES. A created and created_by field can be set by the user,
