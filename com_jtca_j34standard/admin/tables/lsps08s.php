 ...
 *
 */
class JtcaTableLsps08s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps08s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps08'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps08s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO DE ENTREGAS DE TOCAS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE ENTREGAS DE TOCAS. A created and created_by field can be set by the user,
