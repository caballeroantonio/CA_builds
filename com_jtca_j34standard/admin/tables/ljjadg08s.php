 ...
 *
 */
class JtCaTableLjjadg08s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljjadg08s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljjadg08'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljjadg08s','JtCaTable');
