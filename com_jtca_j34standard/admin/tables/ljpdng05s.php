 ...
 *
 */
class JtCaTableLjpdng05s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpdng05s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpdng05'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpdng05s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO PARA SENTENCIAS
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO PARA SENTENCIAS. A created and created_by field can be set by the user,
