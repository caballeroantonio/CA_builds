 ...
 *
 */
class JtCaTableLcp01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lcp01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lcp01'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lcp01s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE TURNO DE JUSTICIA PARA ADOLESCENTES CON DETENIDO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE TURNO DE JUSTICIA PARA ADOLESCENTES CON DETENIDO. A created and created_by field can be set by the user,
