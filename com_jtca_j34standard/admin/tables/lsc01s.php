 ...
 *
 */
class JtCaTableLsc01s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsc01s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsc01'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsc01s','JtCaTable');
	...
	/**
	 * Stores a LIBRETA DE REGISTRO DE SENTENCIAS -TURNO- (OFICIAL)
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRETA DE REGISTRO DE SENTENCIAS -TURNO- (OFICIAL). A created and created_by field can be set by the user,
