 ...
 *
 */
class JtcaTableLjjadng11s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljjadng11s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljjadng11'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljjadng11s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE REMISIÓN AL ARCHIVO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE REMISIÓN AL ARCHIVO. A created and created_by field can be set by the user,
