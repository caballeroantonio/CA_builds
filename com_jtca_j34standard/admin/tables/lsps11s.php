 ...
 *
 */
class JtcaTableLsps11s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_lsps11s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.lsps11'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Lsps11s','JtcaTable');
	...
	/**
	 * Stores a LIBRO DE CONTROL DE FIANZA
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE CONTROL DE FIANZA. A created and created_by field can be set by the user,
