 ...
 *
 */
class JtCaTableLjomf06s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljomf06s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljomf06'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljomf06s','JtCaTable');
