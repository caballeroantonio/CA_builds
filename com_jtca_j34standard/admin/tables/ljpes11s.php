 ...
 *
 */
class JtCaTableLjpes11s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljpes11s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljpes11'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljpes11s','JtCaTable');
	...
	/**
	 * Stores a LIBRO DE INGRESOS Y EGRESOS DE BILLETES DE DEPÓSITO
	 *
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New LIBRO DE INGRESOS Y EGRESOS DE BILLETES DE DEPÓSITO. A created and created_by field can be set by the user,
