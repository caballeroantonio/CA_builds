 ...
 *
 */
class JtcaTableSlpersons extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_slpersons', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.slperson'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Slpersons','JtcaTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Sub Libro Personas. A created and created_by field can be set by the user,
