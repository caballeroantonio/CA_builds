 ...
 *
 */
class JtCaTableLjp03s extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('jt_ljp03s', 'id', $db);
		...
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jtca.ljp03'));
	}
	...
	public function publish($pks = null, $state = 1, $user_id = 0)
	{
		...
		$table = JTable::getInstance('Ljp03s','JtCaTable');
