...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_jtca&task=slincul_jpdng01s.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'slinculjpdng01-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slincul_jpdng01s'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="slinculjpdng01-list">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'slincul_jpdng01s.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'slincul_jpdng01s');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'slincul_jpdng01s');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'slincul_jpdng01s');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'slincul_jpdng01s');
								endif;
