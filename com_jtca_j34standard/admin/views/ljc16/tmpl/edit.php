...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc16&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljc16-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljc16-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc16-tabs', 'details', JText::_('COM_JTCA_LJC16S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljc16-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc16-tabs', 'fieldset-ljc16_fs', JText::_('COM_JTCA_LJC16S_FIELDSET_LJC16_FS_LABEL', true)); ?>
