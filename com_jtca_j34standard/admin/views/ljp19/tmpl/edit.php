...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp19&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljp19-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljp19-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp19-tabs', 'details', JText::_('COM_JTCA_LJP19S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljp19-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp19-tabs', 'fieldset-ljp19_fs', JText::_('COM_JTCA_LJP19S_FIELDSET_LJP19_FS_LABEL', true)); ?>
