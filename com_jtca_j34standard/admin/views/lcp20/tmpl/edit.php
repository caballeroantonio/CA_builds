...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp20&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp20-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp20-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp20-tabs', 'details', JText::_('COM_JTCA_LCP20S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp20-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp20-tabs', 'fieldset-lcp20_fs', JText::_('COM_JTCA_LCP20S_FIELDSET_LCP20_FS_LABEL', true)); ?>
