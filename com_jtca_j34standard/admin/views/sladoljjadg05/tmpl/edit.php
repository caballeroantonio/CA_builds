...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sladoljjadg05&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="sladoljjadg05-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'sladoljjadg05-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sladoljjadg05-tabs', 'details', JText::_('COM_JTCA_SLADOL_JJADG05S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'sladoljjadg05-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sladoljjadg05-tabs', 'fieldset-adol_jjadg05_fs', JText::_('COM_JTCA_SLADOL_JJADG05S_FIELDSET_ADOL_JJADG05_FS_LABEL', true)); ?>
