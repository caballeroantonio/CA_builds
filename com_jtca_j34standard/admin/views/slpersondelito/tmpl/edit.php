...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersondelito&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slpersondelito-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slpersondelito-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersondelito-tabs', 'details', JText::_('COM_JTCA_SLPERSONDELITOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slpersondelito-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersondelito-tabs', 'fieldset-persondelito_fs', JText::_('COM_JTCA_SLPERSONDELITOS_FIELDSET_PERSONDELITO_FS_LABEL', true)); ?>
