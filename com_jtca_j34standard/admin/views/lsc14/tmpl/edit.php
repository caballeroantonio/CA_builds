...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsc14&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsc14-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lsc14-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsc14-tabs', 'details', JText::_('COM_JTCA_LSC14S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lsc14-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsc14-tabs', 'fieldset-lsc08e_fs', JText::_('COM_JTCA_LSC14S_FIELDSET_LSC08E_FS_LABEL', true)); ?>
