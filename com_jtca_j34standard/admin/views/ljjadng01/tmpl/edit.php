...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadng01&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljjadng01-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljjadng01-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng01-tabs', 'details', JText::_('COM_JTCA_LJJADNG01S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng01-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng01-tabs', 'fieldset-ljjadng01_fs', JText::_('COM_JTCA_LJJADNG01S_FIELDSET_LJJADNG01_FS_LABEL', true)); ?>
