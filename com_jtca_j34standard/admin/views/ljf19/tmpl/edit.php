...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf19&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljf19-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljf19-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf19-tabs', 'details', JText::_('COM_JTCA_LJF19S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljf19-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf19-tabs', 'fieldset-ljf19_fs', JText::_('COM_JTCA_LJF19S_FIELDSET_LJF19_FS_LABEL', true)); ?>
