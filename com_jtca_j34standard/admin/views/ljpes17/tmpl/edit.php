...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpes17&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljpes17-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljpes17-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes17-tabs', 'details', JText::_('COM_JTCA_LJPES17S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes17-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes17-tabs', 'fieldset-ljpes17_fs', JText::_('COM_JTCA_LJPES17S_FIELDSET_LJPES17_FS_LABEL', true)); ?>
