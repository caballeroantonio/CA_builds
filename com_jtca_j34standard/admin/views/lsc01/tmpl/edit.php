...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsc01&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsc01-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lsc01-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsc01-tabs', 'details', JText::_('COM_JTCA_LSC01S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lsc01-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsc01-tabs', 'fieldset-lsc01_fs', JText::_('COM_JTCA_LSC01S_FIELDSET_LSC01_FS_LABEL', true)); ?>
