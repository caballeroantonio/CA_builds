...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slaveriguacion&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slaveriguacion-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slaveriguacion-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slaveriguacion-tabs', 'details', JText::_('COM_JTCA_SLAVERIGUACIONES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slaveriguacion-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
