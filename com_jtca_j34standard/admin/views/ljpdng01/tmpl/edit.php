...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng01&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljpdng01-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljpdng01-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng01-tabs', 'details', JText::_('COM_JTCA_LJPDNG01S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng01-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng01-tabs', 'fieldset-ljpdng01_fs', JText::_('COM_JTCA_LJPDNG01S_FIELDSET_LJPDNG01_FS_LABEL', true)); ?>
