...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst09&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljemst09-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljemst09-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst09-tabs', 'details', JText::_('COM_JTCA_LJEMST09S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst09-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst09-tabs', 'fieldset-ljemst09_fs', JText::_('COM_JTCA_LJEMST09S_FIELDSET_LJEMST09_FS_LABEL', true)); ?>
