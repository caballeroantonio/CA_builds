...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng16&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljpdng16-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljpdng16-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng16-tabs', 'details', JText::_('COM_JTCA_LJPDNG16S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng16-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng16-tabs', 'fieldset-ljpdng16_fs', JText::_('COM_JTCA_LJPDNG16S_FIELDSET_LJPDNG16_FS_LABEL', true)); ?>
