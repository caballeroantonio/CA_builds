...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp32&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp32-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp32-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp32-tabs', 'details', JText::_('COM_JTCA_LCP32S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp32-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp32-tabs', 'fieldset-lcp32_fs', JText::_('COM_JTCA_LCP32S_FIELDSET_LCP32_FS_LABEL', true)); ?>
