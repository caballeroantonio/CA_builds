...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljoc07&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljoc07-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljoc07-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljoc07-tabs', 'details', JText::_('COM_JTCA_LJOC07S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljoc07-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljoc07-tabs', 'fieldset-ljoc07_fs', JText::_('COM_JTCA_LJOC07S_FIELDSET_LJOC07_FS_LABEL', true)); ?>
