...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst02&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljemst02-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljemst02-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst02-tabs', 'details', JText::_('COM_JTCA_LJEMST02S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst02-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst02-tabs', 'fieldset-ljemst02_fs', JText::_('COM_JTCA_LJEMST02S_FIELDSET_LJEMST02_FS_LABEL', true)); ?>
