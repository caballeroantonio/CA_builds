...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=expedientes'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="expediente-list">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('searchtools.sort',  'COM_JTCA_HEADING_NAME', 'a.name', $list_dirn, $list_order); ?>
					</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'expedientes.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'expedientes');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'expedientes');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'expedientes');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'expedientes');
								endif;
					...
					<td class="nowrap has-context">
						<div class="pull-left break-word">
							<?php if ($can_edit OR $can_edit_own) : ?>
								<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_jtca&task=expediente.edit&id='.(int) $item->id); ?>">
