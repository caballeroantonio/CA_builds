...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp18&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp18-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp18-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp18-tabs', 'details', JText::_('COM_JTCA_LCP18S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp18-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp18-tabs', 'fieldset-lcp18_fs', JText::_('COM_JTCA_LCP18S_FIELDSET_LCP18_FS_LABEL', true)); ?>
