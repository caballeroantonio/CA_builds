...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slfirmjpdng17&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slfirmjpdng17-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slfirmjpdng17-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slfirmjpdng17-tabs', 'details', JText::_('COM_JTCA_SLFIRM_JPDNG17S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slfirmjpdng17-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slfirmjpdng17-tabs', 'fieldset-firm_jpdng17_fs', JText::_('COM_JTCA_SLFIRM_JPDNG17S_FIELDSET_FIRM_JPDNG17_FS_LABEL', true)); ?>
