...
$function	= $app->input->get('function', 'jSelectSlpartecontenciosa');
...
?>
<h3><?php echo JText::_('COM_JTCA_SLPARTESCONTENCIOSAS_SELECT_ITEM_LABEL'); ?></h3>
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpartescontenciosas&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
	<fieldset class="filter clearfix">
		...
		<div class="filters pull-left">
			<select name="filter_id_record" class="input-medium js-stools-field-order" onchange="this.form.submit()">
			...
			<select name="filter_id_field" class="input-medium js-stools-field-order" onchange="this.form.submit()">
	...
	<table class="table table-striped table-condensed">
		<thead>
			<tr>
				<th width="10%" class="center nowrap">
					<?php echo JTEXT::_('COM_JTCA_SLPARTESCONTENCIOSAS_HEADING_ID_RECORD'); ?>						
				</th>	
				<th width="10%" class="center nowrap">
					<?php echo JTEXT::_('COM_JTCA_SLPARTESCONTENCIOSAS_HEADING_ID_FIELD'); ?>						
				</th>	
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<a class="pointer" href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>');">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'slpartescontenciosas.', false, 'cb'); ?>
					</a>		
				</td>
				<td class="center">
					<a class="pointer" href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>');">
