...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc10&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljc10-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljc10-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc10-tabs', 'details', JText::_('COM_JTCA_LJC10S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljc10-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
