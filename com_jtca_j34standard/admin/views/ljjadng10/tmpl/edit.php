...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadng10&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljjadng10-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljjadng10-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng10-tabs', 'details', JText::_('COM_JTCA_LJJADNG10S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng10-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng10-tabs', 'fieldset-ljjadng10_fs', JText::_('COM_JTCA_LJJADNG10S_FIELDSET_LJJADNG10_FS_LABEL', true)); ?>
