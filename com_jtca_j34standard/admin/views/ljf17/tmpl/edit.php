...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf17&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljf17-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljf17-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf17-tabs', 'details', JText::_('COM_JTCA_LJF17S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljf17-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf17-tabs', 'fieldset-ljf17_fs', JText::_('COM_JTCA_LJF17S_FIELDSET_LJF17_FS_LABEL', true)); ?>
