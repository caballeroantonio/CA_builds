...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldepjoc03&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="sldepjoc03-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'sldepjoc03-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sldepjoc03-tabs', 'details', JText::_('COM_JTCA_SLDEP_JOC03S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'sldepjoc03-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sldepjoc03-tabs', 'fieldset-dep_joc03_fs', JText::_('COM_JTCA_SLDEP_JOC03S_FIELDSET_DEP_JOC03_FS_LABEL', true)); ?>
