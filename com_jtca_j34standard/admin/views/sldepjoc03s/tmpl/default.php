...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_jtca&task=sldep_joc03s.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'sldepjoc03-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldep_joc03s'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="sldepjoc03-list">
			<thead>
				<tr>
					...
					<th width="10%" class="nowrap center hidden-phone">
						<?php echo JTEXT::_('COM_JTCA_SLDEP_JOC03S_HEADING_ID_RECORD'); ?>						
					</th>	
					<th width="10%" class="nowrap center hidden-phone">
						<?php echo JTEXT::_('COM_JTCA_SLDEP_JOC03S_HEADING_ID_FIELD'); ?>						
					</th>	
					<th width="10%" class="nowrap center hidden-phone">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'sldep_joc03s.', $can_change); ?>
							<?php
								if ($archived) :
									JHtml::_('actionsdropdown.unarchive', 'cb' . $i, 'sldep_joc03s');
								else :
									JHtml::_('actionsdropdown.archive', 'cb' . $i, 'sldep_joc03s');
								endif;
								if ($trashed) :
									JHtml::_('actionsdropdown.untrash', 'cb' . $i, 'sldep_joc03s');
								else :
									JHtml::_('actionsdropdown.trash', 'cb' . $i, 'sldep_joc03s');
								endif;
