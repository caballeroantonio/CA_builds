...
/**
 * View class for a list of ljc21s.
 *
 */
class JtCaViewLjc21s extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::editList('ljc21.edit','JTOOLBAR_EDIT');
			...
			{
				JToolbarHelper::custom('ljc21s.publish', 'publish.png', 'publish_f2.png','JTOOLBAR_PUBLISH', true);
				JToolbarHelper::custom('ljc21s.unpublish', 'unpublish.png', 'unpublish_f2.png', 'JTOOLBAR_UNPUBLISH', true);
			}
			...
			if ($this->state->get('filter.state') != -1 ) 
			{
				if ($this->state->get('filter.state') != 2) 
				{
					JToolbarHelper::archiveList('ljc21s.archive','JTOOLBAR_ARCHIVE');
				}
				else 
				{
					if ($this->state->get('filter.state') == 2) 
					{
						JToolbarHelper::unarchiveList('ljc21s.publish', 'JTOOLBAR_UNARCHIVE');
					}
				}
			}
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_jtca&view=ljc21s');
