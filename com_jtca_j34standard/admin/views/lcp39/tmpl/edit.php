...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp39&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp39-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp39-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp39-tabs', 'details', JText::_('COM_JTCA_LCP39S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp39-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp39-tabs', 'fieldset-lcp39_fs', JText::_('COM_JTCA_LCP39S_FIELDSET_LCP39_FS_LABEL', true)); ?>
