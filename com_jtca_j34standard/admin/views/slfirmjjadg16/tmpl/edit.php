...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slfirmjjadg16&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slfirmjjadg16-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slfirmjjadg16-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slfirmjjadg16-tabs', 'details', JText::_('COM_JTCA_SLFIRM_JJADG16S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slfirmjjadg16-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slfirmjjadg16-tabs', 'fieldset-firm_jjadg16_fs', JText::_('COM_JTCA_SLFIRM_JJADG16S_FIELDSET_FIRM_JJADG16_FS_LABEL', true)); ?>
