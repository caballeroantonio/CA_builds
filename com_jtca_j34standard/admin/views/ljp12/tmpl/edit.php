...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp12&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljp12-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljp12-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp12-tabs', 'details', JText::_('COM_JTCA_LJP12S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljp12-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp12-tabs', 'fieldset-ljp12_fs', JText::_('COM_JTCA_LJP12S_FIELDSET_LJP12_FS_LABEL', true)); ?>
