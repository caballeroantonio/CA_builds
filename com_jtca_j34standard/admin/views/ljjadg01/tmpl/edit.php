...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadg01&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljjadg01-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljjadg01-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadg01-tabs', 'details', JText::_('COM_JTCA_LJJADG01S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadg01-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadg01-tabs', 'fieldset-ljjadg01_fs', JText::_('COM_JTCA_LJJADG01S_FIELDSET_LJJADG01_FS_LABEL', true)); ?>
