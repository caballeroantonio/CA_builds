...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp06&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljp06-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljp06-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp06-tabs', 'details', JText::_('COM_JTCA_LJP06S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljp06-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp06-tabs', 'fieldset-ljp06_fs', JText::_('COM_JTCA_LJP06S_FIELDSET_LJP06_FS_LABEL', true)); ?>
