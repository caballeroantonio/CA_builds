...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpes04&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljpes04-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljpes04-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes04-tabs', 'details', JText::_('COM_JTCA_LJPES04S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes04-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes04-tabs', 'fieldset-ljpes04_fs', JText::_('COM_JTCA_LJPES04S_FIELDSET_LJPES04_FS_LABEL', true)); ?>
