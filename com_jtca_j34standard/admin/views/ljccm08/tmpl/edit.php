...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljccm08&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljccm08-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljccm08-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljccm08-tabs', 'details', JText::_('COM_JTCA_LJCCM08S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljccm08-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljccm08-tabs', 'fieldset-ljccm08_fs', JText::_('COM_JTCA_LJCCM08S_FIELDSET_LJCCM08_FS_LABEL', true)); ?>
