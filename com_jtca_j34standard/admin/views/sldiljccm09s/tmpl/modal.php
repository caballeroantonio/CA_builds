...
$function	= $app->input->get('function', 'jSelectSldilJccm09');
...
?>
<h3><?php echo JText::_('COM_JTCA_SLDIL_JCCM09S_SELECT_ITEM_LABEL'); ?></h3>
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldil_jccm09s&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped table-condensed">
		<thead>
			<tr>
				<th width="10%" class="center nowrap">
					<?php echo JTEXT::_('COM_JTCA_SLDIL_JCCM09S_HEADING_ID_RECORD'); ?>						
				</th>	
				<th width="10%" class="center nowrap">
					<?php echo JTEXT::_('COM_JTCA_SLDIL_JCCM09S_HEADING_ID_FIELD'); ?>						
				</th>	
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<a class="pointer" href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>');">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'sldil_jccm09s.', false, 'cb'); ?>
					</a>		
				</td>
				<td class="center">
					<a class="pointer" href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>');">
