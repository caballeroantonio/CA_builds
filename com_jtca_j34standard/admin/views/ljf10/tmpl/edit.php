...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf10&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljf10-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljf10-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf10-tabs', 'details', JText::_('COM_JTCA_LJF10S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljf10-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf10-tabs', 'fieldset-ljf10_fs', JText::_('COM_JTCA_LJF10S_FIELDSET_LJF10_FS_LABEL', true)); ?>
