...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp41&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp41-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp41-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp41-tabs', 'details', JText::_('COM_JTCA_LCP41S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp41-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp41-tabs', 'fieldset-lcp41_fs', JText::_('COM_JTCA_LCP41S_FIELDSET_LCP41_FS_LABEL', true)); ?>
