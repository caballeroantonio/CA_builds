...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=expediente&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="expediente-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'expediente-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'expediente-tabs', 'details', JText::_('COM_JTCA_EXPEDIENTES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'expediente-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'expediente-tabs', 'fieldset-expedientes_fs', JText::_('COM_JTCA_EXPEDIENTES_FIELDSET_EXPEDIENTES_FS_LABEL', true)); ?>
