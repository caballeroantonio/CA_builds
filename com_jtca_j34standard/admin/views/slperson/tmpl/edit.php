...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slperson&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slperson-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slperson-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slperson-tabs', 'details', JText::_('COM_JTCA_SLPERSONS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slperson-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slperson-tabs', 'fieldset-persons_fs', JText::_('COM_JTCA_SLPERSONS_FIELDSET_PERSONS_FS_LABEL', true)); ?>
