...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadng03&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljjadng03-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljjadng03-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng03-tabs', 'details', JText::_('COM_JTCA_LJJADNG03S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng03-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadng03-tabs', 'fieldset-ljjadng03_fs', JText::_('COM_JTCA_LJJADNG03S_FIELDSET_LJJADNG03_FS_LABEL', true)); ?>
