...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp34&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp34-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp34-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp34-tabs', 'details', JText::_('COM_JTCA_LCP34S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp34-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp34-tabs', 'fieldset-lcp34_fs', JText::_('COM_JTCA_LCP34S_FIELDSET_LCP34_FS_LABEL', true)); ?>
