...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp23&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp23-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp23-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp23-tabs', 'details', JText::_('COM_JTCA_LCP23S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp23-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp23-tabs', 'fieldset-lcp23_fs', JText::_('COM_JTCA_LCP23S_FIELDSET_LCP23_FS_LABEL', true)); ?>
