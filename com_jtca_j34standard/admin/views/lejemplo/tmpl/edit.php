...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lejemplo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lejemplo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lejemplo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lejemplo-tabs', 'details', JText::_('COM_JTCA_LEJEMPLOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lejemplo-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lejemplo-tabs', 'fieldset-lejemplo_fs', JText::_('COM_JTCA_LEJEMPLOS_FIELDSET_LEJEMPLO_FS_LABEL', true)); ?>
