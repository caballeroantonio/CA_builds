...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lspe08&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lspe08-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lspe08-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lspe08-tabs', 'details', JText::_('COM_JTCA_LSPE08S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lspe08-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lspe08-tabs', 'fieldset-lsp08_fs', JText::_('COM_JTCA_LSPE08S_FIELDSET_LSP08_FS_LABEL', true)); ?>
