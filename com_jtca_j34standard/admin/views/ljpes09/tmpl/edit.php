...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpes09&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljpes09-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljpes09-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes09-tabs', 'details', JText::_('COM_JTCA_LJPES09S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes09-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpes09-tabs', 'fieldset-ljpes09_fs', JText::_('COM_JTCA_LJPES09S_FIELDSET_LJPES09_FS_LABEL', true)); ?>
