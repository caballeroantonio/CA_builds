...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldiljccm09&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="sldiljccm09-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'sldiljccm09-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sldiljccm09-tabs', 'details', JText::_('COM_JTCA_SLDIL_JCCM09S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'sldiljccm09-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sldiljccm09-tabs', 'fieldset-dil_jccm09_fs', JText::_('COM_JTCA_SLDIL_JCCM09S_FIELDSET_DIL_JCCM09_FS_LABEL', true)); ?>
