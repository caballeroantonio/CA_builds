...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersonaliasedad&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slpersonaliasedad-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slpersonaliasedad-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonaliasedad-tabs', 'details', JText::_('COM_JTCA_SLPERSONALIASEDADES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonaliasedad-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonaliasedad-tabs', 'fieldset-personaliasedad_fs', JText::_('COM_JTCA_SLPERSONALIASEDADES_FIELDSET_PERSONALIASEDAD_FS_LABEL', true)); ?>
