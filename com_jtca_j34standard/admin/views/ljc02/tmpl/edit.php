...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc02&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljc02-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljc02-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc02-tabs', 'details', JText::_('COM_JTCA_LJC02S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljc02-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc02-tabs', 'fieldset-ljc02_fs', JText::_('COM_JTCA_LJC02S_FIELDSET_LJC02_FS_LABEL', true)); ?>
