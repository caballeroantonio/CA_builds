...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf20&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljf20-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljf20-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf20-tabs', 'details', JText::_('COM_JTCA_LJF20S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljf20-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf20-tabs', 'fieldset-ljf20_fs', JText::_('COM_JTCA_LJF20S_FIELDSET_LJF20_FS_LABEL', true)); ?>
