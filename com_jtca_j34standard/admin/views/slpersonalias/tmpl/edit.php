...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersonalias&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slpersonalias-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slpersonalias-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonalias-tabs', 'details', JText::_('COM_JTCA_SLPERSONALIASES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonalias-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonalias-tabs', 'fieldset-personalias_fs', JText::_('COM_JTCA_SLPERSONALIASES_FIELDSET_PERSONALIAS_FS_LABEL', true)); ?>
