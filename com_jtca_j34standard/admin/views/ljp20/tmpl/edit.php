...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp20&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljp20-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljp20-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp20-tabs', 'details', JText::_('COM_JTCA_LJP20S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljp20-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljp20-tabs', 'fieldset-ljp20_fs', JText::_('COM_JTCA_LJP20S_FIELDSET_LJP20_FS_LABEL', true)); ?>
