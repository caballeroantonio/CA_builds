...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp11&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp11-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp11-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp11-tabs', 'details', JText::_('COM_JTCA_LCP11S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp11-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp11-tabs', 'fieldset-lcp11_fs', JText::_('COM_JTCA_LCP11S_FIELDSET_LCP11_FS_LABEL', true)); ?>
