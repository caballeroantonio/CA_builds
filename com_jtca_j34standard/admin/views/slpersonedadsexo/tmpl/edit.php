...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersonedadsexo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slpersonedadsexo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slpersonedadsexo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonedadsexo-tabs', 'details', JText::_('COM_JTCA_SLPERSONEDADSEXOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonedadsexo-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpersonedadsexo-tabs', 'fieldset-personedadsexo_fs', JText::_('COM_JTCA_SLPERSONEDADSEXOS_FIELDSET_PERSONEDADSEXO_FS_LABEL', true)); ?>
