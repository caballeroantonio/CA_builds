...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst01&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljemst01-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljemst01-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst01-tabs', 'details', JText::_('COM_JTCA_LJEMST01S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst01-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst01-tabs', 'fieldset-ljemst01_fs', JText::_('COM_JTCA_LJEMST01S_FIELDSET_LJEMST01_FS_LABEL', true)); ?>
