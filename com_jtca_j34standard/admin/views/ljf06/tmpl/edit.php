...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf06&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljf06-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljf06-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf06-tabs', 'details', JText::_('COM_JTCA_LJF06S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljf06-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljf06-tabs', 'fieldset-ljf06_fs', JText::_('COM_JTCA_LJF06S_FIELDSET_LJF06_FS_LABEL', true)); ?>
