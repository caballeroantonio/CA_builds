...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljoc10&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljoc10-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljoc10-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljoc10-tabs', 'details', JText::_('COM_JTCA_LJOC10S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljoc10-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljoc10-tabs', 'fieldset-ljoc10_fs', JText::_('COM_JTCA_LJOC10S_FIELDSET_LJOC10_FS_LABEL', true)); ?>
