...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst04&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljemst04-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljemst04-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst04-tabs', 'details', JText::_('COM_JTCA_LJEMST04S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst04-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst04-tabs', 'fieldset-ljemst04_fs', JText::_('COM_JTCA_LJEMST04S_FIELDSET_LJEMST04_FS_LABEL', true)); ?>
