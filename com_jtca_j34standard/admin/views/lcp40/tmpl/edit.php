...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp40&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp40-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp40-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp40-tabs', 'details', JText::_('COM_JTCA_LCP40S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp40-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp40-tabs', 'fieldset-lcp40_fs', JText::_('COM_JTCA_LCP40S_FIELDSET_LCP40_FS_LABEL', true)); ?>
