...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc20&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljc20-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljc20-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc20-tabs', 'details', JText::_('COM_JTCA_LJC20S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljc20-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljc20-tabs', 'fieldset-ljc20_fs', JText::_('COM_JTCA_LJC20S_FIELDSET_LJC20_FS_LABEL', true)); ?>
