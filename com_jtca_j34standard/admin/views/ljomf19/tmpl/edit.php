...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf19&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljomf19-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljomf19-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf19-tabs', 'details', JText::_('COM_JTCA_LJOMF19S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf19-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf19-tabs', 'fieldset-ljomf19_fs', JText::_('COM_JTCA_LJOMF19S_FIELDSET_LJOMF19_FS_LABEL', true)); ?>
