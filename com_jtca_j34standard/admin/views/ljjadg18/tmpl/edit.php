...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadg18&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljjadg18-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljjadg18-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadg18-tabs', 'details', JText::_('COM_JTCA_LJJADG18S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadg18-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljjadg18-tabs', 'fieldset-ljjadg18_fs', JText::_('COM_JTCA_LJJADG18S_FIELDSET_LJJADG18_FS_LABEL', true)); ?>
