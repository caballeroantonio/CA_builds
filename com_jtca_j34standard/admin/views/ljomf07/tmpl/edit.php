...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf07&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljomf07-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljomf07-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf07-tabs', 'details', JText::_('COM_JTCA_LJOMF07S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf07-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf07-tabs', 'fieldset-ljomf07_fs', JText::_('COM_JTCA_LJOMF07S_FIELDSET_LJOMF07_FS_LABEL', true)); ?>
