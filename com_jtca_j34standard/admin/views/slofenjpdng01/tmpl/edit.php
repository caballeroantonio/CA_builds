...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slofenjpdng01&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slofenjpdng01-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slofenjpdng01-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slofenjpdng01-tabs', 'details', JText::_('COM_JTCA_SLOFEN_JPDNG01S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slofenjpdng01-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slofenjpdng01-tabs', 'fieldset-ofen_jpdng01_fs', JText::_('COM_JTCA_SLOFEN_JPDNG01S_FIELDSET_OFEN_JPDNG01_FS_LABEL', true)); ?>
