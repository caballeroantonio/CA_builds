...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng15&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljpdng15-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljpdng15-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng15-tabs', 'details', JText::_('COM_JTCA_LJPDNG15S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng15-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljpdng15-tabs', 'fieldset-ljpdng15_fs', JText::_('COM_JTCA_LJPDNG15S_FIELDSET_LJPDNG15_FS_LABEL', true)); ?>
