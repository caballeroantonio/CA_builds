...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst10&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljemst10-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljemst10-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst10-tabs', 'details', JText::_('COM_JTCA_LJEMST10S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst10-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljemst10-tabs', 'fieldset-ljemst10_fs', JText::_('COM_JTCA_LJEMST10S_FIELDSET_LJEMST10_FS_LABEL', true)); ?>
