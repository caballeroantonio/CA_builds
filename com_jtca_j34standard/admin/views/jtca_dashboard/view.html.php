...
class JtcaViewJtca_Dashboard extends JViewLegacy
{
	...
	protected function prepareButtons()
	{
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slpersons',
			'object'=>'slpersons',
			'text'=>'Persons',//JText::_('JTCA_COMPONENT_WIZARD'),
			'desc'=>JText::_('COM_JTCA_SLPERSON_DESCRIPTION')
			);
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sldil_jccm07s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sldil_jccm09s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sldep_joc03s',
			'object'=>'sldep_joc03s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slincul_jpdng01s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slofen_jpdng01s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sldecl_jpdng01s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sldili_jpdng09s',
			'object'=>'sldili_jpdng09s',
			'text'=>'DILIGENCIA Del LIBRO DE ACTUARIOS',//JText::_('JTCA_COMPONENT_WIZARD'),
			'desc'=>JText::_('COM_JTCA_SLDILIJPDNG09_DESCRIPTION')
			);
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slfirm_jpdng17s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sladol_jjadg05s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slfirm_jjadg16s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=sladol_jjadg01s',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slaveriguaciones',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=slpersonaliasedades',
		...
		$buttons[] = array('link'=>'index.php?option=com_jtca&view=expedientes',
			'object'=>'expedientes',
