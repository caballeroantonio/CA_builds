...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpartecontenciosa&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="slpartecontenciosa-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'slpartecontenciosa-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpartecontenciosa-tabs', 'details', JText::_('COM_JTCA_SLPARTESCONTENCIOSAS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'slpartecontenciosa-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'slpartecontenciosa-tabs', 'fieldset-partescontenciosas_fs', JText::_('COM_JTCA_SLPARTESCONTENCIOSAS_FIELDSET_PARTESCONTENCIOSAS_FS_LABEL', true)); ?>
