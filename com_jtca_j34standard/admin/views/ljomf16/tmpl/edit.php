...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf16&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljomf16-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'ljomf16-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf16-tabs', 'details', JText::_('COM_JTCA_LJOMF16S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf16-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'ljomf16-tabs', 'fieldset-ljomf16_fs', JText::_('COM_JTCA_LJOMF16S_FIELDSET_LJOMF16_FS_LABEL', true)); ?>
