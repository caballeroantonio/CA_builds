...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp25&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp25-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp25-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp25-tabs', 'details', JText::_('COM_JTCA_LCP25S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp25-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp25-tabs', 'fieldset-lcp25_fs', JText::_('COM_JTCA_LCP25S_FIELDSET_LCP25_FS_LABEL', true)); ?>
