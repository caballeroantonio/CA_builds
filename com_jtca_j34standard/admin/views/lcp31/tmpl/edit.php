...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp31&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lcp31-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lcp31-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp31-tabs', 'details', JText::_('COM_JTCA_LCP31S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lcp31-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lcp31-tabs', 'fieldset-lcp31_fs', JText::_('COM_JTCA_LCP31S_FIELDSET_LCP31_FS_LABEL', true)); ?>
