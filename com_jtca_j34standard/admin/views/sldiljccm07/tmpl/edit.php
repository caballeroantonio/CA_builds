...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldiljccm07&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="sldiljccm07-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'sldiljccm07-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sldiljccm07-tabs', 'details', JText::_('COM_JTCA_SLDIL_JCCM07S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'sldiljccm07-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'sldiljccm07-tabs', 'fieldset-dil_jccm07_fs', JText::_('COM_JTCA_SLDIL_JCCM07S_FIELDSET_DIL_JCCM07_FS_LABEL', true)); ?>
