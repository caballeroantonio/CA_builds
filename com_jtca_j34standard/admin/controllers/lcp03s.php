...
/**
 * Lcp03s list controller class.
 *
 * 
 */
class JtCaControllerLcp03s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lcp03', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lcp03s','JtCaModel', array('ignore_request' => FALSE));
