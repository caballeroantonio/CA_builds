...
/**
 * Lcp28s list controller class.
 *
 * 
 */
class JtcaControllerLcp28s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lcp28', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lcp28s','JtcaModel', array('ignore_request' => FALSE));
