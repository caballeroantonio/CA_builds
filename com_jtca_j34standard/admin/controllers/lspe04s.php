...
/**
 * Lspe04s list controller class.
 *
 * 
 */
class JtcaControllerLspe04s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lspe04', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lspe04s','JtcaModel', array('ignore_request' => FALSE));
