...
/**
 * Lcp22s list controller class.
 *
 * 
 */
class JtcaControllerLcp22s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lcp22', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lcp22s','JtcaModel', array('ignore_request' => FALSE));
