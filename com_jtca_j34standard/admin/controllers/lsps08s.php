...
/**
 * Lsps08s list controller class.
 *
 * 
 */
class JtcaControllerLsps08s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lsps08', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lsps08s','JtcaModel', array('ignore_request' => FALSE));
