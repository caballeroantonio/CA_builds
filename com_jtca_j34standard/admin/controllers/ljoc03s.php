...
/**
 * Ljoc03s list controller class.
 *
 * 
 */
class JtCaControllerLjoc03s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Ljoc03', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Ljoc03s','JtCaModel', array('ignore_request' => FALSE));
