...
/**
 * Lcp35s list controller class.
 *
 * 
 */
class JtCaControllerLcp35s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lcp35', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lcp35s','JtCaModel', array('ignore_request' => FALSE));
