...
/**
 * Lsps11s list controller class.
 *
 * 
 */
class JtcaControllerLsps11s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lsps11', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lsps11s','JtcaModel', array('ignore_request' => FALSE));
