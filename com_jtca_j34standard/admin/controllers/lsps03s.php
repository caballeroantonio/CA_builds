...
/**
 * Lsps03s list controller class.
 *
 * 
 */
class JtcaControllerLsps03s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lsps03', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lsps03s','JtcaModel', array('ignore_request' => FALSE));
