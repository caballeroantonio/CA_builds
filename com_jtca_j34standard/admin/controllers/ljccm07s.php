...
/**
 * Ljccm07s list controller class.
 *
 * 
 */
class JtCaControllerLjccm07s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Ljccm07', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Ljccm07s','JtCaModel', array('ignore_request' => FALSE));
