...
/**
 * Lsc04s list controller class.
 *
 * 
 */
class JtCaControllerLsc04s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lsc04', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lsc04s','JtCaModel', array('ignore_request' => FALSE));
