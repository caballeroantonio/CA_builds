...
/**
 * Ljp05s list controller class.
 *
 * 
 */
class JtcaControllerLjp05s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Ljp05', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Ljp05s','JtcaModel', array('ignore_request' => FALSE));
