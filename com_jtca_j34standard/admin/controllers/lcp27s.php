...
/**
 * Lcp27s list controller class.
 *
 * 
 */
class JtcaControllerLcp27s extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lcp27', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
			//from outside:
			//$model = JModelLegacy::getInstance('Lcp27s','JtcaModel', array('ignore_request' => FALSE));
