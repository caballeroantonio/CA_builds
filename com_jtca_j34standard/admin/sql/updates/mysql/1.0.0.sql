...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE RECURSOS DE APELACIN',
...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE AUXILIARES DE LA ADMINISTRACIN DE JUSTICIA',
...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE REMISIN AL ARCHIVO',
...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE REMISIN DE DOCUMENTOS AL ARCHIVO',
...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE ENVO DE EXPEDIENTES AL ARCHIVO JUDICIAL PARA SU DESTRUCCIN',
...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE CONTROL DE ASUNTOS CONFORME A LOS ARTCULOS 13 FRACCIN XIV Y 25 DE LA LEY DE TRANSPARENCIA Y ACCESO A LA INFORMACIN PBLICA',
...
--
UPDATE `#__content_types` SET 
`type_title`='LIBRO DE MINISTERIO PBLICO',
