...
class JHTMLLjjadng11Icon
{
	...
	/**
	 * Method to generate a link to versions an ljjadng11
	 *
	 * @param   object		$ljjadng11  The ljjadng11 information
	 * @param   Registry	$params   The item parameters
	 * @param   array		$attribs  Optional attributes for the link
	 ...
	 * @return  string  The HTML markup for the popup link
	 */
	public static function versions($ljjadng11, $params, $attribs = array(), $legacy = false)
	{
...
//            return "<a href=\"index.php?option=com_jtca&task=ljjadng11.showHistory&item_id={$ljjadng11->id}\"  target=\"_blank\" onclick=\"window.open(this.href, this.target, 'width=800,height=600'); return false;\">{$text}</a>";
			return "<a href=\"#\" onclick=\"show_collapsibleModal({$ljjadng11->id});return false;\">{$text}</a>";
	}
}
