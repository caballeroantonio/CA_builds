...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst07.php';

class JtCaModelLjemst07Form extends JtCaModelLjemst07
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst07';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst07';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst07', 'ljemst07', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst07.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst07.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst07.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst07BeforeSave', array('com_jtca.ljemst07', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst07AfterSave', array('com_jtca.ljemst07', $table, $is_new));

		$this->setState('ljemst07.id', $table->id);
