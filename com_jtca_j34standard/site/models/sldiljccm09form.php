...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/sldiljccm09.php';

class JtcaModelSldilJccm09Form extends JtcaModelSldilJccm09
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.sldiljccm09';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.sldiljccm09';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.sldiljccm09', 'sldiljccm09', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('sldiljccm09.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.sldiljccm09.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('sldiljccm09.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onSldilJccm09BeforeSave', array('com_jtca.sldiljccm09', &$table, $is_new));
		...
		$dispatcher->trigger('onSldilJccm09AfterSave', array('com_jtca.sldiljccm09', $table, $is_new));

		$this->setState('sldiljccm09.id', $table->id);
