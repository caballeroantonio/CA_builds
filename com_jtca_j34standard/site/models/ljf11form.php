...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf11.php';

class JtcaModelLjf11Form extends JtcaModelLjf11
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf11';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf11';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf11', 'ljf11', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf11.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf11.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf11.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf11BeforeSave', array('com_jtca.ljf11', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf11AfterSave', array('com_jtca.ljf11', $table, $is_new));

		$this->setState('ljf11.id', $table->id);
