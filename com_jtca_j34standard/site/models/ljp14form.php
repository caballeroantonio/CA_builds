...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp14.php';

class JtCaModelLjp14Form extends JtCaModelLjp14
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp14';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp14';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp14', 'ljp14', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp14.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp14.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp14.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp14BeforeSave', array('com_jtca.ljp14', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp14AfterSave', array('com_jtca.ljp14', $table, $is_new));

		$this->setState('ljp14.id', $table->id);
