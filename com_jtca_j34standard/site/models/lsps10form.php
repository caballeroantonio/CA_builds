...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lsps10.php';

class JtcaModelLsps10Form extends JtcaModelLsps10
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lsps10';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lsps10';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lsps10', 'lsps10', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lsps10.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lsps10.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lsps10.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLsps10BeforeSave', array('com_jtca.lsps10', &$table, $is_new));
		...
		$dispatcher->trigger('onLsps10AfterSave', array('com_jtca.lsps10', $table, $is_new));

		$this->setState('lsps10.id', $table->id);
