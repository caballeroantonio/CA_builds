...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lspe01.php';

class JtcaModelLspe01Form extends JtcaModelLspe01
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lspe01';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lspe01';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lspe01', 'lspe01', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lspe01.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lspe01.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lspe01.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLspe01BeforeSave', array('com_jtca.lspe01', &$table, $is_new));
		...
		$dispatcher->trigger('onLspe01AfterSave', array('com_jtca.lspe01', $table, $is_new));

		$this->setState('lspe01.id', $table->id);
