...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst04.php';

class JtCaModelLjemst04Form extends JtCaModelLjemst04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst04', 'ljemst04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst04BeforeSave', array('com_jtca.ljemst04', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst04AfterSave', array('com_jtca.ljemst04', $table, $is_new));

		$this->setState('ljemst04.id', $table->id);
