...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf17.php';

class JtCaModelLjf17Form extends JtCaModelLjf17
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf17';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf17';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf17', 'ljf17', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf17.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf17.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf17.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf17BeforeSave', array('com_jtca.ljf17', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf17AfterSave', array('com_jtca.ljf17', $table, $is_new));

		$this->setState('ljf17.id', $table->id);
