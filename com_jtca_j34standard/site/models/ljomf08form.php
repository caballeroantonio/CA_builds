...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf08.php';

class JtCaModelLjomf08Form extends JtCaModelLjomf08
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf08';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf08';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf08', 'ljomf08', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf08.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf08.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf08.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf08BeforeSave', array('com_jtca.ljomf08', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf08AfterSave', array('com_jtca.ljomf08', $table, $is_new));

		$this->setState('ljomf08.id', $table->id);
