...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf09.php';

class JtCaModelLjomf09Form extends JtCaModelLjomf09
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf09';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf09';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf09', 'ljomf09', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf09.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf09.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf09.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf09BeforeSave', array('com_jtca.ljomf09', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf09AfterSave', array('com_jtca.ljomf09', $table, $is_new));

		$this->setState('ljomf09.id', $table->id);
