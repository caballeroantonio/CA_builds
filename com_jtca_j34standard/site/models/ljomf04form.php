...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf04.php';

class JtCaModelLjomf04Form extends JtCaModelLjomf04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf04', 'ljomf04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf04BeforeSave', array('com_jtca.ljomf04', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf04AfterSave', array('com_jtca.ljomf04', $table, $is_new));

		$this->setState('ljomf04.id', $table->id);
