...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljc06.php';

class JtCaModelLjc06Form extends JtCaModelLjc06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljc06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljc06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljc06', 'ljc06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljc06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljc06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljc06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjc06BeforeSave', array('com_jtca.ljc06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjc06AfterSave', array('com_jtca.ljc06', $table, $is_new));

		$this->setState('ljc06.id', $table->id);
