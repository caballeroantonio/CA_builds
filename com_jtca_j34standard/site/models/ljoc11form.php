...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc11.php';

class JtcaModelLjoc11Form extends JtcaModelLjoc11
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc11';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc11';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc11', 'ljoc11', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc11.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc11.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc11.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc11BeforeSave', array('com_jtca.ljoc11', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc11AfterSave', array('com_jtca.ljoc11', $table, $is_new));

		$this->setState('ljoc11.id', $table->id);
