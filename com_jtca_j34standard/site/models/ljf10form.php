...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf10.php';

class JtcaModelLjf10Form extends JtcaModelLjf10
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf10';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf10';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf10', 'ljf10', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf10.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf10.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf10.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf10BeforeSave', array('com_jtca.ljf10', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf10AfterSave', array('com_jtca.ljf10', $table, $is_new));

		$this->setState('ljf10.id', $table->id);
