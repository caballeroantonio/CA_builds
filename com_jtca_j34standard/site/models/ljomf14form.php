...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf14.php';

class JtCaModelLjomf14Form extends JtCaModelLjomf14
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf14';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf14';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf14', 'ljomf14', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf14.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf14.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf14.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf14BeforeSave', array('com_jtca.ljomf14', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf14AfterSave', array('com_jtca.ljomf14', $table, $is_new));

		$this->setState('ljomf14.id', $table->id);
