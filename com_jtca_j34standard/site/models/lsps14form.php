...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lsps14.php';

class JtcaModelLsps14Form extends JtcaModelLsps14
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lsps14';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lsps14';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lsps14', 'lsps14', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lsps14.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lsps14.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lsps14.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLsps14BeforeSave', array('com_jtca.lsps14', &$table, $is_new));
		...
		$dispatcher->trigger('onLsps14AfterSave', array('com_jtca.lsps14', $table, $is_new));

		$this->setState('lsps14.id', $table->id);
