...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljjadg12.php';

class JtCaModelLjjadg12Form extends JtCaModelLjjadg12
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljjadg12';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljjadg12';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljjadg12', 'ljjadg12', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljjadg12.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljjadg12.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljjadg12.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjjadg12BeforeSave', array('com_jtca.ljjadg12', &$table, $is_new));
		...
		$dispatcher->trigger('onLjjadg12AfterSave', array('com_jtca.ljjadg12', $table, $is_new));

		$this->setState('ljjadg12.id', $table->id);
