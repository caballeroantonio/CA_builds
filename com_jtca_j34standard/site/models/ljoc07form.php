...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc07.php';

class JtcaModelLjoc07Form extends JtcaModelLjoc07
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc07';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc07';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc07', 'ljoc07', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc07.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc07.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc07.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc07BeforeSave', array('com_jtca.ljoc07', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc07AfterSave', array('com_jtca.ljoc07', $table, $is_new));

		$this->setState('ljoc07.id', $table->id);
