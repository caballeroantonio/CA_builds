...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp01.php';

class JtCaModelLjp01Form extends JtCaModelLjp01
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp01';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp01';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp01', 'ljp01', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp01.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp01.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp01.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp01BeforeSave', array('com_jtca.ljp01', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp01AfterSave', array('com_jtca.ljp01', $table, $is_new));

		$this->setState('ljp01.id', $table->id);
