...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf16.php';

class JtCaModelLjomf16Form extends JtCaModelLjomf16
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf16';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf16';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf16', 'ljomf16', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf16.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf16.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf16.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf16BeforeSave', array('com_jtca.ljomf16', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf16AfterSave', array('com_jtca.ljomf16', $table, $is_new));

		$this->setState('ljomf16.id', $table->id);
