...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lsps06.php';

class JtcaModelLsps06Form extends JtcaModelLsps06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lsps06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lsps06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lsps06', 'lsps06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lsps06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lsps06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lsps06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLsps06BeforeSave', array('com_jtca.lsps06', &$table, $is_new));
		...
		$dispatcher->trigger('onLsps06AfterSave', array('com_jtca.lsps06', $table, $is_new));

		$this->setState('lsps06.id', $table->id);
