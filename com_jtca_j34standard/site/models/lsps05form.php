...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lsps05.php';

class JtcaModelLsps05Form extends JtcaModelLsps05
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lsps05';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lsps05';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lsps05', 'lsps05', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lsps05.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lsps05.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lsps05.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLsps05BeforeSave', array('com_jtca.lsps05', &$table, $is_new));
		...
		$dispatcher->trigger('onLsps05AfterSave', array('com_jtca.lsps05', $table, $is_new));

		$this->setState('lsps05.id', $table->id);
