...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst06.php';

class JtCaModelLjemst06Form extends JtCaModelLjemst06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst06', 'ljemst06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst06BeforeSave', array('com_jtca.ljemst06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst06AfterSave', array('com_jtca.ljemst06', $table, $is_new));

		$this->setState('ljemst06.id', $table->id);
