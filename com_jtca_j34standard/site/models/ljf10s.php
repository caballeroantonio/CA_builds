...
class JtcaModelLjf10s extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single libro de auxiliares de la administración de justicia, tutores y curadores has been specified either as a parameter or in the url Request
