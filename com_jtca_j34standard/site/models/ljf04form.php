...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf04.php';

class JtCaModelLjf04Form extends JtCaModelLjf04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf04', 'ljf04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf04BeforeSave', array('com_jtca.ljf04', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf04AfterSave', array('com_jtca.ljf04', $table, $is_new));

		$this->setState('ljf04.id', $table->id);
