...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf03.php';

class JtCaModelLjomf03Form extends JtCaModelLjomf03
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf03';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf03';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf03', 'ljomf03', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf03.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf03.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf03.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf03BeforeSave', array('com_jtca.ljomf03', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf03AfterSave', array('com_jtca.ljomf03', $table, $is_new));

		$this->setState('ljomf03.id', $table->id);
