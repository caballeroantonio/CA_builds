...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst09.php';

class JtCaModelLjemst09Form extends JtCaModelLjemst09
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst09';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst09';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst09', 'ljemst09', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst09.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst09.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst09.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst09BeforeSave', array('com_jtca.ljemst09', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst09AfterSave', array('com_jtca.ljemst09', $table, $is_new));

		$this->setState('ljemst09.id', $table->id);
