...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljpdng04.php';

class JtCaModelLjpdng04Form extends JtCaModelLjpdng04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljpdng04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljpdng04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljpdng04', 'ljpdng04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljpdng04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljpdng04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljpdng04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjpdng04BeforeSave', array('com_jtca.ljpdng04', &$table, $is_new));
		...
		$dispatcher->trigger('onLjpdng04AfterSave', array('com_jtca.ljpdng04', $table, $is_new));

		$this->setState('ljpdng04.id', $table->id);
