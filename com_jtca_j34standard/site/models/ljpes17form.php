...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljpes17.php';

class JtCaModelLjpes17Form extends JtCaModelLjpes17
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljpes17';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljpes17';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljpes17', 'ljpes17', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljpes17.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljpes17.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljpes17.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjpes17BeforeSave', array('com_jtca.ljpes17', &$table, $is_new));
		...
		$dispatcher->trigger('onLjpes17AfterSave', array('com_jtca.ljpes17', $table, $is_new));

		$this->setState('ljpes17.id', $table->id);
