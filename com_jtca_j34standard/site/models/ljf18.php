 ...
 *
 */
class JtCaModelLjf18 extends JModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.ljf18';
	...
	{
		if (empty($config['ljf18_filter_fields']))
		{
			$config['ljf18_filter_fields'] = array(
				'id', 'a.id',
				...
				'field7','a.field7',
				'field9','a.field9',
				'field10_isMoral','a.field10_isMoral',
				'field10_paterno','a.field10_paterno',
				'field10_materno','a.field10_materno',
				'field10_nombre','a.field10_nombre',
				'field11','a.field11',
				'field12','a.field12',
				'field14_isMoral','a.field14_isMoral',
				'field14_paterno','a.field14_paterno',
				'field14_materno','a.field14_materno',
				'field14_nombre','a.field14_nombre',
				'field15_isMoral','a.field15_isMoral',
				'field15_paterno','a.field15_paterno',
				'field15_materno','a.field15_materno',
				'field15_nombre','a.field15_nombre',
				'field19','a.field19',
				'field19h','a.field19h',
				'field20_isMoral','a.field20_isMoral',
				'field20_paterno','a.field20_paterno',
				'field20_materno','a.field20_materno',
				'field20_nombre','a.field20_nombre',
				'field21','a.field21',
				'field21h','a.field21h',
				'field22','a.field22',
				'state', 'a.state',
	...
	*/
	public function getTable($type = 'Ljf18s', $prefix = 'JtCaTable', $config = array())
	{
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('ljf18.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($item))
				{
					return JError::raiseError(404, JText::_('COM_JTCA_LJF18S_ERROR_ITEM_NOT_FOUND'));
				}
	...
	public function publish(&$pks, $value = 1)
	{
		...
		$result = $dispatcher->trigger('onLjf18ChangeState', array('com_jtca.ljf18', $pks, $value));
		...
		foreach ($pks as $i => $pk)
		{
			...
			if ($table->load($pk))
			{
				if ($this->canDelete($table))
				{
					...
					$result = $dispatcher->trigger('onLjf18BeforeDelete', array('com_jtca.ljf18', &$table));
					if (in_array(false, $result, true))
					{
						$this->setError($table->getError());
						return false;
					...
					$dispatcher->trigger('onLjf18AfterDelete', array('com_jtca.ljf18', &$table));
				}
				else
				{
					// Prune items that you can't change.
