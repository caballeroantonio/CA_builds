...
/**
 * This models supports retrieving lists of libro de control de billetes y pólizas (oficial).
 *
 */
class JtcaModelLsc06s extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single libro de control de billetes y pólizas (oficial) has been specified either as a parameter or in the url Request
	...
	/**
	 * Method to get a list of libro de control de billetes y pólizas (oficial).
	 *
