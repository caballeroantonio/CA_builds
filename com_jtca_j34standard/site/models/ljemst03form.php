...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst03.php';

class JtCaModelLjemst03Form extends JtCaModelLjemst03
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst03';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst03';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst03', 'ljemst03', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst03.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst03.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst03.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst03BeforeSave', array('com_jtca.ljemst03', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst03AfterSave', array('com_jtca.ljemst03', $table, $is_new));

		$this->setState('ljemst03.id', $table->id);
