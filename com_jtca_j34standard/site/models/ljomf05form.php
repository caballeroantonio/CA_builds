...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf05.php';

class JtCaModelLjomf05Form extends JtCaModelLjomf05
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf05';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf05';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf05', 'ljomf05', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf05.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf05.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf05.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf05BeforeSave', array('com_jtca.ljomf05', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf05AfterSave', array('com_jtca.ljomf05', $table, $is_new));

		$this->setState('ljomf05.id', $table->id);
