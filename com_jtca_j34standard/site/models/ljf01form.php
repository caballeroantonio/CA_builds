...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf01.php';

class JtCaModelLjf01Form extends JtCaModelLjf01
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf01';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf01';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf01', 'ljf01', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf01.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf01.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf01.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf01BeforeSave', array('com_jtca.ljf01', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf01AfterSave', array('com_jtca.ljf01', $table, $is_new));

		$this->setState('ljf01.id', $table->id);
