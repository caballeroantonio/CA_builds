 ...
 *
 */
class JtCaModelLsps09 extends JModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.lsps09';
	...
	{
		if (empty($config['lsps09_filter_fields']))
		{
			$config['lsps09_filter_fields'] = array(
				'id', 'a.id',
				'id_expediente','a.id_expediente',
				'id_organo','a.id_organo',
				'id_secretaria','a.id_secretaria',
				'anoj','a.anoj',
				'field2418','a.field2418',
				'field2419','a.field2419',
				'field2420','a.field2420',
				'field2421','a.field2421',
				'field2422','a.field2422',
				'field2423','a.field2423',
				'field2424','a.field2424',
				'field2425','a.field2425',
				'state', 'a.state',
				'created', 'a.created',
	...
	*/
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('lsps09.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($item))
				{
					return JError::raiseError(404, JText::_('COM_JTCA_LSPS09S_ERROR_ITEM_NOT_FOUND'));
				}
	...
	public function publish(&$pks, $value = 1)
	{
		...
		$result = $dispatcher->trigger('onLsps09ChangeState', array('com_jtca.lsps09', $pks, $value));
		...
		foreach ($pks as $i => $pk)
		{
			...
			if ($table->load($pk))
			{
				if ($this->canDelete($table))
				{
					...
					$result = $dispatcher->trigger('onLsps09BeforeDelete', array('com_jtca.lsps09', &$table));
					if (in_array(false, $result, true))
					{
						$this->setError($table->getError());
						return false;
					...
					$dispatcher->trigger('onLsps09AfterDelete', array('com_jtca.lsps09', &$table));
				}
				else
				{
					// Prune items that you can't change.
