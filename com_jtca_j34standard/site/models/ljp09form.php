...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp09.php';

class JtcaModelLjp09Form extends JtcaModelLjp09
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp09';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp09';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp09', 'ljp09', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp09.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp09.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp09.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp09BeforeSave', array('com_jtca.ljp09', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp09AfterSave', array('com_jtca.ljp09', $table, $is_new));

		$this->setState('ljp09.id', $table->id);
