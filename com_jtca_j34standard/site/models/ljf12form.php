...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf12.php';

class JtcaModelLjf12Form extends JtcaModelLjf12
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf12';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf12';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf12', 'ljf12', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf12.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf12.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf12.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf12BeforeSave', array('com_jtca.ljf12', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf12AfterSave', array('com_jtca.ljf12', $table, $is_new));

		$this->setState('ljf12.id', $table->id);
