...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljpes03.php';

class JtCaModelLjpes03Form extends JtCaModelLjpes03
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljpes03';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljpes03';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljpes03', 'ljpes03', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljpes03.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljpes03.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljpes03.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjpes03BeforeSave', array('com_jtca.ljpes03', &$table, $is_new));
		...
		$dispatcher->trigger('onLjpes03AfterSave', array('com_jtca.ljpes03', $table, $is_new));

		$this->setState('ljpes03.id', $table->id);
