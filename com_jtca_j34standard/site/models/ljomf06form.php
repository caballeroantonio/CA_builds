...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf06.php';

class JtCaModelLjomf06Form extends JtCaModelLjomf06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf06', 'ljomf06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf06BeforeSave', array('com_jtca.ljomf06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf06AfterSave', array('com_jtca.ljomf06', $table, $is_new));

		$this->setState('ljomf06.id', $table->id);
