...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf17.php';

class JtCaModelLjomf17Form extends JtCaModelLjomf17
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf17';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf17';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf17', 'ljomf17', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf17.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf17.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf17.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf17BeforeSave', array('com_jtca.ljomf17', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf17AfterSave', array('com_jtca.ljomf17', $table, $is_new));

		$this->setState('ljomf17.id', $table->id);
