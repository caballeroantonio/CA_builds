...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf02.php';

class JtCaModelLjf02Form extends JtCaModelLjf02
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf02';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf02';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf02', 'ljf02', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf02.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf02.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf02.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf02BeforeSave', array('com_jtca.ljf02', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf02AfterSave', array('com_jtca.ljf02', $table, $is_new));

		$this->setState('ljf02.id', $table->id);
