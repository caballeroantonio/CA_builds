...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc10.php';

class JtCaModelLjoc10Form extends JtCaModelLjoc10
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc10';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc10';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc10', 'ljoc10', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc10.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc10.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc10.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc10BeforeSave', array('com_jtca.ljoc10', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc10AfterSave', array('com_jtca.ljoc10', $table, $is_new));

		$this->setState('ljoc10.id', $table->id);
