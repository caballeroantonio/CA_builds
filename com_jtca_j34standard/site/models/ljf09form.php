...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf09.php';

class JtcaModelLjf09Form extends JtcaModelLjf09
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf09';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf09';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf09', 'ljf09', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf09.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf09.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf09.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf09BeforeSave', array('com_jtca.ljf09', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf09AfterSave', array('com_jtca.ljf09', $table, $is_new));

		$this->setState('ljf09.id', $table->id);
