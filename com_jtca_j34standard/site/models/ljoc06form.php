...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc06.php';

class JtCaModelLjoc06Form extends JtCaModelLjoc06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc06', 'ljoc06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc06BeforeSave', array('com_jtca.ljoc06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc06AfterSave', array('com_jtca.ljoc06', $table, $is_new));

		$this->setState('ljoc06.id', $table->id);
