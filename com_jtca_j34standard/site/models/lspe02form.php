...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lspe02.php';

class JtCaModelLspe02Form extends JtCaModelLspe02
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lspe02';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lspe02';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lspe02', 'lspe02', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lspe02.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lspe02.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lspe02.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLspe02BeforeSave', array('com_jtca.lspe02', &$table, $is_new));
		...
		$dispatcher->trigger('onLspe02AfterSave', array('com_jtca.lspe02', $table, $is_new));

		$this->setState('lspe02.id', $table->id);
