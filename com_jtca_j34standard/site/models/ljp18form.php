...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp18.php';

class JtCaModelLjp18Form extends JtCaModelLjp18
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp18';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp18';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp18', 'ljp18', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp18.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp18.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp18.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp18BeforeSave', array('com_jtca.ljp18', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp18AfterSave', array('com_jtca.ljp18', $table, $is_new));

		$this->setState('ljp18.id', $table->id);
