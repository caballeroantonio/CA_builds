...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf13.php';

class JtCaModelLjomf13Form extends JtCaModelLjomf13
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf13';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf13';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf13', 'ljomf13', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf13.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf13.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf13.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf13BeforeSave', array('com_jtca.ljomf13', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf13AfterSave', array('com_jtca.ljomf13', $table, $is_new));

		$this->setState('ljomf13.id', $table->id);
