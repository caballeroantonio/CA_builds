...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp04.php';

class JtcaModelLjp04Form extends JtcaModelLjp04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp04', 'ljp04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp04BeforeSave', array('com_jtca.ljp04', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp04AfterSave', array('com_jtca.ljp04', $table, $is_new));

		$this->setState('ljp04.id', $table->id);
