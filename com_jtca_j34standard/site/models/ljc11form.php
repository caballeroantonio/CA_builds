...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljc11.php';

class JtCaModelLjc11Form extends JtCaModelLjc11
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljc11';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljc11';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljc11', 'ljc11', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljc11.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljc11.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljc11.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjc11BeforeSave', array('com_jtca.ljc11', &$table, $is_new));
		...
		$dispatcher->trigger('onLjc11AfterSave', array('com_jtca.ljc11', $table, $is_new));

		$this->setState('ljc11.id', $table->id);
