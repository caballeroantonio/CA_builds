...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf03.php';

class JtCaModelLjf03Form extends JtCaModelLjf03
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf03';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf03';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf03', 'ljf03', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf03.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf03.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf03.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf03BeforeSave', array('com_jtca.ljf03', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf03AfterSave', array('com_jtca.ljf03', $table, $is_new));

		$this->setState('ljf03.id', $table->id);
