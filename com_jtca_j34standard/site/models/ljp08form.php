...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp08.php';

class JtcaModelLjp08Form extends JtcaModelLjp08
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp08';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp08';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp08', 'ljp08', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp08.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp08.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp08.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp08BeforeSave', array('com_jtca.ljp08', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp08AfterSave', array('com_jtca.ljp08', $table, $is_new));

		$this->setState('ljp08.id', $table->id);
