...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf21.php';

class JtCaModelLjf21Form extends JtCaModelLjf21
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf21';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf21';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf21', 'ljf21', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf21.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf21.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf21.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf21BeforeSave', array('com_jtca.ljf21', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf21AfterSave', array('com_jtca.ljf21', $table, $is_new));

		$this->setState('ljf21.id', $table->id);
