...
class JtcaModelLsps09Form extends JtcaModelLsps09
{
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lsps09';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lsps09';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lsps09', 'lsps09', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lsps09.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lsps09.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lsps09.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLsps09BeforeSave', array('com_jtca.lsps09', &$table, $is_new));
		...
		$dispatcher->trigger('onLsps09AfterSave', array('com_jtca.lsps09', $table, $is_new));

		$this->setState('lsps09.id', $table->id);
