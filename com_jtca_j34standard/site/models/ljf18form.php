...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf18.php';

class JtcaModelLjf18Form extends JtcaModelLjf18
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf18';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf18';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf18', 'ljf18', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf18.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf18.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf18.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf18BeforeSave', array('com_jtca.ljf18', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf18AfterSave', array('com_jtca.ljf18', $table, $is_new));

		$this->setState('ljf18.id', $table->id);
