...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/lsps04.php';

class JtcaModelLsps04Form extends JtcaModelLsps04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.lsps04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.lsps04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.lsps04', 'lsps04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('lsps04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.lsps04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('lsps04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLsps04BeforeSave', array('com_jtca.lsps04', &$table, $is_new));
		...
		$dispatcher->trigger('onLsps04AfterSave', array('com_jtca.lsps04', $table, $is_new));

		$this->setState('lsps04.id', $table->id);
