...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp16.php';

class JtcaModelLjp16Form extends JtcaModelLjp16
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp16';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp16';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp16', 'ljp16', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp16.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp16.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp16.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp16BeforeSave', array('com_jtca.ljp16', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp16AfterSave', array('com_jtca.ljp16', $table, $is_new));

		$this->setState('ljp16.id', $table->id);
