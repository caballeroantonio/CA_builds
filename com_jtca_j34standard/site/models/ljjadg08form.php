...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljjadg08.php';

class JtCaModelLjjadg08Form extends JtCaModelLjjadg08
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljjadg08';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljjadg08';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljjadg08', 'ljjadg08', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljjadg08.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljjadg08.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljjadg08.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjjadg08BeforeSave', array('com_jtca.ljjadg08', &$table, $is_new));
		...
		$dispatcher->trigger('onLjjadg08AfterSave', array('com_jtca.ljjadg08', $table, $is_new));

		$this->setState('ljjadg08.id', $table->id);
