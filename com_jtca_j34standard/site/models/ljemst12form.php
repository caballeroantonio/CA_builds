...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst12.php';

class JtCaModelLjemst12Form extends JtCaModelLjemst12
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst12';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst12';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst12', 'ljemst12', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst12.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst12.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst12.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst12BeforeSave', array('com_jtca.ljemst12', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst12AfterSave', array('com_jtca.ljemst12', $table, $is_new));

		$this->setState('ljemst12.id', $table->id);
