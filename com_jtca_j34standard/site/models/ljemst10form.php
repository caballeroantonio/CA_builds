...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst10.php';

class JtCaModelLjemst10Form extends JtCaModelLjemst10
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst10';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst10';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst10', 'ljemst10', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst10.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst10.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst10.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst10BeforeSave', array('com_jtca.ljemst10', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst10AfterSave', array('com_jtca.ljemst10', $table, $is_new));

		$this->setState('ljemst10.id', $table->id);
