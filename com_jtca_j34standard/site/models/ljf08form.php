...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf08.php';

class JtCaModelLjf08Form extends JtCaModelLjf08
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf08';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf08';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf08', 'ljf08', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf08.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf08.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf08.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf08BeforeSave', array('com_jtca.ljf08', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf08AfterSave', array('com_jtca.ljf08', $table, $is_new));

		$this->setState('ljf08.id', $table->id);
