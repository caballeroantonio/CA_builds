...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf07.php';

class JtcaModelLjf07Form extends JtcaModelLjf07
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf07';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf07';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf07', 'ljf07', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf07.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf07.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf07.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf07BeforeSave', array('com_jtca.ljf07', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf07AfterSave', array('com_jtca.ljf07', $table, $is_new));

		$this->setState('ljf07.id', $table->id);
