...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp06.php';

class JtCaModelLjp06Form extends JtCaModelLjp06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp06', 'ljp06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp06BeforeSave', array('com_jtca.ljp06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp06AfterSave', array('com_jtca.ljp06', $table, $is_new));

		$this->setState('ljp06.id', $table->id);
