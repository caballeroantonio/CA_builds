...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljjadg06.php';

class JtCaModelLjjadg06Form extends JtCaModelLjjadg06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljjadg06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljjadg06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljjadg06', 'ljjadg06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljjadg06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljjadg06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljjadg06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjjadg06BeforeSave', array('com_jtca.ljjadg06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjjadg06AfterSave', array('com_jtca.ljjadg06', $table, $is_new));

		$this->setState('ljjadg06.id', $table->id);
