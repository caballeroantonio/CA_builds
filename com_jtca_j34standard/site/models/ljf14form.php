...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf14.php';

class JtCaModelLjf14Form extends JtCaModelLjf14
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf14';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf14';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf14', 'ljf14', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf14.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf14.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf14.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf14BeforeSave', array('com_jtca.ljf14', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf14AfterSave', array('com_jtca.ljf14', $table, $is_new));

		$this->setState('ljf14.id', $table->id);
