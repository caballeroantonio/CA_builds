...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc05.php';

class JtCaModelLjoc05Form extends JtCaModelLjoc05
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc05';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc05';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc05', 'ljoc05', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc05.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc05.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc05.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc05BeforeSave', array('com_jtca.ljoc05', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc05AfterSave', array('com_jtca.ljoc05', $table, $is_new));

		$this->setState('ljoc05.id', $table->id);
