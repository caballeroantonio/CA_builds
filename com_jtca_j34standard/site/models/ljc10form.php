...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljc10.php';

class JtcaModelLjc10Form extends JtcaModelLjc10
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljc10';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljc10';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljc10', 'ljc10', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljc10.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljc10.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljc10.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjc10BeforeSave', array('com_jtca.ljc10', &$table, $is_new));
		...
		$dispatcher->trigger('onLjc10AfterSave', array('com_jtca.ljc10', $table, $is_new));

		$this->setState('ljc10.id', $table->id);
