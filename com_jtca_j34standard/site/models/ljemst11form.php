...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst11.php';

class JtCaModelLjemst11Form extends JtCaModelLjemst11
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst11';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst11';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst11', 'ljemst11', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst11.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst11.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst11.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst11BeforeSave', array('com_jtca.ljemst11', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst11AfterSave', array('com_jtca.ljemst11', $table, $is_new));

		$this->setState('ljemst11.id', $table->id);
