...
/**
 * This models supports retrieving lists of libro de registro de billetes de depÃ³sito (ingreso.
 *
 */
class JtCaModelLjp02s extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single libro de registro de billetes de depÃ³sito (ingresos) has been specified either as a parameter or in the url Request
	...
	/**
	 * Method to get a list of libro de registro de billetes de depÃ³sito (ingreso.
	 *
