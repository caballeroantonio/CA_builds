...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf06.php';

class JtcaModelLjf06Form extends JtcaModelLjf06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf06', 'ljf06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf06BeforeSave', array('com_jtca.ljf06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf06AfterSave', array('com_jtca.ljf06', $table, $is_new));

		$this->setState('ljf06.id', $table->id);
