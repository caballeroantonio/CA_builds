...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst01.php';

class JtCaModelLjemst01Form extends JtCaModelLjemst01
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst01';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst01';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst01', 'ljemst01', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst01.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst01.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst01.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst01BeforeSave', array('com_jtca.ljemst01', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst01AfterSave', array('com_jtca.ljemst01', $table, $is_new));

		$this->setState('ljemst01.id', $table->id);
