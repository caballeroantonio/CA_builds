...
/**
 * TSJ CDMX Libros TxCA Component LIBRO DE GOBIERNO Model
 *
 */
class JtCaModelLspe01 extends JModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.lspe01';
	...
	{
		if (empty($config['lspe01_filter_fields']))
		{
			$config['lspe01_filter_fields'] = array(
				'id', 'a.id',
				'id_organo','a.id_organo',
				'anoj','a.anoj',
				'id_expediente','a.id_expediente',
				'id_secretaria','a.id_secretaria',
				'field2286','a.field2286',
				'field2287','a.field2287',
				'field2288','a.field2288',
				'field2289','a.field2289',
				'field2290','a.field2290',
				'field2291','a.field2291',
				'field2292','a.field2292',
				'field2293_isMoral','a.field2293_isMoral',
				'field2293_paterno','a.field2293_paterno',
				'field2293_materno','a.field2293_materno',
				'field2293_nombre','a.field2293_nombre',
				'field2294','a.field2294',
				'field2295','a.field2295',
				'field2296','a.field2296',
				'field2297','a.field2297',
				'field2343','a.field2343',
				'field2344','a.field2344',
				'field2298','a.field2298',
				'state', 'a.state',
				'created', 'a.created',
	...
	*/
	public function getTable($type = 'Lspe01s', $prefix = 'JtCaTable', $config = array())
	{
		return JTable::getInstance($type, $prefix, $config);
	}
	/**
	 * Method to get LIBRO DE GOBIERNO data.
	 *
	 * @param	integer	$pk	The id of the libro de gobierno.
	 *
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('lspe01.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($item))
				{
					return JError::raiseError(404, JText::_('COM_JTCA_LSPE01S_ERROR_ITEM_NOT_FOUND'));
				}
	...
	public function publish(&$pks, $value = 1)
	{
		...
		$result = $dispatcher->trigger('onLspe01ChangeState', array('com_jtca.lspe01', $pks, $value));
		...
		foreach ($pks as $i => $pk)
		{
			...
			if ($table->load($pk))
			{
				if ($this->canDelete($table))
				{
					...
					$result = $dispatcher->trigger('onLspe01BeforeDelete', array('com_jtca.lspe01', &$table));
					if (in_array(false, $result, true))
					{
						$this->setError($table->getError());
						return false;
					...
					$dispatcher->trigger('onLspe01AfterDelete', array('com_jtca.lspe01', &$table));
				}
				else
				{
					// Prune items that you can't change.
