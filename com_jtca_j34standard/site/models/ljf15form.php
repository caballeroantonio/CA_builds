...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf15.php';

class JtcaModelLjf15Form extends JtcaModelLjf15
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf15';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf15';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf15', 'ljf15', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf15.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf15.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf15.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf15BeforeSave', array('com_jtca.ljf15', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf15AfterSave', array('com_jtca.ljf15', $table, $is_new));

		$this->setState('ljf15.id', $table->id);
