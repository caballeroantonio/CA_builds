...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst05.php';

class JtCaModelLjemst05Form extends JtCaModelLjemst05
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst05';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst05';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst05', 'ljemst05', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst05.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst05.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst05.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst05BeforeSave', array('com_jtca.ljemst05', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst05AfterSave', array('com_jtca.ljemst05', $table, $is_new));

		$this->setState('ljemst05.id', $table->id);
