...
/**
 * This models supports retrieving lists of libro de ordenes de detención para juzgados de jus.
 *
 */
class JtCaModelLcp40s extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single libro de ordenes de detención para juzgados de justicia para adolescentes has been specified either as a parameter or in the url Request
	...
	/**
	 * Method to get a list of libro de ordenes de detención para juzgados de jus.
	 *
