...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljpes08.php';

class JtCaModelLjpes08Form extends JtCaModelLjpes08
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljpes08';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljpes08';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljpes08', 'ljpes08', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljpes08.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljpes08.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljpes08.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjpes08BeforeSave', array('com_jtca.ljpes08', &$table, $is_new));
		...
		$dispatcher->trigger('onLjpes08AfterSave', array('com_jtca.ljpes08', $table, $is_new));

		$this->setState('ljpes08.id', $table->id);
