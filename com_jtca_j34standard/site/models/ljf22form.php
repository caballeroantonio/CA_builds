...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf22.php';

class JtCaModelLjf22Form extends JtCaModelLjf22
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf22';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf22';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf22', 'ljf22', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf22.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf22.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf22.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf22BeforeSave', array('com_jtca.ljf22', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf22AfterSave', array('com_jtca.ljf22', $table, $is_new));

		$this->setState('ljf22.id', $table->id);
