...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp21.php';

class JtCaModelLjp21Form extends JtCaModelLjp21
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp21';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp21';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp21', 'ljp21', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp21.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp21.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp21.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp21BeforeSave', array('com_jtca.ljp21', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp21AfterSave', array('com_jtca.ljp21', $table, $is_new));

		$this->setState('ljp21.id', $table->id);
