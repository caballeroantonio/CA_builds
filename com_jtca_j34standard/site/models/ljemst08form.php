...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst08.php';

class JtCaModelLjemst08Form extends JtCaModelLjemst08
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst08';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst08';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst08', 'ljemst08', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst08.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst08.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst08.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst08BeforeSave', array('com_jtca.ljemst08', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst08AfterSave', array('com_jtca.ljemst08', $table, $is_new));

		$this->setState('ljemst08.id', $table->id);
