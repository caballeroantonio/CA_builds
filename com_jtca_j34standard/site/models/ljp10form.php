...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp10.php';

class JtCaModelLjp10Form extends JtCaModelLjp10
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp10';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp10';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp10', 'ljp10', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp10.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp10.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp10.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp10BeforeSave', array('com_jtca.ljp10', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp10AfterSave', array('com_jtca.ljp10', $table, $is_new));

		$this->setState('ljp10.id', $table->id);
