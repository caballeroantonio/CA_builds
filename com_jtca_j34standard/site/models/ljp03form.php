...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp03.php';

class JtCaModelLjp03Form extends JtCaModelLjp03
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp03';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp03';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp03', 'ljp03', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp03.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp03.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp03.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp03BeforeSave', array('com_jtca.ljp03', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp03AfterSave', array('com_jtca.ljp03', $table, $is_new));

		$this->setState('ljp03.id', $table->id);
