...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf16.php';

class JtCaModelLjf16Form extends JtCaModelLjf16
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf16';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf16';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf16', 'ljf16', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf16.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf16.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf16.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf16BeforeSave', array('com_jtca.ljf16', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf16AfterSave', array('com_jtca.ljf16', $table, $is_new));

		$this->setState('ljf16.id', $table->id);
