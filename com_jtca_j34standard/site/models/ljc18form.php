...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljc18.php';

class JtCaModelLjc18Form extends JtCaModelLjc18
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljc18';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljc18';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljc18', 'ljc18', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljc18.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljc18.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljc18.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjc18BeforeSave', array('com_jtca.ljc18', &$table, $is_new));
		...
		$dispatcher->trigger('onLjc18AfterSave', array('com_jtca.ljc18', $table, $is_new));

		$this->setState('ljc18.id', $table->id);
