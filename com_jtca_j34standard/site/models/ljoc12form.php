...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc12.php';

class JtcaModelLjoc12Form extends JtcaModelLjoc12
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc12';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc12';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc12', 'ljoc12', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc12.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc12.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc12.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc12BeforeSave', array('com_jtca.ljoc12', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc12AfterSave', array('com_jtca.ljoc12', $table, $is_new));

		$this->setState('ljoc12.id', $table->id);
