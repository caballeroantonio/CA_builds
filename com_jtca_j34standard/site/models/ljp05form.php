...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp05.php';

class JtCaModelLjp05Form extends JtCaModelLjp05
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp05';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp05';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp05', 'ljp05', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp05.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp05.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp05.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp05BeforeSave', array('com_jtca.ljp05', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp05AfterSave', array('com_jtca.ljp05', $table, $is_new));

		$this->setState('ljp05.id', $table->id);
