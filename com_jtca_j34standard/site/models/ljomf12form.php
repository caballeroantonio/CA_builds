...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf12.php';

class JtCaModelLjomf12Form extends JtCaModelLjomf12
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf12';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf12';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf12', 'ljomf12', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf12.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf12.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf12.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf12BeforeSave', array('com_jtca.ljomf12', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf12AfterSave', array('com_jtca.ljomf12', $table, $is_new));

		$this->setState('ljomf12.id', $table->id);
