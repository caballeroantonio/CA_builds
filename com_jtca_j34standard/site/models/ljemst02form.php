...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljemst02.php';

class JtCaModelLjemst02Form extends JtCaModelLjemst02
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljemst02';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljemst02';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljemst02', 'ljemst02', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljemst02.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljemst02.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljemst02.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjemst02BeforeSave', array('com_jtca.ljemst02', &$table, $is_new));
		...
		$dispatcher->trigger('onLjemst02AfterSave', array('com_jtca.ljemst02', $table, $is_new));

		$this->setState('ljemst02.id', $table->id);
