...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljc19.php';

class JtCaModelLjc19Form extends JtCaModelLjc19
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljc19';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljc19';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljc19', 'ljc19', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljc19.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljc19.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljc19.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjc19BeforeSave', array('com_jtca.ljc19', &$table, $is_new));
		...
		$dispatcher->trigger('onLjc19AfterSave', array('com_jtca.ljc19', $table, $is_new));

		$this->setState('ljc19.id', $table->id);
