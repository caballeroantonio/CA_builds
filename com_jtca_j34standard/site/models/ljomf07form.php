...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf07.php';

class JtCaModelLjomf07Form extends JtCaModelLjomf07
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf07';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf07';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf07', 'ljomf07', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf07.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf07.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf07.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf07BeforeSave', array('com_jtca.ljomf07', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf07AfterSave', array('com_jtca.ljomf07', $table, $is_new));

		$this->setState('ljomf07.id', $table->id);
