...
/**
 * TSJ CDMX Libros TxCA Component LIBRO DE REGISTRO DE AMPAROS Model
 *
 */
class JtCaModelLsps05 extends JModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.lsps05';
	...
	{
		if (empty($config['lsps05_filter_fields']))
		{
			$config['lsps05_filter_fields'] = array(
				'id', 'a.id',
				'id_expediente','a.id_expediente',
				'id_organo','a.id_organo',
				'id_secretaria','a.id_secretaria',
				'anoj','a.anoj',
				'field2389','a.field2389',
				'field2390','a.field2390',
				'field2391_isMoral','a.field2391_isMoral',
				'field2391_paterno','a.field2391_paterno',
				'field2391_materno','a.field2391_materno',
				'field2391_nombre','a.field2391_nombre',
				'field2392','a.field2392',
				'field2393','a.field2393',
				'field2394','a.field2394',
				'field2395','a.field2395',
				'field2396','a.field2396',
				'field2397','a.field2397',
				'field2398','a.field2398',
				'state', 'a.state',
				'created', 'a.created',
	...
	*/
	public function getTable($type = 'Lsps05s', $prefix = 'JtCaTable', $config = array())
	{
		return JTable::getInstance($type, $prefix, $config);
	}
	/**
	 * Method to get LIBRO DE REGISTRO DE AMPAROS data.
	 *
	 * @param	integer	$pk	The id of the libro de registro de amparos.
	 *
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('lsps05.id');
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				if (empty($item))
				{
					return JError::raiseError(404, JText::_('COM_JTCA_LSPS05S_ERROR_ITEM_NOT_FOUND'));
				}
	...
	public function publish(&$pks, $value = 1)
	{
		...
		$result = $dispatcher->trigger('onLsps05ChangeState', array('com_jtca.lsps05', $pks, $value));
		...
		foreach ($pks as $i => $pk)
		{
			...
			if ($table->load($pk))
			{
				if ($this->canDelete($table))
				{
					...
					$result = $dispatcher->trigger('onLsps05BeforeDelete', array('com_jtca.lsps05', &$table));
					if (in_array(false, $result, true))
					{
						$this->setError($table->getError());
						return false;
					...
					$dispatcher->trigger('onLsps05AfterDelete', array('com_jtca.lsps05', &$table));
				}
				else
				{
					// Prune items that you can't change.
