...
/**
 * This models supports retrieving lists of libro de ministerio público.
 *
 */
class JtCaModelLjc21s extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single libro de ministerio público has been specified either as a parameter or in the url Request
	...
	/**
	 * Method to get a list of libro de ministerio público.
	 *
