...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf11.php';

class JtCaModelLjomf11Form extends JtCaModelLjomf11
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf11';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf11';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf11', 'ljomf11', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf11.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf11.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf11.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf11BeforeSave', array('com_jtca.ljomf11', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf11AfterSave', array('com_jtca.ljomf11', $table, $is_new));

		$this->setState('ljomf11.id', $table->id);
