...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf13.php';

class JtCaModelLjf13Form extends JtCaModelLjf13
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf13';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf13';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf13', 'ljf13', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf13.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf13.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf13.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf13BeforeSave', array('com_jtca.ljf13', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf13AfterSave', array('com_jtca.ljf13', $table, $is_new));

		$this->setState('ljf13.id', $table->id);
