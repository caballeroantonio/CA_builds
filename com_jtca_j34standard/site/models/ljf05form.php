...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf05.php';

class JtCaModelLjf05Form extends JtCaModelLjf05
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf05';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf05';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf05', 'ljf05', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf05.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf05.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf05.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf05BeforeSave', array('com_jtca.ljf05', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf05AfterSave', array('com_jtca.ljf05', $table, $is_new));

		$this->setState('ljf05.id', $table->id);
