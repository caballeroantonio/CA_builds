...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp13.php';

class JtcaModelLjp13Form extends JtcaModelLjp13
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp13';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp13';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp13', 'ljp13', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp13.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp13.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp13.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp13BeforeSave', array('com_jtca.ljp13', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp13AfterSave', array('com_jtca.ljp13', $table, $is_new));

		$this->setState('ljp13.id', $table->id);
