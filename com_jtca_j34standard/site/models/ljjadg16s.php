...
/**
 * This models supports retrieving lists of libro de control de presentación de adolescentes e.
 *
 */
class JtcaModelLjjadg16s extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Check to see if a single libro de control de presentación de adolescentes en libertad ante el juez has been specified either as a parameter or in the url Request
	...
	/**
	 * Method to get a list of libro de control de presentación de adolescentes e.
	 *
