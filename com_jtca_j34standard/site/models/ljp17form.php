...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljp17.php';

class JtCaModelLjp17Form extends JtCaModelLjp17
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljp17';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljp17';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljp17', 'ljp17', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljp17.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljp17.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljp17.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjp17BeforeSave', array('com_jtca.ljp17', &$table, $is_new));
		...
		$dispatcher->trigger('onLjp17AfterSave', array('com_jtca.ljp17', $table, $is_new));

		$this->setState('ljp17.id', $table->id);
