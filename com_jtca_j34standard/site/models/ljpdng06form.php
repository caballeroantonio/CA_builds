...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljpdng06.php';

class JtCaModelLjpdng06Form extends JtCaModelLjpdng06
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljpdng06';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljpdng06';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljpdng06', 'ljpdng06', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljpdng06.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljpdng06.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljpdng06.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjpdng06BeforeSave', array('com_jtca.ljpdng06', &$table, $is_new));
		...
		$dispatcher->trigger('onLjpdng06AfterSave', array('com_jtca.ljpdng06', $table, $is_new));

		$this->setState('ljpdng06.id', $table->id);
