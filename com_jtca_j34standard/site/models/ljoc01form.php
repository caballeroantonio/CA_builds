...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc01.php';

class JtCaModelLjoc01Form extends JtCaModelLjoc01
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc01';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc01';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc01', 'ljoc01', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc01.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc01.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc01.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc01BeforeSave', array('com_jtca.ljoc01', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc01AfterSave', array('com_jtca.ljoc01', $table, $is_new));

		$this->setState('ljoc01.id', $table->id);
