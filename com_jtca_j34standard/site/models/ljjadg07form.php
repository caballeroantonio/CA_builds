...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljjadg07.php';

class JtCaModelLjjadg07Form extends JtCaModelLjjadg07
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljjadg07';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljjadg07';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljjadg07', 'ljjadg07', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljjadg07.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljjadg07.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljjadg07.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjjadg07BeforeSave', array('com_jtca.ljjadg07', &$table, $is_new));
		...
		$dispatcher->trigger('onLjjadg07AfterSave', array('com_jtca.ljjadg07', $table, $is_new));

		$this->setState('ljjadg07.id', $table->id);
