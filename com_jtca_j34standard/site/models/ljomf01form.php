...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf01.php';

class JtCaModelLjomf01Form extends JtCaModelLjomf01
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf01';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf01';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf01', 'ljomf01', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf01.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf01.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf01.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf01BeforeSave', array('com_jtca.ljomf01', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf01AfterSave', array('com_jtca.ljomf01', $table, $is_new));

		$this->setState('ljomf01.id', $table->id);
