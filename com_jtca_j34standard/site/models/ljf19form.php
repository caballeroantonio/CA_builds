...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljf19.php';

class JtcaModelLjf19Form extends JtcaModelLjf19
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljf19';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljf19';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljf19', 'ljf19', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljf19.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljf19.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljf19.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjf19BeforeSave', array('com_jtca.ljf19', &$table, $is_new));
		...
		$dispatcher->trigger('onLjf19AfterSave', array('com_jtca.ljf19', $table, $is_new));

		$this->setState('ljf19.id', $table->id);
