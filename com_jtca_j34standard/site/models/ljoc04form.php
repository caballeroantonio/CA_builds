...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljoc04.php';

class JtCaModelLjoc04Form extends JtCaModelLjoc04
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljoc04';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljoc04';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljoc04', 'ljoc04', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljoc04.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljoc04.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljoc04.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjoc04BeforeSave', array('com_jtca.ljoc04', &$table, $is_new));
		...
		$dispatcher->trigger('onLjoc04AfterSave', array('com_jtca.ljoc04', $table, $is_new));

		$this->setState('ljoc04.id', $table->id);
