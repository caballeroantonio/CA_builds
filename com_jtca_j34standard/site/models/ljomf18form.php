...
require_once JPATH_ADMINISTRATOR.'/components/com_jtca/models/ljomf18.php';

class JtCaModelLjomf18Form extends JtCaModelLjomf18
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_jtca.edit.ljomf18';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_jtca.ljomf18';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jtca.edit.ljomf18', 'ljomf18', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	...
	public function getItem($item_id = null, $recursive = false)
	{
		...
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('ljomf18.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jtca.edit.ljomf18.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ljomf18.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onLjomf18BeforeSave', array('com_jtca.ljomf18', &$table, $is_new));
		...
		$dispatcher->trigger('onLjomf18AfterSave', array('com_jtca.ljomf18', $table, $is_new));

		$this->setState('ljomf18.id', $table->id);
