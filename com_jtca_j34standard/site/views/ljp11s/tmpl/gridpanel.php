...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ÓRGANO DE PROCEDENCIA (JDO DE DTO O TRIB.COL)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL ÓRGANO DE PROCEDENCIA (JDO DE DTO O TRIB.COL)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL INFORME SOLICITADO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENVÍO DEL INFORME
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No. DE OFICIO DE INFORME',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE OFICIO DE INFORME
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CUMPLIMIENTO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljp11_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljp11Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljp11form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
