...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No DE EXP

                FIELD_NAME_LATEX=No DE EXP
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'txt_field1219',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD1219
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['txt_field1219'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DESTINATARIO',
        'FIELD_CODE_NAME' => 'id_field1219',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD1219
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL DESTINATARIO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes04Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes04form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
