...
function getFields(){
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'field116',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD116
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN DEL ASUNTO

                FIELD_NAME_LATEX=FECHA DE RECEPCI\'ON DEL ASUNTO
                FIELD_CODE_NAME_LATEX=field116
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field116'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE PROYECTO',
        'FIELD_CODE_NAME' => 'field117',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD117
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE PROYECTO
    ...
    */
    $fields['field117'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CONSTANCIAS RECIBIDAS',
        'FIELD_CODE_NAME' => 'field120',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD120
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL CONSTANCIAS RECIBIDAS

                FIELD_NAME_LATEX=CONSTANCIAS RECIBIDAS
                FIELD_CODE_NAME_LATEX=field120
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field120'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'RESOLUCIÓN RECURRIDA',
        'FIELD_CODE_NAME' => 'field121',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD121
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL RESOLUCIÓN RECURRIDA
    ...
    */
    $fields['field121'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE CIRCULACIÓN',
        'FIELD_CODE_NAME' => 'field122',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD122
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE CIRCULACIÓN
    ...
    */
    $fields['field122'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE CIRCULACIÓN',
        'FIELD_CODE_NAME' => 'field236',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD236
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field236'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PONENCIA REVISORA',
        'FIELD_CODE_NAME' => 'field2347',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 38,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2347
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL PONENCIA REVISORA

                FIELD_NAME_LATEX=PONENCIA REVISORA
                FIELD_CODE_NAME_LATEX=field2347
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2347'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL DICTADO DE LA SENTENCIA',
        'FIELD_CODE_NAME' => 'field123',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD123
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL DICTADO DE LA SENTENCIA
    ...
    */
    $fields['field123'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN AL ARCHIVO',
        'FIELD_CODE_NAME' => 'field124',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD124
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIÓN AL ARCHIVO

                FIELD_NAME_LATEX=FECHA DE DEVOLUCI\'ON AL ARCHIVO
                FIELD_CODE_NAME_LATEX=field124
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field124'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PONENCIA REVISORA',
        'FIELD_CODE_NAME' => 'field2348',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 38,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2348
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2348'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DE QUIEN RECIBE LAS CONSTANCIAS',
        'FIELD_CODE_NAME' => 'field253',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 35,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD253
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL DE QUIEN RECIBE LAS CONSTANCIAS
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsc01_save_history'))
{
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsc01form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRETA DE REGISTRO DE SENTENCIAS -TURNO- (OFICIAL',
