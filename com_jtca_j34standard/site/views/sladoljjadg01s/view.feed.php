...
class JtcaViewSladolJjadg01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sladol_jjadg01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sladoljjadg01 slug
			$row->slug = $row->id;

			// url link to sladoljjadg01
			$link = JRoute::_(JtcaHelperRoute::getSladolJjadg01Route($row->slug, 
																						'default',								
