...
$function	= $app->input->get('function', 'jSelectLsc07');
 ...
 */
?>
<div class="lsc07s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSC07S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsc07s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsc07_add_link', 1) AND $can_create)
	echo JHtml::_('lsc07icon.create', $this->params);
?>
