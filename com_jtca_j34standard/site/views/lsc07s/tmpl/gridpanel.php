...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE FOLIO',
        'FIELD_CODE_NAME' => 'field162',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD162
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE FOLIO
    ...
    */
    $fields['field162'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SECRETARÍA',
        'FIELD_CODE_NAME' => 'field163',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD163
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SECRETARÍA
    ...
    */
    $fields['field163'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE (isMoral)',
        'FIELD_CODE_NAME' => 'field164_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD164_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field164_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE (paterno)',
        'FIELD_CODE_NAME' => 'field164_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD164_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field164_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE (materno)',
        'FIELD_CODE_NAME' => 'field164_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD164_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field164_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE (nombre)',
        'FIELD_CODE_NAME' => 'field164_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD164_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field164_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CARÁCTER (ACTOR, DEMANDADO ETC)',
        'FIELD_CODE_NAME' => 'field165',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD165
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CARÁCTER (ACTOR, DEMANDADO ETC)

                FIELD_NAME_LATEX=CAR\'ACTER (ACTOR, DEMANDADO ETC)
                FIELD_CODE_NAME_LATEX=field165
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field165'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'JUEZ O MAGISTRADO',
        'FIELD_CODE_NAME' => 'field166',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD166
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL JUEZ O MAGISTRADO
    ...
    */
    $fields['field166'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL JUEZ O MAGISTRADO (isMoral)',
        'FIELD_CODE_NAME' => 'field167_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD167_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DEL JUEZ O MAGISTRADO (isMoral)

                FIELD_NAME_LATEX=NOMBRE DEL JUEZ O MAGISTRADO (isMoral)
                FIELD_CODE_NAME_LATEX=field167\_isMoral
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field167_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL JUEZ O MAGISTRADO (paterno)',
        'FIELD_CODE_NAME' => 'field167_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD167_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DEL JUEZ O MAGISTRADO (paterno)
    ...
    */
    $fields['field167_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL JUEZ O MAGISTRADO (materno)',
        'FIELD_CODE_NAME' => 'field167_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD167_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DEL JUEZ O MAGISTRADO (materno)

                FIELD_NAME_LATEX=NOMBRE DEL JUEZ O MAGISTRADO (materno)
                FIELD_CODE_NAME_LATEX=field167\_materno
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field167_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL JUEZ O MAGISTRADO (nombre)',
        'FIELD_CODE_NAME' => 'field167_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD167_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DEL JUEZ O MAGISTRADO (nombre)
    ...
    */
    $fields['field167_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE BILLETE DE DEPÓSITO',
        'FIELD_CODE_NAME' => 'field168',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD168
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
                ...
                FIELD_CODE_NAME_LATEX=field168
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field168'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CANTIDAD EN NÚMERO',
        'FIELD_CODE_NAME' => 'field169',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 37,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD169
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DECIMAL(11,2) DEFAULT NULL CANTIDAD EN NÚMERO
    ...
    */
    $fields['field169'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CANTIDAD EN LETRA',
        'FIELD_CODE_NAME' => 'field169b',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD169B
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL CANTIDAD EN LETRA

                FIELD_NAME_LATEX=CANTIDAD EN LETRA
                FIELD_CODE_NAME_LATEX=field169b
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field169b'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ASIENTO DE CAJA FOLIO',
        'FIELD_CODE_NAME' => 'field170',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD170
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL ASIENTO DE CAJA FOLIO
    ...
    */
    $fields['field170'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA',
        'FIELD_CODE_NAME' => 'field171',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD171
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field171'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FIRMA',
        'FIELD_CODE_NAME' => 'field172',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 34,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD172
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL FIRMA  
    ...
    */
    $fields['field172'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DE PRESIDENTE DE SALA',
        'FIELD_CODE_NAME' => 'field173',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 35,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD173
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL DE PRESIDENTE DE SALA

                FIELD_NAME_LATEX=DE PRESIDENTE DE SALA
                FIELD_CODE_NAME_LATEX=field173
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field173'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DE SECRETARIA DE ACUERDOS',
        'FIELD_CODE_NAME' => 'field174',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 35,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD174
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL DE SECRETARIA DE ACUERDOS
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsc07_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lsc07Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsc07form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE EGRESOS (OFICIAL)',
