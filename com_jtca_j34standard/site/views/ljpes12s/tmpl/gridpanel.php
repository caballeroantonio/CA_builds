...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE PÓLIZA

                FIELD_NAME_LATEX=No. DE P\'OLIZA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE SE RECIBE LA PÓLIZA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE RECIBE LA PÓLIZA 
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL AFIANZADORA 
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ORDEN PARA HACERLA EFECTIVA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ORDEN PARA HACERLA EFECTIVA

                FIELD_NAME_LATEX=FECHA DE ORDEN PARA HACERLA EFECTIVA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE CANCELACION',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE CANCELACION

                FIELD_NAME_LATEX=FECHA DE CANCELACION
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes12_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes12Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes12form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
