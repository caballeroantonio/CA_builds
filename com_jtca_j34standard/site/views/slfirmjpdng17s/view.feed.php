...
class JtcaViewSlfirmJpdng17s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slfirm_jpdng17s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slfirmjpdng17 slug
			$row->slug = $row->id;

			// url link to slfirmjpdng17
			$link = JRoute::_(JtcaHelperRoute::getSlfirmJpdng17Route($row->slug, 
																						'default',								
