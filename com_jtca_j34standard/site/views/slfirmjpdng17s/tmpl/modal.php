...
$function	= $app->input->get('function', 'jSelectSlfirmJpdng17');
 ...
 */
?>
<div class="slfirm_jpdng17s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLFIRM_JPDNG17S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slfirm_jpdng17s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slfirm_jpdng17s">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLFIRM_JPDNG17S_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLFIRM_JPDNG17S_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slfirmjpdng17_add_link', 1) AND $can_create)
	echo JHtml::_('slfirmjpdng17icon.create', $this->params);
?>
