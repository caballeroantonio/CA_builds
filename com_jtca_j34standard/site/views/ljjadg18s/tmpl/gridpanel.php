...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL TIPO DE AMPARO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL QUEJOSO (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DEL QUEJOSO (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL QUEJOSO (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DEL QUEJOSO (paterno)

                FIELD_NAME_LATEX=NOMBRE DEL QUEJOSO (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL QUEJOSO (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DEL QUEJOSO (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL QUEJOSO (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DEL QUEJOSO (nombre)

                FIELD_NAME_LATEX=NOMBRE DEL QUEJOSO (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ORGANO DE PROCEDENCIA (JDO DE DTO O TRIB. COL)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL ORGANO DE PROCEDENCIA (JDO DE DTO O TRIB. COL)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL INFORME SOLICITADO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENVÍO DE INFORME PREVIO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENVÍO DE INFORME PREVIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No. DE OFICIO DEL INFORME',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE OFICIO DEL INFORME

                FIELD_NAME_LATEX=No. DE OFICIO DEL INFORME
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL RESOLUCIÓN DE AMPARO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE EJECUTORIA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE EJECUTORIA

                FIELD_NAME_LATEX=FECHA DE EJECUTORIA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CUMPLIMENTO

                FIELD_NAME_LATEX=CUMPLIMENTO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENVÍO DE INFORME JUSTIFICADO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENVÍO DE INFORME JUSTIFICADO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljjadg18_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadg18Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadg18form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
