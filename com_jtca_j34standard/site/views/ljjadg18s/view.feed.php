...
class JtcaViewLjjadg18s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg18s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg18 slug
			$row->slug = $row->id;

			// url link to ljjadg18
			$link = JRoute::_(JtcaHelperRoute::getLjjadg18Route($row->slug, 
																						'default',								
