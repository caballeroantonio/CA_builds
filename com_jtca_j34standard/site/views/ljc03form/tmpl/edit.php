...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc03_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc03_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC03S_FIELDSET_JC03_FS_LABEL');?></a></li>
