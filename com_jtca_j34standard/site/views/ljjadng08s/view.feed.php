...
class JtCaViewLjjadng08s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng08s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng08 slug
			$row->slug = $row->id;

			// url link to ljjadng08
			$link = JRoute::_(JtCaHelperRoute::getLjjadng08Route($row->slug, 
																						'default',								
