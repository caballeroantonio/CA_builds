...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL  DÍAS MULTA

                FIELD_NAME_LATEX=D\'IAS MULTA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE AUTO

                FIELD_NAME_LATEX=FECHA DE AUTO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA A  LA QUE SE LE IMPONE',
        'FIELD_CODE_NAME' => 'txt_field1248',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD1248
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PERSONA A  LA QUE SE LE IMPONE
    ...
    */
    $fields['txt_field1248'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA A  LA QUE SE LE IMPONE',
        'FIELD_CODE_NAME' => 'id_field1248',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD1248
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL PERSONA A  LA QUE SE LE IMPONE
    ...
    */
    $fields['id_field1248'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NO. DE OFICIO CON EL QUE SE COMUNICA LA SANCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NO. DE OFICIO CON EL QUE SE COMUNICA LA SANCIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENTREGA DEL OFICIO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENTREGA DEL OFICIO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes09_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes09Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes09form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE MULTAS JUDICIALES',
