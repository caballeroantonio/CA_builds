...
class JtcaViewSlpersons extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slpersons');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slperson slug
			$row->slug = $row->id;

			// url link to slperson
			$link = JRoute::_(JtcaHelperRoute::getSlpersonRoute($row->slug, 
																						'default',								
