...
$function	= $app->input->get('function', 'jSelectSlperson');
 ...
 */
?>
<div class="slpersons-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLPERSONS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersons&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slpersons">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLPERSONS_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLPERSONS_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slperson_add_link', 1) AND $can_create)
	echo JHtml::_('slpersonicon.create', $this->params);
?>
