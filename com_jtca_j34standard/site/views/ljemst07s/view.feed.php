...
class JtCaViewLjemst07s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst07s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst07 slug
			$row->slug = $row->id;

			// url link to ljemst07
			$link = JRoute::_(JtCaHelperRoute::getLjemst07Route($row->slug, 
																						'default',								
