...
$function	= $app->input->get('function', 'jSelectLspe04');
 ...
 */
?>
<div class="lspe04s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPE04S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lspe04s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lspe04_add_link', 1) AND $can_create)
	echo JHtml::_('lspe04icon.create', $this->params);
?>
