	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<?php if (($this->params->get('show_ljc21_filter_field') != '' AND $this->params->get('show_ljc21_filter_field') != 'hide')) :?>
			<div class="filter-search">
				...
				<?php endif; ?>	
				<?php if ($this->params->get('list_show_ljc21_id_expediente',0)) : ?>
					<select name="filter_id_expediente" onchange="this.form.submit()">
					<option value=""><?php echo JText::_('COM_JTCA_LJC21S_SELECT_ID_EXPEDIENTE');?></option>
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljc21_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljc21_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field8_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field8_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field8_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field8_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field9h',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc21_field10',0)) : ?>
