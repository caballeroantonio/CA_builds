...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL AUTO A DILIGENCIAR
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DOMICILIO 

                FIELD_NAME_LATEX=DOMICILIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENTREGA DE CEDULAS',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENTREGA DE CEDULAS
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN DE CEDULA AL JUZGADO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIÓN DE CEDULA AL JUZGADO

                FIELD_NAME_LATEX=FECHA DE DEVOLUCI\'ON DE CEDULA AL JUZGADO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes05_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes05Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes05form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
