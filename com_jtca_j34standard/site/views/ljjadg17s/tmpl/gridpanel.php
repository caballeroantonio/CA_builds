...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL AUTO QUE ORDENA LA REMISIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO QUE ORDENA LA REMISIÓN

                FIELD_NAME_LATEX=FECHA DEL AUTO QUE ORDENA LA REMISI\'ON
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN AL ARCHIVO JUDICIAL',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN AL ARCHIVO JUDICIAL
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadg17Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadg17form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
