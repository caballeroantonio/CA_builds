...
class JtcaViewLjjadg17s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg17s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg17 slug
			$row->slug = $row->id;

			// url link to ljjadg17
			$link = JRoute::_(JtcaHelperRoute::getLjjadg17Route($row->slug, 
																						'default',								
