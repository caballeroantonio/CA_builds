...
<div class="jtca lcp20-view<?php echo $params->get('pageclass_sfx')?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<h1>
		<?php echo $this->escape($this->params->get('page_heading')); ?>
	</h1>
	<?php endif; ?>
	<?php if ($params->get('show_lcp20_icons',-1) >= 0) : ?>
		<?php if ($params->get('show_lcp20_print_icon') 
			OR $params->get('show_lcp20_email_icon') 
			OR $can_edit 
			OR $can_delete 
			): ?>
			<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu">
					<?php if (!$this->print) : ?>
							<?php if ($params->get('show_lcp20_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('lcp20icon.print_popup',  $this->item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_lcp20_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('lcp20icon.email',  $this->item, $params); ?>
								</li>
							<?php endif; ?>
							<?php if ($can_edit) : ?>
								<li class="edit-icon">
									<?php echo JHtml::_('lcp20icon.edit', $this->item, $params); ?>
								</li>
							<?php endif; ?>
							<?php if ($can_delete) : ?>
								<li class="delete-icon">
									<?php echo JHtml::_('lcp20icon.delete',$this->item, $params); ?>
								</li>					
							<?php endif; ?>
					<?php else : ?>
						<li>
							<?php echo JHtml::_('lcp20icon.print_screen',  $this->item, $params); ?>
						</li>
					<?php endif; ?>
				</ul>
			</div>
	...
	<?php echo $this->item->event->beforeDisplayLcp20; ?>
	<div style="clear:both; padding-top: 10px;">

	</div>
	<div style="padding-top: 10px;">

			<form action="" name="lcp20Form" id="lcp20Form">
			<?php $dummy = false;
					$display_fieldset = (
								...
								($params->get('show_lcp20_field9')) OR 
								($params->get('show_lcp20_organo2')) OR 
								($params->get('show_lcp20_field11')) OR 
								($params->get('show_lcp20_field13')) OR 
								($params->get('show_lcp20_field14')) OR 
								$dummy
								);
			?>
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_JTCA_LCP20S_FIELDSET_LCP20_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_lcp20_id_organo')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_ID_ORGANO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_ID_SECRETARIA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_fh_recepcion')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_FH_RECEPCION_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_field7')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_FIELD7_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_organo1')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_ORGANO1_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_field9')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_FIELD9_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_organo2')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_ORGANO2_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_field11')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_FIELD11_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_field13')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_FIELD13_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_lcp20_field14')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LCP20S_FIELD_FIELD14_LABEL'); ?>
							</label>
							<span>
								<?php
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_lcp20_created_by')) OR
							($params->get('show_lcp20_created')) OR
							($params->get('show_lcp20_modified')) OR
							($params->get('show_lcp20_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php if ($params->get('show_lcp20_created_by') ) : ?>
				...
				<div class="formelm">				
					<label>
						...
						<?php if (!empty($this->item->created_by ) AND  $this->params->get('link_lcp20_created_by') == 1):?>
							<?php echo JHtml::_(
									'link',
			...
			<?php endif; ?>	
			<?php if ($params->get('show_lcp20_created_by_alias')) : ?>
				<div class="formelm">				
					<label>
			...
			<?php endif; ?>				
			<?php if ($params->get('show_lcp20_created')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_lcp20_modified')) : ?>
				<div class="formelm">
					<label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_lcp20_admin')) : ?>
		...
		<?php echo $this->item->event->afterDisplayLcp20; ?>
	</div>		
</div>