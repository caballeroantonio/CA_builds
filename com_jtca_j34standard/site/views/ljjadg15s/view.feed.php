...
class JtCaViewLjjadg15s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg15s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg15 slug
			$row->slug = $row->id;

			// url link to ljjadg15
			$link = JRoute::_(JtCaHelperRoute::getLjjadg15Route($row->slug, 
																						'default',								
