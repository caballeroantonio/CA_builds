...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CAUSA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL NOMBRE DEL  MP
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DEFENSOR

                FIELD_NAME_LATEX=DEFENSOR
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE RECIBE LA CAUSA (MP)',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL FECHA EN QUE RECIBE LA CAUSA (MP)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE RECIBE LA CAUSA (DEFENSOR)',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL FECHA EN QUE RECIBE LA CAUSA (DEFENSOR)

                FIELD_NAME_LATEX=FECHA EN QUE RECIBE LA CAUSA (DEFENSOR)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN DE LA CAUSA (MP)',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL FECHA DE DEVOLUCIÓN DE LA CAUSA (MP)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN (DEFENSOR)',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL FECHA DE DEVOLUCIÓN (DEFENSOR)

                FIELD_NAME_LATEX=FECHA DE DEVOLUCI\'ON (DEFENSOR)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE PRESENTACIÓN DE CONCLUSIONES (MP)',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL FECHA DE PRESENTACIÓN DE CONCLUSIONES (MP)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE PRESENTACIÓN DE CONCLUSIONES (DEFENSOR)',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL FECHA DE PRESENTACIÓN DE CONCLUSIONES (DEFENSOR)

                FIELD_NAME_LATEX=FECHA DE PRESENTACI\'ON DE CONCLUSIONES (DEFENSOR)
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljp20_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljp20Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljp20form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE TURNO PARA CONCLUSIONES',
