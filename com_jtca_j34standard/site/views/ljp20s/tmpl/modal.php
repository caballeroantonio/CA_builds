...
$function	= $app->input->get('function', 'jSelectLjp20');
 ...
 */
?>
<div class="ljp20s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP20S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp20s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp20_add_link', 1) AND $can_create)
	echo JHtml::_('ljp20icon.create', $this->params);
?>
