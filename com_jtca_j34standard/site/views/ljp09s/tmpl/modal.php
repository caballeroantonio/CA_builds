...
$function	= $app->input->get('function', 'jSelectLjp09');
 ...
 */
?>
<div class="ljp09s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP09S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp09s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp09_add_link', 1) AND $can_create)
	echo JHtml::_('ljp09icon.create', $this->params);
?>
