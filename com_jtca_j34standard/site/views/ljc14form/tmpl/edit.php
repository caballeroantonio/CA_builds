...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc14_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc14_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC14S_FIELDSET_JC14_FS_LABEL');?></a></li>
