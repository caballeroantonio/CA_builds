...
$function	= $app->input->get('function', 'jSelectLcp36');
 ...
 */
?>
<div class="lcp36s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LCP36S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp36s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lcp36_add_link', 1) AND $can_create)
	echo JHtml::_('lcp36icon.create', $this->params);
?>
