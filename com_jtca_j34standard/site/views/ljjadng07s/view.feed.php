...
class JtCaViewLjjadng07s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng07s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng07 slug
			$row->slug = $row->id;

			// url link to ljjadng07
			$link = JRoute::_(JtCaHelperRoute::getLjjadng07Route($row->slug, 
																						'default',								
