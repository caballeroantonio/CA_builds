...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc08_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc08_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC08S_FIELDSET_JC08_FS_LABEL');?></a></li>
