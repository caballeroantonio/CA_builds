...
$function	= $app->input->get('function', 'jSelectLjomf22');
 ...
 */
?>
<div class="ljomf22s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOMF22S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf22s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljomf22_add_link', 1) AND $can_create)
	echo JHtml::_('ljomf22icon.create', $this->params);
?>
