...
<div class="jtca ljf09s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljf09_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljf09_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field10',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf09_field13',0)) : ?>
