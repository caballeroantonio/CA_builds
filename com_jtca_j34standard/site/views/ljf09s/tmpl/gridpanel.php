...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'LUGAR DONDE DEBE REALIZARSE',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL LUGAR DONDE DEBE REALIZARSE
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf09Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf09form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
