...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DECIMAL(11,2) DEFAULT NULL SUERTE PRINCIPAL
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA RESOLUCIÓN DE LA SALA O DE LA AUTORIDAD FEDERAL',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA RESOLUCIÓN DE LA SALA O DE LA AUTORIDAD FEDERAL
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SENTIDO DE LA RESOLUCIÓN DE LA SALA O DE LA AUTORIDAD FEDERAL',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SENTIDO DE LA RESOLUCIÓN DE LA SALA O DE LA AUTORIDAD FEDERAL

                FIELD_NAME_LATEX=SENTIDO DE LA RESOLUCI\'ON DE LA SALA O DE LA AUTORIDAD FEDERAL
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljccm01Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljccm01form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
