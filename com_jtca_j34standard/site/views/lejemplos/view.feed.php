...
class JtCaViewLejemplos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=lejemplos');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the lejemplo slug
			$row->slug = $row->id;

			// url link to lejemplo
			$link = JRoute::_(JtCaHelperRoute::getLejemploRoute($row->slug, 
																						'default',								
