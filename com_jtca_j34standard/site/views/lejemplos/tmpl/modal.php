...
$function	= $app->input->get('function', 'jSelectLejemplo');
 ...
 */
?>
<div class="lejemplos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LEJEMPLOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lejemplos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lejemplo_add_link', 1) AND $can_create)
	echo JHtml::_('lejemploicon.create', $this->params);
?>
