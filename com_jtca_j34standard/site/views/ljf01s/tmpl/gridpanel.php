...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENTRADA AL JUZGADO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENTRADA AL JUZGADO

                FIELD_NAME_LATEX=FECHA DE ENTRADA AL JUZGADO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA RESOLUCIÓN 1A. INSTANCIA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA RESOLUCIÓN 1A. INSTANCIA

                FIELD_NAME_LATEX=FECHA DE LA RESOLUCI\'ON 1A. INSTANCIA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SENTIDO DE LA RESOLUCIÓN 1A. INSTANCIA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SENTIDO DE LA RESOLUCIÓN 1A. INSTANCIA

                FIELD_NAME_LATEX=SENTIDO DE LA RESOLUCI\'ON 1A. INSTANCIA
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf01Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf01form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
