...
$function	= $app->input->get('function', 'jSelectLjf01');
 ...
 */
?>
<div class="ljf01s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF01S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf01s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf01_add_link', 1) AND $can_create)
	echo JHtml::_('ljf01icon.create', $this->params);
?>
