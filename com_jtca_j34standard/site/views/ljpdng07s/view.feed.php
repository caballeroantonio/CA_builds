...
class JtcaViewLjpdng07s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng07s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng07 slug
			$row->slug = $row->id;

			// url link to ljpdng07
			$link = JRoute::_(JtcaHelperRoute::getLjpdng07Route($row->slug, 
																						'default',								
