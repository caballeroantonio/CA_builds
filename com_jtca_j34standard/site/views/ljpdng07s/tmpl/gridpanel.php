...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No DE EXHORTO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL AUTORIDAD EXHORTANTE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DILIGENCIA ENCOMENDADA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SENTIDO DEL AUTO QUE RECAE',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SENTIDO DEL AUTO QUE RECAE

                FIELD_NAME_LATEX=SENTIDO DEL AUTO QUE RECAE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL SE CUMPLIMENTO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng07Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng07form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
