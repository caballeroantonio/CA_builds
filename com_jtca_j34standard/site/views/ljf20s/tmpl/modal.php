...
$function	= $app->input->get('function', 'jSelectLjf20');
 ...
 */
?>
<div class="ljf20s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF20S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf20s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf20_add_link', 1) AND $can_create)
	echo JHtml::_('ljf20icon.create', $this->params);
?>
