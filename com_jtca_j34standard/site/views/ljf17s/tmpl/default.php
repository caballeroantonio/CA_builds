...
<div class="jtca ljf17s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljf17_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljf17_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field10_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field10_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field10_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field10_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf17_field13',0)) : ?>
