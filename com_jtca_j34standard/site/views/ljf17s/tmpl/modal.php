...
$function	= $app->input->get('function', 'jSelectLjf17');
 ...
 */
?>
<div class="ljf17s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF17S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf17s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf17_add_link', 1) AND $can_create)
	echo JHtml::_('ljf17icon.create', $this->params);
?>
