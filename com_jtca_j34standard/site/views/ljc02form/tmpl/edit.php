...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc02_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc02_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC02S_FIELDSET_JC02_FS_LABEL');?></a></li>
