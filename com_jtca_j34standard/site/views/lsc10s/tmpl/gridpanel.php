...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) UNSIGNED  DEFAULT NULL NÚMERO TOCA
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'field199',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD199
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field199'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL AUTO A DILIGENCIAR',
        'FIELD_CODE_NAME' => 'field200',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD200
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO A DILIGENCIAR
    ...
    */
    $fields['field200'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'LUGAR DONDE DEBE ACTUARSE',
        'FIELD_CODE_NAME' => 'field201',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD201
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field201'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA DILIGENCIA',
        'FIELD_CODE_NAME' => 'field202',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD202
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field202'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA DEVOLUCIÓN',
        'FIELD_CODE_NAME' => 'field203',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD203
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field203'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'OBSERVACIONES',
        'FIELD_CODE_NAME' => 'field204',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 4,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD204
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsc10_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lsc10Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsc10form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE ACTUARIO (OFICIAL)',
