...
$function	= $app->input->get('function', 'jSelectLjp04');
 ...
 */
?>
<div class="ljp04s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP04S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp04s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp04_add_link', 1) AND $can_create)
	echo JHtml::_('ljp04icon.create', $this->params);
?>
