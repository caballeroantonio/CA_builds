...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DE LA PERSONA A  QUIEN SE LE IMPUSO (isMoral)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DE LA PERSONA A  QUIEN SE LE IMPUSO (paterno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA A  QUIEN SE LE IMPUSO (materno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA A  QUIEN SE LE IMPUSO (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No. DE OFICIO EN  EL QUE SE  COMUNICA LA SANCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE OFICIO EN  EL QUE SE  COMUNICA LA SANCIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL OFICIO EN QUE SE COMUNICA LA SANCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL OFICIO EN QUE SE COMUNICA LA SANCIÓN

                FIELD_NAME_LATEX=FECHA DEL OFICIO EN QUE SE COMUNICA LA SANCI\'ON
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE SE GIRA  OFICIO A LA OFICINA  RECAUDADORA DEL TSJDF',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE GIRA  OFICIO A LA OFICINA  RECAUDADORA DEL TSJDF

                FIELD_NAME_LATEX=FECHA EN QUE SE GIRA  OFICIO A LA OFICINA  RECAUDADORA DEL TSJDF
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENTREGA A LA DIRECCIÓN DE MULTAS JUDICIALES',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENTREGA A LA DIRECCIÓN DE MULTAS JUDICIALES
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljf14_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf14Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf14form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
