...
$function	= $app->input->get('function', 'jSelectLjf22');
 ...
 */
?>
<div class="ljf22s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF22S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf22s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf22_add_link', 1) AND $can_create)
	echo JHtml::_('ljf22icon.create', $this->params);
?>
