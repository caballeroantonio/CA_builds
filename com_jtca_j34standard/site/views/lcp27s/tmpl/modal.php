...
$function	= $app->input->get('function', 'jSelectLcp27');
 ...
 */
?>
<div class="lcp27s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LCP27S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp27s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lcp27_add_link', 1) AND $can_create)
	echo JHtml::_('lcp27icon.create', $this->params);
?>
