...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc21_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc21_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC21S_FIELDSET_JC21_FS_LABEL');?></a></li>
