...
$function	= $app->input->get('function', 'jSelectLjomf14');
 ...
 */
?>
<div class="ljomf14s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOMF14S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf14s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljomf14_add_link', 1) AND $can_create)
	echo JHtml::_('ljomf14icon.create', $this->params);
?>
