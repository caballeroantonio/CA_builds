...
class JtCaViewLjjadg08s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg08s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg08 slug
			$row->slug = $row->id;

			// url link to ljjadg08
			$link = JRoute::_(JtCaHelperRoute::getLjjadg08Route($row->slug, 
																						'default',								
