...
$function	= $app->input->get('function', 'jSelectLjc16');
 ...
 */
?>
<div class="ljc16s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC16S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc16s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc16_add_link', 1) AND $can_create)
	echo JHtml::_('ljc16icon.create', $this->params);
?>
