...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO EN QUE SE SEÑALA LA AUDIENCIA
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_DESCRIPTION' => 'FECHA Y HORA DE LA CELEBRACIÓN DE LA AUDIENCIA',//FECHA Y HORA DE LA CELEBRACIÓN DE LA AUDIENCIA
        'FIELDTYPE_ID' => 36,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL PRUEBAS A DESAHOGAR
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljc16Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljc16form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
