...
class JtcaViewLjpdng11s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng11s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng11 slug
			$row->slug = $row->id;

			// url link to ljpdng11
			$link = JRoute::_(JtcaHelperRoute::getLjpdng11Route($row->slug, 
																						'default',								
