...
$function	= $app->input->get('function', 'jSelectLjpdng11');
 ...
 */
?>
<div class="ljpdng11s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPDNG11S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng11s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpdng11_add_link', 1) AND $can_create)
	echo JHtml::_('ljpdng11icon.create', $this->params);
?>
