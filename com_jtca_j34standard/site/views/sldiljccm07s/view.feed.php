...
class JtcaViewSldilJccm07s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sldil_jccm07s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sldiljccm07 slug
			$row->slug = $row->id;

			// url link to sldiljccm07
			$link = JRoute::_(JtcaHelperRoute::getSldilJccm07Route($row->slug, 
																						'default',								
