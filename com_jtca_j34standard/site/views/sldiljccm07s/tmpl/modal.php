...
$function	= $app->input->get('function', 'jSelectSldilJccm07');
 ...
 */
?>
<div class="sldil_jccm07s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLDIL_JCCM07S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldil_jccm07s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="sldil_jccm07s">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLDIL_JCCM07S_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLDIL_JCCM07S_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_sldiljccm07_add_link', 1) AND $can_create)
	echo JHtml::_('sldiljccm07icon.create', $this->params);
?>
