...
$function	= $app->input->get('function', 'jSelectLjf03');
 ...
 */
?>
<div class="ljf03s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF03S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf03s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf03_add_link', 1) AND $can_create)
	echo JHtml::_('ljf03icon.create', $this->params);
?>
