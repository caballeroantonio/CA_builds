...
<div class="jtca ljpdng18s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljpdng18_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljpdng18_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field3',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field4',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field8_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field8_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field8_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field8_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field10',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_field12',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_exp_extinto',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng18_jorigen',0)) : ?>
