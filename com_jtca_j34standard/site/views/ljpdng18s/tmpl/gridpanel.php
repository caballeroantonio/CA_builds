...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN POR EL ARCHIVO JUDICIAL',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN POR EL ARCHIVO JUDICIAL

                FIELD_NAME_LATEX=FECHA DE RECEPCI\'ON POR EL ARCHIVO JUDICIAL
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN DE SOLICITUD DE DEVOLUCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN DE SOLICITUD DE DEVOLUCIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN DEL ARCHIVO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIÓN DEL ARCHIVO

                FIELD_NAME_LATEX=FECHA DE DEVOLUCI\'ON DEL ARCHIVO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpdng18_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng18Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng18form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
