...
class JtCaViewLjpdng18s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng18s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng18 slug
			$row->slug = $row->id;

			// url link to ljpdng18
			$link = JRoute::_(JtCaHelperRoute::getLjpdng18Route($row->slug, 
																						'default',								
