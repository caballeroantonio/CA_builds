...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc01_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc01_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC01S_FIELDSET_JC01_FS_LABEL');?></a></li>
