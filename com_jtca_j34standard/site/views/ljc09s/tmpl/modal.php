...
$function	= $app->input->get('function', 'jSelectLjc09');
 ...
 */
?>
<div class="ljc09s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC09S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc09s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc09_add_link', 1) AND $can_create)
	echo JHtml::_('ljc09icon.create', $this->params);
?>
