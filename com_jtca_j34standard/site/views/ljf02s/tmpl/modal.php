...
$function	= $app->input->get('function', 'jSelectLjf02');
 ...
 */
?>
<div class="ljf02s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF02S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf02s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf02_add_link', 1) AND $can_create)
	echo JHtml::_('ljf02icon.create', $this->params);
?>
