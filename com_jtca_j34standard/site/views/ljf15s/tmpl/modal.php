...
$function	= $app->input->get('function', 'jSelectLjf15');
 ...
 */
?>
<div class="ljf15s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF15S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf15s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf15_add_link', 1) AND $can_create)
	echo JHtml::_('ljf15icon.create', $this->params);
?>
