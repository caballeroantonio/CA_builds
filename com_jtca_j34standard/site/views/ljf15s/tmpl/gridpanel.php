...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE PUBLICACIÓN EN EL BOLETÍN JUDICIAL',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE PUBLICACIÓN EN EL BOLETÍN JUDICIAL
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECIBIDO POR PARTE DEL EMPLEADO/ACTUARIO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECIBIDO POR PARTE DEL EMPLEADO/ACTUARIO

                FIELD_NAME_LATEX=FECHA DE RECIBIDO POR PARTE DEL EMPLEADO/ACTUARIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DEL EMPLEADO/ACTUARIO',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL DEL EMPLEADO/ACTUARIO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf15Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf15form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE TURNO A CARGO DE LOS SECRETARIOS DE ACUER',
