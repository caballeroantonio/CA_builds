...
class JtcaViewSldeclJpdng01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sldecl_jpdng01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sldecljpdng01 slug
			$row->slug = $row->id;

			// url link to sldecljpdng01
			$link = JRoute::_(JtcaHelperRoute::getSldeclJpdng01Route($row->slug, 
																						'default',								
