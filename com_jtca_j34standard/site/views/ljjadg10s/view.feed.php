...
class JtCaViewLjjadg10s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg10s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg10 slug
			$row->slug = $row->id;

			// url link to ljjadg10
			$link = JRoute::_(JtCaHelperRoute::getLjjadg10Route($row->slug, 
																						'default',								
