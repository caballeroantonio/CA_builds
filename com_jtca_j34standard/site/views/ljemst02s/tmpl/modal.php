...
$function	= $app->input->get('function', 'jSelectLjemst02');
 ...
 */
?>
<div class="ljemst02s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJEMST02S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst02s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljemst02_add_link', 1) AND $can_create)
	echo JHtml::_('ljemst02icon.create', $this->params);
?>
