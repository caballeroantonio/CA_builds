...
class JtCaViewLjemst02s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst02s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst02 slug
			$row->slug = $row->id;

			// url link to ljemst02
			$link = JRoute::_(JtCaHelperRoute::getLjemst02Route($row->slug, 
																						'default',								
