...
<div class="jtca ljpes14s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div style="overflow-x:auto;">
			<table class="table table-striped" id="ljpes14s" style="margin-bottom: 200px;">
				...
				?>			
					...
					<?php if ($this->params->get('list_show_ljpes14_id_expediente',1)) : ?>
						<td class="list-id_expediente">
							<?php 
								if ($params->get('list_link_ljpes14_id_expediente')) :
...
function show_collapsibleModal(item_id){
	...
	modalBody.prepend('<iframe class="iframe" src="index.php?option=com_jtca&task=ljpes14.showHistory&item_id='+item_id+'" name="titulo" height="450"></iframe>');
	return;
}
</script>
