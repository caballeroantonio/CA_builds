...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PENA POR CUMPLIR
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PENA TOTAL

                FIELD_NAME_LATEX=PENA TOTAL
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL BENEFICIO PENITENCIARIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE PRESCRIPCIÓN DE LA PENA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE PRESCRIPCIÓN DE LA PENA

                FIELD_NAME_LATEX=FECHA DE PRESCRIPCI\'ON DE LA PENA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE REVOCACIÓN DEL BENEFICIO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE REVOCACIÓN DEL BENEFICIO 
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ORDEN DE REAPREHENSIÓN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL ORDEN DE REAPREHENSIÓN

                FIELD_NAME_LATEX=ORDEN DE REAPREHENSI\'ON
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL CUMPLIMIENTO DE LA ORDEN DE REAPREHENSIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL CUMPLIMIENTO DE LA ORDEN DE REAPREHENSIÓN

                FIELD_NAME_LATEX=FECHA DEL CUMPLIMIENTO DE LA ORDEN DE REAPREHENSI\'ON
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes15_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes15Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes15form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE BENEFICIOS REVOCADOS Y ORDENES DE RE-APRE',
