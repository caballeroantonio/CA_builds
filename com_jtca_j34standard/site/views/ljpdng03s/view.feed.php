...
class JtCaViewLjpdng03s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng03s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng03 slug
			$row->slug = $row->id;

			// url link to ljpdng03
			$link = JRoute::_(JtCaHelperRoute::getLjpdng03Route($row->slug, 
																						'default',								
