...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE SE EXPIDE EL BILLETE',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE EXPIDE EL BILLETE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DECIMAL(11,2) DEFAULT NULL MONTO DEL BILLETE
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE A QUIEN SE ENTREGA (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE A QUIEN SE ENTREGA (isMoral)

                FIELD_NAME_LATEX=NOMBRE A QUIEN SE ENTREGA (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE A QUIEN SE ENTREGA (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE A QUIEN SE ENTREGA (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE A QUIEN SE ENTREGA (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE A QUIEN SE ENTREGA (materno)

                FIELD_NAME_LATEX=NOMBRE A QUIEN SE ENTREGA (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE A QUIEN SE ENTREGA (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE A QUIEN SE ENTREGA (nombre)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ACUERDO

                FIELD_NAME_LATEX=FECHA DE ACUERDO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpdng03_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng03Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng03form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE CERTIFICADO DE DEPÓSITOS DE EGRESO',
