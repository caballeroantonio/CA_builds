...
$function	= $app->input->get('function', 'jSelectLjpdng03');
 ...
 */
?>
<div class="ljpdng03s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPDNG03S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng03s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpdng03_add_link', 1) AND $can_create)
	echo JHtml::_('ljpdng03icon.create', $this->params);
?>
