...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc17_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc17_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC17S_FIELDSET_JC17_FS_LABEL');?></a></li>
