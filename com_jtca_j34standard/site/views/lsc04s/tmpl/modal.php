...
$function	= $app->input->get('function', 'jSelectLsc04');
 ...
 */
?>
<div class="lsc04s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSC04S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsc04s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsc04_add_link', 1) AND $can_create)
	echo JHtml::_('lsc04icon.create', $this->params);
?>
