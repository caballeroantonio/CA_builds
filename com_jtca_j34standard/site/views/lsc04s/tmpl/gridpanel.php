...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'EXPEDIENTE PRINCIPAL',
        'FIELD_CODE_NAME' => 'field137',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD137
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL EXPEDIENTE PRINCIPAL

                FIELD_NAME_LATEX=EXPEDIENTE PRINCIPAL
                FIELD_CODE_NAME_LATEX=field137
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field137'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MONTO DE LA MULTA',
        'FIELD_CODE_NAME' => 'field139',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD139
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL MONTO DE LA MULTA
    ...
    */
    $fields['field139'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RESOLUCIÓN EN DONDE SE IMPONE',
        'FIELD_CODE_NAME' => 'field140',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD140
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RESOLUCIÓN EN DONDE SE IMPONE

                FIELD_NAME_LATEX=FECHA DE RESOLUCI\'ON EN DONDE SE IMPONE
                FIELD_CODE_NAME_LATEX=field140
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field140'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (isMoral)',
        'FIELD_CODE_NAME' => 'field141_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD141_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (isMoral)
    ...
    */
    $fields['field141_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (paterno)',
        'FIELD_CODE_NAME' => 'field141_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD141_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (paterno)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA A QUI\'EN SE DECRETA (paterno)
                FIELD_CODE_NAME_LATEX=field141\_paterno
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field141_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (materno)',
        'FIELD_CODE_NAME' => 'field141_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD141_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (materno)
    ...
    */
    $fields['field141_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (nombre)',
        'FIELD_CODE_NAME' => 'field141_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD141_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA A QUIÉN SE DECRETA (nombre)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA A QUI\'EN SE DECRETA (nombre)
                FIELD_CODE_NAME_LATEX=field141\_nombre
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field141_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DEL OFICIO',
        'FIELD_CODE_NAME' => 'field142',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD142
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DEL OFICIO
    ...
    */
    $fields['field142'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL OFICIO',
        'FIELD_CODE_NAME' => 'field250',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD250
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL OFICIO
    ...
    */
    $fields['field250'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'OBSERVACIONES',
        'FIELD_CODE_NAME' => 'field143',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 4,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD143
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsc04_save_history'))
{
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsc04form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
