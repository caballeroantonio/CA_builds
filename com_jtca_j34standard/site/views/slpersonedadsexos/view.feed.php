...
class JtcaViewSlpersonedadsexos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slpersonedadsexos');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slpersonedadsexo slug
			$row->slug = $row->id;

			// url link to slpersonedadsexo
			$link = JRoute::_(JtcaHelperRoute::getSlpersonedadsexoRoute($row->slug, 
																						'default',								
