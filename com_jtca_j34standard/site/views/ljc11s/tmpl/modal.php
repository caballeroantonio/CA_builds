...
$function	= $app->input->get('function', 'jSelectLjc11');
 ...
 */
?>
<div class="ljc11s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC11S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc11s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc11_add_link', 1) AND $can_create)
	echo JHtml::_('ljc11icon.create', $this->params);
?>
