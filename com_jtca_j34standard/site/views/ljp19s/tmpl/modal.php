...
$function	= $app->input->get('function', 'jSelectLjp19');
 ...
 */
?>
<div class="ljp19s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP19S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp19s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp19_add_link', 1) AND $can_create)
	echo JHtml::_('ljp19icon.create', $this->params);
?>
