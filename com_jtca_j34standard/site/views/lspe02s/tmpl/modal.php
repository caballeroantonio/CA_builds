...
$function	= $app->input->get('function', 'jSelectLspe02');
 ...
 */
?>
<div class="lspe02s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPE02S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lspe02s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lspe02_add_link', 1) AND $can_create)
	echo JHtml::_('lspe02icon.create', $this->params);
?>
