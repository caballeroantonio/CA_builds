...
$function	= $app->input->get('function', 'jSelectLjpdng10');
 ...
 */
?>
<div class="ljpdng10s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPDNG10S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng10s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpdng10_add_link', 1) AND $can_create)
	echo JHtml::_('ljpdng10icon.create', $this->params);
?>
