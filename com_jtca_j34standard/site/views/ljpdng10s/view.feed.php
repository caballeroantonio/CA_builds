...
class JtCaViewLjpdng10s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng10s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng10 slug
			$row->slug = $row->id;

			// url link to ljpdng10
			$link = JRoute::_(JtCaHelperRoute::getLjpdng10Route($row->slug, 
																						'default',								
