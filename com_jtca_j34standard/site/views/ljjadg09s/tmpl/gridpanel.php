...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' DESTINATARIO (isMoral)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL DESTINATARIO (paterno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DESTINATARIO (materno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DESTINATARIO (nombre)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE CÉDULA(S)

                FIELD_NAME_LATEX=No. DE C\'EDULA(S)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL DEL ACTUARIO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO POR DILIGENCIAR
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA DILIGENCIA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA DEVOLUCIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FIRMA DE QUIEN RECIBE LA DEVOLUCION DE LA CEDULA',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL FIRMA DE QUIEN RECIBE LA DEVOLUCION DE LA CEDULA

                FIELD_NAME_LATEX=FIRMA DE QUIEN RECIBE LA DEVOLUCION DE LA CEDULA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'HUELLA DE QUIEN RECIBE LA DEVOLUCION DE LA CEDULA',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL HUELLA DE QUIEN RECIBE LA DEVOLUCION DE LA CEDULA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljjadg09_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadg09Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadg09form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
