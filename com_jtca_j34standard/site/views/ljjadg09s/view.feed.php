...
class JtCaViewLjjadg09s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg09s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg09 slug
			$row->slug = $row->id;

			// url link to ljjadg09
			$link = JRoute::_(JtCaHelperRoute::getLjjadg09Route($row->slug, 
																						'default',								
