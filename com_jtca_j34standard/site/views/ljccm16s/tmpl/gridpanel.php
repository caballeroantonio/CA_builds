...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL No. Y DESCRIPCIÓN DE LOS EXPEDIENTES
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA ULTIMA ACTUACIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA ULTIMA ACTUACIÓN

                FIELD_NAME_LATEX=FECHA DE LA ULTIMA ACTUACI\'ON
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN DEL ARCHIVO JUDICIAL
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljccm16Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljccm16form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE REMISIÓN DE EXPEDIENTES AL ARCHIVO',
