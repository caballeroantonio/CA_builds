...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL JUZGADO DE ORIGEN
    ...
    */
    ...
    $field = array(
        'FIELD_NAME' => 'PETICIÓN',
        'FIELD_CODE_NAME' => 'txt_field1198',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD1198
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PETICIÓN
    ...
    */
    $fields['txt_field1198'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PETICIÓN',
        'FIELD_CODE_NAME' => 'id_field1198',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD1198
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL PETICIÓN
    ...
    */
    $fields['id_field1198'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'RESOLUCIÓN',
        'FIELD_CODE_NAME' => 'txt_field1199',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD1199
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL RESOLUCIÓN
    ...
    */
    $fields['txt_field1199'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'RESOLUCIÓN',
        'FIELD_CODE_NAME' => 'id_field1199',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD1199
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL RESOLUCIÓN
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes01Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes01form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
