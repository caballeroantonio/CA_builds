...
class JtcaViewLjpdng13s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng13s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng13 slug
			$row->slug = $row->id;

			// url link to ljpdng13
			$link = JRoute::_(JtcaHelperRoute::getLjpdng13Route($row->slug, 
																						'default',								
