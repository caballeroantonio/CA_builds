...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA RESOLUCIÓN QUE LA ORDENA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA RESOLUCIÓN QUE LA ORDENA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA QUE SE LE IMPUSO (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DE LA PERSONA QUE SE LE IMPUSO (isMoral)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA QUE SE LE IMPUSO (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA QUE SE LE IMPUSO (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DE LA PERSONA QUE SE LE IMPUSO (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA QUE SE LE IMPUSO (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA QUE SE LE IMPUSO (materno)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA QUE SE LE IMPUSO (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA QUE SE LE IMPUSO (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA QUE SE LE IMPUSO (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCION DEL OFICIO POR EL QUE SE COMUNICA LA SANCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCION DEL OFICIO POR EL QUE SE COMUNICA LA SANCIÓN

                FIELD_NAME_LATEX=FECHA DE RECEPCION DEL OFICIO POR EL QUE SE COMUNICA LA SANCI\'ON
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL Expediente extinto

                FIELD_NAME_LATEX=Expediente extinto
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpdng13_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng13Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng13form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
