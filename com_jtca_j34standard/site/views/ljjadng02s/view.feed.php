...
class JtcaViewLjjadng02s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng02s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng02 slug
			$row->slug = $row->id;

			// url link to ljjadng02
			$link = JRoute::_(JtcaHelperRoute::getLjjadng02Route($row->slug, 
																						'default',								
