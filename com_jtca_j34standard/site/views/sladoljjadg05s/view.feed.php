...
class JtcaViewSladolJjadg05s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sladol_jjadg05s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sladoljjadg05 slug
			$row->slug = $row->id;

			// url link to sladoljjadg05
			$link = JRoute::_(JtcaHelperRoute::getSladolJjadg05Route($row->slug, 
																						'default',								
