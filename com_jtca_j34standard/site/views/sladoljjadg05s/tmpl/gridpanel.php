...
function getFields(){
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'sfield1_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' ADOLESCENTE (isMoral)
    ...
    */
    $fields['sfield1_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ADOLESCENTE (paterno)',
        'FIELD_CODE_NAME' => 'sfield1_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL ADOLESCENTE (paterno)
    ...
    */
    $fields['sfield1_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ADOLESCENTE (materno)',
        'FIELD_CODE_NAME' => 'sfield1_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL ADOLESCENTE (materno)
    ...
    */
    $fields['sfield1_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ADOLESCENTE (nombre)',
        'FIELD_CODE_NAME' => 'sfield1_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL ADOLESCENTE (nombre)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CONDUCTA TIPIFICADA COMO DELITO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE AUDIENCIA DE VISTA O CONCLUSIONES VERBALES
    ...
    */
    $fields['sfield2'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No DE FOJAS',
        'FIELD_CODE_NAME' => 'sfield3',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 22,
    );
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL No DE FOJAS
    ...
    */
    $fields['sfield3'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE TURNO AL PROYECTISTA',
        'FIELD_CODE_NAME' => 'sfield4',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE TURNO AL PROYECTISTA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL SENTIDO DE LA RESOLUCIÓN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL MEDIDA PRINCIPAL
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL MEDIDA ALTERNA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL AÑOS
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL MESES
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL DIAS
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('sladoljjadg05_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('SladolJjadg05Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=sladoljjadg05form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'ADOLESCENTES Del LIBRO DE SENTENCIAS',
