...
$function	= $app->input->get('function', 'jSelectSladolJjadg05');
 ...
 */
?>
<div class="sladol_jjadg05s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLADOL_JJADG05S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sladol_jjadg05s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="sladol_jjadg05s">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLADOL_JJADG05S_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLADOL_JJADG05S_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_sladoljjadg05_add_link', 1) AND $can_create)
	echo JHtml::_('sladoljjadg05icon.create', $this->params);
?>
