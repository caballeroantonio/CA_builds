...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOTIVO DE INGRESO DE BILLETE',
        'FIELD_CODE_NAME' => 'field2334',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2334
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL MOTIVO DE INGRESO DE BILLETE
    ...
    */
    $fields['field2334'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE INGRESO DE BILLETE',
        'FIELD_CODE_NAME' => 'field2335',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2335
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE INGRESO DE BILLETE

                FIELD_NAME_LATEX=FECHA DE INGRESO DE BILLETE
                FIELD_CODE_NAME_LATEX=field2335
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2335'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE EXPEDICIÓN DE BILLETE',
        'FIELD_CODE_NAME' => 'field2336',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2336
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE EXPEDICIÓN DE BILLETE 
    ...
    */
    $fields['field2336'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'IMPORTE',
        'FIELD_CODE_NAME' => 'field2337',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 37,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2337
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2337'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE EGRESO DE BILLETE',
        'FIELD_CODE_NAME' => 'field2338',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2338
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE EGRESO DE BILLETE
    ...
    */
    $fields['field2338'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOTIVO DE EGRESO DE BILLETE',
        'FIELD_CODE_NAME' => 'field2339',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2339
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL MOTIVO DE EGRESO DE BILLETE

                FIELD_NAME_LATEX=MOTIVO DE EGRESO DE BILLETE
                FIELD_CODE_NAME_LATEX=field2339
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2339'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA QUE RECIBE (isMoral)',
        'FIELD_CODE_NAME' => 'field2340_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2340_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' PERSONA QUE RECIBE (isMoral)
    ...
    */
    $fields['field2340_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA QUE RECIBE (paterno)',
        'FIELD_CODE_NAME' => 'field2340_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2340_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PERSONA QUE RECIBE (paterno)

                FIELD_NAME_LATEX=PERSONA QUE RECIBE (paterno)
                FIELD_CODE_NAME_LATEX=field2340\_paterno
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2340_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA QUE RECIBE (materno)',
        'FIELD_CODE_NAME' => 'field2340_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2340_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PERSONA QUE RECIBE (materno)
    ...
    */
    $fields['field2340_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA QUE RECIBE (nombre)',
        'FIELD_CODE_NAME' => 'field2340_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2340_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PERSONA QUE RECIBE (nombre)

                FIELD_NAME_LATEX=PERSONA QUE RECIBE (nombre)
                FIELD_CODE_NAME_LATEX=field2340\_nombre
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2340_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FIRMA DE QUIEN RECIBE',
        'FIELD_CODE_NAME' => 'field2341',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 34,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2341
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2341'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'OBSERVACIONES',
        'FIELD_CODE_NAME' => 'field2342',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 4,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2342
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lspe08_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lspe08Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lspe08form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE INGRESO Y EGRESO DE BILLETES',
