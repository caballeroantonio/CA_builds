...
$function	= $app->input->get('function', 'jSelectLjomf08');
 ...
 */
?>
<div class="ljomf08s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOMF08S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf08s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljomf08_add_link', 1) AND $can_create)
	echo JHtml::_('ljomf08icon.create', $this->params);
?>
