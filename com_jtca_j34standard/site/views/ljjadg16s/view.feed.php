...
class JtCaViewLjjadg16s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg16s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg16 slug
			$row->slug = $row->id;

			// url link to ljjadg16
			$link = JRoute::_(JtCaHelperRoute::getLjjadg16Route($row->slug, 
																						'default',								
