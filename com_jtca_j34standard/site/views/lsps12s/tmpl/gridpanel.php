...
function getFields(){
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'field2441',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 36,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2441
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2441'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROMOVENTE (isMoral)',
        'FIELD_CODE_NAME' => 'field2442_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2442_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' PROMOVENTE (isMoral)
    ...
    */
    $fields['field2442_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROMOVENTE (paterno)',
        'FIELD_CODE_NAME' => 'field2442_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2442_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PROMOVENTE (paterno)

                FIELD_NAME_LATEX=PROMOVENTE (paterno)
                FIELD_CODE_NAME_LATEX=field2442\_paterno
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2442_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROMOVENTE (materno)',
        'FIELD_CODE_NAME' => 'field2442_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2442_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PROMOVENTE (materno)
    ...
    */
    $fields['field2442_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROMOVENTE (nombre)',
        'FIELD_CODE_NAME' => 'field2442_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2442_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PROMOVENTE (nombre)

                FIELD_NAME_LATEX=PROMOVENTE (nombre)
                FIELD_CODE_NAME_LATEX=field2442\_nombre
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2442_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ASUNTO',
        'FIELD_CODE_NAME' => 'field2443',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2443
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsps12_save_history'))
{
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsps12form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
