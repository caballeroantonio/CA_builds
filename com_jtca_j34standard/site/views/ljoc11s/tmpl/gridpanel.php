...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DE LA PERSONA  A QUE SE LE IMPUSO (isMoral)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DE LA PERSONA  A QUE SE LE IMPUSO (paterno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA  A QUE SE LE IMPUSO (materno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA  A QUE SE LE IMPUSO (nombre)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DEL FORMATO Y/O EXHORTO EN QUE SE COMUNICA A LA AUTORIDAD
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL OFICIO Y/O EXHORTO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE PRESENTACIÓN DE FORMATO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljoc11Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljoc11form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
