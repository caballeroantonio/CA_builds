...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE PEDIMENTO

                FIELD_NAME_LATEX=FECHA DE PEDIMENTO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CENTRO DE RECLUSIÓN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL CENTRO DE RECLUSIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CAUSA O MOTIVO DEL PEDIMENTO',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL CAUSA O MOTIVO DEL PEDIMENTO

                FIELD_NAME_LATEX=CAUSA O MOTIVO DEL PEDIMENTO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE PRESENTACIÓN DEL O LOS SENTENCIADOS',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE PRESENTACIÓN DEL O LOS SENTENCIADOS

                FIELD_NAME_LATEX=FECHA DE PRESENTACI\'ON DEL O LOS SENTENCIADOS
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes08Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes08form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
