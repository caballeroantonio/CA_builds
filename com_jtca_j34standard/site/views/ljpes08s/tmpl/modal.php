...
$function	= $app->input->get('function', 'jSelectLjpes08');
 ...
 */
?>
<div class="ljpes08s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPES08S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpes08s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpes08_add_link', 1) AND $can_create)
	echo JHtml::_('ljpes08icon.create', $this->params);
?>
