...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL ADOLESCENTE

                FIELD_NAME_LATEX=ADOLESCENTE
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CONDUCTA TÍFICADA COMO DELITO',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL CONDUCTA TÍFICADA COMO DELITO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE INGRESO AL ARCHIVO JUDICIAL',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE INGRESO AL ARCHIVO JUDICIAL
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL MOTIVO DE LA REMISIÓN AL ARCHIVO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL FOLIO DE DEVOLUCIÓN
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadng11form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
