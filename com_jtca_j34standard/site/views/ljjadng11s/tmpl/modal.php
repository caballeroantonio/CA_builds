...
$function	= $app->input->get('function', 'jSelectLjjadng11');
 ...
 */
?>
<div class="ljjadng11s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJJADNG11S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadng11s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljjadng11_add_link', 1) AND $can_create)
	echo JHtml::_('ljjadng11icon.create', $this->params);
?>
