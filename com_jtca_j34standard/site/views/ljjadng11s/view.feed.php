...
class JtCaViewLjjadng11s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng11s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng11 slug
			$row->slug = $row->id;

			// url link to ljjadng11
			$link = JRoute::_(JtCaHelperRoute::getLjjadng11Route($row->slug, 
																						'default',								
