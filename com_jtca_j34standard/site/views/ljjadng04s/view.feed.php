...
class JtcaViewLjjadng04s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng04s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng04 slug
			$row->slug = $row->id;

			// url link to ljjadng04
			$link = JRoute::_(JtcaHelperRoute::getLjjadng04Route($row->slug, 
																						'default',								
