...
<div class="jtca lcp19s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_lcp19_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_lcp19_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_organo1',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp19_field9',0)) : ?>
