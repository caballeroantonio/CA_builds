...
$function	= $app->input->get('function', 'jSelectLjoc12');
 ...
 */
?>
<div class="ljoc12s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOC12S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljoc12s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljoc12_add_link', 1) AND $can_create)
	echo JHtml::_('ljoc12icon.create', $this->params);
?>
