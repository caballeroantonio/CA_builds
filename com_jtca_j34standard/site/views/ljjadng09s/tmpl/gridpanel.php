...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA A QUIEN SE DIRIGE LA CÉDULA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PERSONA A QUIEN SE DIRIGE LA CÉDULA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DE ENTREGA AL ACTUARIO',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL DE ENTREGA AL ACTUARIO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadng09Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadng09form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
