...
$function	= $app->input->get('function', 'jSelectLjjadng09');
 ...
 */
?>
<div class="ljjadng09s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJJADNG09S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadng09s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljjadng09_add_link', 1) AND $can_create)
	echo JHtml::_('ljjadng09icon.create', $this->params);
?>
