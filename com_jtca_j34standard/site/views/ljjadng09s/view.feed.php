...
class JtCaViewLjjadng09s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng09s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng09 slug
			$row->slug = $row->id;

			// url link to ljjadng09
			$link = JRoute::_(JtCaHelperRoute::getLjjadng09Route($row->slug, 
																						'default',								
