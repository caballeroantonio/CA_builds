...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' TERCERO INTERESADO (isMoral)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL TERCERO INTERESADO (paterno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL TERCERO INTERESADO (materno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL TERCERO INTERESADO (nombre)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SENTIDO DE LA RESOLUCIÓN DE AMPARO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE CUMPLIMIENTO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DATOS DE ENVIO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljoc10_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljoc10Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljoc10form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
