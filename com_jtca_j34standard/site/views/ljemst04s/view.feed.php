...
class JtCaViewLjemst04s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst04s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst04 slug
			$row->slug = $row->id;

			// url link to ljemst04
			$link = JRoute::_(JtCaHelperRoute::getLjemst04Route($row->slug, 
																						'default',								
