...
class JtCaViewLjpdng06s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng06s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng06 slug
			$row->slug = $row->id;

			// url link to ljpdng06
			$link = JRoute::_(JtCaHelperRoute::getLjpdng06Route($row->slug, 
																						'default',								
