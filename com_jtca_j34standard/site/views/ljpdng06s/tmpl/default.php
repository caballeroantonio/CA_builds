...
<div class="jtca ljpdng06s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljpdng06_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljpdng06_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field2',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field3',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field4',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field10',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field12',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field13',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field14',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_field15',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_exp_extinto',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng06_jorigen',0)) : ?>
