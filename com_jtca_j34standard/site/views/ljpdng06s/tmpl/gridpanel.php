...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL RECURRENTES(S)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL RESOLUCIÓN APELADA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE SE IMPUGNA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE IMPUGNA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO ADMISORIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SENTIDO EN QUE SE ADMITE',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SENTIDO EN QUE SE ADMITE

                FIELD_NAME_LATEX=SENTIDO EN QUE SE ADMITE
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN OFICIALIA DE PARTES COMÚN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN OFICIALIA DE PARTES COMÚN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN EN SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN EN SALA

                FIELD_NAME_LATEX=FECHA DE RECEPCI\'ON EN SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No DE SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No DE TOCA

                FIELD_NAME_LATEX=No DE TOCA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN DE LA RESOLUCIÓN DE LA SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN DE LA RESOLUCIÓN DE LA SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SENTIDO EN QUE RESUELVE LA SALA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpdng06_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng06Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng06form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE RECURSOS DE APELACIÓN',
