...
<div class="jtca ljc13s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div style="overflow-x:auto;">
			<table class="table table-striped" id="ljc13s" style="margin-bottom: 200px;">
			<?php if ($this->params->get('show_ljc13_headings',1)) :?>
			<thead>
				<tr>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljc13_id_organo',1)) : ?>
						<th class="list-id_organo" id="tableOrderingid_organo">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_ID_ORGANO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_id_secretaria',1)) : ?>
						<th class="list-id_secretaria" id="tableOrderingid_secretaria">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_ID_SECRETARIA'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_anoj',1)) : ?>
						<th class="list-anoj" id="tableOrderinganoj">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_ANOJ'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_id_expediente',1)) : ?>
						<th class="list-id_expediente" id="tableOrderingid_expediente">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_ID_EXPEDIENTE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field2_isMoral',1)) : ?>
						<th class="list-field2_isMoral" id="tableOrderingfield2_isMoral">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD2_ISMORAL'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field2_paterno',1)) : ?>
						<th class="list-field2_paterno" id="tableOrderingfield2_paterno">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD2_PATERNO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field2_materno',1)) : ?>
						<th class="list-field2_materno" id="tableOrderingfield2_materno">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD2_MATERNO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field2_nombre',1)) : ?>
						<th class="list-field2_nombre" id="tableOrderingfield2_nombre">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD2_NOMBRE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field4',1)) : ?>
						<th class="list-field4" id="tableOrderingfield4">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD4'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field5',1)) : ?>
						<th class="list-field5" id="tableOrderingfield5">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD5'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field6',1)) : ?>
						<th class="list-field6" id="tableOrderingfield6">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD6'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field7',1)) : ?>
						<th class="list-field7" id="tableOrderingfield7">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD7'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljc13_field8',1)) : ?>
						<th class="list-field8" id="tableOrderingfield8">
							<?php echo JTEXT::_('COM_JTCA_LJC13S_HEADING_FIELD8'); ?>
						</th>
					<?php endif; ?>	
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljc13_headings',1)) :
										echo $created_by;
									else :
					...
					<?php if ($this->params->get('list_show_ljc13_id_expediente',1)) : ?>
						<td class="list-id_expediente">
							<?php 
								if ($params->get('list_link_ljc13_id_expediente')) :
					...
					<?php if ($show_actions) : ?>
						<td class="list-actions">
							...
							<?php if ($params->get('show_ljc13_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('ljc13icon.print_popup',  $item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_ljc13_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('ljc13icon.email',  $item, $params); ?>
								</li>
							<?php endif; ?>
								<?php if ($can_edit ) : ?>
                                    <li class="edit-icon">
                                ...
                                <?php endif; ?>
							<?php if ($can_edit AND $params->get('save_history') AND $params->get('ljc13_save_history')) : ?>
								<li class="version-icon">
									<?php echo JHtml::_('ljc13icon.versions',$item, $params); ?>
								</li>	
							<?php endif; ?>	
                                </ul>
                            </div>
...
function show_collapsibleModal(item_id){
	...
	modalBody.prepend('<iframe class="iframe" src="index.php?option=com_jtca&task=ljc13.showHistory&item_id='+item_id+'" name="titulo" height="450"></iframe>');
	return;
}
</script>
