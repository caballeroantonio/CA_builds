	...
	<div style="padding-top: 10px;">
			...
			<?php $dummy = false;
					$display_fieldset = (
								...
								($params->get('show_lsc07_field168')) OR 
			...
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						...
						<?php endif; ?>
						<?php if ($params->get('show_lsc07_field168')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LSC07S_FIELD_FIELD168_LABEL'); ?>
							</label>
							<span>
								<?php
									echo $this->item->field168 != '' ? $this->item->field168 : $empty;
								?>
							</span>
						</div>	
						<?php endif; ?>
