...
$function	= $app->input->get('function', 'jSelectLjf08');
 ...
 */
?>
<div class="ljf08s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF08S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf08s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf08_add_link', 1) AND $can_create)
	echo JHtml::_('ljf08icon.create', $this->params);
?>
