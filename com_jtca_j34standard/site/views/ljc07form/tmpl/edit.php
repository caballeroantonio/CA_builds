...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc07_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc07_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC07S_FIELDSET_JC07_FS_LABEL');?></a></li>
