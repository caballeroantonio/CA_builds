...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL SENTENCIADO

                FIELD_NAME_LATEX=SENTENCIADO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL APELANTE

                FIELD_NAME_LATEX=APELANTE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL AUTO ADMISORIO

                FIELD_NAME_LATEX=AUTO ADMISORIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'OFICIO DE REMISIÓN A LA SALA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL OFICIO DE REMISIÓN A LA SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL TOCA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL SALA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RESOLUCIÓN A LA SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RESOLUCIÓN A LA SALA

                FIELD_NAME_LATEX=FECHA DE RESOLUCI\'ON A LA SALA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes03_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes03Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes03form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
