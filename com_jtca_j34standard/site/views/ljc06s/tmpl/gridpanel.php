...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE INTERPUSO LA APELACIN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RESOLUCIN  APELADA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL EFECTOS
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE CONTESTACIN DE AGRAVIOS O REBELDA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE REMISIN A  LA SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No DE OFICIO DE REMISIN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIN DE LA SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL PREVENTIVA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIN
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljc06Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljc06form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
