...
$function	= $app->input->get('function', 'jSelectLjc06');
 ...
 */
?>
<div class="ljc06s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC06S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc06s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc06_add_link', 1) AND $can_create)
	echo JHtml::_('ljc06icon.create', $this->params);
?>
