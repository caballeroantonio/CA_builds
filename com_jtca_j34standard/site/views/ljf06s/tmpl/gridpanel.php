...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL RECURRENTE

                FIELD_NAME_LATEX=RECURRENTE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE INTERPUSO LA APELACIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA RESOLUCIÓN APELADA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA RESOLUCIÓN APELADA

                FIELD_NAME_LATEX=FECHA RESOLUCI\'ON APELADA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'TIPO DE RESOLUCIÓN APELADA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL TIPO DE RESOLUCIÓN APELADA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'EFECTO EN QUE SE ADMITE',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL EFECTO EN QUE SE ADMITE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE CONTESTACIÓN DE AGRAVIOS O REBELDÍA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SALA A LA QUE SE TURNÓ EL RECURSO',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL SALA A LA QUE SE TURNÓ EL RECURSO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL OFICIO A LA SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL OFICIO A LA SALA

                FIELD_NAME_LATEX=FECHA DEL OFICIO A LA SALA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NUM. DEL OFICIO A LA SALA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NUM. DEL OFICIO A LA SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE REMISIÓN A LA SALA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE RECEPCIÓN EN LA SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE RECEPCIÓN EN LA SALA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljf06_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf06Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf06form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
