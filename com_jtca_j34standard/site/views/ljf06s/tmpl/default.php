...
<div class="jtca ljf06s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljf06_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljf06_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field16',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field15',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field18',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field17',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field10',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field12',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field13',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf06_field14',0)) : ?>
