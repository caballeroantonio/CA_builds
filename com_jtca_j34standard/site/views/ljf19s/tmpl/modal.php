...
$function	= $app->input->get('function', 'jSelectLjf19');
 ...
 */
?>
<div class="ljf19s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF19S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf19s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf19_add_link', 1) AND $can_create)
	echo JHtml::_('ljf19icon.create', $this->params);
?>
