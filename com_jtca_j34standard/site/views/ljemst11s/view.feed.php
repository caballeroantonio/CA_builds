...
class JtCaViewLjemst11s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst11s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst11 slug
			$row->slug = $row->id;

			// url link to ljemst11
			$link = JRoute::_(JtCaHelperRoute::getLjemst11Route($row->slug, 
																						'default',								
