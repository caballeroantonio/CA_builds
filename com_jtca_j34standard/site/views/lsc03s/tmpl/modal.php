...
$function	= $app->input->get('function', 'jSelectLsc03');
 ...
 */
?>
<div class="lsc03s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSC03S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsc03s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsc03_add_link', 1) AND $can_create)
	echo JHtml::_('lsc03icon.create', $this->params);
?>
