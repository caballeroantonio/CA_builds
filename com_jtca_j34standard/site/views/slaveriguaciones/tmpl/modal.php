...
$function	= $app->input->get('function', 'jSelectSlaveriguacion');
 ...
 */
?>
<div class="slaveriguaciones-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLAVERIGUACIONES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slaveriguaciones&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slaveriguaciones">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLAVERIGUACIONES_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLAVERIGUACIONES_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slaveriguacion_add_link', 1) AND $can_create)
	echo JHtml::_('slaveriguacionicon.create', $this->params);
?>
