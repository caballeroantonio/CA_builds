...
class JtcaViewSlaveriguaciones extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slaveriguaciones');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slaveriguacion slug
			$row->slug = $row->id;

			// url link to slaveriguacion
			$link = JRoute::_(JtcaHelperRoute::getSlaveriguacionRoute($row->slug, 
																						'default',								
