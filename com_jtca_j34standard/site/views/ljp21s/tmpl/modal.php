...
$function	= $app->input->get('function', 'jSelectLjp21');
 ...
 */
?>
<div class="ljp21s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP21S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp21s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp21_add_link', 1) AND $can_create)
	echo JHtml::_('ljp21icon.create', $this->params);
?>
