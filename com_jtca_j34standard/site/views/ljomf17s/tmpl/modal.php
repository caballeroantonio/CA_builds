...
$function	= $app->input->get('function', 'jSelectLjomf17');
 ...
 */
?>
<div class="ljomf17s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOMF17S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf17s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljomf17_add_link', 1) AND $can_create)
	echo JHtml::_('ljomf17icon.create', $this->params);
?>
