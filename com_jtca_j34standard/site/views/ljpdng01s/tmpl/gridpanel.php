...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'AVERIGUACIÓN PREVIA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL AVERIGUACIÓN PREVIA

                FIELD_NAME_LATEX=AVERIGUACI\'ON PREVIA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOTIVO CONSIGNACIÓN',
        'FIELD_CODE_NAME' => 'txt_field975',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD975
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL MOTIVO CONSIGNACIÓN
    ...
    */
    $fields['txt_field975'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOTIVO CONSIGNACIÓN',
        'FIELD_CODE_NAME' => 'id_field975',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD975
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL MOTIVO CONSIGNACIÓN
    ...
    */
    $fields['id_field975'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL AUTO QUE RECAE A LA PETICION MINISTERIAL',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL AUTO QUE RECAE A LA PETICION MINISTERIAL
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'EXTINCION DE LA PRETENSION PUNITIVA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL EXTINCION DE LA PRETENSION PUNITIVA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpdng01_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng01Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng01form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
