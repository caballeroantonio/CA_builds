...
class JtCaViewLjpdng01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng01 slug
			$row->slug = $row->id;

			// url link to ljpdng01
			$link = JRoute::_(JtCaHelperRoute::getLjpdng01Route($row->slug, 
																						'default',								
