...
class JtCaViewLjemst08s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst08s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst08 slug
			$row->slug = $row->id;

			// url link to ljemst08
			$link = JRoute::_(JtCaHelperRoute::getLjemst08Route($row->slug, 
																						'default',								
