...
$function	= $app->input->get('function', 'jSelectLjc19');
 ...
 */
?>
<div class="ljc19s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC19S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc19s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc19_add_link', 1) AND $can_create)
	echo JHtml::_('ljc19icon.create', $this->params);
?>
