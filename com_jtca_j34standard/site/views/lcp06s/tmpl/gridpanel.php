...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CONDUCTA CONSIDERADA COMO DELICTIVA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CONDUCTA CONSIDERADA COMO DELICTIVA

                FIELD_NAME_LATEX=CONDUCTA CONSIDERADA COMO DELICTIVA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'JUZGADO INCOMPETENTE',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL JUZGADO INCOMPETENTE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL SITUACION LEGAL

                FIELD_NAME_LATEX=SITUACION LEGAL
    ...
    */
    ...
    $field = array(
        'FIELD_NAME' => 'JUZGADO',
        'FIELD_CODE_NAME' => 'organo2',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 38,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ORGANO2
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA Y HORA DE ENTREGA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA Y HORA DE ENTREGA

                FIELD_NAME_LATEX=FECHA Y HORA DE ENTREGA
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lcp06Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lcp06form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE TURNO PARA INCOMPETENCIAS ADOLESCENTES',
