...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROCESADO 0 SENTENCIADO (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' PROCESADO 0 SENTENCIADO (isMoral)

                FIELD_NAME_LATEX=PROCESADO 0 SENTENCIADO (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROCESADO 0 SENTENCIADO (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PROCESADO 0 SENTENCIADO (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROCESADO 0 SENTENCIADO (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PROCESADO 0 SENTENCIADO (materno)

                FIELD_NAME_LATEX=PROCESADO 0 SENTENCIADO (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PROCESADO 0 SENTENCIADO (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PROCESADO 0 SENTENCIADO (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA Y HORA DE LA DILIGENCIA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA Y HORA DE LA DILIGENCIA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOTIVO DE LA SOLICITUD',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL MOTIVO DE LA SOLICITUD
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljp17_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljp17Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljp17form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE CONTROL DE PEDIMENTOS',
