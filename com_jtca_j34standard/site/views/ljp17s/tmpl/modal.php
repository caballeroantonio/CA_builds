...
$function	= $app->input->get('function', 'jSelectLjp17');
 ...
 */
?>
<div class="ljp17s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP17S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp17s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp17_add_link', 1) AND $can_create)
	echo JHtml::_('ljp17icon.create', $this->params);
?>
