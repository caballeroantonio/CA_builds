...
$function	= $app->input->get('function', 'jSelectLcp35');
 ...
 */
?>
<div class="lcp35s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LCP35S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp35s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lcp35_add_link', 1) AND $can_create)
	echo JHtml::_('lcp35icon.create', $this->params);
?>
