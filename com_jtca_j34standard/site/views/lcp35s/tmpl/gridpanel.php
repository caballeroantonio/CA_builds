...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL SALA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL TOCA PENAL

                FIELD_NAME_LATEX=TOCA PENAL
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE ADOLESCENTES',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE ADOLESCENTES
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lcp35form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRETA DE LIBERTADES DE SALAS DE ADOLESCENTES',
