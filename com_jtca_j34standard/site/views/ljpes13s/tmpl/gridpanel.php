...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PENA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SENTIDO DE RESOLUCION',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL SENTIDO DE RESOLUCION

                FIELD_NAME_LATEX=SENTIDO DE RESOLUCION
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes13Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes13form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE RESOLUCIONES EN AUDIENCIA',
