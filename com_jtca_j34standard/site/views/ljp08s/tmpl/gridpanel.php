...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE PARTIDA DEL JUZGADO DE ORIGEN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE PARTIDA DEL JUZGADO DE ORIGEN

                FIELD_NAME_LATEX=N\'UMERO DE PARTIDA DEL JUZGADO DE ORIGEN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE PARTIDA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL AUTORIDAD EXHORTANTE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DILIGENCIA ENCOMENDADA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL DESPACHO
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'txt_field1975',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD1975
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL SE CUMPLIMENTÓ
    ...
    */
    $fields['txt_field1975'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'SE CUMPLIMENTÓ',
        'FIELD_CODE_NAME' => 'id_field1975',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD1975
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL SE CUMPLIMENTÓ
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE OFICIO DE DEVOLUCIÓN
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljp08_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljp08Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljp08form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
