...
class JtCaViewLjpdng04s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng04s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng04 slug
			$row->slug = $row->id;

			// url link to ljpdng04
			$link = JRoute::_(JtCaHelperRoute::getLjpdng04Route($row->slug, 
																						'default',								
