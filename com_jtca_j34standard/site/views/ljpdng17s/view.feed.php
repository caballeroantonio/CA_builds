...
class JtcaViewLjpdng17s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng17s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng17 slug
			$row->slug = $row->id;

			// url link to ljpdng17
			$link = JRoute::_(JtcaHelperRoute::getLjpdng17Route($row->slug, 
																						'default',								
