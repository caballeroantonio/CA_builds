...
class JtcaViewSlofenJpdng01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slofen_jpdng01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slofenjpdng01 slug
			$row->slug = $row->id;

			// url link to slofenjpdng01
			$link = JRoute::_(JtcaHelperRoute::getSlofenJpdng01Route($row->slug, 
																						'default',								
