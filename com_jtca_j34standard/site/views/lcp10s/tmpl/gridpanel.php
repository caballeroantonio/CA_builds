...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'LUGAR DE INTERNAMIENTO ACTUAL',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL LUGAR DE INTERNAMIENTO ACTUAL

                FIELD_NAME_LATEX=LUGAR DE INTERNAMIENTO ACTUAL
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lcp10Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lcp10form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE TURNO DE BENEFICIOS PENITENCIARIOS.',
