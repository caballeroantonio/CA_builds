...
class JtcaViewSlpersondelitos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slpersondelitos');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slpersondelito slug
			$row->slug = $row->id;

			// url link to slpersondelito
			$link = JRoute::_(JtcaHelperRoute::getSlpersondelitoRoute($row->slug, 
																						'default',								
