...
$function	= $app->input->get('function', 'jSelectSlpersondelito');
 ...
 */
?>
<div class="slpersondelitos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLPERSONDELITOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersondelitos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slpersondelitos">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLPERSONDELITOS_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLPERSONDELITOS_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slpersondelito_add_link', 1) AND $can_create)
	echo JHtml::_('slpersondelitoicon.create', $this->params);
?>
