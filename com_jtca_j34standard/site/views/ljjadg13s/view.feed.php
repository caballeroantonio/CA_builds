...
class JtcaViewLjjadg13s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg13s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg13 slug
			$row->slug = $row->id;

			// url link to ljjadg13
			$link = JRoute::_(JtcaHelperRoute::getLjjadg13Route($row->slug, 
																						'default',								
