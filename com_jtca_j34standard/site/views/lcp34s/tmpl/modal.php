...
$function	= $app->input->get('function', 'jSelectLcp34');
 ...
 */
?>
<div class="lcp34s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LCP34S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp34s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lcp34_add_link', 1) AND $can_create)
	echo JHtml::_('lcp34icon.create', $this->params);
?>
