...
class JtcaViewSldilJccm09s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sldil_jccm09s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sldiljccm09 slug
			$row->slug = $row->id;

			// url link to sldiljccm09
			$link = JRoute::_(JtcaHelperRoute::getSldilJccm09Route($row->slug, 
																						'default',								
