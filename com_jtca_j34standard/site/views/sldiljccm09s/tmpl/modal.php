 ...
 */
?>
<div class="sldil_jccm09s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLDIL_JCCM09S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldil_jccm09s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_sldiljccm09_add_link', 1) AND $can_create)
	echo JHtml::_('sldiljccm09icon.create', $this->params);
?>
