...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE CÉDULA
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'sfield8_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' PERSONA A NOTIFICAR (isMoral)
    ...
    */
    $fields['sfield8_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA A NOTIFICAR (paterno)',
        'FIELD_CODE_NAME' => 'sfield8_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL PERSONA A NOTIFICAR (paterno)
    ...
    */
    $fields['sfield8_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA A NOTIFICAR (materno)',
        'FIELD_CODE_NAME' => 'sfield8_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PERSONA A NOTIFICAR (materno)
    ...
    */
    $fields['sfield8_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'PERSONA A NOTIFICAR (nombre)',
        'FIELD_CODE_NAME' => 'sfield8_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL PERSONA A NOTIFICAR (nombre)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL LUGAR DONDE DEBE ACTUARSE
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('sldiljccm09_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('SldilJccm09Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=sldiljccm09form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
