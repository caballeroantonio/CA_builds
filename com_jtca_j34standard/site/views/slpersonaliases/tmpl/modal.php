...
$function	= $app->input->get('function', 'jSelectSlpersonalias');
 ...
 */
?>
<div class="slpersonaliases-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLPERSONALIASES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersonaliases&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slpersonaliases">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLPERSONALIASES_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLPERSONALIASES_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slpersonalias_add_link', 1) AND $can_create)
	echo JHtml::_('slpersonaliasicon.create', $this->params);
?>
