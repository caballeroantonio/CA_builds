...
class JtcaViewSlpersonaliases extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slpersonaliases');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slpersonalias slug
			$row->slug = $row->id;

			// url link to slpersonalias
			$link = JRoute::_(JtcaHelperRoute::getSlpersonaliasRoute($row->slug, 
																						'default',								
