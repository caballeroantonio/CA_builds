...
class JtCaViewLjemst12s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst12s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst12 slug
			$row->slug = $row->id;

			// url link to ljemst12
			$link = JRoute::_(JtCaHelperRoute::getLjemst12Route($row->slug, 
																						'default',								
