...
$function	= $app->input->get('function', 'jSelectLspe07');
 ...
 */
?>
<div class="lspe07s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPE07S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lspe07s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lspe07_add_link', 1) AND $can_create)
	echo JHtml::_('lspe07icon.create', $this->params);
?>
