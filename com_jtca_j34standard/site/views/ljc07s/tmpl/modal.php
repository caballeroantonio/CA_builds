...
$function	= $app->input->get('function', 'jSelectLjc07');
 ...
 */
?>
<div class="ljc07s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC07S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc07s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc07_add_link', 1) AND $can_create)
	echo JHtml::_('ljc07icon.create', $this->params);
?>
