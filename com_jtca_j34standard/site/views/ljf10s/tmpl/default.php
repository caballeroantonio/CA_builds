...
<div class="jtca ljf10s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			<table class="table table-striped" id="ljf10s">
			<?php if ($this->params->get('show_ljf10_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljf10_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field13',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field5_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field5_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field5_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field5_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field10',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljf10_field12',0)) : ?>
