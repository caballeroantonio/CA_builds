...
$function	= $app->input->get('function', 'jSelectLjf10');
 ...
 */
?>
<div class="ljf10s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJF10S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljf10s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljf10_add_link', 1) AND $can_create)
	echo JHtml::_('ljf10icon.create', $this->params);
?>
