...
function getFields(){
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'field3_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD3_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field3_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL NOTARIO (paterno)',
        'FIELD_CODE_NAME' => 'field3_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD3_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field3_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL NOTARIO (materno)',
        'FIELD_CODE_NAME' => 'field3_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD3_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field3_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL NOTARIO (nombre)',
        'FIELD_CODE_NAME' => 'field3_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD3_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field3_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DIRECCION Y TELÉFONO',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DIRECCION Y TELÉFONO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CUADERNO

                FIELD_NAME_LATEX=CUADERNO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL FOJAS
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DOCUMENTOS

                FIELD_NAME_LATEX=DOCUMENTOS
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DATOS DE IDENTIFICACIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA AUTORIZADA (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DE LA PERSONA AUTORIZADA (isMoral)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA AUTORIZADA (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA AUTORIZADA (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DE LA PERSONA AUTORIZADA (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA AUTORIZADA (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA AUTORIZADA (materno)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA AUTORIZADA (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA AUTORIZADA (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA AUTORIZADA (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FIRMA DE LA PERSONA AUTORIZADA',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL FIRMA DE LA PERSONA AUTORIZADA

                FIELD_NAME_LATEX=FIRMA DE LA PERSONA AUTORIZADA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'HUELLA DE LA PERSONA AUTORIZADA',
        'FIELD_CODE_NAME' => 'field15h',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 39,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD15H
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL HUELLA DE LA PERSONA AUTORIZADA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN DEL EXPEDIENTE AL JUZGADO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIÓN DEL EXPEDIENTE AL JUZGADO

                FIELD_NAME_LATEX=FECHA DE DEVOLUCI\'ON DEL EXPEDIENTE AL JUZGADO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DE DEVOLUCIÓN DEL EXPEDIENTE AL JUZGADO',
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL DE DEVOLUCIÓN DEL EXPEDIENTE AL JUZGADO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljf11_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf11Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf11form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
