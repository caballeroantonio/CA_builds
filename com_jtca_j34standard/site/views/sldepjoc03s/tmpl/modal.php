 ...
 */
?>
<div class="sldep_joc03s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLDEP_JOC03S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldep_joc03s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_sldepjoc03_add_link', 1) AND $can_create)
	echo JHtml::_('sldepjoc03icon.create', $this->params);
?>
