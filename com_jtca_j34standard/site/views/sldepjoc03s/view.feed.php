...
class JtcaViewSldepJoc03s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sldep_joc03s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sldepjoc03 slug
			$row->slug = $row->id;

			// url link to sldepjoc03
			$link = JRoute::_(JtcaHelperRoute::getSldepJoc03Route($row->slug, 
																						'default',								
