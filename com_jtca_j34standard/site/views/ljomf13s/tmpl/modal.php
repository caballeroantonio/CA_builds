...
$function	= $app->input->get('function', 'jSelectLjomf13');
 ...
 */
?>
<div class="ljomf13s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOMF13S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf13s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljomf13_add_link', 1) AND $can_create)
	echo JHtml::_('ljomf13icon.create', $this->params);
?>
