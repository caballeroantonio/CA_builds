...
class JtCaViewLjemst09s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst09s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst09 slug
			$row->slug = $row->id;

			// url link to ljemst09
			$link = JRoute::_(JtCaHelperRoute::getLjemst09Route($row->slug, 
																						'default',								
