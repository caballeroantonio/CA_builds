...
class JtCaViewLjjadng10s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng10s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng10 slug
			$row->slug = $row->id;

			// url link to ljjadng10
			$link = JRoute::_(JtCaHelperRoute::getLjjadng10Route($row->slug, 
																						'default',								
