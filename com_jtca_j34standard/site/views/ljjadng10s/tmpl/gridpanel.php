...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL ADOLESCENTE (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DEL ADOLESCENTE (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL ADOLESCENTE (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DEL ADOLESCENTE (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL ADOLESCENTE (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DEL ADOLESCENTE (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL ADOLESCENTE (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DEL ADOLESCENTE (nombre)

                FIELD_NAME_LATEX=NOMBRE DEL ADOLESCENTE (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'LUGAR DE INTERNAMIENTO',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL LUGAR DE INTERNAMIENTO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL TIPO DE AUDIENCIA
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadng10Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadng10form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
