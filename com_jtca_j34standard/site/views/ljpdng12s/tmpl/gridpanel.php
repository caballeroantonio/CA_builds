...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE RECIBE LA PÓLIZA DE FIANZA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE RECIBE LA PÓLIZA DE FIANZA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE NOTIFICACIÓN A LA AFIANZADORA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE NOTIFICACIÓN A LA AFIANZADORA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOTIVO POR EL CUAL SE HIZO EFECTIVA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL MOTIVO POR EL CUAL SE HIZO EFECTIVA

                FIELD_NAME_LATEX=MOTIVO POR EL CUAL SE HIZO EFECTIVA
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng12Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng12form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
