...
class JtCaViewLjpdng12s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng12s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng12 slug
			$row->slug = $row->id;

			// url link to ljpdng12
			$link = JRoute::_(JtCaHelperRoute::getLjpdng12Route($row->slug, 
																						'default',								
