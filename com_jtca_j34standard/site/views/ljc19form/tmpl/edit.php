...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc19_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc19_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC19S_FIELDSET_JC19_FS_LABEL');?></a></li>
