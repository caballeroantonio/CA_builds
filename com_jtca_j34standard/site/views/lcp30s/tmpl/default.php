...
<div class="jtca lcp30s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_lcp30_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_lcp30_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_organo1',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field4',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field6_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field6_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field6_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field6_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp30_field9',0)) : ?>
