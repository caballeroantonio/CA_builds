...
class JtcaViewSlinculJpdng01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slincul_jpdng01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slinculjpdng01 slug
			$row->slug = $row->id;

			// url link to slinculjpdng01
			$link = JRoute::_(JtcaHelperRoute::getSlinculJpdng01Route($row->slug, 
																						'default',								
