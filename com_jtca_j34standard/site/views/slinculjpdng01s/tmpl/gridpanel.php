...
function getFields(){
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'sfield3_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
    ...
    */
    $fields['sfield3_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL INCULPADO (paterno)',
        'FIELD_CODE_NAME' => 'sfield3_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
    ...
    */
    $fields['sfield3_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL INCULPADO (materno)',
        'FIELD_CODE_NAME' => 'sfield3_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
    ...
    */
    $fields['sfield3_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DEL INCULPADO (nombre)',
        'FIELD_CODE_NAME' => 'sfield3_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL DETENIDO (SI/NO)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL LUGAR DONDE SE ENCUENTRA
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('SlinculJpdng01Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=slinculjpdng01form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'DATOS DEL(OS) INCULPADO(S) Del LIBRO DE GOBIERNO',
