...
$function	= $app->input->get('function', 'jSelectSlinculJpdng01');
 ...
 */
?>
<div class="slincul_jpdng01s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLINCUL_JPDNG01S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slincul_jpdng01s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slincul_jpdng01s">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLINCUL_JPDNG01S_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLINCUL_JPDNG01S_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slinculjpdng01_add_link', 1) AND $can_create)
	echo JHtml::_('slinculjpdng01icon.create', $this->params);
?>
