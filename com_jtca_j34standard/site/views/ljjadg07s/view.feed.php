...
class JtCaViewLjjadg07s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg07s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg07 slug
			$row->slug = $row->id;

			// url link to ljjadg07
			$link = JRoute::_(JtCaHelperRoute::getLjjadg07Route($row->slug, 
																						'default',								
