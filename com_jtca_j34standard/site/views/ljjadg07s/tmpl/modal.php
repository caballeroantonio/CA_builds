...
$function	= $app->input->get('function', 'jSelectLjjadg07');
 ...
 */
?>
<div class="ljjadg07s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJJADG07S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadg07s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljjadg07_add_link', 1) AND $can_create)
	echo JHtml::_('ljjadg07icon.create', $this->params);
?>
