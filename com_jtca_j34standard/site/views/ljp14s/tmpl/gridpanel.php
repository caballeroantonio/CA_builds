...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (isMoral)',
        'FIELD_CODE_NAME' => 'field4_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD4_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (isMoral)
    ...
    */
    $fields['field4_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (paterno)',
        'FIELD_CODE_NAME' => 'field4_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD4_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (paterno)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (paterno)
                FIELD_CODE_NAME_LATEX=field4\_paterno
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field4_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (materno)',
        'FIELD_CODE_NAME' => 'field4_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD4_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (materno)
    ...
    */
    $fields['field4_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (nombre)',
        'FIELD_CODE_NAME' => 'field4_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD4_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (nombre)

                FIELD_NAME_LATEX=NOMBRE DE LA PERSONA A LA QUE SE LE IMPUSO (nombre)
                FIELD_CODE_NAME_LATEX=field4\_nombre
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field4_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DEL DOCUMENTO EN QUE SE COMUNICA LA SANCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DEL DOCUMENTO EN QUE SE COMUNICA LA SANCIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL DOCUMENTO EN QUE SE COMUNICA LA SANCIÓN',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL DOCUMENTO EN QUE SE COMUNICA LA SANCIÓN

                FIELD_NAME_LATEX=FECHA DEL DOCUMENTO EN QUE SE COMUNICA LA SANCI\'ON
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE ES ENTREGADO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE ES ENTREGADO

                FIELD_NAME_LATEX=FECHA EN QUE ES ENTREGADO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljp14_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljp14Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljp14form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
