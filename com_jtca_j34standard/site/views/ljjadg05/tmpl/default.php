...
<div class="jtca ljjadg05-view<?php echo $params->get('pageclass_sfx')?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<h1>
		<?php echo $this->escape($this->params->get('page_heading')); ?>
	</h1>
	<?php endif; ?>
	<?php if ($params->get('show_ljjadg05_icons',-1) >= 0) : ?>
		<?php if ($params->get('show_ljjadg05_print_icon') 
			OR $params->get('show_ljjadg05_email_icon') 
			OR $can_edit 
			OR $can_delete 
			): ?>
			<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu">
					<?php if (!$this->print) : ?>
							<?php if ($params->get('show_ljjadg05_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('ljjadg05icon.print_popup',  $this->item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_ljjadg05_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('ljjadg05icon.email',  $this->item, $params); ?>
								</li>
							<?php endif; ?>
							<?php if ($can_edit) : ?>
								<li class="edit-icon">
									<?php echo JHtml::_('ljjadg05icon.edit', $this->item, $params); ?>
								</li>
							<?php endif; ?>
							<?php if ($can_delete) : ?>
								<li class="delete-icon">
									<?php echo JHtml::_('ljjadg05icon.delete',$this->item, $params); ?>
								</li>					
							<?php endif; ?>
					<?php else : ?>
						<li>
							<?php echo JHtml::_('ljjadg05icon.print_screen',  $this->item, $params); ?>
						</li>
					<?php endif; ?>
				</ul>
			</div>
	...
	<?php echo $this->item->event->beforeDisplayLjjadg05; ?>
	<div style="clear:both; padding-top: 10px;">

	</div>
	<div style="padding-top: 10px;">

			<form action="" name="ljjadg05Form" id="ljjadg05Form">
			<?php $dummy = false;
					$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_JTCA_LJJADG05S_FIELDSET_LJJADG05_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_ljjadg05_id_organo')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LJJADG05S_FIELD_ID_ORGANO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LJJADG05S_FIELD_ID_SECRETARIA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<?php endif; ?>
						<?php if ($params->get('show_ljjadg05_field10')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_JTCA_LJJADG05S_FIELD_FIELD10_LABEL'); ?>
							</label>
							<span>
								<?php
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_ljjadg05_created_by')) OR
							($params->get('show_ljjadg05_created')) OR
							($params->get('show_ljjadg05_modified')) OR
							($params->get('show_ljjadg05_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php if ($params->get('show_ljjadg05_created_by') ) : ?>
				...
				<div class="formelm">				
					<label>
						...
						<?php if (!empty($this->item->created_by ) AND  $this->params->get('link_ljjadg05_created_by') == 1):?>
							<?php echo JHtml::_(
									'link',
			...
			<?php endif; ?>	
			<?php if ($params->get('show_ljjadg05_created_by_alias')) : ?>
				<div class="formelm">				
					<label>
			...
			<?php endif; ?>				
			<?php if ($params->get('show_ljjadg05_created')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_ljjadg05_modified')) : ?>
				<div class="formelm">
					<label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_ljjadg05_admin')) : ?>
		...
		<?php echo $this->item->event->afterDisplayLjjadg05; ?>
	</div>		
</div>