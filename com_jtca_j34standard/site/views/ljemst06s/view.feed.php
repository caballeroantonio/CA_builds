...
class JtCaViewLjemst06s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst06s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst06 slug
			$row->slug = $row->id;

			// url link to ljemst06
			$link = JRoute::_(JtCaHelperRoute::getLjemst06Route($row->slug, 
																						'default',								
