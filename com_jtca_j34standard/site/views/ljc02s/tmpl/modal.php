...
$function	= $app->input->get('function', 'jSelectLjc02');
 ...
 */
?>
<div class="ljc02s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJC02S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc02s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljc02_add_link', 1) AND $can_create)
	echo JHtml::_('ljc02icon.create', $this->params);
?>
