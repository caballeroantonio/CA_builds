...
<div class="jtca expediente-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					echo JText::sprintf('COM_JTCA_EDIT_ITEM', $this->escape($this->item->name)); 
				else :
					echo JText::_('COM_JTCA_EXPEDIENTES_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=expedienteform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="expediente-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('expediente.save')">
			...
			<?php if (
				  ...
				  AND $params->get('expediente_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_expedientes_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_JTCA_EXPEDIENTES_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-expedientes_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_EXPEDIENTES_FIELDSET_EXPEDIENTES_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="expediente-form" />
