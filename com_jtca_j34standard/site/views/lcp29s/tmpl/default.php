...
<div class="jtca lcp29s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_lcp29_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_lcp29_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_fh_recepcion',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_organo1',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp29_field10',0)) : ?>
