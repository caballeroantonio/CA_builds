...
$function	= $app->input->get('function', 'jSelectLjomf15');
 ...
 */
?>
<div class="ljomf15s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOMF15S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljomf15s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljomf15_add_link', 1) AND $can_create)
	echo JHtml::_('ljomf15icon.create', $this->params);
?>
