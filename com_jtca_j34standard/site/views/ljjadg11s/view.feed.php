...
class JtCaViewLjjadg11s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg11s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg11 slug
			$row->slug = $row->id;

			// url link to ljjadg11
			$link = JRoute::_(JtCaHelperRoute::getLjjadg11Route($row->slug, 
																						'default',								
