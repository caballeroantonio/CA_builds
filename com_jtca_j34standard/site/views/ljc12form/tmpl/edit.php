...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc12_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc12_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC12S_FIELDSET_JC12_FS_LABEL');?></a></li>
