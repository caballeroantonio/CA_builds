...
class JtCaViewLjjadg06s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg06s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg06 slug
			$row->slug = $row->id;

			// url link to ljjadg06
			$link = JRoute::_(JtCaHelperRoute::getLjjadg06Route($row->slug, 
																						'default',								
