...
class JtcaViewLjjadng12s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng12s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng12 slug
			$row->slug = $row->id;

			// url link to ljjadng12
			$link = JRoute::_(JtcaHelperRoute::getLjjadng12Route($row->slug, 
																						'default',								
