...
$layout		= $this->params->get('ljjadng12_layout', 'default');
...
<div class="jtca ljjadng12s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<?php if (($this->params->get('show_ljjadng12_filter_field') != '' AND $this->params->get('show_ljjadng12_filter_field') != 'hide')) :?>
			<div class="filter-search">
				<?php if ($this->params->get('show_ljjadng12_filter_field') != '' AND $this->params->get('show_ljjadng12_filter_field') != 'hide') :?>
					<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_JTCA_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_JTCA_'.$this->params->get('show_ljjadng12_filter_field').'_FILTER_LABEL'); ?>" />
				<?php endif; ?>	
				<?php if ($this->params->get('list_show_ljjadng12_billete',1)) : ?>
					<select name="filter_billete" onchange="this.form.submit()">
					<option value=""><?php echo JText::_('COM_JTCA_LJJADNG12S_SELECT_BILLETE');?></option>
		...
		<?php if ($this->params->get('show_ljjadng12_pagination_limit')) : ?>
		...
		<?php if (empty($this->items)) : ?>
			...
			<?php if ($this->params->get('show_no_ljjadng12s',1)) : ?>
			<p><?php echo JText::_('COM_JTCA_LJJADNG12S_NO_ITEMS'); ?></p>
			<?php endif; ?>
		...
		<div style="overflow-x:auto;">
			...
			<thead>
				<tr>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_id_organo',1)) : ?>
						<th class="list-id_organo" id="tableOrderingid_organo">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_ID_ORGANO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_id_secretaria',1)) : ?>
						<th class="list-id_secretaria" id="tableOrderingid_secretaria">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_ID_SECRETARIA'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_anoj',1)) : ?>
						<th class="list-anoj" id="tableOrderinganoj">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_ANOJ'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_id_expediente',1)) : ?>
						<th class="list-id_expediente" id="tableOrderingid_expediente">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_ID_EXPEDIENTE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field2',1)) : ?>
						<th class="list-field2" id="tableOrderingfield2">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD2'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_billete',1)) : ?>
						<th class="list-billete" id="tableOrderingbillete">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_BILLETE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field4',1)) : ?>
						<th class="list-field4" id="tableOrderingfield4">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD4'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field5',1)) : ?>
						<th class="list-field5" id="tableOrderingfield5">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD5'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field6',1)) : ?>
						<th class="list-field6" id="tableOrderingfield6">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD6'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field7',1)) : ?>
						<th class="list-field7" id="tableOrderingfield7">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD7'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field8',1)) : ?>
						<th class="list-field8" id="tableOrderingfield8">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD8'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field9_isMoral',1)) : ?>
						<th class="list-field9_isMoral" id="tableOrderingfield9_isMoral">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD9_ISMORAL'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field9_paterno',1)) : ?>
						<th class="list-field9_paterno" id="tableOrderingfield9_paterno">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD9_PATERNO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field9_materno',1)) : ?>
						<th class="list-field9_materno" id="tableOrderingfield9_materno">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD9_MATERNO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field9_nombre',1)) : ?>
						<th class="list-field9_nombre" id="tableOrderingfield9_nombre">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD9_NOMBRE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field10',1)) : ?>
						<th class="list-field10" id="tableOrderingfield10">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD10'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field10h',1)) : ?>
						<th class="list-field10h" id="tableOrderingfield10h">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD10H'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field11',1)) : ?>
						<th class="list-field11" id="tableOrderingfield11">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD11'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field12',1)) : ?>
						<th class="list-field12" id="tableOrderingfield12">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD12'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_field13',1)) : ?>
						<th class="list-field13" id="tableOrderingfield13">
							<?php echo JTEXT::_('COM_JTCA_LJJADNG12S_HEADING_FIELD13'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljjadng12_ordering',0)) : ?>
						<th width="10%">
			...
			<tbody>
				...
				?>			
					...
					<?php if ($this->params->get('list_show_ljjadng12_date')) : ?>
						<td class="list-date">
							<time datetime="<?php echo JHtml::_('date', $item->display_date, 'c'); ?>">
								<?php echo JHtml::_('date',$item->display_date, $this->escape($this->params->get('ljjadng12_date_format', JText::_('DATE_FORMAT_LC3')))); ?>
							</time>
						</td>
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_created_by',0)) : ?>
					...
					<?php if ($this->params->get('list_show_ljjadng12_id_expediente',1)) : ?>
						<td class="list-id_expediente">
							<?php 
								if ($params->get('list_link_ljjadng12_id_expediente')) :
					...
					<?php if ($show_actions) : ?>
						<td class="list-actions">
							...
							<?php if ($params->get('show_ljjadng12_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('ljjadng12icon.print_popup',  $item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_ljjadng12_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('ljjadng12icon.email',  $item, $params); ?>
								</li>
							<?php endif; ?>
								<?php if ($can_edit ) : ?>
                                    <li class="edit-icon">
                                        <?php echo JHtml::_('ljjadng12icon.edit',$item, $params); ?>
                                    </li>
                                <?php endif; ?>					
                                <?php if ($can_delete) : ?>
                                    <li class="delete-icon">
                                        <?php echo JHtml::_('ljjadng12icon.delete',$item, $params); ?>
                                    </li>
                                <?php endif; ?>
							<?php if ($can_edit AND $params->get('save_history') AND $params->get('ljjadng12_save_history')) : ?>
								<li class="version-icon">
									<?php echo JHtml::_('ljjadng12icon.versions',$item, $params); ?>
								</li>	
							<?php endif; ?>	
                                </ul>
                            </div>
			...
			<?php if (($this->params->def('show_ljjadng12_pagination', 2) == 1  OR ($this->params->get('show_ljjadng12_pagination') == 2)) AND ($this->pagination->get('pages.total') > 1)) : ?>
			<div class="pagination">

				<?php if ($this->params->def('show_ljjadng12_pagination_results', 0)) : ?>
				<p class="counter">
		...
		<?php endif; ?>
		<?php // Code to add a link to submit an ljjadng12. ?>
		<?php if ($this->params->get('show_ljjadng12_add_link', 1)) : ?>
			<?php if ($can_create) : ?>
				<?php echo JHtml::_('ljjadng12icon.create', $this->params); ?>
			<?php  endif; ?>
		<?php endif; ?>		
                <?php echo '<button>export</button>'//JHtml::_('ljjadng12icon.create', $this->params); ?>
	</form>
</div>
...
function show_collapsibleModal(item_id){
	...
	modalBody.prepend('<iframe class="iframe" src="index.php?option=com_jtca&task=ljjadng12.showHistory&item_id='+item_id+'" name="titulo" height="450"></iframe>');
	return;
}
</script>
