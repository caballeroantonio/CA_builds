	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<?php if (($this->params->get('show_ljjadng12_filter_field') != '' AND $this->params->get('show_ljjadng12_filter_field') != 'hide')) :?>
			<div class="filter-search">
				...
				<?php endif; ?>	
				<?php if ($this->params->get('list_show_ljjadng12_billete',0)) : ?>
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljjadng12_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljjadng12_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field2',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field4',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field6',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field9_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field9_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field9_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field9_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field10',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field10h',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field11',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field12',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadng12_field13',0)) : ?>
