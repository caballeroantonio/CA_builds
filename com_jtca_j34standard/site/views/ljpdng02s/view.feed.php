...
class JtCaViewLjpdng02s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng02s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng02 slug
			$row->slug = $row->id;

			// url link to ljpdng02
			$link = JRoute::_(JtCaHelperRoute::getLjpdng02Route($row->slug, 
																						'default',								
