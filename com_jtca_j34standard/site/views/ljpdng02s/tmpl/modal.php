...
$function	= $app->input->get('function', 'jSelectLjpdng02');
 ...
 */
?>
<div class="ljpdng02s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPDNG02S_SELECT_ITEM_LABEL'); ?></h3>
...
if ($this->params->get('show_ljpdng02_add_link', 1) AND $can_create)
	echo JHtml::_('ljpdng02icon.create', $this->params);
?>
