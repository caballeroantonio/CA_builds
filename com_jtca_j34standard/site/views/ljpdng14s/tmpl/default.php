...
<div class="jtca ljpdng14s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div style="overflow-x:auto;">
			<table class="table table-striped" id="ljpdng14s" style="margin-bottom: 200px;">
			<?php if ($this->params->get('show_ljpdng14_headings',1)) :?>
			<thead>
				<tr>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljpdng14_id_organo',1)) : ?>
						<th class="list-id_organo" id="tableOrderingid_organo">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_ID_ORGANO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_id_secretaria',1)) : ?>
						<th class="list-id_secretaria" id="tableOrderingid_secretaria">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_ID_SECRETARIA'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_anoj',1)) : ?>
						<th class="list-anoj" id="tableOrderinganoj">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_ANOJ'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_id_expediente',1)) : ?>
						<th class="list-id_expediente" id="tableOrderingid_expediente">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_ID_EXPEDIENTE'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_field3',1)) : ?>
						<th class="list-field3" id="tableOrderingfield3">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_FIELD3'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_faudiencia',1)) : ?>
						<th class="list-faudiencia" id="tableOrderingfaudiencia">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_FAUDIENCIA'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_field5',1)) : ?>
						<th class="list-field5" id="tableOrderingfield5">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_FIELD5'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_field6',1)) : ?>
						<th class="list-field6" id="tableOrderingfield6">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_FIELD6'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_exp_extinto',1)) : ?>
						<th class="list-exp_extinto" id="tableOrderingexp_extinto">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_EXP_EXTINTO'); ?>
						</th>
					<?php endif; ?>	
					<?php if ($this->params->get('list_show_ljpdng14_jorigen',1)) : ?>
						<th class="list-jorigen" id="tableOrderingjorigen">
							<?php echo JTEXT::_('COM_JTCA_LJPDNG14S_HEADING_JORIGEN'); ?>
						</th>
					<?php endif; ?>	
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljpdng14_headings',1)) :
										echo $created_by;
									else :
					...
					<?php if ($this->params->get('list_show_ljpdng14_id_expediente',1)) : ?>
						<td class="list-id_expediente">
							<?php 
								if ($params->get('list_link_ljpdng14_id_expediente')) :
					...
					<?php if ($show_actions) : ?>
						<td class="list-actions">
							...
							<?php if ($params->get('show_ljpdng14_print_icon')) : ?>
								<li class="print-icon">
										<?php echo JHtml::_('ljpdng14icon.print_popup',  $item, $params); ?>
								</li>
							<?php endif; ?>

							<?php if ($params->get('show_ljpdng14_email_icon')) : ?>
								<li class="email-icon">
										<?php echo JHtml::_('ljpdng14icon.email',  $item, $params); ?>
								</li>
							<?php endif; ?>
								<?php if ($can_edit ) : ?>
                                    <li class="edit-icon">
                                ...
                                <?php endif; ?>
							<?php if ($can_edit AND $params->get('save_history') AND $params->get('ljpdng14_save_history')) : ?>
								<li class="version-icon">
									<?php echo JHtml::_('ljpdng14icon.versions',$item, $params); ?>
								</li>	
							<?php endif; ?>	
                                </ul>
                            </div>
...
function show_collapsibleModal(item_id){
	...
	modalBody.prepend('<iframe class="iframe" src="index.php?option=com_jtca&task=ljpdng14.showHistory&item_id='+item_id+'" name="titulo" height="450"></iframe>');
	return;
}
</script>
