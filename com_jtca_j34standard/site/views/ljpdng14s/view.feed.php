...
class JtcaViewLjpdng14s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng14s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng14 slug
			$row->slug = $row->id;

			// url link to ljpdng14
			$link = JRoute::_(JtcaHelperRoute::getLjpdng14Route($row->slug, 
																						'default',								
