...
if ($this->params->get('save_history') AND $this->params->get('ljc05_save_history'))
{
...
<div class="jtca ljc05-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljc05form&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="ljc05-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('ljc05.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('ljc05.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('ljc05_save_history')
			) : ?>
				<div class="btn-group">
...
<?php /*?>
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_JTCA_LJC05S_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
<?php */?>
