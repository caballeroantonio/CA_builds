...
class JtCaViewLjemst05s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst05s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst05 slug
			$row->slug = $row->id;

			// url link to ljemst05
			$link = JRoute::_(JtCaHelperRoute::getLjemst05Route($row->slug, 
																						'default',								
