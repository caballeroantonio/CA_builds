...
function getFields(){
    ...
    */
    ...
    $field = array(
        'FIELD_NAME' => 'JUZGADO',
        'FIELD_CODE_NAME' => 'txt_field1233',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=TXT_FIELD1233
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL JUZGADO
    ...
    */
    $fields['txt_field1233'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'JUZGADO',
        'FIELD_CODE_NAME' => 'id_field1233',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 40,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=ID_FIELD1233
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL ACTO RECLAMADO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'EJECUTORIA AUTORIDAD FEDERAL',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL EJECUTORIA AUTORIDAD FEDERAL

                FIELD_NAME_LATEX=EJECUTORIA AUTORIDAD FEDERAL
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes06_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes06Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes06form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
