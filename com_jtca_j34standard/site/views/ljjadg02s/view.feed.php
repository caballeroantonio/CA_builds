...
class JtcaViewLjjadg02s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg02s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg02 slug
			$row->slug = $row->id;

			// url link to ljjadg02
			$link = JRoute::_(JtcaHelperRoute::getLjjadg02Route($row->slug, 
																						'default',								
