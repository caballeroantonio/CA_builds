...
class JtCaViewLjjadg04s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg04s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg04 slug
			$row->slug = $row->id;

			// url link to ljjadg04
			$link = JRoute::_(JtCaHelperRoute::getLjjadg04Route($row->slug, 
																						'default',								
