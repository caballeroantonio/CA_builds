...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ORDEN DE PAGO o TRANSFERENCIA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL ORDEN DE PAGO o TRANSFERENCIA

                FIELD_NAME_LATEX=ORDEN DE PAGO o TRANSFERENCIA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL FIRMA DE RECEPCION
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'HUELLA DE RECEPCION',
        'FIELD_CODE_NAME' => 'field8h',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 39,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD8H
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` INT(10) DEFAULT NULL HUELLA DE RECEPCION

                FIELD_NAME_LATEX=HUELLA DE RECEPCION
                FIELD_CODE_NAME_LATEX=field8h
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field8h'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'IDENTIFICACIÓN U OFICIO',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL IDENTIFICACIÓN U OFICIO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadg04Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadg04form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
