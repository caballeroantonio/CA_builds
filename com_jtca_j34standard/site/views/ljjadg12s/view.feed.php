...
class JtCaViewLjjadg12s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg12s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg12 slug
			$row->slug = $row->id;

			// url link to ljjadg12
			$link = JRoute::_(JtCaHelperRoute::getLjjadg12Route($row->slug, 
																						'default',								
