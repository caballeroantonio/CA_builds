...
function getFields(){
    ...
    */
    ...
    $field = array(
        ...
        'FIELD_CODE_NAME' => 'field2433_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2433_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2433_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'BENEFICIARIO (paterno)',
        'FIELD_CODE_NAME' => 'field2433_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2433_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2433_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'BENEFICIARIO (materno)',
        'FIELD_CODE_NAME' => 'field2433_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2433_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2433_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'BENEFICIARIO (nombre)',
        'FIELD_CODE_NAME' => 'field2433_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2433_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2433_nombre'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'CONCEPTO DE FIANZA',
        'FIELD_CODE_NAME' => 'field2434',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2434
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL CONCEPTO DE FIANZA

                FIELD_NAME_LATEX=CONCEPTO DE FIANZA
                FIELD_CODE_NAME_LATEX=field2434
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2434'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NO. DE BOLETA',
        'FIELD_CODE_NAME' => 'field2435',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2435
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NO. DE BOLETA
    ...
    */
    $fields['field2435'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE SE RECIBE POLIZA DE FIANZA',
        'FIELD_CODE_NAME' => 'field2436',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2436
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE RECIBE POLIZA DE FIANZA

                FIELD_NAME_LATEX=FECHA EN QUE SE RECIBE POLIZA DE FIANZA
                FIELD_CODE_NAME_LATEX=field2436
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2436'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MONTO',
        'FIELD_CODE_NAME' => 'field2437',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 37,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2437
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2437'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE PÓLIZA DE FIANZA',
        'FIELD_CODE_NAME' => 'field2438',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2438
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE PÓLIZA DE FIANZA

                FIELD_NAME_LATEX=N\'UMERO DE P\'OLIZA DE FIANZA
                FIELD_CODE_NAME_LATEX=field2438
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2438'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN',
        'FIELD_CODE_NAME' => 'field2439',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2439
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=
    ...
    */
    $fields['field2439'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'A QUIEN SE DEVUELVE (isMoral)',
        'FIELD_CODE_NAME' => 'field2440_isMoral',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2440_ISMORAL
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' A QUIEN SE DEVUELVE (isMoral)

                FIELD_NAME_LATEX=A QUIEN SE DEVUELVE (isMoral)
                FIELD_CODE_NAME_LATEX=field2440\_isMoral
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2440_isMoral'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'A QUIEN SE DEVUELVE (paterno)',
        'FIELD_CODE_NAME' => 'field2440_paterno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2440_PATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(255) DEFAULT NULL A QUIEN SE DEVUELVE (paterno)
    ...
    */
    $fields['field2440_paterno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'A QUIEN SE DEVUELVE (materno)',
        'FIELD_CODE_NAME' => 'field2440_materno',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2440_MATERNO
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL A QUIEN SE DEVUELVE (materno)

                FIELD_NAME_LATEX=A QUIEN SE DEVUELVE (materno)
                FIELD_CODE_NAME_LATEX=field2440\_materno
                FIELD_DBCOMMENT_LATEX=


    */
    $fields['field2440_materno'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'A QUIEN SE DEVUELVE (nombre)',
        'FIELD_CODE_NAME' => 'field2440_nombre',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 41,
    );
    /*
                FIELD_OPTIONS_LANGUAGE_VARS=
                FIELD_CODE_NAME_UPPER=FIELD2440_NOMBRE
                FIELD_INTRO=
                FIELD_DESCRIPTION_INI=

                FIELD_DB=`` VARCHAR(45) DEFAULT NULL A QUIEN SE DEVUELVE (nombre)
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsps11_save_history'))
{
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsps11form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE CONTROL DE FIANZA',
