...
class JtcaViewSldiliJpdng09s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=sldili_jpdng09s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the sldilijpdng09 slug
			$row->slug = $row->id;

			// url link to sldilijpdng09
			$link = JRoute::_(JtcaHelperRoute::getSldiliJpdng09Route($row->slug, 
																						'default',								
