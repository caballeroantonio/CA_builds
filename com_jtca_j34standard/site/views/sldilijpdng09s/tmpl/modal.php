...
$function	= $app->input->get('function', 'jSelectSldiliJpdng09');
 ...
 */
?>
<div class="sldili_jpdng09s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLDILI_JPDNG09S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=sldili_jpdng09s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="sldili_jpdng09s">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLDILI_JPDNG09S_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLDILI_JPDNG09S_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_sldilijpdng09_add_link', 1) AND $can_create)
	echo JHtml::_('sldilijpdng09icon.create', $this->params);
?>
