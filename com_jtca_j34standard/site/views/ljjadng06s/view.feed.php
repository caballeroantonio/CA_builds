...
class JtCaViewLjjadng06s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng06s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng06 slug
			$row->slug = $row->id;

			// url link to ljjadng06
			$link = JRoute::_(JtCaHelperRoute::getLjjadng06Route($row->slug, 
																						'default',								
