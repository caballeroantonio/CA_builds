...
$function	= $app->input->get('function', 'jSelectLjccm05');
 ...
 */
?>
<div class="ljccm05s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJCCM05S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljccm05s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljccm05_add_link', 1) AND $can_create)
	echo JHtml::_('ljccm05icon.create', $this->params);
?>
