...
class JtCaViewLjjadg03s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg03s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg03 slug
			$row->slug = $row->id;

			// url link to ljjadg03
			$link = JRoute::_(JtCaHelperRoute::getLjjadg03Route($row->slug, 
																						'default',								
