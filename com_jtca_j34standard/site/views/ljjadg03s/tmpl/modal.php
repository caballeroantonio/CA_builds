...
$function	= $app->input->get('function', 'jSelectLjjadg03');
 ...
 */
?>
<div class="ljjadg03s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJJADG03S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljjadg03s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljjadg03_add_link', 1) AND $can_create)
	echo JHtml::_('ljjadg03icon.create', $this->params);
?>
