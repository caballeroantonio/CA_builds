	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<?php if (($this->params->get('show_ljjadg03_filter_field') != '' AND $this->params->get('show_ljjadg03_filter_field') != 'hide')) :?>
			<div class="filter-search">
				...
				<?php endif; ?>	
				<?php if ($this->params->get('list_show_ljjadg03_billete',0)) : ?>
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_ljjadg03_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_ljjadg03_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_id_expediente',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field3',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field9',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field4',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field5',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field6_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field6_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field6_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field6_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_ljjadg03_field8',0)) : ?>
