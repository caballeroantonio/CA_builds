...
$function	= $app->input->get('function', 'jSelectLjp13');
 ...
 */
?>
<div class="ljp13s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP13S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp13s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp13_add_link', 1) AND $can_create)
	echo JHtml::_('ljp13icon.create', $this->params);
?>
