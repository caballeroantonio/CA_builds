...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE RECIBE LA PÓLIZA DE FIANZA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No. DE LA PÓLIZA DE FIANZA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE LA PÓLIZA DE FIANZA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOTIFICACIÓN A LA AFIANZADORA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOTIFICACIÓN A LA AFIANZADORA

                FIELD_NAME_LATEX=NOTIFICACI\'ON A LA AFIANZADORA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'EN CASO DE HACER EFECTIVA LA PÓLIZA DE FIANZA, ANOTAR EL MOTIVO POR EL CUAL SE HIZO EFECTIVA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL EN CASO DE HACER EFECTIVA LA PÓLIZA DE FIANZA, ANOTAR EL MOTIVO POR EL CUAL SE HIZO EFECTIVA

                FIELD_NAME_LATEX=EN CASO DE HACER EFECTIVA LA P\'OLIZA DE FIANZA, ANOTAR EL MOTIVO POR EL CUAL SE HIZO EFECTIVA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljp13_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljp13Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljp13form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
