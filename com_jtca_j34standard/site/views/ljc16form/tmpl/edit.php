...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc16_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc16_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC16S_FIELDSET_JC16_FS_LABEL');?></a></li>
