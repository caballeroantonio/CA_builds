...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc06_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc06_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC06S_FIELDSET_JC06_FS_LABEL');?></a></li>
