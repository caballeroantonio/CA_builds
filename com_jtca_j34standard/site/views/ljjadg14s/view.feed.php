...
class JtCaViewLjjadg14s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg14s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg14 slug
			$row->slug = $row->id;

			// url link to ljjadg14
			$link = JRoute::_(JtCaHelperRoute::getLjjadg14Route($row->slug, 
																						'default',								
