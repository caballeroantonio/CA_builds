...
class JtCaViewLjjadg01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg01 slug
			$row->slug = $row->id;

			// url link to ljjadg01
			$link = JRoute::_(JtCaHelperRoute::getLjjadg01Route($row->slug, 
																						'default',								
