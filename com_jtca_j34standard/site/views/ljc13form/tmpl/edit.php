...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc13_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc13_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC13S_FIELDSET_JC13_FS_LABEL');?></a></li>
