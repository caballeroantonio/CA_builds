...
$function	= $app->input->get('function', 'jSelectLsc08');
 ...
 */
?>
<div class="lsc08s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSC08S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsc08s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsc08_add_link', 1) AND $can_create)
	echo JHtml::_('lsc08icon.create', $this->params);
?>
