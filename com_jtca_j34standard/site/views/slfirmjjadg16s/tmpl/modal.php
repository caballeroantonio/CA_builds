...
$function	= $app->input->get('function', 'jSelectSlfirmJjadg16');
 ...
 */
?>
<div class="slfirm_jjadg16s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLFIRM_JJADG16S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slfirm_jjadg16s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slfirm_jjadg16s">
			<thead>
				<tr>
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLFIRM_JJADG16S_HEADING_ID_RECORD'); ?>
					</th>	
					<th width="10%">
						<?php echo JTEXT::_('COM_JTCA_SLFIRM_JJADG16S_HEADING_ID_FIELD'); ?>
					</th>	
...
if ($this->params->get('show_slfirmjjadg16_add_link', 1) AND $can_create)
	echo JHtml::_('slfirmjjadg16icon.create', $this->params);
?>
