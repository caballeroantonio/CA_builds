...
class JtCaViewLjjadng05s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng05s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng05 slug
			$row->slug = $row->id;

			// url link to ljjadng05
			$link = JRoute::_(JtCaHelperRoute::getLjjadng05Route($row->slug, 
																						'default',								
