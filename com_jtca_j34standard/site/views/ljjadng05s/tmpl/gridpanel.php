...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL APELANTE(S)

                FIELD_NAME_LATEX=APELANTE(S)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL EFECTO ADMISORIO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE REMISIÓN A SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE REMISIÓN A SALA

                FIELD_NAME_LATEX=FECHA DE REMISI\'ON A SALA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NÚMERO DE OFICIO DE REMISIÓN',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE OFICIO DE REMISIÓN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NÚMERO DE TOCA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE LA RESOLUCIÓN DE SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE LA RESOLUCIÓN DE SALA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN DE LA RESOLUCIÓN DE SALA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIÓN DE LA RESOLUCIÓN DE SALA

                FIELD_NAME_LATEX=FECHA DE DEVOLUCI\'ON DE LA RESOLUCI\'ON DE SALA
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljjadng05_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadng05Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadng05form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
