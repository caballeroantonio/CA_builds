...
function getFields(){
    ...
    */
    $fields['field2447'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DESTINATARIO',
        'FIELD_CODE_NAME' => 'field2448',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
    ...
    */
    $fields['field2448'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'ASUNTO',
        'FIELD_CODE_NAME' => 'field2449',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 1,
    );
    /*
    ...
    */
    $fields['field2449'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE ENTREGA AL DESTINATARIO',
        'FIELD_CODE_NAME' => 'field2450',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE ENTREGA AL DESTINATARIO
    ...
    */
    $fields['field2450'] = $field;
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN AL JUZGADO',
        'FIELD_CODE_NAME' => 'field2451',
        'FIELD_DESCRIPTION' => '',//
        'FIELDTYPE_ID' => 5,
    );
    /*
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lsps14_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lsps14Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lsps14form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
