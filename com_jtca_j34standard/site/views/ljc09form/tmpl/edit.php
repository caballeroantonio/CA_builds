...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc09_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc09_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC09S_FIELDSET_JC09_FS_LABEL');?></a></li>
