...
<div class="jtca lcp32s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
			...
			<?php if ($this->params->get('show_lcp32_headings')) :?>
			<thead>
				<tr>
			...
			<tbody>
				...
				?>			
						...
						<td class="createdby">
							<?php 
								...
								if (!empty($item->created_by )) :
									...
									if ($this->params->get('show_lcp32_headings')) :
										echo $created_by;
									else :
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_id_organo',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_anoj',0)) : ?>
						<td class="list-anoj">
							<?php 
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_id_secretaria',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_organo1',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field4',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_fh_recepcion',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field6_isMoral',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field6_paterno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field6_materno',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field6_nombre',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field7',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field8',0)) : ?>
					...
					<?php endif; ?>
					<?php if ($this->params->get('list_show_lcp32_field9',0)) : ?>
