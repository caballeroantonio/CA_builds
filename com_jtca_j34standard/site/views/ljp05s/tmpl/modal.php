...
$function	= $app->input->get('function', 'jSelectLjp05');
 ...
 */
?>
<div class="ljp05s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP05S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp05s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp05_add_link', 1) AND $can_create)
	echo JHtml::_('ljp05icon.create', $this->params);
?>
