...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No DE ORDEN 

                FIELD_NAME_LATEX=No DE ORDEN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE REMISIÓN
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DELITO(S)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FOJAS DEL EXPEDIENTE, TOMOS Y DOCUMENTOS',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL FOJAS DEL EXPEDIENTE, TOMOS Y DOCUMENTOS  
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL FOLIO DEVOLUCIÓN

                FIELD_NAME_LATEX=FOLIO DEVOLUCI\'ON
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DE DEVOLUCIÓN DEL ARCHIVO AL JUZGADO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DE DEVOLUCIÓN DEL ARCHIVO AL JUZGADO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljpes17_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes17Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes17form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
