...
class JtcaViewSlpartescontenciosas extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slpartescontenciosas');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slpartecontenciosa slug
			$row->slug = $row->id;

			// url link to slpartecontenciosa
			$link = JRoute::_(JtcaHelperRoute::getSlpartecontenciosaRoute($row->slug, 
																						'default',								
