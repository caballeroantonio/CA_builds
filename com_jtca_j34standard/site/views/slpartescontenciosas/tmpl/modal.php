 ...
 */
?>
<div class="slpartescontenciosas-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLPARTESCONTENCIOSAS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpartescontenciosas&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slpartescontenciosas">
			<thead>
				<tr>
					<th width="10%">
...
if ($this->params->get('show_slpartecontenciosa_add_link', 1) AND $can_create)
	echo JHtml::_('slpartecontenciosaicon.create', $this->params);
?>
