...
class JtcaViewExpedientes extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=expedientes');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the expediente slug
			$row->slug = $row->id;

			// url link to expediente
			$link = JRoute::_(JtcaHelperRoute::getExpedienteRoute($row->slug, 
																						'default',								
