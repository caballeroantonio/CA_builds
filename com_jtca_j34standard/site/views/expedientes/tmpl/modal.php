 ...
 */
?>
<div class="expedientes-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_EXPEDIENTES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=expedientes&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_expediente_add_link', 1) AND $can_create)
	echo JHtml::_('expedienteicon.create', $this->params);
?>
