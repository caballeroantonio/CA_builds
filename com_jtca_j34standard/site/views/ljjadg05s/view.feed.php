...
class JtCaViewLjjadg05s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadg05s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadg05 slug
			$row->slug = $row->id;

			// url link to ljjadg05
			$link = JRoute::_(JtCaHelperRoute::getLjjadg05Route($row->slug, 
																						'default',								
