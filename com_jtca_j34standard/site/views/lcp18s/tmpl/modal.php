...
$function	= $app->input->get('function', 'jSelectLcp18');
 ...
 */
?>
<div class="lcp18s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LCP18S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp18s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lcp18_add_link', 1) AND $can_create)
	echo JHtml::_('lcp18icon.create', $this->params);
?>
