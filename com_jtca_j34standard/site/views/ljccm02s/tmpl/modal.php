...
$function	= $app->input->get('function', 'jSelectLjccm02');
 ...
 */
?>
<div class="ljccm02s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJCCM02S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljccm02s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljccm02_add_link', 1) AND $can_create)
	echo JHtml::_('ljccm02icon.create', $this->params);
?>
