...
$function	= $app->input->get('function', 'jSelectLjpes10');
 ...
 */
?>
<div class="ljpes10s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPES10S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpes10s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpes10_add_link', 1) AND $can_create)
	echo JHtml::_('ljpes10icon.create', $this->params);
?>
