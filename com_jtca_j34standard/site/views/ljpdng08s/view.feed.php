...
class JtCaViewLjpdng08s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng08s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng08 slug
			$row->slug = $row->id;

			// url link to ljpdng08
			$link = JRoute::_(JtCaHelperRoute::getLjpdng08Route($row->slug, 
																						'default',								
