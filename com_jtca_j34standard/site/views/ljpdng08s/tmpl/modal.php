...
$function	= $app->input->get('function', 'jSelectLjpdng08');
 ...
 */
?>
<div class="ljpdng08s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPDNG08S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng08s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpdng08_add_link', 1) AND $can_create)
	echo JHtml::_('ljpdng08icon.create', $this->params);
?>
