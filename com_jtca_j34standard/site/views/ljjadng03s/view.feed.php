...
class JtCaViewLjjadng03s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng03s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng03 slug
			$row->slug = $row->id;

			// url link to ljjadng03
			$link = JRoute::_(JtCaHelperRoute::getLjjadng03Route($row->slug, 
																						'default',								
