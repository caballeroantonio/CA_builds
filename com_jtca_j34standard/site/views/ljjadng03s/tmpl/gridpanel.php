...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA Y HORA DE LA AUDIENCIA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL FECHA Y HORA DE LA AUDIENCIA

                FIELD_NAME_LATEX=FECHA Y HORA DE LA AUDIENCIA
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljjadng03Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljjadng03form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
