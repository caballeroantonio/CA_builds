...
$function	= $app->input->get('function', 'jSelectLjoc04');
 ...
 */
?>
<div class="ljoc04s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJOC04S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljoc04s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljoc04_add_link', 1) AND $can_create)
	echo JHtml::_('ljoc04icon.create', $this->params);
?>
