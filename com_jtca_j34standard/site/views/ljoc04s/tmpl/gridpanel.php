...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL DOCUMENTOS QUE SE ANEXAN
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljoc04form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
