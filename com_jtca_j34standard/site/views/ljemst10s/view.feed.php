...
class JtCaViewLjemst10s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst10s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst10 slug
			$row->slug = $row->id;

			// url link to ljemst10
			$link = JRoute::_(JtCaHelperRoute::getLjemst10Route($row->slug, 
																						'default',								
