...
$function	= $app->input->get('function', 'jSelectLjemst10');
 ...
 */
?>
<div class="ljemst10s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJEMST10S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst10s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljemst10_add_link', 1) AND $can_create)
	echo JHtml::_('ljemst10icon.create', $this->params);
?>
