...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DELITOS(S)

                FIELD_NAME_LATEX=DELITOS(S)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MOMENTO DEL DESISTIMIENTO',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL MOMENTO DEL DESISTIMIENTO

                FIELD_NAME_LATEX=MOMENTO DEL DESISTIMIENTO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpes16Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpes16form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
