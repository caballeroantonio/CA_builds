...
$function	= $app->input->get('function', 'jSelectLcp09');
 ...
 */
?>
<div class="lcp09s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LCP09S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lcp09s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lcp09_add_link', 1) AND $can_create)
	echo JHtml::_('lcp09icon.create', $this->params);
?>
