...
class JtCaViewLjemst03s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst03s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst03 slug
			$row->slug = $row->id;

			// url link to ljemst03
			$link = JRoute::_(JtCaHelperRoute::getLjemst03Route($row->slug, 
																						'default',								
