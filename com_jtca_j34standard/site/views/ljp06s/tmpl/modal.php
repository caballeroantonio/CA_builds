...
$function	= $app->input->get('function', 'jSelectLjp06');
 ...
 */
?>
<div class="ljp06s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJP06S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljp06s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljp06_add_link', 1) AND $can_create)
	echo JHtml::_('ljp06icon.create', $this->params);
?>
