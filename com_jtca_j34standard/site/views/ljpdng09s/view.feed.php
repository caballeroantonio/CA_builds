...
class JtCaViewLjpdng09s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng09s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng09 slug
			$row->slug = $row->id;

			// url link to ljpdng09
			$link = JRoute::_(JtCaHelperRoute::getLjpdng09Route($row->slug, 
																						'default',								
