...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DEPOSITANTE (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' DEPOSITANTE (isMoral)

                FIELD_NAME_LATEX=DEPOSITANTE (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DEPOSITANTE (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL DEPOSITANTE (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DEPOSITANTE (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DEPOSITANTE (materno)

                FIELD_NAME_LATEX=DEPOSITANTE (materno)
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DEPOSITANTE (nombre)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA EN QUE SE RECIBE LA GARANTIA Y/O PÓLIZA',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA EN QUE SE RECIBE LA GARANTIA Y/O PÓLIZA

                FIELD_NAME_LATEX=FECHA EN QUE SE RECIBE LA GARANTIA Y/O P\'OLIZA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE DE LA AFIANZADORA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'MONTO DE LA GARANTÍA',
    ...
    /*
                ...
                FIELD_DB=`` DECIMAL(11,2) DEFAULT NULL MONTO DE LA GARANTÍA

                FIELD_NAME_LATEX=MONTO DE LA GARANT\'IA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No. DE PÓLIZA DE FIANZA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE PÓLIZA DE FIANZA
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'EN CASO DE HACER EFECTIVA LA GARANTÍA Y/O POLIZA DE FIANZA, ANOTAR EL MOTIVO',
    ...
    /*
                ...
                FIELD_DB=`` TEXT DEFAULT NULL EN CASO DE HACER EFECTIVA LA GARANTÍA Y/O POLIZA DE FIANZA, ANOTAR EL MOTIVO

                FIELD_NAME_LATEX=EN CASO DE HACER EFECTIVA LA GARANT\'IA Y/O POLIZA DE FIANZA, ANOTAR EL MOTIVO
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('ljf13_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljf13Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljf13form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE CONTROL DE FIANZAS',
