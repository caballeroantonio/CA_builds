 ...
 */
?>
<div class="slpersonaliasedades-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_SLPERSONALIASEDADES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=slpersonaliasedades&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="slpersonaliasedades">
			<thead>
				<tr>
					<th width="10%">
...
if ($this->params->get('show_slpersonaliasedad_add_link', 1) AND $can_create)
	echo JHtml::_('slpersonaliasedadicon.create', $this->params);
?>
