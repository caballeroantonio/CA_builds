...
class JtcaViewSlpersonaliasedades extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=slpersonaliasedades');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the slpersonaliasedad slug
			$row->slug = $row->id;

			// url link to slpersonaliasedad
			$link = JRoute::_(JtcaHelperRoute::getSlpersonaliasedadRoute($row->slug, 
																						'default',								
