...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No. DE FIANZA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL INSTITUCIÓN QUE LA EXPIDE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL GARANTE
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL SE HACE EFECTIVA LA GARANTÍA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL MOTIVOS POR LOS QUE SE HIZO EFECTIVA LA GARANTÍA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL HUELLA DEL BENEFICIARIO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljoc14Form','JtCaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljoc14form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
