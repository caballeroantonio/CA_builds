...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_jc20_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				...
				<li><a href="#fieldset-jc20_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LJC20S_FIELDSET_JC20_FS_LABEL');?></a></li>
