...
class JtcaViewLjpdng05s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng05s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng05 slug
			$row->slug = $row->id;

			// url link to ljpdng05
			$link = JRoute::_(JtcaHelperRoute::getLjpdng05Route($row->slug, 
																						'default',								
