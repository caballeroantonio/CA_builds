...
$function	= $app->input->get('function', 'jSelectLjpdng05');
 ...
 */
?>
<div class="ljpdng05s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJPDNG05S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljpdng05s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljpdng05_add_link', 1) AND $can_create)
	echo JHtml::_('ljpdng05icon.create', $this->params);
?>
