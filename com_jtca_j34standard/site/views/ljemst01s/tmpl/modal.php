...
$function	= $app->input->get('function', 'jSelectLjemst01');
 ...
 */
?>
<div class="ljemst01s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LJEMST01S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=ljemst01s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_ljemst01_add_link', 1) AND $can_create)
	echo JHtml::_('ljemst01icon.create', $this->params);
?>
