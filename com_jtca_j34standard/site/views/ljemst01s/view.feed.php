...
class JtCaViewLjemst01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljemst01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljemst01 slug
			$row->slug = $row->id;

			// url link to ljemst01
			$link = JRoute::_(JtCaHelperRoute::getLjemst01Route($row->slug, 
																						'default',								
