...
class JtcaViewLjpdng16s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng16s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng16 slug
			$row->slug = $row->id;

			// url link to ljpdng16
			$link = JRoute::_(JtcaHelperRoute::getLjpdng16Route($row->slug, 
																						'default',								
