...
function getFields(){
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'DOMICILIO DONDE SE GENERA LA VIOLENCIA',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL DOMICILIO DONDE SE GENERA LA VIOLENCIA

                FIELD_NAME_LATEX=DOMICILIO DONDE SE GENERA LA VIOLENCIA
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL DELEGACION
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 66 Frac. I

                FIELD_NAME_LATEX=Art. 66 Frac. I
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 66 Frac. II
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 66 Frac. III

                FIELD_NAME_LATEX=Art. 66 Frac. III
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 66 Frac. IV
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 66 Frac. V

                FIELD_NAME_LATEX=Art. 66 Frac. V
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 71 Frac. I
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 71 Frac. II

                FIELD_NAME_LATEX=Art. 71 Frac. II
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 71 Frac. III
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) DEFAULT NULL Art. 71 Frac. IV

                FIELD_NAME_LATEX=Art. 71 Frac. IV
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` INT(10) DEFAULT NULL JUZGADO EN TURNO
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL RESOLUCIÓN 
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE QUIEN INFORMO RESOLUCIÓN (isMoral)',
    ...
    /*
                ...
                FIELD_DB=`` TINYINT(1) NOT NULL DEFAULT '0' NOMBRE QUIEN INFORMO RESOLUCIÓN (isMoral)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE QUIEN INFORMO RESOLUCIÓN (paterno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(255) DEFAULT NULL NOMBRE QUIEN INFORMO RESOLUCIÓN (paterno)

                FIELD_NAME_LATEX=NOMBRE QUIEN INFORMO RESOLUCI\'ON (paterno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE QUIEN INFORMO RESOLUCIÓN (materno)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE QUIEN INFORMO RESOLUCIÓN (materno)

                FIELD_NAME_LATEX=NOMBRE QUIEN INFORMO RESOLUCI\'ON (materno)
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'NOMBRE QUIEN INFORMO RESOLUCIÓN (nombre)',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL NOMBRE QUIEN INFORMO RESOLUCIÓN (nombre)
...
<?php /*?>
<?php
if ($this->params->get('save_history') AND $this->params->get('lcp24_save_history'))
{
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Lcp24Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=lcp24form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
...
document.id = Ext.documentId;
	...
	Ext.create('Ext.grid.Panel', {
		title: 'LIBRO DE REGISTRO DE LA LEY DE ACCESO A LAS MUJERE',
