...
<div class="jtca ljoc13s-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div style="overflow-x:auto;">
			<table class="table table-striped" id="ljoc13s" style="margin-bottom: 200px;">
				...
				?>			
					...
					<?php if ($this->params->get('list_show_ljoc13_id_expediente',1)) : ?>
						<td class="list-id_expediente">
							<?php 
								if ($params->get('list_link_ljoc13_id_expediente')) :
...
function show_collapsibleModal(item_id){
	...
	modalBody.prepend('<iframe class="iframe" src="index.php?option=com_jtca&task=ljoc13.showHistory&item_id='+item_id+'" name="titulo" height="450"></iframe>');
	return;
}
</script>
