...
class JtCaViewLjpdng15s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljpdng15s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljpdng15 slug
			$row->slug = $row->id;

			// url link to ljpdng15
			$link = JRoute::_(JtCaHelperRoute::getLjpdng15Route($row->slug, 
																						'default',								
