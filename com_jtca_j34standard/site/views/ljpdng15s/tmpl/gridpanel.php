...
function getFields(){
    ...
    */
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL LUGAR DE RECLUSIÓN
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'No OFICIO PEDIMENTO',
    ...
    /*
                ...
                FIELD_DB=`` VARCHAR(45) DEFAULT NULL No OFICIO PEDIMENTO
    ...
    */
    ...
    //{OBJECT_FIELD}
    $field = array(
        'FIELD_NAME' => 'FECHA DEL OFICIO PEDIMENTO',
    ...
    /*
                ...
                FIELD_DB=`` DATETIME DEFAULT NULL FECHA DEL OFICIO PEDIMENTO

                FIELD_NAME_LATEX=FECHA DEL OFICIO PEDIMENTO
...
//	JHtml::_('behavior.modal', 'a.modal_jform_contenthistory');//creo que se carga con el botón versiones
	...
	$model	= JModelLegacy::getInstance('Ljpdng15Form','JtcaModel', array('ignore_request' => FALSE));
	$data = array();
	$data['id'] = 1;
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=com_jtca&view=ljpdng15form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
