...
class JtcaViewLjjadng01s extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_jtca&view=ljjadng01s');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the ljjadng01 slug
			$row->slug = $row->id;

			// url link to ljjadng01
			$link = JRoute::_(JtcaHelperRoute::getLjjadng01Route($row->slug, 
																						'default',								
