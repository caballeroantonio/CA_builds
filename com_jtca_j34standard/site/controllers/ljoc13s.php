...
/**
 * LIBRO DE NOTARIOS list controller class.
 *
 */
class JtCaControllerLjoc13s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Ljoc13s', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
