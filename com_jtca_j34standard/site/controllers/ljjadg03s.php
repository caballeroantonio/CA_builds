...
/**
 * LIBRO DE INGRESOS list controller class.
 *
 */
class JtCaControllerLjjadg03s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Ljjadg03s', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
