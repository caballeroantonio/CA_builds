...
/**
 * LIBRETA DE LIBERTADES JUZGADOS DE PRIMERA INSTANCI list controller class.
 *
 */
class JtCaControllerLcp30s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lcp30s', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
