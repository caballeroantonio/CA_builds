...
/**
 * ADOLESCENTE Del LIBRO DE GOBIERNO list controller class.
 *
 */
class JtcaControllerSladolJjadg01s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'SladolJjadg01s', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
