...
/**
 * CERTIFICADO DE EGRESOS Del LIBRO DE CERTIFICADO DE list controller class.
 *
 */
class JtcaControllerSldepJoc03s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'SldepJoc03s', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
