...
/**
 * Libro De Ejemplo list controller class.
 *
 */
class JtCaControllerLejemplos extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lejemplos', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
