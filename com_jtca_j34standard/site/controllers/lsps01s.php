...
/**
 * LIBRO DE GOBIERNO (SISTEMA TRADICIONAL) list controller class.
 *
 */
class JtcaControllerLsps01s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lsps01s', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
