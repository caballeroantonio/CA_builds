...
/**
 * LIBRO DE FINANZAS list controller class.
 *
 */
class JtcaControllerLspe07s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lspe07s', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
