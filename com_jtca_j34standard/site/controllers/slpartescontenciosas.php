...
/**
 * Partes Contenciosas En Juicio list controller class.
 *
 */
class JtcaControllerSlpartescontenciosas extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Slpartescontenciosas', $prefix = 'JtcaModel',$config = array('ignore_request' => true))
	{
