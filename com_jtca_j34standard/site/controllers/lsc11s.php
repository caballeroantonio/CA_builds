...
/**
 * LIBRETA DE OFICIOS (OFICIAL) list controller class.
 *
 */
class JtCaControllerLsc11s extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Lsc11s', $prefix = 'JtCaModel',$config = array('ignore_request' => true))
	{
