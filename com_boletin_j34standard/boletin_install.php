 ...
 * @package			com_boletin
 * @subpackage		com_boletin.install
 * @copyright		
 ...
 */
class com_boletinInstallerScript
{
    /**
...
UPDATE #__extensions SET enabled = 1 WHERE type = 'plugin' name = {$plugin};
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/boletin_install.html';
		...
		ob_start();            
		?>
		<div id="boletininstall-info">
			<h1><?php echo JText::_('COM_BOLETIN_INSTALL_HEADER'); ?></h1>
			<div id="boletininstall-intro">
				<?php echo JText::_('COM_BOLETIN_INSTALL_INTRO'); ?>
			</div>
			<table id="boletininstall-table" class="adminlist">
				<thead class="boletininstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_BOLETIN_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="boletininstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_BOLETIN_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_BOLETIN_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="boletininstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_BOLETIN');?>
						</td>
						<td class="boletininstall-success">
							<?php echo JText::_('COM_BOLETIN_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_BOLETIN_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="boletininstall-subheading">
				<th>
					<?php echo JText::_('COM_BOLETIN_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_BOLETIN_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_BOLETIN_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="boletininstall-subheading">
				<th>
					<?php echo JText::_('COM_BOLETIN_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_BOLETIN_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_BOLETIN_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="boletininstall-component-error">
									<?php echo JText::_('COM_BOLETIN_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="boletininstall-component-success">
									<?php echo JText::_('COM_BOLETIN_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_BOLETIN_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
...
$installer->uninstall('module', $mod_id)
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/boletin_uninstall.html';
     ...
     ?>
	<div id="boletininstall-info">
		<h1><?php echo JText::_('COM_BOLETIN_UNINSTALL_HEADER'); ?></h1>
			<table id="boletininstall-table" class="adminlist">
				<thead class="boletininstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_BOLETIN_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="boletininstall-row">
						...
						<td class="boletininstall-success">
							<?php echo JText::_('COM_BOLETIN_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			JFolder::delete(JPATH_SITE.'/plugins/boletin'); 
		}  
		...
		JFolder::delete(JPATH_SITE.'/images/boletin'); 
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="boletininstall-component-error">
									<?php echo JText::_('COM_BOLETIN_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="boletininstall-component-success">
									<?php echo JText::_('COM_BOLETIN_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
...
UPDATE #__extensions SET enabled = 1 WHERE type = 'plugin' name = {$plugin};
    ...
    function update($parent) 
    {
		...
		?>
		<div id="boletininstall-info">
			<h1><?php echo JText::_('COM_BOLETIN_UPDATE_HEADER'); ?></h1>
			<table id="boletininstall-table" class="adminlist">
				<thead class="boletininstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_BOLETIN_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="boletininstall-row">
						...
						<td class="boletininstall-success">
							<?php echo JText::_('COM_BOLETIN_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="boletininstall-component-error">
									<?php echo JText::_('COM_BOLETIN_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="boletininstall-component-success">
									<?php echo JText::_('COM_BOLETIN_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_BOLETIN_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_BOLETIN_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/boletin'); 
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_boletin'));		
...
UPDATE #__extensions SET params = '{$params_string}' WHERE type = 'component' AND name = 'com_boletin'
	...
	<tr class="boletininstall-row">
		...
		<td class="boletininstall-error">
			<div>
				<?php echo JText::_('COM_BOLETIN_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="boletininstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="boletininstall-row">
			...
			<td class="boletininstall-success">
				<div><?php echo JText::_('COM_BOLETIN_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
