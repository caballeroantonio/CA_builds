...
$function	= $app->input->get('function', 'jSelectTsjcdmx_juzgados_civiles_antiguo');
 ...
 */
?>
<div class="tsjcdmx_juzgados_civiles_antiguos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_juzgados_civiles_antiguos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="tsjcdmx_juzgados_civiles_antiguos">
			<thead>
				<tr>
					<th width="10%">
...
if ($this->params->get('show_tsjcdmx_juzgados_civiles_antiguo_add_link', 1) AND $can_create)
	echo JHtml::_('tsjcdmx_juzgados_civiles_antiguoicon.create', $this->params);
?>
