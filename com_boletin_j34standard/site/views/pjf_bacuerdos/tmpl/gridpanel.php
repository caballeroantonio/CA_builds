...
class pjf_bacuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new pjf_bacuerdosApp();
$extJSHelper->parse('pjf_bacuerdo', 'pjf_bacuerdos');
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('boletin.model.pjf_bacuerdo', {
