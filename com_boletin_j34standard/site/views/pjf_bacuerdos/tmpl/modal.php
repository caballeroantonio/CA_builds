...
$function	= $app->input->get('function', 'jSelectPjf_bacuerdo');
 ...
 */
?>
<div class="pjf_bacuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=pjf_bacuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_pjf_bacuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('pjf_bacuerdoicon.create', $this->params);
?>
