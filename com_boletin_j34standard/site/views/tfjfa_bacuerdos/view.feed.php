...
class BoletinViewTfjfa_bacuerdos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_boletin&view=tfjfa_bacuerdos');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the tfjfa_bacuerdo slug
			$row->slug = $row->id;
			...
			if ($item->featured == 1)
			{
				$item->category[]	= JText::_('JFEATURED'); // All featured tfjfa_bacuerdos are categorized as "Featured"
			}
