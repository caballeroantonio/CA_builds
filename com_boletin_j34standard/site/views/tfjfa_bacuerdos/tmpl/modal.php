...
$function	= $app->input->get('function', 'jSelectTfjfa_bacuerdo');
 ...
 */
?>
<div class="tfjfa_bacuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_TFJFA_BACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tfjfa_bacuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_tfjfa_bacuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('tfjfa_bacuerdoicon.create', $this->params);
?>
