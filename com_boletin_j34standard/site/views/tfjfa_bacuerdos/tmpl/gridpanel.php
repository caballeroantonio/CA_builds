...
class tfjfa_bacuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new tfjfa_bacuerdosApp();
$extJSHelper->parse('tfjfa_bacuerdo', 'tfjfa_bacuerdos');
...
Ext.Loader.require(
    ...
    */
    ...
    Ext.define('boletin.model.tfjfa_bacuerdo', {
...
//                "allowSingle": false,//todavía no veo cómo retornar valores con errores.
            ...
            extraParams: {
                ...
                'option': 'com_boletin',
                'model': 'tfjfa_bacuerdo',
                'store': 'tfjfa_bacuerdos',
            },
        },
