...
<div class="boletin tsjcdmx_sala_acuerdo-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_sala_acuerdoform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="tsjcdmx_sala_acuerdo-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('tsjcdmx_sala_acuerdo.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('tsjcdmx_sala_acuerdo.cancel')">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_tsjcdmx_sala_acuerdo_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-tsjcdmx_sala_acuerdo_fs" data-toggle="tab"><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELDSET_TSJCDMX_SALA_ACUERDO_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="tsjcdmx_sala_acuerdo-form" />
