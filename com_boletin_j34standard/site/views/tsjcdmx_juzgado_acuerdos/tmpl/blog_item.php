...
$layout		= $params->get('tsjcdmx_juzgado_acuerdo_layout', 'default');
...
<?php if (!$params->get('show_tsjcdmx_juzgado_acuerdo_readmore') 
		):?>
	<?php
...
<?php else : ?>
	...
	?>			
	<?php 
        //Optional link to let them register to see the whole tsjcdmx_juzgado_acuerdo.
		if ($params->get('show_tsjcdmx_juzgado_acuerdo_readmore')) :
				$link = JRoute::_(BoletinHelperRoute::getTsjcdmx_juzgado_acuerdoRoute($this->item->slug, 
																							$layout,									
																							$params->get('keep_tsjcdmx_juzgado_acuerdo_itemid')));
			?>
			<p class="readmore">
			...
			<?php
				...
				if ($item_params->get('tsjcdmx_juzgado_acuerdo_alternative_readmore') == null) :
						echo JText::sprintf('COM_BOLETIN_READ_MORE');
				else :
					echo $this->item->tsjcdmx_juzgado_acuerdo_alternative_readmore;
				endif;?>
			</a>
		</p>
	<?php endif; ?>
