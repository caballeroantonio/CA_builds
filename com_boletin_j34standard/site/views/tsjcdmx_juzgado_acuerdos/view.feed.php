...
class BoletinViewTsjcdmx_juzgado_acuerdos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_boletin&view=tsjcdmx_juzgado_acuerdos');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the tsjcdmx_juzgado_acuerdo slug
			$row->slug = $row->id;

			// url link to tsjcdmx_juzgado_acuerdo
			$link = JRoute::_(BoletinHelperRoute::getTsjcdmx_juzgado_acuerdoRoute($row->slug, 
																						'default',								
