...
$function	= $app->input->get('function', 'jSelectSrsps_bacuerdo');
 ...
 */
?>
<div class="srsps_bacuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_SRSPS_BACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=srsps_bacuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_srsps_bacuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('srsps_bacuerdoicon.create', $this->params);
?>
