...
class srsps_bacuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new srsps_bacuerdosApp();
$extJSHelper->parse('srsps_bacuerdo', 'srsps_bacuerdos');
...
Ext.Loader.require(
    ...
    */
    ...
    Ext.define('boletin.model.srsps_bacuerdo', {
...
//                "allowSingle": false,//todavía no veo cómo retornar valores con errores.
            ...
            extraParams: {
                ...
                'option': 'com_boletin',
                'model': 'srsps_bacuerdo',
                'store': 'srsps_bacuerdos',
            },
        },
