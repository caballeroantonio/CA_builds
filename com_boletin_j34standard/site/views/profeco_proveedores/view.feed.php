...
class BoletinViewProfeco_proveedores extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_boletin&view=profeco_proveedores');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the profeco_proveedor slug
			$row->slug = $row->id;

			// url link to profeco_proveedor
			$link = JRoute::_(BoletinHelperRoute::getProfeco_proveedorRoute($row->slug, 
																						'default',								
