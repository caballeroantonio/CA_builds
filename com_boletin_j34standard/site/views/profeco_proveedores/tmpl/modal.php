...
$function	= $app->input->get('function', 'jSelectProfeco_proveedor');
 ...
 */
?>
<div class="profeco_proveedores-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_PROFECO_PROVEEDORES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=profeco_proveedores&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="profeco_proveedores">
			<thead>
				<tr>
...
if ($this->params->get('show_profeco_proveedor_add_link', 1) AND $can_create)
	echo JHtml::_('profeco_proveedoricon.create', $this->params);
?>
