...
class profeco_proveedoresApp extends ExtJSHelper{
    
}
$extJSHelper = new profeco_proveedoresApp();
$extJSHelper->parse('profeco_proveedor', 'profeco_proveedores');
...
Ext.Loader.require(
    ...
    */
    ...
    Ext.define('boletin.model.profeco_proveedor', {
...
//                "allowSingle": false,//todavía no veo cómo retornar valores con errores.
            ...
            extraParams: {
                ...
                'option': 'com_boletin',
                'model': 'profeco_proveedor',
                'store': 'profeco_proveedores',
            },
        },
