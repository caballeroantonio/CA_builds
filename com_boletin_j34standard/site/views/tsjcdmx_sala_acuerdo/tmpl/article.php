...
$info		= $this->item->params->get('tsjcdmx_sala_acuerdo_info_block_position', 0);
...
<div class="boletin tsjcdmx_sala_acuerdo-article<?php echo $params->get('pageclass_sfx')?>">
	...
	<?php if ($params->get('show_tsjcdmx_sala_acuerdo_icons',-1) >= 0) : ?>
		<?php
			if ($params->get('show_tsjcdmx_sala_acuerdo_print_icon') 
	...
	<?php echo $this->item->event->beforeDisplayTsjcdmx_sala_acuerdo; ?>
		...
		<dl class="info">
			<dt class="info-title"><?php  echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_INFO'); ?></dt>
		<?php endif; ?>		
		
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_fecha_acuerdo')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_FECHA_ACUERDO_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_fecha_boletin')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_FECHA_BOLETIN_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_sala')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_SALA_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_actor')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_ACTOR_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_demandado')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_DEMANDADO_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_terceria')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_TERCERIA_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_tipo_juicio')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_TIPO_JUICIO_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_toca')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_TOCA_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_anio')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_ANIO_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_asunto')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_ASUNTO_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_tsjcdmx_sala_acuerdo_tipo_resolucion')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELD_TIPO_RESOLUCION_LABEL'); ?></strong>
					<?php
