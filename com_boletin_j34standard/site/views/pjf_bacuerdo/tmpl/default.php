...
<div class="boletin pjf_bacuerdo-view<?php echo $params->get('pageclass_sfx')?>">
	...
	<div style="padding-top: 10px;">
			...
			<form action="" name="pjf_bacuerdoForm" id="pjf_bacuerdoForm">
			<?php $dummy = false;
					$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELDSET_PJF_BACUERDO_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_pjf_bacuerdo_id_instancia')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_ID_INSTANCIA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_ID_ASUNTO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_NEUN_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_EXPEDIENTE_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_NCOCC_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_FECHA_AUTO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_ID_CUADERNO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELD_FECHA_PUBLICACION_LABEL'); ?>
							</label>
							<span>
								<?php
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_pjf_bacuerdo_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_pjf_bacuerdo_admin')) : ?>
