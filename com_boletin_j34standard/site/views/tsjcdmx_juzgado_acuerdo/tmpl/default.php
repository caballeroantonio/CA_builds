...
<div class="boletin tsjcdmx_juzgado_acuerdo-view<?php echo $params->get('pageclass_sfx')?>">
	...
	<div style="padding-top: 10px;">
			...
			<form action="" name="tsjcdmx_juzgado_acuerdoForm" id="tsjcdmx_juzgado_acuerdoForm">
			<?php $dummy = false;
					$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELDSET_TSJCDMX_JUZGADO_ACUERDO_FS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_tsjcdmx_juzgado_acuerdo_fecha_acuerdo')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_FECHA_ACUERDO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_FECHA_BOLETIN_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_JUZGADO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_ACTOR_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_DEMANDADO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_TERCERIA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_TIPO_JUICIO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_TOCA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_ANIO_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_BOLETIN_TSJCDMX_JUZGADO_ACUERDOS_FIELD_TIPO_RESOLUCION_LABEL'); ?>
							</label>
							<span>
								<?php
			...
			<?php
				$dummy = false;
		$display_fieldset = (
							($params->get('show_tsjcdmx_juzgado_acuerdo_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_tsjcdmx_juzgado_acuerdo_admin')) : ?>
