...
<div class="boletin tsjcdmx_juzgados_familiares_antiguos-blog<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<?php else : ?>
		...
		<div class="pagination">
				...
				<?php if ($this->params->def('show_tsjcdmx_juzgados_familiares_antiguo_pagination_results', 1)) : ?>
					<p class="counter">
