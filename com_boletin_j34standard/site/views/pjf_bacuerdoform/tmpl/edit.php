...
<div class="boletin pjf_bacuerdo-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=pjf_bacuerdoform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="pjf_bacuerdo-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('pjf_bacuerdo.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('pjf_bacuerdo.cancel')">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_pjf_bacuerdo_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-pjf_bacuerdo_fs" data-toggle="tab"><?php echo JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELDSET_PJF_BACUERDO_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="pjf_bacuerdo-form" />
