...
class BoletinViewFacuerdos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_boletin&view=facuerdos');
		...
		foreach ($rows as $row)
		{
			...
			if ($item->featured == 1)
			{
				$item->category[]	= JText::_('JFEATURED'); // All featured facuerdos are categorized as "Featured"
			}
