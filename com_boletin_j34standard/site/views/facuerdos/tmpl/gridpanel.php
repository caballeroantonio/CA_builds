...
class facuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new facuerdosApp();
$extJSHelper->parse('facuerdo', 'facuerdos');
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('boletin.model.facuerdo', {
...
//                "allowSingle": false,//todavía no veo cómo retornar valores con errores.
        ...
        Ext.define('boletin.store.facuerdos', {
            extend: 'Ext.data.Store',
            remoteSort: true,
            storeId: 'facuerdos',
            model: 'boletin.model.facuerdo',
            autoSync: true,
        });
