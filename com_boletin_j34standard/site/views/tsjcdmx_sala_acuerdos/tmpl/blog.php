...
<div class="boletin tsjcdmx_sala_acuerdos-blog<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<?php else : ?>
		...
		<div class="pagination">
				...
				<?php if ($this->params->def('show_tsjcdmx_sala_acuerdo_pagination_results', 1)) : ?>
					<p class="counter">
