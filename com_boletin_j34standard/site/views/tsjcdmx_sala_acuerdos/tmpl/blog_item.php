...
$layout		= $params->get('tsjcdmx_sala_acuerdo_layout', 'default');
...
<?php if (!$params->get('show_tsjcdmx_sala_acuerdo_readmore') 
		):?>
	<?php
...
<?php else : ?>
	...
	?>			
	<?php 
        //Optional link to let them register to see the whole tsjcdmx_sala_acuerdo.
		if ($params->get('show_tsjcdmx_sala_acuerdo_readmore')) :
				$link = JRoute::_(BoletinHelperRoute::getTsjcdmx_sala_acuerdoRoute($this->item->slug, 
																							$layout,									
																							$params->get('keep_tsjcdmx_sala_acuerdo_itemid')));
			?>
			<p class="readmore">
			...
			<?php
				...
				if ($item_params->get('tsjcdmx_sala_acuerdo_alternative_readmore') == null) :
						echo JText::sprintf('COM_BOLETIN_READ_MORE');
				else :
					echo $this->item->tsjcdmx_sala_acuerdo_alternative_readmore;
				endif;?>
			</a>
		</p>
	<?php endif; ?>
