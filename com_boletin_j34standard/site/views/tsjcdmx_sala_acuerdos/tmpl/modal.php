 ...
 */
?>
<div class="tsjcdmx_sala_acuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_sala_acuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="tsjcdmx_sala_acuerdos">
			<thead>
				<tr>
...
if ($this->params->get('show_tsjcdmx_sala_acuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('tsjcdmx_sala_acuerdoicon.create', $this->params);
?>
