...
class BoletinViewProdecon_bacuerdos extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_boletin&view=prodecon_bacuerdos');
		...
		foreach ($rows as $row)
		{
			...
			// Compute the prodecon_bacuerdo slug
			$row->slug = $row->id;

			// url link to prodecon_bacuerdo
			$link = JRoute::_(BoletinHelperRoute::getProdecon_bacuerdoRoute($row->slug, 
																						'default',								
