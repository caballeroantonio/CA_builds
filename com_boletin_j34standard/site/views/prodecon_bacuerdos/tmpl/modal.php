...
$function	= $app->input->get('function', 'jSelectProdecon_bacuerdo');
 ...
 */
?>
<div class="prodecon_bacuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=prodecon_bacuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="prodecon_bacuerdos">
			<thead>
				<tr>
...
if ($this->params->get('show_prodecon_bacuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('prodecon_bacuerdoicon.create', $this->params);
?>
