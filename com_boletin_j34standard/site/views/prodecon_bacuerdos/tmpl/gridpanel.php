...
class prodecon_bacuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new prodecon_bacuerdosApp();
$extJSHelper->parse('prodecon_bacuerdo', 'prodecon_bacuerdos');
...
Ext.Loader.require(
    ...
    */
    ...
    Ext.define('boletin.model.prodecon_bacuerdo', {
...
//                "allowSingle": false,//todavía no veo cómo retornar valores con errores.
            ...
            extraParams: {
                ...
                'option': 'com_boletin',
                'model': 'prodecon_bacuerdo',
                'store': 'prodecon_bacuerdos',
            },
        },
