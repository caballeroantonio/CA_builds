...
class tfca_bacuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new tfca_bacuerdosApp();
$extJSHelper->parse('tfca_bacuerdo', 'tfca_bacuerdos');
...
Ext.Loader.require(
    ...
    */
    ...
    Ext.define('boletin.model.tfca_bacuerdo', {
