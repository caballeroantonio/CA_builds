...
$function	= $app->input->get('function', 'jSelectTfca_bacuerdo');
 ...
 */
?>
<div class="tfca_bacuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_TFCA_BACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tfca_bacuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_tfca_bacuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('tfca_bacuerdoicon.create', $this->params);
?>
