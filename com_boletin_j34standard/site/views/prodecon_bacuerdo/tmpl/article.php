...
$info		= $this->item->params->get('prodecon_bacuerdo_info_block_position', 0);
...
<div class="boletin prodecon_bacuerdo-article<?php echo $params->get('pageclass_sfx')?>">
	...
	<?php if ($params->get('show_prodecon_bacuerdo_icons',-1) >= 0) : ?>
		<?php
			if ($params->get('show_prodecon_bacuerdo_print_icon') 
	...
	<?php echo $this->item->event->beforeDisplayProdecon_bacuerdo; ?>
		...
		<dl class="info">
			<dt class="info-title"><?php  echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_INFO'); ?></dt>
		<?php endif; ?>		
		
			<?php if ($params->get('show_prodecon_bacuerdo_id_delegacion')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELD_ID_DELEGACION_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_prodecon_bacuerdo_expediente')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELD_EXPEDIENTE_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_prodecon_bacuerdo_promovente')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELD_PROMOVENTE_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_prodecon_bacuerdo_destinatario')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELD_DESTINATARIO_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_prodecon_bacuerdo_autoridades')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELD_AUTORIDADES_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_prodecon_bacuerdo_fecha')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELD_FECHA_LABEL'); ?></strong>
					<?php
