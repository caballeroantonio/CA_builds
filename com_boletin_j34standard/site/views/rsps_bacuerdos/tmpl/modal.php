...
$function	= $app->input->get('function', 'jSelectRsps_bacuerdo');
 ...
 */
?>
<div class="rsps_bacuerdos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_BOLETIN_RSPS_BACUERDOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=rsps_bacuerdos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_rsps_bacuerdo_add_link', 1) AND $can_create)
	echo JHtml::_('rsps_bacuerdoicon.create', $this->params);
?>
