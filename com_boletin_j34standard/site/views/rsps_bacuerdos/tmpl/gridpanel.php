...
class rsps_bacuerdosApp extends ExtJSHelper{
    
}
$extJSHelper = new rsps_bacuerdosApp();
$extJSHelper->parse('rsps_bacuerdo', 'rsps_bacuerdos');
...
<script language="javascript">
    ...
    */
    ...
    Ext.define('boletin.model.rsps_bacuerdo', {
