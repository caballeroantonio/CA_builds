...
/**
 * Tsjcdmx_sala_acuerdo Field class from the Joomla! Framework.
 *
 */
class JFormFieldTsjcdmx_sala_acuerdo extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * 
	 */
	protected $type = 'Tsjcdmx_sala_acuerdo';
