...
/**
 * Tsjcdmx_juzgado_acuerdo Field class from the Joomla! Framework.
 *
 */
class JFormFieldTsjcdmx_juzgado_acuerdo extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * 
	 */
	protected $type = 'Tsjcdmx_juzgado_acuerdo';
