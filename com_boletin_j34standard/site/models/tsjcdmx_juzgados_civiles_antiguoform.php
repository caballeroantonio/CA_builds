...
require_once JPATH_ADMINISTRATOR.'/components/com_boletin/models/tsjcdmx_juzgados_civiles_antiguo.php';

class BoletinModelTsjcdmx_juzgados_civiles_antiguoForm extends BoletinModelTsjcdmx_juzgados_civiles_antiguo
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_boletin.edit.tsjcdmx_juzgados_civiles_antiguo';
	/**
	...
	*/
	 ...
	 *
	 * @param	integer	$item_id	The id of the tsjcdmx_juzgados_civiles_antiguo.
	 * @param	boolean		Get recursively item children - true or false
	 * @return	mixed	tsjcdmx_juzgados_civiles_antiguo item data object on success, false on failure.
	 */
	public function getItem($item_id = null, $recursive = false)
	{
		
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('tsjcdmx_juzgados_civiles_antiguo.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_boletin.edit.tsjcdmx_juzgados_civiles_antiguo.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('tsjcdmx_juzgados_civiles_antiguo.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onTsjcdmx_juzgados_civiles_antiguoBeforeSave', array('com_boletin.tsjcdmx_juzgados_civiles_antiguo', &$table, $is_new));
		...
		$dispatcher->trigger('onTsjcdmx_juzgados_civiles_antiguoAfterSave', array('com_boletin.tsjcdmx_juzgados_civiles_antiguo', $table, $is_new));

		$this->setState('tsjcdmx_juzgados_civiles_antiguo.id', $table->id);
