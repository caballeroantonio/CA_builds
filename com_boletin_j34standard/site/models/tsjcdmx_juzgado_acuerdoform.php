...
require_once JPATH_ADMINISTRATOR.'/components/com_boletin/models/tsjcdmx_juzgado_acuerdo.php';

class BoletinModelTsjcdmx_juzgado_acuerdoForm extends BoletinModelTsjcdmx_juzgado_acuerdo
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_boletin.edit.tsjcdmx_juzgado_acuerdo';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_boletin.tsjcdmx_juzgado_acuerdo';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_boletin.edit.tsjcdmx_juzgado_acuerdo', 'tsjcdmx_juzgado_acuerdo', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	 ...
	 *
	 * @param	integer	$item_id	The id of the tsjcdmx_juzgado_acuerdo.
	 * @param	boolean		Get recursively item children - true or false
	 * @return	mixed	tsjcdmx_juzgado_acuerdo item data object on success, false on failure.
	 */
	public function getItem($item_id = null, $recursive = false)
	{
		
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('tsjcdmx_juzgado_acuerdo.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_boletin.edit.tsjcdmx_juzgado_acuerdo.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('tsjcdmx_juzgado_acuerdo.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onTsjcdmx_juzgado_acuerdoBeforeSave', array('com_boletin.tsjcdmx_juzgado_acuerdo', &$table, $is_new));
		...
		$dispatcher->trigger('onTsjcdmx_juzgado_acuerdoAfterSave', array('com_boletin.tsjcdmx_juzgado_acuerdo', $table, $is_new));

		$this->setState('tsjcdmx_juzgado_acuerdo.id', $table->id);
