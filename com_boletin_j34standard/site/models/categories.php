...
/**
 * This models supports retrieving lists of boletin categories.
 *
 */
class BoletinModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_boletin.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_boletin';
