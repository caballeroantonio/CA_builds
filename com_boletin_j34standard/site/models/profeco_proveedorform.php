...
require_once JPATH_ADMINISTRATOR.'/components/com_boletin/models/profeco_proveedor.php';

class BoletinModelProfeco_proveedorForm extends BoletinModelProfeco_proveedor
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_boletin.edit.profeco_proveedor';
	/**
	 * Model typeAlias string. Used for version history.
	 *
	 * @var        string
	 */
	public $typeAlias = 'com_boletin.profeco_proveedor';
	/**
	...
	*/
	...
	{
		// Get the form.
		$form = $this->loadForm('com_boletin.edit.profeco_proveedor', 'profeco_proveedor', array('control' => 'jform', 'load_data' => $load_data));
		if (empty($form))
		{
			return false;
		}
	 ...
	 *
	 * @param	integer	$item_id	The id of the profeco_proveedor.
	 * @param	boolean		Get recursively item children - true or false
	 * @return	mixed	profeco_proveedor item data object on success, false on failure.
	 */
	public function getItem($item_id = null, $recursive = false)
	{
		
		$item_id = (int) (!empty($item_id)) ? $item_id : $this->getState('profeco_proveedor.id');
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_boletin.edit.profeco_proveedor.data', array());
	...
	public function save($data)
	{
		...
		$pk			= (!empty($data['id'])) ? $data['id'] : (int) $this->getState('profeco_proveedor.id');
		$is_new		= true;
		...
		$result = $dispatcher->trigger('onProfeco_proveedorBeforeSave', array('com_boletin.profeco_proveedor', &$table, $is_new));
		...
		$dispatcher->trigger('onProfeco_proveedorAfterSave', array('com_boletin.profeco_proveedor', $table, $is_new));

		$this->setState('profeco_proveedor.id', $table->id);
