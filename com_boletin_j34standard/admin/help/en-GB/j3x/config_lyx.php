...
class Foo {
    ...
    $output .= '\textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_FIELD_CONFIG_SINGLE_ITEM_DISPLAY'). '} & \textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_FIELD_CONFIG_SINGLE_ITEM_DESC'). '} \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_FIELD_LAYOUT_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_CHOOSE_LAYOUT_DESC'). ' \tabularnewline\hline '. "\r\n";
    ...
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_EMAIL_ICON_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_EMAIL_ICON_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_KEEP_ITEMID_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_KEEP_ITEMID_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_NAVIGATION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_NAVIGATION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_READMORE_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_READMORE_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_READMORE_LIMIT_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_READMORE_LIMIT_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_ADMIN_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_ADMIN_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ID_ACUERDO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ID_ACUERDO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_JUZGADO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_JUZGADO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_EXPEDIENTE_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_EXPEDIENTE_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ANIO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ANIO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_BIS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_BIS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_TIPO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_TIPO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ACTOR_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ACTOR_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_DEMANDADO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_DEMANDADO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_TERCERIA_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_TERCERIA_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_JUICIO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_JUICIO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ACCION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ACCION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_MATERIA_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_MATERIA_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_RESOLUCION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_RESOLUCION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_FECHA_ACUERDO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_FECHA_ACUERDO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_FECHA_PUBLICACION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_FECHA_PUBLICACION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_TIPO_ACUERDO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_TIPO_ACUERDO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_VISIBILIDAD_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_VISIBILIDAD_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ESPECIAL_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_FIELD_ESPECIAL_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= '\textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_FIELD_CONFIG_BLOG_LIST_LABEL'). '} & \textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_FIELD_CONFIG_BLOG_LIST_DESC'). '} \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_LEADING_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_LEADING_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_INTRO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_INTRO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_NUM_COLUMNS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_COLUMNS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_NUM_LINKS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_LINKS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_MULTI_COLUMN_ORDER_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_MULTI_COLUMN_ORDER_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_ORDER_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_ORDER_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_ORDER_DIRECTION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_ORDER_DIRECTION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_FILTER_FIELD_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_FILTER_FIELD_DESC'). ' \tabularnewline\hline '. "\r\n";
    ...
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_PAGINATION_LIMIT_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_PAGINATION_LIMIT_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NUM_PER_PAGE_LABEL'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NO_ITEMS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_NO_ITEMS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_ADD_LINK_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_ADD_LINK_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_DATE_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_FAMILIARES_ANTIGUOS_SHOW_DATE_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_DATE_FORMAT_LABEL'). ' & ' . $this->jtext2lyx('JGLOBAL_DATE_FORMAT_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= '\textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_FIELD_CONFIG_SINGLE_ITEM_DISPLAY'). '} & \textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_FIELD_CONFIG_SINGLE_ITEM_DESC'). '} \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_FIELD_LAYOUT_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_CHOOSE_LAYOUT_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_ICONS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_SHOW_ICONS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_PRINT_ICON_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_SHOW_PRINT_ICON_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_EMAIL_ICON_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_EMAIL_ICON_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_KEEP_ITEMID_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_KEEP_ITEMID_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_NAVIGATION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_NAVIGATION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_READMORE_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_READMORE_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_READMORE_LIMIT_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_READMORE_LIMIT_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_ADMIN_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_ADMIN_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ID_ACUERDO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ID_ACUERDO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_JUZGADO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_JUZGADO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_EXPEDIENTE_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_EXPEDIENTE_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ANIO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ANIO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_BIS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_BIS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_TIPO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_TIPO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ACTOR_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ACTOR_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_DEMANDADO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_DEMANDADO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_TERCERIA_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_TERCERIA_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_JUICIO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_JUICIO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ACCION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ACCION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_MATERIA_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_MATERIA_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_RESOLUCION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_RESOLUCION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_FECHA_ACUERDO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_FECHA_ACUERDO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_FECHA_PUBLICACION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_FECHA_PUBLICACION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_TIPO_ACUERDO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_TIPO_ACUERDO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_VISIBILIDAD_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_VISIBILIDAD_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ESPECIAL_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_FIELD_ESPECIAL_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= '\textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_FIELD_CONFIG_BLOG_LIST_LABEL'). '} & \textbf{' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_FIELD_CONFIG_BLOG_LIST_DESC'). '} \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_LEADING_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_LEADING_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_INTRO_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_INTRO_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_NUM_COLUMNS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_COLUMNS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_NUM_LINKS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_LINKS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_MULTI_COLUMN_ORDER_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_MULTI_COLUMN_ORDER_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_ORDER_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_ORDER_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_ORDER_DIRECTION_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_ORDER_DIRECTION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_FILTER_FIELD_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_FILTER_FIELD_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_SHOW_HEADINGS_LABEL'). ' & ' . $this->jtext2lyx('JGLOBAL_SHOW_HEADINGS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_PAGINATION_LABEL'). ' & ' . $this->jtext2lyx('JGLOBAL_PAGINATION_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_PAGINATION_RESULTS_LABEL'). ' & ' . $this->jtext2lyx('JGLOBAL_PAGINATION_RESULTS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_PAGINATION_LIMIT_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_PAGINATION_LIMIT_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NUM_PER_PAGE_LABEL'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NO_ITEMS_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_NO_ITEMS_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_ADD_LINK_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_ADD_LINK_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('COM_BOLETIN_SHOW_DATE_LABEL'). ' & ' . $this->jtext2lyx('COM_BOLETIN_TSJCDMX_JUZGADOS_CIVILES_ANTIGUOS_SHOW_DATE_DESC'). ' \tabularnewline\hline '. "\r\n";
    $output .= $this->jtext2lyx('JGLOBAL_DATE_FORMAT_LABEL'). ' & ' . $this->jtext2lyx('JGLOBAL_DATE_FORMAT_DESC'). ' \tabularnewline\hline '. "\r\n";
