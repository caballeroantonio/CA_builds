...
/**
 * Srsps_bacuerdo table
 *
 */
class BoletinTableSrsps_bacuerdos extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__boletin_srsps_bacuerdos', 'id', $db);
	...
	/**
	 * Stores a Secretaría De Hacienda Y Crédito Público - Sistema Del Registro De Servidores Públicos Sancionados
	 *
