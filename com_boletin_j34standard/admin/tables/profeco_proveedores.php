...
/**
 * Profeco_proveedor table
 *
 */
class BoletinTableProfeco_proveedores extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__boletin_profeco_proveedores', 'id', $db);
	...
	public function bind($array, $ignore = array())
	{
		...
		if ( !array_key_exists('is_concilianet',$array)  ) 
		{
			$array['is_concilianet'] = '0';
		}
			
		if ( !array_key_exists('is_conciliaexpres',$array)  ) 
		{
			$array['is_conciliaexpres'] = '0';
		}
	...
	/**
	 * Stores a Procuraduría Federal Del Consumidor - Buró Comercial
	 *
