...
/**
 * Tsjcdmx_juzgado_acuerdo model.
 *
 */
class BoletinModelTsjcdmx_juzgado_acuerdo extends JModelAdmin
{
	/**
	...
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.tsjcdmx_juzgado_acuerdo')
	 */
	 ...
	 */
	protected $event_before_save = 'onTsjcdmx_juzgado_acuerdoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onTsjcdmx_juzgado_acuerdoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onTsjcdmx_juzgado_acuerdoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onTsjcdmx_juzgado_acuerdoAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.tsjcdmx_juzgado_acuerdo.data', array());
