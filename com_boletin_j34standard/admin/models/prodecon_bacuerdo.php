...
/**
 * Prodecon_bacuerdo model.
 *
 */
class BoletinModelProdecon_bacuerdo extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_BOLETIN_PRODECON_BACUERDOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.prodecon_bacuerdo')
	 */
	 ...
	 */
	protected $event_before_save = 'onProdecon_bacuerdoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onProdecon_bacuerdoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onProdecon_bacuerdoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onProdecon_bacuerdoAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.prodecon_bacuerdo.data', array());
