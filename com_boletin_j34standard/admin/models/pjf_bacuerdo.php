 ...
 *
 */
class BoletinModelPjf_bacuerdo extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_BOLETIN_PJF_BACUERDOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.pjf_bacuerdo')
	 */
	 ...
	 */
	protected $event_before_save = 'onPjf_bacuerdoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onPjf_bacuerdoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onPjf_bacuerdoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onPjf_bacuerdoAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.pjf_bacuerdo.data', array());
