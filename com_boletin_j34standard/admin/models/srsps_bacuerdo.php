...
/**
 * Srsps_bacuerdo model.
 *
 */
class BoletinModelSrsps_bacuerdo extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_BOLETIN_SRSPS_BACUERDOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.srsps_bacuerdo')
	 */
	 ...
	 */
	protected $event_before_save = 'onSrsps_bacuerdoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onSrsps_bacuerdoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onSrsps_bacuerdoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onSrsps_bacuerdoAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.srsps_bacuerdo.data', array());
