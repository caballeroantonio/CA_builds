...
/**
 * Tsjcdmx_juzgados_familiares_antiguo Field class from the Joomla! Framework.
 *
 */
class JFormFieldTsjcdmx_juzgados_familiares_antiguo extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	 ...
	 * 
	 */
	protected $type = 'Tsjcdmx_juzgados_familiares_antiguo';
