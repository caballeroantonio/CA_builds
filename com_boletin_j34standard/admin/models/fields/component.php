...
class JFormFieldComponent extends JFormFieldList
{
	...
	public function getOptions()
	{
		...
		$query->where($db->quoteName('a.name').' <> "'.JText::_('COM_BOLETIN_COMPONENT_NAME').'"');
		...
		array_unshift($options, JHtml::_('select.option', '0', JText::_('COM_BOLETIN_COMPONENT_NAME')));
		array_unshift($options, JHtml::_('select.option', '0', JText::_('COM_BOLETIN_FIELD_CATEGORY_COMPONENT_NO_CATEGORIES')));
		return $options;
	}
}
