...
/**
 * Profeco_proveedor model.
 *
 */
class BoletinModelProfeco_proveedor extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_BOLETIN_PROFECO_PROVEEDORES';
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.profeco_proveedor')
	 */
	 ...
	 */
	protected $event_before_save = 'onProfeco_proveedorBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onProfeco_proveedorAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onProfeco_proveedorBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onProfeco_proveedorAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.profeco_proveedor.data', array());
