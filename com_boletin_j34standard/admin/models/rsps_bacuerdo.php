 ...
 *
 */
class BoletinModelRsps_bacuerdo extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_BOLETIN_RSPS_BACUERDOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.rsps_bacuerdo')
	 */
	 ...
	 */
	protected $event_before_save = 'onRsps_bacuerdoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onRsps_bacuerdoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onRsps_bacuerdoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onRsps_bacuerdoAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.rsps_bacuerdo.data', array());
