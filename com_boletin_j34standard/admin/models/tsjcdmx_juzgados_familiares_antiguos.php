...
/**
 * Methods supporting a list of tsjcdmx_juzgados_familiares_antiguo records.
 *
 */
class BoletinModelTsjcdmx_juzgados_familiares_antiguos extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// Select the required tsjcdmx_juzgados_familiares_antiguos from the table.
		$query->select(
			$this->getState(
					'list.select',
					'a.*'
		...
		if ($id_acuerdo = $this->getState('filter.id_acuerdo'))
		{
			...
			$query->where('LOWER('.$db->quoteName('a.id_acuerdo').') = ' . $db->quote($id_acuerdo));
		}
