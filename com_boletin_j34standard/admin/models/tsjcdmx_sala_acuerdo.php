...
/**
 * Tsjcdmx_sala_acuerdo model.
 *
 */
class BoletinModelTsjcdmx_sala_acuerdo extends JModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 */
	protected $text_prefix = 'COM_BOLETIN_TSJCDMX_SALA_ACUERDOS';
	/**
	 * @var      string	The type alias for this object (for example, 'com_boletin.tsjcdmx_sala_acuerdo')
	 */
	 ...
	 */
	protected $event_before_save = 'onTsjcdmx_sala_acuerdoBeforeSave';
	/**
	 * @var		string	The event to trigger after saving the data.
	 */
	protected $event_after_save = 'onTsjcdmx_sala_acuerdoAfterSave';

	/**
	 * @var    string	The event to trigger before deleting the data.
	 */
	protected $event_before_delete = 'onTsjcdmx_sala_acuerdoBeforeDelete';	
	/**
	 * @var    string	The event to trigger after deleting the data.
	 */
	protected $event_after_delete = 'onTsjcdmx_sala_acuerdoAfterDelete';	
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_boletin.edit.tsjcdmx_sala_acuerdo.data', array());
