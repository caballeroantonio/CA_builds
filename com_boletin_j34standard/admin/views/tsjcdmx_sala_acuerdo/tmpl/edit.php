...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_sala_acuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="tsjcdmx_sala_acuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'tsjcdmx_sala_acuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'tsjcdmx_sala_acuerdo-tabs', 'details', JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'tsjcdmx_sala_acuerdo-tabs', 'fieldset-tsjcdmx_sala_acuerdo_fs', JText::_('COM_BOLETIN_TSJCDMX_SALA_ACUERDOS_FIELDSET_TSJCDMX_SALA_ACUERDO_FS_LABEL', true)); ?>
