...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_sala_acuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="tsjcdmx_sala_acuerdo-list">
			<thead>
				<tr>
