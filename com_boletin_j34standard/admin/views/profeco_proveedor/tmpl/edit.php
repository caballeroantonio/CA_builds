...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=profeco_proveedor&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="profeco_proveedor-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'profeco_proveedor-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'profeco_proveedor-tabs', 'details', JText::_('COM_BOLETIN_PROFECO_PROVEEDORES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'profeco_proveedor-tabs', 'fieldset-profeco_proveedor_fs', JText::_('COM_BOLETIN_PROFECO_PROVEEDORES_FIELDSET_PROFECO_PROVEEDOR_FS_LABEL', true)); ?>
