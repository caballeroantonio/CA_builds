...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_boletin&task=tfjfa_bacuerdos.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'tfjfa_bacuerdo-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tfjfa_bacuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="tfjfa_bacuerdo-list">
			<thead>
				<tr>
