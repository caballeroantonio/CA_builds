...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tfca_bacuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="tfca_bacuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'tfca_bacuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'tfca_bacuerdo-tabs', 'details', JText::_('COM_BOLETIN_TFCA_BACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'tfca_bacuerdo-tabs', 'fieldset-tfca_bacuerdo_fs', JText::_('COM_BOLETIN_TFCA_BACUERDOS_FIELDSET_TFCA_BACUERDO_FS_LABEL', true)); ?>
