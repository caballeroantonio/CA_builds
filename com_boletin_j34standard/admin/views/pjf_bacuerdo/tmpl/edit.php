...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=pjf_bacuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="pjf_bacuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'pjf_bacuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'pjf_bacuerdo-tabs', 'details', JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'pjf_bacuerdo-tabs', 'fieldset-pjf_bacuerdo_fs', JText::_('COM_BOLETIN_PJF_BACUERDOS_FIELDSET_PJF_BACUERDO_FS_LABEL', true)); ?>
