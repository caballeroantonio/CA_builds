...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=prodecon_bacuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="prodecon_bacuerdo-list">
			<thead>
				<tr>
