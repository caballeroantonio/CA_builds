...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=rsps_bacuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="rsps_bacuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'rsps_bacuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'rsps_bacuerdo-tabs', 'details', JText::_('COM_BOLETIN_RSPS_BACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'rsps_bacuerdo-tabs', 'fieldset-rsps_bacuerdo_fs', JText::_('COM_BOLETIN_RSPS_BACUERDOS_FIELDSET_RSPS_BACUERDO_FS_LABEL', true)); ?>
