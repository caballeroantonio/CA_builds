...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=pjf_bacuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="pjf_bacuerdo-list">
			<thead>
				<tr>
