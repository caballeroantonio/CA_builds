...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=srsps_bacuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="srsps_bacuerdo-list">
			<thead>
				<tr>
