...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=facuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="facuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'facuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'facuerdo-tabs', 'details', JText::_('COM_BOLETIN_FACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'facuerdo-tabs', 'fieldset-facuerdo_fs', JText::_('COM_BOLETIN_FACUERDOS_FIELDSET_FACUERDO_FS_LABEL', true)); ?>
