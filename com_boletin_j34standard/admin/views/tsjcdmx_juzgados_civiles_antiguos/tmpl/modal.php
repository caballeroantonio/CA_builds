...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_juzgados_civiles_antiguos&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
	<fieldset class="filter clearfix">
		...
		<div class="filters pull-left">
			<select name="filter_id_acuerdo" class="input-medium js-stools-field-order" onchange="this.form.submit()">
