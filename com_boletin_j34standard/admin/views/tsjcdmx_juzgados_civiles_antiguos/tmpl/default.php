...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_juzgados_civiles_antiguos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="tsjcdmx_juzgados_civiles_antiguo-list">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				$can_change = true;
				$can_edit	= $user->authorise('core.edit',	'com_boletin');
		
				$can_edit_own	= $user->authorise('core.edit.own',		'com_boletin') 
								;
				$can_change	= $user->authorise('core.edit.state',	'com_boletin') 
								;
