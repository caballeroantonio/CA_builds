...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=srsps_bacuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="srsps_bacuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'srsps_bacuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'srsps_bacuerdo-tabs', 'details', JText::_('COM_BOLETIN_SRSPS_BACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'srsps_bacuerdo-tabs', 'fieldset-srsps_bacuerdo_fs', JText::_('COM_BOLETIN_SRSPS_BACUERDOS_FIELDSET_SRSPS_BACUERDO_FS_LABEL', true)); ?>
