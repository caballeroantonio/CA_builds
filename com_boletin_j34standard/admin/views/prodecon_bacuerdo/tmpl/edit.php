...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=prodecon_bacuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="prodecon_bacuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'prodecon_bacuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'prodecon_bacuerdo-tabs', 'details', JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'prodecon_bacuerdo-tabs', 'fieldset-prodecon_bacuerdo_fs', JText::_('COM_BOLETIN_PRODECON_BACUERDOS_FIELDSET_PRODECON_BACUERDO_FS_LABEL', true)); ?>
