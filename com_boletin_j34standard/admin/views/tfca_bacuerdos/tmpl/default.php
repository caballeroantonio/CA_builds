...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tfca_bacuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="tfca_bacuerdo-list">
			<thead>
				<tr>
