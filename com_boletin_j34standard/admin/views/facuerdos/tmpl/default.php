...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_boletin&task=facuerdos.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'facuerdo-list', 'adminForm', strtolower($list_dirn), $save_ordering_url);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=facuerdos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="facuerdo-list">
			<thead>
				<tr>
