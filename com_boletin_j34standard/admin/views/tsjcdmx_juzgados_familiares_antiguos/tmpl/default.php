...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tsjcdmx_juzgados_familiares_antiguos'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="tsjcdmx_juzgados_familiares_antiguo-list">
			<thead>
				<tr>
