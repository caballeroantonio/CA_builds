...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=profeco_proveedores'); ?>" method="post" name="adminForm" id="adminForm">
...
?>	
	...
	<?php else : ?>
		<table class="table table-striped" id="profeco_proveedor-list">
			<thead>
				<tr>
