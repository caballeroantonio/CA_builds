...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=profeco_proveedores&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
