...
<form action="<?php echo JRoute::_('index.php?option=com_boletin&view=tfjfa_bacuerdo&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="tfjfa_bacuerdo-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'tfjfa_bacuerdo-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'tfjfa_bacuerdo-tabs', 'details', JText::_('COM_BOLETIN_TFJFA_BACUERDOS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'tfjfa_bacuerdo-tabs', 'fieldset-tfjfa_bacuerdo_fs', JText::_('COM_BOLETIN_TFJFA_BACUERDOS_FIELDSET_TFJFA_BACUERDO_FS_LABEL', true)); ?>
