...
<div id="dashboard" style="width: 100%">
	...
	<div style="width: 45%; display:block; float:left; margin-left: 10px;">
		...
		<div class="description">
			<?php echo JText::_('COM_BOLETIN_DASHBOARD_DESCRIPTION'); ?>
		</div>	
		<h3 align="center" style="margin-top: 30px;">
			<?php echo JText::_('COM_BOLETIN_DASHBOARD_UPDATE_HEADER'); ?>
		</h3>		
		<div class="updated">
			<?php echo JText::_('COM_BOLETIN_DASHBOARD_USE_JOOMLA_UPDATES'); ?>
		</div>	
		<div class="alert alert-message" style="width: 50%; margin-left: auto; margin-right: auto;">
			<p style="font-weight: bold; text-align: center; margin-bottom: 0px;"><?php echo JText::_('COM_BOLETIN_DASHBOARD_CURRENT_RELEASE'); ?></p>
		</div>
		<h3 align="center" style="margin-top: 30px;">
			<?php echo JText::_('COM_BOLETIN_DASHBOARD_COPYRIGHT_HEADER'); ?>
		</h3>		
		<div class="copyright">
			<?php echo JText::_('COM_BOLETIN_DASHBOARD_COPYRIGHT'); ?><br/>
			<?php echo JText::_('COM_BOLETIN_DASHBOARD_LICENSE'); ?>
			<br/><br/>
		</div>
		<div class="copyright">
			<br /><br />
			<em><?php echo JText::_('COM_BOLETIN_JOOMLA_LOGO_DISCLAIMER'); ?></em>
		</div>	
	</div>
</div>