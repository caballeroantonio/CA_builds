 ...
 *
 * @CAversion		Id: renderfield.php 571 2016-01-04 15:03:02Z BrianWade $
 * @CAauthor		Component Architect (www.componentarchitect.com)
 * @CApackage		architectcomp
 * @CAsubpackage	architectcomp.admin.layout
		...
		<?php if (!isset($displayData['options']['user'])) : ?>
			...
			<?php if (isset($displayData['options']['file']) AND $displayData['options']['file'] != '') : ?>
				<div class="button2-left">
					<div class="blank">
						<a title="<?php echo JText::_('COM_BOLETIN_VIEW_FILE');?>" href="<?php echo JRoute::_(JUri::root().trim($displayData['options']['file']), false); ?>" target="_blank">
							<?php echo JText::_('COM_BOLETIN_VIEW_FILE');?>
						</a>
					</div>
				</div>
			<?php endif; ?>	
